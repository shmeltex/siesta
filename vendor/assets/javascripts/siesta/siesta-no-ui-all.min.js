...
!0;return(new b(a,c)).c},create:function(b,c,d){if(!b)return(new c(b,d)).c;var e=this;if(/^\./.test(b))return this.executeIn(a.top,function(){return e.create(b.replace(/^\./,""),c,d)});for(var f=d||{},g=a.S.saneSplit(b,"."),q=this.getCurrent(),u=q==a.top?[]:a.S.saneSplit(q.meta.name,"."),y=0;y<g.length;y++){var z=g[y],r=y==g.length-1;if("meta"==z||"my"==z||!z)throw"Module name ["+b+"] may not include a part called 'meta' or 'my' or empty part.";var v=q[z];u.push(z);var A=u.join("."),C=!1;if("undefined"==
typeof v)r?(v=this.earlyCreate(A,c,f),C=!0):v=(new a.Namespace.Keeper(A)).c,q[z]=v;else if(r&&v&&v.meta)if(q=v.meta,c==a.Namespace.Keeper)q.extend(f);else if(q instanceof a.Namespace.Keeper)q.plant(this.earlyCreate(A,c,f)),C=!0;else throw Error("Double declaration of ["+A+"]");else if(r&&!(v&&v.meta&&v.meta.meta))throw"Trying to setup module "+A+" failed. There is already something: "+v;r&&this.prepareMeta(v.meta);C&&v.meta.construct(f);q=v}return q},prepareMeta:function(){},prepareProperties:function(a,
...
"Please enable popups for the host with this test suite running: "+this.parentWindow.location.host;"v"!="\v"&&!this.parentWindow.msWriteProfilerMark||this.sourceURL||(b=this.getDocument(),b.open(),b.write(""),b.close());this.cachedOnError&&this.installOnErrorHandler(this.cachedOnError);var d=function(a,b){var c=!1,d=!0,l=a.document,m=l.documentElement,n=l.addEventListener?"addEventListener":"attachEvent",p=l.addEventListener?"removeEventListener":"detachEvent",w=l.addEventListener?"":"on",q=function(d){if("readystatechange"!=
d.type||"complete"==l.readyState)("load"==d.type?a:l)[p](w+d.type,q,!1),!c&&(c=!0)&&b.call(a,d.type||d)},u=function(){try{m.doScroll("left")}catch(a){setTimeout(u,50);return}q("poll")};if("complete"==l.readyState)b.call(a,"lazy");else{if(l.createEventObject&&m.doScroll){try{d=!a.frameElement}catch(y){}d&&u()}l[n](w+"DOMContentLoaded",q,!1);l[n](w+"readystatechange",q,!1);a[n](w+"load",q,!1)}};this.sourceURL?setTimeout(function(){d(c,a||function(){})},10):d(c,a||function(){})},getDocument:function(){return this.popupWindow.document},
...
(function(){function a(a){return 10>a?"0"+a:a}function b(a){e.lastIndex=0;return e.test(a)?'"'+a.replace(e,function(a){var b=k[a];return"string"===typeof b?b:"\\u"+("0000"+a.charCodeAt(0).toString(16)).slice(-4)})+'"':'"'+a+'"'}function c(a,d){var e,k,q,u,y=f,z,r=d[a];r&&"object"===typeof r&&"function"===typeof r.toJSON&&(r=r.toJSON(a));"function"===typeof l&&(r=l.call(d,a,r));switch(typeof r){case "string":return b(r);case "number":return isFinite(r)?String(r):"null";case "boolean":case "null":return String(r);
case "object":if(!r)return"null";f+=g;z=[];if("[object Array]"===Object.prototype.toString.apply(r)){u=r.length;for(e=0;e<u;e+=1)z[e]=c(e,r)||"null";q=0===z.length?"[]":f?"[\n"+f+z.join(",\n"+f)+"\n"+y+"]":"["+z.join(",")+"]";f=y;return q}if(l&&"object"===typeof l)for(u=l.length,e=0;e<u;e+=1)"string"===typeof l[e]&&(k=l[e],(q=c(k,r))&&z.push(b(k)+(f?": ":":")+q));else for(k in r)Object.prototype.hasOwnProperty.call(r,k)&&(q=c(k,r))&&z.push(b(k)+(f?": ":":")+q);q=0===z.length?"{}":f?"{\n"+f+z.join(",\n"+
f)+"\n"+y+"}":"{"+z.join(",")+"}";f=y;return q}}"function"!==typeof Date.prototype.toJSON&&(Date.prototype.toJSON=function(b){return isFinite(this.valueOf())?this.getUTCFullYear()+"-"+a(this.getUTCMonth()+1)+"-"+a(this.getUTCDate())+"T"+a(this.getUTCHours())+":"+a(this.getUTCMinutes())+":"+a(this.getUTCSeconds())+"Z":null},String.prototype.toJSON=Number.prototype.toJSON=Boolean.prototype.toJSON=function(a){return this.valueOf()});var d=/[\u0000\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,
...
this.fireEvent("testupdate",this,c,this.getResults());return c},finalizeWaiting:function(a,b,c,d,e,f){a.completed=!0;b?this.suppressPassedWaitForAssertion||f?this.fireEvent("assertiondiscard",this,a):this.pass(c,d,a):(this.fail(c,d,a),e&&e())},waitFor:function(a,b,c,d,e){var f=Siesta.Resource("Siesta.Test.More"),g=" "+f.get("conditionToBeFulfilled"),k="waitFor",l=this,m=l.getSourceLine(),n=l.originalSetTimeout,p=l.originalClearTimeout,w,q;if(1===arguments.length&&"Object"==this.typeOf(a)){var u=a;
a=u.method;b=u.callback;c=u.scope;d=u.timeout;e=u.interval;g=u.description||g;k=u.assertionName||k;q=u.suppressAssertion;w=u.errback}u="Number"==this.typeOf(a);b=b||function(){};var g=u?a+" "+f.get("ms"):g,y,z=l.startWaiting(f.get("waitingFor")+" "+g,m);e=e||this.waitForPollInterval;d=d||this.waitForTimeout;var r=this.beginAsync((u?a:d)+3*e,function(){v=!0;p(y);l.finalizeWaiting(z,!1,f.get("waitedTooLong")+": "+g,{assertionName:k,annotation:f.get("conditionNotFulfilled")+" "+d+f.get("ms")},w,q);return!0}),
v=!1;this.on("beforetestfinalize",function(){v||(v=!0,l.finalizeWaiting(z,!1,f.get("waitingAborted"),null,null,q),l.endAsync(r),p(y))},null,{single:!0});if(u){if(0>a)throw"Cannot wait for a negative amount of time";y=n(function(){v=!0;l.finalizeWaiting(z,!0,f.get("Waited")+" "+a+" "+f.get("ms"),null,null,q||0===a);l.endAsync(r);l.processCallbackFromTest(b,[],c||l)},a)}else{var A,C=new Date,E=function(){var m=new Date-C;if(m>d)l.endAsync(r),l.finalizeWaiting(z,!1,f.get("waitedTooLong")+": "+g,{assertionName:k,
annotation:f.get("conditionNotFulfilled")+" "+d+f.get("ms")},w,q),v=!0;else{try{A=a.call(c||l)}catch(p){l.endAsync(r);l.finalizeWaiting(z,!1,k+" "+f.get("checkerException"),{assertionName:k,got:p.toString(),gotDesc:f.get("Exception")},w,q);v=!0;return}null!=A&&!1!==A?(l.endAsync(r),v=!0,l.finalizeWaiting(z,!0,f.get("Waited")+" "+m+" "+f.get("msFor")+" "+g,null,null,q||0===m),l.processCallbackFromTest(b,[A],c||l)):y=n(E,e)}};E()}return{force:function(){v||(v=!0,p(y),l.endAsync(r),l.finalizeWaiting(z,
...
{sourceLine:k,annotation:b.get("stepNumber")+": "+(c+1)+" "+b.get("oneBased")+(k?"\n"+b.get("atLine")+": "+k:""),ownTextOnly:!0});return!0});return{next:function(){var p=arguments.callee;p.__CALLED__&&e.fail(b.get("calledMoreThanOnce",{num:c+1,line:k}));p.__CALLED__=!0;f||e.endAsync(g);l=Array.prototype.slice.call(arguments);a.desc&&e.pass(a.desc);d.next()},async:g}};if(a instanceof Siesta.Test)e.launchSubTest(a,g(!0).next);else if("Function"==e.typeOf(a)||"Function"==e.typeOf(a.action)){var u="Function"==
e.typeOf(a)?a:a.action,g=g(!1);l.unshift(f?function(){}:g.next);f||e.analyzeChainStep(u)||e.fail(b.get("stepFn")+" ["+u.toString()+"] "+b.get("notUsingNext"));if(e.transparentEx)u.apply(e,l);else{var y=e.getExceptionCatcher()(function(){u.apply(e,l)});void 0!==y&&e.fail(b.get("chainStepEx"),{annotation:e.stringifyException(y)})}f&&(e.endAsync(g.async),a.desc&&e.pass(a.desc))}else("String"==e.typeOf(a)?new Siesta.Test.Action.Eval({actionString:a,next:g(!1).next,test:e}):Siesta.Test.ActionRegistry().create(a,
...
(function(a,b){function c(a,c,d){if(d===b&&1===a.nodeType)if(d="data-"+c.replace(Ua,"$1-$2").toLowerCase(),d=a.getAttribute(d),"string"===typeof d){try{d="true"===d?!0:"false"===d?!1:"null"===d?null:h.isNaN(d)?Va.test(d)?h.parseJSON(d):d:parseFloat(d)}catch(e){}h.data(a,c,d)}else d=b;return d}function d(a){for(var b in a)if("toJSON"!==b)return!1;return!0}function e(a,c,d){var e=c+"defer",f=c+"queue",g=c+"mark",k=h.data(a,e,b,!0);!k||"queue"!==d&&h.data(a,f,b,!0)||"mark"!==d&&h.data(a,g,b,!0)||setTimeout(function(){h.data(a,
f,b,!0)||h.data(a,g,b,!0)||(h.removeData(a,e,!0),k.resolve())},0)}function f(){return!1}function g(){return!0}function k(a,c,d){var e=h.extend({},d[0]);e.type=a;e.originalEvent={};e.liveFired=b;h.event.handle.call(c,e);e.isDefaultPrevented()&&d[0].preventDefault()}function l(a){var b,c,d,e,f,g,k,l,m,n,r,p=[];e=[];f=h._data(this,"events");if(a.liveFired!==this&&f&&f.live&&!a.target.disabled&&(!a.button||"click"!==a.type)){a.namespace&&(r=new RegExp("(^|\\.)"+a.namespace.split(".").join("\\.(?:.*\\.)?")+
"(\\.|$)"));a.liveFired=this;var v=f.live.slice(0);for(k=0;k<v.length;k++)f=v[k],f.origType.replace(fa,"")===a.type?e.push(f.selector):v.splice(k--,1);e=h(a.target).closest(e,a.currentTarget);l=0;for(m=e.length;l<m;l++)for(n=e[l],k=0;k<v.length;k++)if(f=v[k],n.selector===f.selector&&(!r||r.test(f.namespace))&&!n.elem.disabled){g=n.elem;d=null;if("mouseenter"===f.preType||"mouseleave"===f.preType)a.type=f.preType,(d=h(a.relatedTarget).closest(f.selector)[0])&&h.contains(g,d)&&(d=g);d&&d===g||p.push({elem:g,
handleObj:f,level:n.level})}l=0;for(m=p.length;l<m;l++){e=p[l];if(c&&e.level>c)break;a.currentTarget=e.elem;a.data=e.handleObj.data;a.handleObj=e.handleObj;r=e.handleObj.origHandler.apply(e.elem,arguments);if(!1===r||a.isPropagationStopped())if(c=e.level,!1===r&&(b=!1),a.isImmediatePropagationStopped())break}return b}}function m(a,b){return(a&&"*"!==a?a+".":"")+b.replace(Wa,"`").replace(Xa,"&")}function n(a){return!a||!a.parentNode||11===a.parentNode.nodeType}function p(a,b,c){b=b||0;if(h.isFunction(b))return h.grep(a,
function(a,d){return!!b.call(a,d,a)===c});if(b.nodeType)return h.grep(a,function(a,d){return a===b===c});if("string"===typeof b){var d=h.grep(a,function(a){return 1===a.nodeType});if(Ya.test(b))return h.filter(b,d,!c);b=h.filter(b,d)}return h.grep(a,function(a,d){return 0<=h.inArray(a,b)===c})}function w(a,b){return h.nodeName(a,"table")?a.getElementsByTagName("tbody")[0]||a.appendChild(a.ownerDocument.createElement("tbody")):a}function q(a,b){if(1===b.nodeType&&h.hasData(a)){var c=h.expando,d=h.data(a),
e=h.data(b,d);if(d=d[c]){var f=d.events,e=e[c]=h.extend({},d);if(f){delete e.handle;e.events={};for(var g in f)for(c=0,d=f[g].length;c<d;c++)h.event.add(b,g+(f[g][c].namespace?".":"")+f[g][c].namespace,f[g][c],f[g][c].data)}}}}function u(a,b){var c;if(1===b.nodeType){b.clearAttributes&&b.clearAttributes();b.mergeAttributes&&b.mergeAttributes(a);c=b.nodeName.toLowerCase();if("object"===c)b.outerHTML=a.outerHTML;else if("input"===c&&("checkbox"===a.type||"radio"===a.type))a.checked&&(b.defaultChecked=
b.checked=a.checked),b.value!==a.value&&(b.value=a.value);else if("option"===c)b.selected=a.defaultSelected;else if("input"===c||"textarea"===c)b.defaultValue=a.defaultValue;b.removeAttribute(h.expando)}}function y(a){return"getElementsByTagName"in a?a.getElementsByTagName("*"):"querySelectorAll"in a?a.querySelectorAll("*"):[]}function z(a){if("checkbox"===a.type||"radio"===a.type)a.defaultChecked=a.checked}function r(a){h.nodeName(a,"input")?z(a):"getElementsByTagName"in a&&h.grep(a.getElementsByTagName("input"),
z)}function v(a,b){b.src?h.ajax({url:b.src,async:!1,dataType:"script"}):h.globalEval((b.text||b.textContent||b.innerHTML||"").replace(Za,"/*$0*/"));b.parentNode&&b.parentNode.removeChild(b)}function A(a,b,c){var d="width"===b?a.offsetWidth:a.offsetHeight,e="width"===b?$a:ab;if(0<d)return"border"!==c&&h.each(e,function(){c||(d-=parseFloat(h.css(a,"padding"+this))||0);d="margin"===c?d+(parseFloat(h.css(a,c+this))||0):d-(parseFloat(h.css(a,"border"+this+"Width"))||0)}),d+"px";d=M(a,b,b);if(0>d||null==
d)d=a.style[b]||0;d=parseFloat(d)||0;c&&h.each(e,function(){d+=parseFloat(h.css(a,"padding"+this))||0;"padding"!==c&&(d+=parseFloat(h.css(a,"border"+this+"Width"))||0);"margin"===c&&(d+=parseFloat(h.css(a,c+this))||0)});return d+"px"}function C(a){return function(b,c){"string"!==typeof b&&(c=b,b="*");if(h.isFunction(c))for(var d=b.toLowerCase().split(sa),e=0,f=d.length,g,k;e<f;e++)g=d[e],(k=/^\+/.test(g))&&(g=g.substr(1)||"*"),g=a[g]=a[g]||[],g[k?"unshift":"push"](c)}}function E(a,c,d,e,f,h){f=f||
c.dataTypes[0];h=h||{};h[f]=!0;f=a[f];for(var g=0,k=f?f.length:0,l=a===ga,m;g<k&&(l||!m);g++)m=f[g](c,d,e),"string"===typeof m&&(!l||h[m]?m=b:(c.dataTypes.unshift(m),m=E(a,c,d,e,m,h)));!l&&m||h["*"]||(m=E(a,c,d,e,"*",h));return m}function B(a,b,c,d){if(h.isArray(b))h.each(b,function(b,e){c||bb.test(a)?d(a,e):B(a+"["+("object"===typeof e||h.isArray(e)?b:"")+"]",e,c,d)});else if(c||null==b||"object"!==typeof b)d(a,b);else for(var e in b)B(a+"["+e+"]",b[e],c,d)}function D(){try{return new a.XMLHttpRequest}catch(b){}}
function H(){setTimeout(ha,0);return aa=h.now()}function ha(){aa=b}function P(a,b){var c={};h.each(ta.concat.apply([],ta.slice(0,b)),function(){c[this]=a});return c}function ua(a){if(!ia[a]){var b=x.body,c=h("<"+a+">").appendTo(b),d=c.css("display");c.remove();if("none"===d||""===d)J||(J=x.createElement("iframe"),J.frameBorder=J.width=J.height=0),b.appendChild(J),Q&&J.createElement||(Q=(J.contentWindow||J.contentDocument).document,Q.write(("CSS1Compat"===x.compatMode?"<!doctype html>":"")+"<html><body>"),
Q.close()),c=Q.createElement(a),Q.body.appendChild(c),d=h.css(c,"display"),b.removeChild(J);ia[a]=d}return ia[a]}function ja(a){return h.isWindow(a)?a:9===a.nodeType?a.defaultView||a.parentWindow:!1}var x=a.document,cb=a.navigator,db=a.location,h=function(){function c(){if(!d.isReady){try{x.documentElement.doScroll("left")}catch(a){setTimeout(c,1);return}d.ready()}}var d=function(a,b){return new d.fn.init(a,b,h)},e=a.jQuery,f=a.$,h,g=/^(?:[^<]*(<[\w\W]+>)[^>]*$|#([\w\-]*)$)/,k=/\S/,l=/^\s+/,m=/\s+$/,
n=/\d/,r=/^<(\w+)\s*\/?>(?:<\/\1>)?$/,p=/^[\],:{}\s]*$/,v=/\\(?:["\\\/bfnrt]|u[0-9a-fA-F]{4})/g,A=/"[^"\\\n\r]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g,q=/(?:^|:|,)(?:\s*\[)+/g,w=/(webkit)[ \/]([\w.]+)/,u=/(opera)(?:.*version)?[ \/]([\w.]+)/,z=/(msie) ([\w.]+)/,va=/(mozilla)(?:.*? rv:([\w.]+))?/,eb=/-([a-z])/ig,fb=function(a,b){return b.toUpperCase()},ka=cb.userAgent,T,ba,U,gb=Object.prototype.toString,C=Object.prototype.hasOwnProperty,B=Array.prototype.push,E=Array.prototype.slice,y=
String.prototype.trim,wa=Array.prototype.indexOf,D={};d.fn=d.prototype={constructor:d,init:function(a,c,e){var t;if(!a)return this;if(a.nodeType)return this.context=this[0]=a,this.length=1,this;if("body"===a&&!c&&x.body)return this.context=x,this[0]=x.body,this.selector=a,this.length=1,this;if("string"===typeof a){t="<"===a.charAt(0)&&">"===a.charAt(a.length-1)&&3<=a.length?[null,a,null]:g.exec(a);if(!t||!t[1]&&c)return!c||c.jquery?(c||e).find(a):this.constructor(c).find(a);if(t[1])return e=(c=c instanceof
d?c[0]:c)?c.ownerDocument||c:x,(a=r.exec(a))?d.isPlainObject(c)?(a=[x.createElement(a[1])],d.fn.attr.call(a,c,!0)):a=[e.createElement(a[1])]:(a=d.buildFragment([t[1]],[e]),a=(a.cacheable?d.clone(a.fragment):a.fragment).childNodes),d.merge(this,a);if((c=x.getElementById(t[2]))&&c.parentNode){if(c.id!==t[2])return e.find(a);this.length=1;this[0]=c}this.context=x;this.selector=a;return this}if(d.isFunction(a))return e.ready(a);a.selector!==b&&(this.selector=a.selector,this.context=a.context);return d.makeArray(a,
this)},selector:"",jquery:"1.6.2",length:0,size:function(){return this.length},toArray:function(){return E.call(this,0)},get:function(a){return null==a?this.toArray():0>a?this[this.length+a]:this[a]},pushStack:function(a,b,c){var e=this.constructor();d.isArray(a)?B.apply(e,a):d.merge(e,a);e.prevObject=this;e.context=this.context;"find"===b?e.selector=this.selector+(this.selector?" ":"")+c:b&&(e.selector=this.selector+"."+b+"("+c+")");return e},each:function(a,b){return d.each(this,a,b)},ready:function(a){d.bindReady();
ba.done(a);return this},eq:function(a){return-1===a?this.slice(a):this.slice(a,+a+1)},first:function(){return this.eq(0)},last:function(){return this.eq(-1)},slice:function(){return this.pushStack(E.apply(this,arguments),"slice",E.call(arguments).join(","))},map:function(a){return this.pushStack(d.map(this,function(b,c){return a.call(b,c,b)}))},end:function(){return this.prevObject||this.constructor(null)},push:B,sort:[].sort,splice:[].splice};d.fn.init.prototype=d.fn;d.extend=d.fn.extend=function(){var a,
c,e,t,f,h=arguments[0]||{},g=1,F=arguments.length,N=!1;"boolean"===typeof h&&(N=h,h=arguments[1]||{},g=2);"object"===typeof h||d.isFunction(h)||(h={});F===g&&(h=this,--g);for(;g<F;g++)if(null!=(a=arguments[g]))for(c in a)e=h[c],t=a[c],h!==t&&(N&&t&&(d.isPlainObject(t)||(f=d.isArray(t)))?(f?(f=!1,e=e&&d.isArray(e)?e:[]):e=e&&d.isPlainObject(e)?e:{},h[c]=d.extend(N,e,t)):t!==b&&(h[c]=t));return h};d.extend({noConflict:function(b){a.$===d&&(a.$=f);b&&a.jQuery===d&&(a.jQuery=e);return d},isReady:!1,readyWait:1,
holdReady:function(a){a?d.readyWait++:d.ready(!0)},ready:function(a){if(!0===a&&!--d.readyWait||!0!==a&&!d.isReady){if(!x.body)return setTimeout(d.ready,1);d.isReady=!0;!0!==a&&0<--d.readyWait||(ba.resolveWith(x,[d]),d.fn.trigger&&d(x).trigger("ready").unbind("ready"))}},bindReady:function(){if(!ba){ba=d._Deferred();if("complete"===x.readyState)return setTimeout(d.ready,1);if(x.addEventListener)x.addEventListener("DOMContentLoaded",U,!1),a.addEventListener("load",d.ready,!1);else if(x.attachEvent){x.attachEvent("onreadystatechange",
U);a.attachEvent("onload",d.ready);var b=!1;try{b=null==a.frameElement}catch(e){}x.documentElement.doScroll&&b&&c()}}},isFunction:function(a){return"function"===d.type(a)},isArray:Array.isArray||function(a){return"array"===d.type(a)},isWindow:function(a){return a&&"object"===typeof a&&"setInterval"in a},isNaN:function(a){return null==a||!n.test(a)||isNaN(a)},type:function(a){return null==a?String(a):D[gb.call(a)]||"object"},isPlainObject:function(a){if(!a||"object"!==d.type(a)||a.nodeType||d.isWindow(a)||
a.constructor&&!C.call(a,"constructor")&&!C.call(a.constructor.prototype,"isPrototypeOf"))return!1;for(var c in a);return c===b||C.call(a,c)},isEmptyObject:function(a){for(var b in a)return!1;return!0},error:function(a){throw a;},parseJSON:function(b){if("string"!==typeof b||!b)return null;b=d.trim(b);if(a.JSON&&a.JSON.parse)return a.JSON.parse(b);if(p.test(b.replace(v,"@").replace(A,"]").replace(q,"")))return(new Function("return "+b))();d.error("Invalid JSON: "+b)},parseXML:function(b,c,e){a.DOMParser?
(e=new DOMParser,c=e.parseFromString(b,"text/xml")):(c=new ActiveXObject("Microsoft.XMLDOM"),c.async="false",c.loadXML(b));(e=c.documentElement)&&e.nodeName&&"parsererror"!==e.nodeName||d.error("Invalid XML: "+b);return c},noop:function(){},globalEval:function(b){b&&k.test(b)&&(a.execScript||function(b){a.eval.call(a,b)})(b)},camelCase:function(a){return a.replace(eb,fb)},nodeName:function(a,b){return a.nodeName&&a.nodeName.toUpperCase()===b.toUpperCase()},each:function(a,c,e){var t,f=0,h=a.length,
g=h===b||d.isFunction(a);if(e)if(g)for(t in a){if(!1===c.apply(a[t],e))break}else for(;f<h&&!1!==c.apply(a[f++],e););else if(g)for(t in a){if(!1===c.call(a[t],t,a[t]))break}else for(;f<h&&!1!==c.call(a[f],f,a[f++]););return a},trim:y?function(a){return null==a?"":y.call(a)}:function(a){return null==a?"":a.toString().replace(l,"").replace(m,"")},makeArray:function(a,b){var c=b||[];if(null!=a){var e=d.type(a);null==a.length||"string"===e||"function"===e||"regexp"===e||d.isWindow(a)?B.call(c,a):d.merge(c,
a)}return c},inArray:function(a,b){if(wa)return wa.call(b,a);for(var c=0,d=b.length;c<d;c++)if(b[c]===a)return c;return-1},merge:function(a,c){var d=a.length,e=0;if("number"===typeof c.length)for(var t=c.length;e<t;e++)a[d++]=c[e];else for(;c[e]!==b;)a[d++]=c[e++];a.length=d;return a},grep:function(a,b,c){var d=[],e;c=!!c;for(var t=0,f=a.length;t<f;t++)e=!!b(a[t],t),c!==e&&d.push(a[t]);return d},map:function(a,c,e){var t,f,h=[],g=0,F=a.length;if(a instanceof d||F!==b&&"number"===typeof F&&(0<F&&a[0]&&
a[F-1]||0===F||d.isArray(a)))for(;g<F;g++)t=c(a[g],g,e),null!=t&&(h[h.length]=t);else for(f in a)t=c(a[f],f,e),null!=t&&(h[h.length]=t);return h.concat.apply([],h)},guid:1,proxy:function(a,c){if("string"===typeof c){var e=a[c];c=a;a=e}if(!d.isFunction(a))return b;var t=E.call(arguments,2),e=function(){return a.apply(c,t.concat(E.call(arguments)))};e.guid=a.guid=a.guid||e.guid||d.guid++;return e},access:function(a,c,e,t,f,h){var g=a.length;if("object"===typeof c){for(var F in c)d.access(a,F,c[F],t,
f,e);return a}if(e!==b){t=!h&&t&&d.isFunction(e);for(F=0;F<g;F++)f(a[F],c,t?e.call(a[F],F,f(a[F],c)):e,h);return a}return g?f(a[0],c):b},now:function(){return(new Date).getTime()},uaMatch:function(a){a=a.toLowerCase();if(a.match(/trident/i)&&a.match(/rv.\d\d/))return{browser:"msie",version:"11.0"};a=w.exec(a)||u.exec(a)||z.exec(a)||0>a.indexOf("compatible")&&va.exec(a)||[];return{browser:a[1]||"",version:a[2]||"0"}},sub:function(){function a(b,c){return new a.fn.init(b,c)}d.extend(!0,a,this);a.superclass=
this;a.fn=a.prototype=this();a.fn.constructor=a;a.sub=this.sub;a.fn.init=function(c,e){e&&e instanceof d&&!(e instanceof a)&&(e=a(e));return d.fn.init.call(this,c,e,b)};a.fn.init.prototype=a.fn;var b=a(x);return a},browser:{}});d.each("Boolean Number String Function Array Date RegExp Object".split(" "),function(a,b){D["[object "+b+"]"]=b.toLowerCase()});T=d.uaMatch(ka);T.browser&&(d.browser[T.browser]=!0,d.browser.version=T.version);d.browser.webkit&&(d.browser.safari=/safari/i.test(ka)&&!/chrome/i.test(ka));
k.test("\u00a0")&&(l=/^[\s\xA0]+/,m=/[\s\xA0]+$/);h=d(x);x.addEventListener?U=function(){x.removeEventListener("DOMContentLoaded",U,!1);d.ready()}:x.attachEvent&&(U=function(){"complete"===x.readyState&&(x.detachEvent("onreadystatechange",U),d.ready())});return d}(),la="done fail isResolved isRejected promise then always pipe".split(" "),xa=[].slice;h.extend({_Deferred:function(){var a=[],b,c,d,e={done:function(){if(!d){var c=arguments,f,g,F,k,l;b&&(l=b,b=0);f=0;for(g=c.length;f<g;f++)F=c[f],k=h.type(F),
...
arguments).fail.apply(this,arguments)},fail:c.done,rejectWith:c.resolveWith,reject:c.resolve,isRejected:c.isResolved,pipe:function(a,c){return h.Deferred(function(d){h.each({done:[a,"resolve"],fail:[c,"reject"]},function(a,c){var e=c[0],t=c[1],f;if(h.isFunction(e))b[a](function(){if((f=e.apply(this,arguments))&&h.isFunction(f.promise))f.promise().then(d.resolve,d.reject);else d[t](f)});else b[a](d[t])})}).promise()},promise:function(a){if(null==a){if(d)return d;d=a={}}for(var c=la.length;c--;)a[la[c]]=
b[la[c]];return a}});b.done(c.cancel).fail(b.cancel);delete b.cancel;a&&a.call(b,b);return b},when:function(a){function b(a){return function(b){c[a]=1<arguments.length?xa.call(arguments,0):b;--f||g.resolveWith(g,xa.call(c,0))}}var c=arguments,d=0,e=c.length,f=e,g=1>=e&&a&&h.isFunction(a.promise)?a:h.Deferred();if(1<e){for(;d<e;d++)c[d]&&h.isFunction(c[d].promise)?c[d].promise().then(b(d),g.reject):--f;f||g.resolveWith(g,c)}else g!==a&&g.resolveWith(g,e?[a]:[]);return g.promise()}});h.support=function(){var a=
x.createElement("div"),b=x.documentElement,c,d,e,f,g,k;a.setAttribute("className","t");a.innerHTML="   <link/><table></table><a href='/a' style='top:1px;float:left;opacity:.55;'>a</a><input type='checkbox'/>";c=a.getElementsByTagName("*");d=a.getElementsByTagName("a")[0];if(!c||!c.length||!d)return{};e=x.createElement("select");f=e.appendChild(x.createElement("option"));c=a.getElementsByTagName("input")[0];g={leadingWhitespace:3===a.firstChild.nodeType,tbody:!a.getElementsByTagName("tbody").length,
...
a.parentNode&&a.parentNode.selectedIndex}}));h.support.checkOn||h.each(["radio","checkbox"],function(){h.valHooks[this]={get:function(a){return null===a.getAttribute("value")?"on":a.value}}});h.each(["radio","checkbox"],function(){h.valHooks[this]=h.extend(h.valHooks[this],{set:function(a,b){if(h.isArray(b))return a.checked=0<=h.inArray(h(a).val(),b)}})});var fa=/\.(.*)$/,na=/^(?:textarea|input|select)$/i,Wa=/\./g,Xa=/ /g,mb=/[^\w\s.|`]/g,nb=function(a){return a.replace(mb,"\\$&")};h.event={add:function(a,
c,d,e){if(3!==a.nodeType&&8!==a.nodeType){if(!1===d)d=f;else if(!d)return;var g,k;d.handler&&(g=d,d=g.handler);d.guid||(d.guid=h.guid++);if(k=h._data(a)){var l=k.events,m=k.handle;l||(k.events=l={});m||(k.handle=m=function(a){return"undefined"===typeof h||a&&h.event.triggered===a.type?b:h.event.handle.apply(m.elem,arguments)});m.elem=a;c=c.split(" ");for(var n,r=0,p;n=c[r++];){k=g?h.extend({},g):{handler:d,data:e};-1<n.indexOf(".")?(p=n.split("."),n=p.shift(),k.namespace=p.slice(0).sort().join(".")):
(p=[],k.namespace="");k.type=n;k.guid||(k.guid=d.guid);var v=l[n],A=h.event.special[n]||{};v||(v=l[n]=[],A.setup&&!1!==A.setup.call(a,e,p,m)||(a.addEventListener?a.addEventListener(n,m,!1):a.attachEvent&&a.attachEvent("on"+n,m)));A.add&&(A.add.call(a,k),k.handler.guid||(k.handler.guid=d.guid));v.push(k);h.event.global[n]=!0}a=null}}},global:{},remove:function(a,c,d,e){if(3!==a.nodeType&&8!==a.nodeType){!1===d&&(d=f);var g,k,l=0,m,n,r,p,v,A,q=h.hasData(a)&&h._data(a),w=q&&q.events;if(q&&w)if(c&&c.type&&
(d=c.handler,c=c.type),!c||"string"===typeof c&&"."===c.charAt(0))for(g in c=c||"",w)h.event.remove(a,g+c);else{for(c=c.split(" ");g=c[l++];)if(p=g,m=0>g.indexOf("."),n=[],m||(n=g.split("."),g=n.shift(),r=new RegExp("(^|\\.)"+h.map(n.slice(0).sort(),nb).join("\\.(?:.*\\.)?")+"(\\.|$)")),v=w[g])if(d){p=h.event.special[g]||{};for(k=e||0;k<v.length;k++)if(A=v[k],d.guid===A.guid){if(m||r.test(A.namespace))null==e&&v.splice(k--,1),p.remove&&p.remove.call(a,A);if(null!=e)break}if(0===v.length||null!=e&&
1===v.length)p.teardown&&!1!==p.teardown.call(a,n)||h.removeEvent(a,g,q.handle),delete w[g]}else for(k=0;k<v.length;k++)if(A=v[k],m||r.test(A.namespace))h.event.remove(a,p,A.handler,k),v.splice(k--,1);if(h.isEmptyObject(w)){if(c=q.handle)c.elem=null;delete q.events;delete q.handle;h.isEmptyObject(q)&&h.removeData(a,b,!0)}}}},customEvent:{getData:!0,setData:!0,changeData:!0},trigger:function(c,d,e,f){var g=c.type||c,k=[],l;0<=g.indexOf("!")&&(g=g.slice(0,-1),l=!0);0<=g.indexOf(".")&&(k=g.split("."),
...
isImmediatePropagationStopped:f};var Ba=function(a){var b=a.relatedTarget,c=!1,d=a.type;a.type=a.data;b!==this&&(b&&(c=h.contains(this,b)),c||(h.event.handle.apply(this,arguments),a.type=d))},Ca=function(a){a.type=a.data;h.event.handle.apply(this,arguments)};h.each({mouseenter:"mouseover",mouseleave:"mouseout"},function(a,b){h.event.special[a]={setup:function(c){h.event.add(this,b,c&&c.selector?Ca:Ba,a)},teardown:function(a){h.event.remove(this,b,a&&a.selector?Ca:Ba)}}});h.support.submitBubbles||
(h.event.special.submit={setup:function(a,b){if(h.nodeName(this,"form"))return!1;h.event.add(this,"click.specialSubmit",function(a){var b=a.target,c=b.type;"submit"!==c&&"image"!==c||!h(b).closest("form").length||k("submit",this,arguments)});h.event.add(this,"keypress.specialSubmit",function(a){var b=a.target,c=b.type;"text"!==c&&"password"!==c||!h(b).closest("form").length||13!==a.keyCode||k("submit",this,arguments)})},teardown:function(a){h.event.remove(this,".specialSubmit")}});if(!h.support.changeBubbles){var X,
Da=function(a){var b=a.type,c=a.value;"radio"===b||"checkbox"===b?c=a.checked:"select-multiple"===b?c=-1<a.selectedIndex?h.map(a.options,function(a){return a.selected}).join("-"):"":h.nodeName(a,"select")&&(c=a.selectedIndex);return c},ca=function(a,c){var d=a.target,e,f;na.test(d.nodeName)&&!d.readOnly&&(e=h._data(d,"_change_data"),f=Da(d),"focusout"===a.type&&"radio"===d.type||h._data(d,"_change_data",f),e===b||f===e||null==e&&!f||(a.type="change",a.liveFired=b,h.event.trigger(a,c,d)))};h.event.special.change=
{filters:{focusout:ca,beforedeactivate:ca,click:function(a){var b=a.target,c=h.nodeName(b,"input")?b.type:"";("radio"===c||"checkbox"===c||h.nodeName(b,"select"))&&ca.call(this,a)},keydown:function(a){var b=a.target,c=h.nodeName(b,"input")?b.type:"";(13===a.keyCode&&!h.nodeName(b,"textarea")||32===a.keyCode&&("checkbox"===c||"radio"===c)||"select-multiple"===c)&&ca.call(this,a)},beforeactivate:function(a){a=a.target;h._data(a,"_change_data",Da(a))}},setup:function(a,b){if("file"===this.type)return!1;
for(var c in X)h.event.add(this,c+".specialChange",X[c]);return na.test(this.nodeName)},teardown:function(a){h.event.remove(this,".specialChange");return na.test(this.nodeName)}};X=h.event.special.change.filters;X.focus=X.beforeactivate}h.support.focusinBubbles||h.each({focus:"focusin",blur:"focusout"},function(a,b){function c(a){var d=h.event.fix(a);d.type=b;d.originalEvent={};h.event.trigger(d,null,d.target);d.isDefaultPrevented()&&a.preventDefault()}var d=0;h.event.special[b]={setup:function(){0===
d++&&x.addEventListener(a,c,!0)},teardown:function(){0===--d&&x.removeEventListener(a,c,!0)}}});h.each(["bind","one"],function(a,c){h.fn[c]=function(a,d,e){var f;if("object"===typeof a){for(var g in a)this[c](g,d,a[g],e);return this}if(2===arguments.length||!1===d)e=d,d=b;"one"===c?(f=function(a){h(this).unbind(a,f);return e.apply(this,arguments)},f.guid=e.guid||h.guid++):f=e;if("unload"===a&&"one"!==c)this.one(a,d,e);else{g=0;for(var t=this.length;g<t;g++)h.event.add(this[g],a,f,d)}return this}});
...
arguments,c=a.guid||h.guid++,d=0,e=function(c){var e=(h.data(this,"lastToggle"+a.guid)||0)%d;h.data(this,"lastToggle"+a.guid,e+1);c.preventDefault();return b[e].apply(this,arguments)||!1};for(e.guid=c;d<b.length;)b[d++].guid=c;return this.click(e)},hover:function(a,b){return this.mouseenter(a).mouseleave(b||a)}});var oa={focus:"focusin",blur:"focusout",mouseenter:"mouseover",mouseleave:"mouseout"};h.each(["live","die"],function(a,c){h.fn[c]=function(a,d,e,g){var k=0,t,l,n=g||this.selector,r=g?this:
h(this.context);if("object"===typeof a&&!a.preventDefault){for(t in a)r[c](t,d,a[t],n);return this}if("die"===c&&!a&&g&&"."===g.charAt(0))return r.unbind(g),this;if(!1===d||h.isFunction(d))e=d||f,d=b;for(a=(a||"").split(" ");null!=(g=a[k++]);)if(t=fa.exec(g),l="",t&&(l=t[0],g=g.replace(fa,"")),"hover"===g)a.push("mouseenter"+l,"mouseleave"+l);else if(t=g,oa[g]?(a.push(oa[g]+l),g+=l):g=(oa[g]||g)+l,"live"===c){l=0;for(var p=r.length;l<p;l++)h.event.add(r[l],"live."+m(g,n),{data:d,selector:n,handler:e,
origType:g,origHandler:e,preType:t})}else r.unbind("live."+m(g,n),e);return this}});h.each("blur focus focusin focusout load resize scroll unload click dblclick mousedown mouseup mousemove mouseover mouseout mouseenter mouseleave change select submit keydown keypress keyup error".split(" "),function(a,b){h.fn[b]=function(a,c){null==c&&(c=a,a=null);return 0<arguments.length?this.bind(b,a,c):this.trigger(b)};h.attrFn&&(h.attrFn[b]=!0)});(function(){function a(b,c,d,e,f,g){f=0;for(var h=e.length;f<h;f++){var k=
...
e=0,f=Object.prototype.toString,g=!1,k=!0,l=/\\/g,m=/\W/;[0,0].sort(function(){k=!1;return 0});var n=function(a,b,c,e){c=c||[];var g=b=b||x;if(1!==b.nodeType&&9!==b.nodeType)return[];if(!a||"string"!==typeof a)return c;var h,k,t,l,I,N=!0,m=n.isXML(b),v=[],A=a;do if(d.exec(""),h=d.exec(A))if(A=h[3],v.push(h[1]),h[2]){l=h[3];break}while(h);if(1<v.length&&p.exec(a))if(2===v.length&&r.relative[v[0]])k=z(v[0]+v[1],b);else for(k=r.relative[v[0]]?[b]:n(v.shift(),b);v.length;)a=v.shift(),r.relative[a]&&(a+=
v.shift()),k=z(a,k);else if(!e&&1<v.length&&9===b.nodeType&&!m&&r.match.ID.test(v[0])&&!r.match.ID.test(v[v.length-1])&&(h=n.find(v.shift(),b,m),b=h.expr?n.filter(h.expr,h.set)[0]:h.set[0]),b)for(h=e?{expr:v.pop(),set:q(e)}:n.find(v.pop(),1!==v.length||"~"!==v[0]&&"+"!==v[0]||!b.parentNode?b:b.parentNode,m),k=h.expr?n.filter(h.expr,h.set):h.set,0<v.length?t=q(k):N=!1;v.length;)h=I=v.pop(),r.relative[I]?h=v.pop():I="",null==h&&(h=b),r.relative[I](t,h,m);else t=[];t||(t=k);t||n.error(I||a);if("[object Array]"===
f.call(t))if(N)if(b&&1===b.nodeType)for(a=0;null!=t[a];a++)t[a]&&(!0===t[a]||1===t[a].nodeType&&n.contains(b,t[a]))&&c.push(k[a]);else for(a=0;null!=t[a];a++)t[a]&&1===t[a].nodeType&&c.push(k[a]);else c.push.apply(c,t);else q(t,c);l&&(n(l,g,c,e),n.uniqueSort(c));return c};n.uniqueSort=function(a){if(w&&(g=k,a.sort(w),g))for(var b=1;b<a.length;b++)a[b]===a[b-1]&&a.splice(b--,1);return a};n.matches=function(a,b){return n(a,null,null,b)};n.matchesSelector=function(a,b){return 0<n(b,null,null,[a]).length};
n.find=function(a,b,c){var d;if(!a)return[];for(var e=0,f=r.order.length;e<f;e++){var g,h=r.order[e];if(g=r.leftMatch[h].exec(a)){var k=g[1];g.splice(1,1);if("\\"!==k.substr(k.length-1)&&(g[1]=(g[1]||"").replace(l,""),d=r.find[h](g,b,c),null!=d)){a=a.replace(r.match[h],"");break}}}d||(d="undefined"!==typeof b.getElementsByTagName?b.getElementsByTagName("*"):[]);return{set:d,expr:a}};n.filter=function(a,c,d,e){for(var f,g,h=a,k=[],t=c,l=c&&c[0]&&n.isXML(c[0]);a&&c.length;){for(var I in r.filter)if(null!=
(f=r.leftMatch[I].exec(a))&&f[2]){var N,m,F=r.filter[I];m=f[1];g=!1;f.splice(1,1);if("\\"!==m.substr(m.length-1)){t===k&&(k=[]);if(r.preFilter[I])if(f=r.preFilter[I](f,t,d,k,e,l),!f)g=N=!0;else if(!0===f)continue;if(f)for(var Y=0;null!=(m=t[Y]);Y++)if(m){N=F(m,f,Y,t);var v=e^!!N;d&&null!=N?v?g=!0:t[Y]=!1:v&&(k.push(m),g=!0)}if(N!==b){d||(t=k);a=a.replace(r.match[I],"");if(!g)return[];break}}}if(a===h)if(null==g)n.error(a);else break;h=a}return t};n.error=function(a){throw"Syntax error, unrecognized expression: "+
...
b},CLASS:function(a,b){return-1<(" "+(a.className||a.getAttribute("class"))+" ").indexOf(b)},ATTR:function(a,b){var c=b[1],c=r.attrHandle[c]?r.attrHandle[c](a):null!=a[c]?a[c]:a.getAttribute(c),d=c+"",e=b[2],f=b[4];return null==c?"!="===e:"="===e?d===f:"*="===e?0<=d.indexOf(f):"~="===e?0<=(" "+d+" ").indexOf(f):f?"!="===e?d!==f:"^="===e?0===d.indexOf(f):"$="===e?d.substr(d.length-f.length)===f:"|="===e?d===f||d.substr(0,f.length+1)===f+"-":!1:d&&!1!==c},POS:function(a,b,c,d){var e=r.setFilters[b[2]];
if(e)return e(a,c,b,d)}}},p=r.match.POS,v=function(a,b){return"\\"+(b-0+1)},A;for(A in r.match)r.match[A]=new RegExp(r.match[A].source+/(?![^\[]*\])(?![^\(]*\))/.source),r.leftMatch[A]=new RegExp(/(^(?:.|\r|\n)*?)/.source+r.match[A].source.replace(/\\(\d+)/g,v));var q=function(a,b){a=Array.prototype.slice.call(a,0);return b?(b.push.apply(b,a),b):a};try{Array.prototype.slice.call(x.documentElement.childNodes,0)[0].nodeType}catch(va){q=function(a,b){var c=0,d=b||[];if("[object Array]"===f.call(a))Array.prototype.push.apply(d,
a);else if("number"===typeof a.length)for(var e=a.length;c<e;c++)d.push(a[c]);else for(;a[c];c++)d.push(a[c]);return d}}var w,u;x.documentElement.compareDocumentPosition?w=function(a,b){return a===b?(g=!0,0):a.compareDocumentPosition&&b.compareDocumentPosition?a.compareDocumentPosition(b)&4?-1:1:a.compareDocumentPosition?-1:1}:(w=function(a,b){if(a===b)return g=!0,0;if(a.sourceIndex&&b.sourceIndex)return a.sourceIndex-b.sourceIndex;var c,d,e=[],f=[];c=a.parentNode;d=b.parentNode;var h=c;if(c===d)return u(a,
...
x.createElement("div"),c="script"+(new Date).getTime(),d=x.documentElement;a.innerHTML="<a name='"+c+"'/>";d.insertBefore(a,d.firstChild);x.getElementById(c)&&(r.find.ID=function(a,c,d){if("undefined"!==typeof c.getElementById&&!d)return(c=c.getElementById(a[1]))?c.id===a[1]||"undefined"!==typeof c.getAttributeNode&&c.getAttributeNode("id").nodeValue===a[1]?[c]:b:[]},r.filter.ID=function(a,b){var c="undefined"!==typeof a.getAttributeNode&&a.getAttributeNode("id");return 1===a.nodeType&&c&&c.nodeValue===
b});d.removeChild(a);d=a=null})();(function(){var a=x.createElement("div");a.appendChild(x.createComment(""));0<a.getElementsByTagName("*").length&&(r.find.TAG=function(a,b){var c=b.getElementsByTagName(a[1]);if("*"===a[1]){for(var d=[],e=0;c[e];e++)1===c[e].nodeType&&d.push(c[e]);c=d}return c});a.innerHTML="<a href='#'></a>";a.firstChild&&"undefined"!==typeof a.firstChild.getAttribute&&"#"!==a.firstChild.getAttribute("href")&&(r.attrHandle.href=function(a){return a.getAttribute("href",2)});a=null})();
x.querySelectorAll&&function(){var a=n,b=x.createElement("div");b.innerHTML="<p class='TEST'></p>";if(!b.querySelectorAll||0!==b.querySelectorAll(".TEST").length){n=function(b,c,d,e){c=c||x;if(!e&&!n.isXML(c)){var f=/^(\w+$)|^\.([\w\-]+$)|^#([\w\-]+$)/.exec(b);if(f&&(1===c.nodeType||9===c.nodeType)){if(f[1])return q(c.getElementsByTagName(b),d);if(f[2]&&r.find.CLASS&&c.getElementsByClassName)return q(c.getElementsByClassName(f[2]),d)}if(9===c.nodeType){if("body"===b&&c.body)return q([c.body],d);if(f&&
...
for(var c in a)n[c]=a[c];b=null}}();(function(){var a=x.documentElement,b=a.matchesSelector||a.mozMatchesSelector||a.webkitMatchesSelector||a.msMatchesSelector;if(b){var c=!b.call(x.createElement("div"),"div"),d=!1;try{b.call(x.documentElement,"[test!='']:sizzle")}catch(e){d=!0}n.matchesSelector=function(a,e){e=e.replace(/\=\s*([^'"\]]*)\s*\]/g,"='$1']");if(!n.isXML(a))try{if(d||!r.match.PSEUDO.test(e)&&!/!=/.test(e)){var f=b.call(a,e);if(f||!c||a.document&&11!==a.document.nodeType)return f}}catch(g){}return 0<
n(e,null,null,[a]).length}}})();(function(){var a=x.createElement("div");a.innerHTML="<div class='test e'></div><div class='test'></div>";a.getElementsByClassName&&0!==a.getElementsByClassName("e").length&&(a.lastChild.className="e",1!==a.getElementsByClassName("e").length&&(r.order.splice(1,0,"CLASS"),r.find.CLASS=function(a,b,c){if("undefined"!==typeof b.getElementsByClassName&&!c)return b.getElementsByClassName(a[1])},a=null))})();n.contains=x.documentElement.contains?function(a,b){return a!==
b&&(a.contains?a.contains(b):!0)}:x.documentElement.compareDocumentPosition?function(a,b){return!!(a.compareDocumentPosition(b)&16)}:function(){return!1};n.isXML=function(a){return(a=(a?a.ownerDocument||a:0).documentElement)?"HTML"!==a.nodeName:!1};var z=function(a,b){for(var c,d=[],e="",f=b.nodeType?[b]:b;c=r.match.PSEUDO.exec(a);)e+=c[0],a=a.replace(r.match.PSEUDO,"");a=r.relative[a]?a+"*":a;c=0;for(var g=f.length;c<g;c++)n(a,f[c],d);return n.filter(e,d)};h.find=n;h.expr=n.selectors;h.expr[":"]=
h.expr.filters;h.unique=n.uniqueSort;h.text=n.getText;h.isXMLDoc=n.isXML;h.contains=n.contains})();var ob=/Until$/,pb=/^(?:parents|prevUntil|prevAll)/,qb=/,/,Ya=/^.[^:#\[\.,]*$/,rb=Array.prototype.slice,Ea=h.expr.match.POS,sb={children:!0,contents:!0,next:!0,prev:!0};h.fn.extend({find:function(a){var b=this,c,d;if("string"!==typeof a)return h(a).filter(function(){c=0;for(d=b.length;c<d;c++)if(h.contains(b[c],this))return!0});var e=this.pushStack("","find",a),f,g,k;c=0;for(d=this.length;c<d;c++)if(f=
...
a)},children:function(a){return h.sibling(a.firstChild)},contents:function(a){return h.nodeName(a,"iframe")?a.contentDocument||a.contentWindow.document:h.makeArray(a.childNodes)}},function(a,b){h.fn[a]=function(c,d){var e=h.map(this,b,c),f=rb.call(arguments);ob.test(a)||(d=c);d&&"string"===typeof d&&(e=h.filter(d,e));e=1<this.length&&!sb[a]?h.unique(e):e;(1<this.length||qb.test(d))&&pb.test(a)&&(e=e.reverse());return this.pushStack(e,a,f.join(","))}});h.extend({filter:function(a,b,c){c&&(a=":not("+
a+")");return 1===b.length?h.find.matchesSelector(b[0],a)?[b[0]]:[]:h.find.matches(a,b)},dir:function(a,c,d){var e=[];for(a=a[c];a&&9!==a.nodeType&&(d===b||1!==a.nodeType||!h(a).is(d));)1===a.nodeType&&e.push(a),a=a[c];return e},nth:function(a,b,c,d){b=b||1;for(d=0;a&&(1!==a.nodeType||++d!==b);a=a[c]);return a},sibling:function(a,b){for(var c=[];a;a=a.nextSibling)1===a.nodeType&&a!==b&&c.push(a);return c}});var tb=/ jQuery\d+="(?:\d+|null)"/g,pa=/^\s+/,Fa=/<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/ig,
Ga=/<([\w:]+)/,ub=/<tbody/i,vb=/<|&#?\w+;/,Ha=/<(?:script|object|embed|option|style)/i,Ia=/checked\s*(?:[^=]|=\s*.checked.)/i,wb=/\/(java|ecma)script/i,Za=/^\s*<!(?:\[CDATA\[|\-\-)/,G={option:[1,"<select multiple='multiple'>","</select>"],legend:[1,"<fieldset>","</fieldset>"],thead:[1,"<table>","</table>"],tr:[2,"<table><tbody>","</tbody></table>"],td:[3,"<table><tbody><tr>","</tr></tbody></table>"],col:[2,"<table><tbody></tbody><colgroup>","</colgroup></table>"],area:[1,"<map>","</map>"],_default:[0,
...
empty:function(){for(var a=0,b;null!=(b=this[a]);a++)for(1===b.nodeType&&h.cleanData(b.getElementsByTagName("*"));b.firstChild;)b.removeChild(b.firstChild);return this},clone:function(a,b){a=null==a?!1:a;b=null==b?a:b;return this.map(function(){return h.clone(this,a,b)})},html:function(a){if(a===b)return this[0]&&1===this[0].nodeType?this[0].innerHTML.replace(tb,""):null;if("string"!==typeof a||Ha.test(a)||!h.support.leadingWhitespace&&pa.test(a)||G[(Ga.exec(a)||["",""])[1].toLowerCase()])h.isFunction(a)?
this.each(function(b){var c=h(this);c.html(a.call(this,b,c.html()))}):this.empty().append(a);else{a=a.replace(Fa,"<$1></$2>");try{for(var c=0,d=this.length;c<d;c++)1===this[c].nodeType&&(h.cleanData(this[c].getElementsByTagName("*")),this[c].innerHTML=a)}catch(e){this.empty().append(a)}}return this},replaceWith:function(a){if(this[0]&&this[0].parentNode){if(h.isFunction(a))return this.each(function(b){var c=h(this),d=c.html();c.replaceWith(a.call(this,b,d))});"string"!==typeof a&&(a=h(a).detach());
return this.each(function(){var b=this.nextSibling,c=this.parentNode;h(this).remove();b?h(b).before(a):h(c).append(a)})}return this.length?this.pushStack(h(h.isFunction(a)?a():a),"replaceWith",a):this},detach:function(a){return this.remove(a,!0)},domManip:function(a,c,d){var e,f,g,k=a[0],l=[];if(!h.support.checkClone&&3===arguments.length&&"string"===typeof k&&Ia.test(k))return this.each(function(){h(this).domManip(a,c,d,!0)});if(h.isFunction(k))return this.each(function(e){var f=h(this);a[0]=k.call(this,
e,c?f.html():b);f.domManip(a,c,d)});if(this[0]){e=k&&k.parentNode;e=h.support.parentNode&&e&&11===e.nodeType&&e.childNodes.length===this.length?{fragment:e}:h.buildFragment(a,this,l);g=e.fragment;if(f=1===g.childNodes.length?g=g.firstChild:g.firstChild){c=c&&h.nodeName(f,"tr");for(var m=0,n=this.length,r=n-1;m<n;m++)d.call(c?w(this[m],f):this[m],e.cacheable||1<n&&m<r?h.clone(g,!0,!0):g)}l.length&&h.each(l,v)}return this}});h.buildFragment=function(a,b,c){var d,e,f,g;b&&b[0]&&(g=b[0].ownerDocument||
b[0]);g.createDocumentFragment||(g=x);1===a.length&&"string"===typeof a[0]&&512>a[0].length&&g===x&&"<"===a[0].charAt(0)&&!Ha.test(a[0])&&(h.support.checkClone||!Ia.test(a[0]))&&(e=!0,(f=h.fragments[a[0]])&&1!==f&&(d=f));d||(d=g.createDocumentFragment(),h.clean(a,g,d,c));e&&(h.fragments[a[0]]=f?d:1);return{fragment:d,cacheable:e}};h.fragments={};h.each({appendTo:"append",prependTo:"prepend",insertBefore:"before",insertAfter:"after",replaceAll:"replaceWith"},function(a,b){h.fn[a]=function(c){var d=
[];c=h(c);var e=1===this.length&&this[0].parentNode;if(e&&11===e.nodeType&&1===e.childNodes.length&&1===c.length)return c[b](this[0]),this;for(var e=0,f=c.length;e<f;e++){var g=(0<e?this.clone(!0):this).get();h(c[e])[b](g);d=d.concat(g)}return this.pushStack(d,a,c.selector)}});h.extend({clone:function(a,b,c){var d=a.cloneNode(!0),e,f,g;if(!(h.support.noCloneEvent&&h.support.noCloneChecked||1!==a.nodeType&&11!==a.nodeType||h.isXMLDoc(a)))for(u(a,d),e=y(a),f=y(d),g=0;e[g];++g)u(e[g],f[g]);if(b&&(q(a,
d),c))for(e=y(a),f=y(d),g=0;e[g];++g)q(e[g],f[g]);return d},clean:function(a,b,c,d){b=b||x;"undefined"===typeof b.createElement&&(b=b.ownerDocument||b[0]&&b[0].ownerDocument||x);for(var e=[],f,g=0,k;null!=(k=a[g]);g++)if("number"===typeof k&&(k+=""),k){if("string"===typeof k)if(vb.test(k)){k=k.replace(Fa,"<$1></$2>");f=(Ga.exec(k)||["",""])[1].toLowerCase();var l=G[f]||G._default,m=l[0],n=b.createElement("div");for(n.innerHTML=l[1]+k+l[2];m--;)n=n.lastChild;if(!h.support.tbody)for(m=ub.test(k),l=
"table"!==f||m?"<table>"!==l[1]||m?[]:n.childNodes:n.firstChild&&n.firstChild.childNodes,f=l.length-1;0<=f;--f)h.nodeName(l[f],"tbody")&&!l[f].childNodes.length&&l[f].parentNode.removeChild(l[f]);!h.support.leadingWhitespace&&pa.test(k)&&n.insertBefore(b.createTextNode(pa.exec(k)[0]),n.firstChild);k=n.childNodes}else k=b.createTextNode(k);var v;if(!h.support.appendChecked)if(k[0]&&"number"===typeof(v=k.length))for(f=0;f<v;f++)r(k[f]);else r(k);k.nodeType?e.push(k):e=h.merge(e,k)}if(c)for(a=function(a){return!a.type||
wb.test(a.type)},g=0;e[g];g++)!d||!h.nodeName(e[g],"script")||e[g].type&&"text/javascript"!==e[g].type.toLowerCase()?(1===e[g].nodeType&&(b=h.grep(e[g].getElementsByTagName("script"),a),e.splice.apply(e,[g+1,0].concat(b))),c.appendChild(e[g])):d.push(e[g].parentNode?e[g].parentNode.removeChild(e[g]):e[g]);return e},cleanData:function(a){for(var b,c,d=h.cache,e=h.expando,f=h.event.special,g=h.support.deleteExpando,k=0,l;null!=(l=a[k]);k++)if(!l.nodeName||!h.noData[l.nodeName.toLowerCase()])if(c=l[h.expando]){if((b=
d[c]&&d[c][e])&&b.events){for(var m in b.events)f[m]?h.event.remove(l,m):h.removeEvent(l,m,b.handle);b.handle&&(b.handle.elem=null)}g?delete l[h.expando]:l.removeAttribute&&l.removeAttribute(h.expando);delete d[c]}}});var Ja=/alpha\([^)]*\)/i,xb=/opacity=([^)]*)/,yb=/([A-Z]|^ms)/g,Ka=/^-?\d+(?:px)?$/i,zb=/^-?\d/,Ab=/^[+\-]=/,Bb=/[^+\-\.\de]+/g,Cb={position:"absolute",visibility:"hidden",display:"block"},$a=["Left","Right"],ab=["Top","Bottom"],M,La,Ma;h.fn.css=function(a,c){return 2===arguments.length&&
...
c=h.cssProps[g]||g;if(d!==b){if(e=typeof d,!("number"===e&&isNaN(d)||null==d||("string"===e&&Ab.test(d)&&(d=+d.replace(Bb,"")+parseFloat(h.css(a,c)),e="number"),"number"!==e||h.cssNumber[g]||(d+="px"),l&&"set"in l&&(d=l.set(a,d))===b)))try{k[c]=d}catch(m){}}else return l&&"get"in l&&(f=l.get(a,!1,e))!==b?f:k[c]}},css:function(a,c,d){var e,f;c=h.camelCase(c);f=h.cssHooks[c];c=h.cssProps[c]||c;"cssFloat"===c&&(c="float");if(f&&"get"in f&&(e=f.get(a,!0,d))!==b)return e;if(M)return M(a,c)},swap:function(a,
b,c){var d={},e;for(e in b)d[e]=a.style[e],a.style[e]=b[e];c.call(a);for(e in b)a.style[e]=d[e]}});h.curCSS=h.css;h.each(["height","width"],function(a,b){h.cssHooks[b]={get:function(a,c,d){var e;if(c){if(0!==a.offsetWidth)return A(a,b,d);h.swap(a,Cb,function(){e=A(a,b,d)});return e}},set:function(a,b){if(Ka.test(b)){if(b=parseFloat(b),0<=b)return b+"px"}else return b}}});h.support.opacity||(h.cssHooks.opacity={get:function(a,b){return xb.test((b&&a.currentStyle?a.currentStyle.filter:a.style.filter)||
"")?parseFloat(RegExp.$1)/100+"":b?"1":""},set:function(a,b){var c=a.style,d=a.currentStyle;c.zoom=1;var e=h.isNaN(b)?"":"alpha(opacity="+100*b+")",d=d&&d.filter||c.filter||"";c.filter=Ja.test(d)?d.replace(Ja,e):d+" "+e}});h(function(){h.support.reliableMarginRight||(h.cssHooks.marginRight={get:function(a,b){var c;h.swap(a,{display:"inline-block"},function(){c=b?M(a,"margin-right","marginRight"):a.style.marginRight});return c}})});x.defaultView&&x.defaultView.getComputedStyle&&(La=function(a,c){var d,
e;c=c.replace(yb,"-$1").toLowerCase();if(!(e=a.ownerDocument.defaultView))return b;if(e=e.getComputedStyle(a,null))d=e.getPropertyValue(c),""!==d||h.contains(a.ownerDocument.documentElement,a)||(d=h.style(a,c));return d});x.documentElement.currentStyle&&(Ma=function(a,b){var c,d=a.currentStyle&&a.currentStyle[b],e=a.runtimeStyle&&a.runtimeStyle[b],f=a.style;!Ka.test(d)&&zb.test(d)&&(c=f.left,e&&(a.runtimeStyle.left=a.currentStyle.left),f.left="fontSize"===b?"1em":d||0,d=f.pixelLeft+"px",f.left=c,
e&&(a.runtimeStyle.left=e));return""===d?"auto":d});M=La||Ma;h.expr&&h.expr.filters&&(h.expr.filters.hidden=function(a){var b=a.offsetHeight;return 0===a.offsetWidth&&0===b||!h.support.reliableHiddenOffsets&&"none"===(a.style.display||h.css(a,"display"))},h.expr.filters.visible=function(a){return!h.expr.filters.hidden(a)});var Db=/%20/g,bb=/\[\]$/,Na=/\r?\n/g,Eb=/#.*$/,Fb=/^(.*?):[ \t]*([^\r\n]*)\r?$/mg,Gb=/^(?:color|date|datetime|email|hidden|month|number|password|range|search|tel|text|time|url|week)$/i,
Hb=/^(?:GET|HEAD)$/,Ib=/^\/\//,Oa=/\?/,Jb=/<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi,Kb=/^(?:select|textarea)/i,sa=/\s+/,Lb=/([?&])_=[^&]*/,Pa=/^([\w\+\.\-]+:)(?:\/\/([^\/?#:]*)(?::(\d+))?)?/,Qa=h.fn.load,ga={},Ra={},O,K;try{O=db.href}catch(t){O=x.createElement("a"),O.href="",O=O.href}K=Pa.exec(O.toLowerCase())||[];h.fn.extend({load:function(a,c,d){if("string"!==typeof a&&Qa)return Qa.apply(this,arguments);if(!this.length)return this;var e=a.indexOf(" ");if(0<=e){var f=a.slice(e,a.length);
a=a.slice(0,e)}e="GET";c&&(h.isFunction(c)?(d=c,c=b):"object"===typeof c&&(c=h.param(c,h.ajaxSettings.traditional),e="POST"));var g=this;h.ajax({url:a,type:e,dataType:"html",data:c,complete:function(a,b,c){c=a.responseText;a.isResolved()&&(a.done(function(a){c=a}),g.html(f?h("<div>").append(c.replace(Jb,"")).find(f):c));d&&g.each(d,[c,b,a])}});return this},serialize:function(){return h.param(this.serializeArray())},serializeArray:function(){return this.map(function(){return this.elements?h.makeArray(this.elements):
this}).filter(function(){return this.name&&!this.disabled&&(this.checked||Kb.test(this.nodeName)||Gb.test(this.type))}).map(function(a,b){var c=h(this).val();return null==c?null:h.isArray(c)?h.map(c,function(a,c){return{name:b.name,value:a.replace(Na,"\r\n")}}):{name:b.name,value:c.replace(Na,"\r\n")}}).get()}});h.each("ajaxStart ajaxStop ajaxComplete ajaxError ajaxSuccess ajaxSend".split(" "),function(a,b){h.fn[b]=function(a){return this.bind(b,a)}});h.each(["get","post"],function(a,c){h[c]=function(a,
...
global:!0,type:"GET",contentType:"application/x-www-form-urlencoded",processData:!0,async:!0,accepts:{xml:"application/xml, text/xml",html:"text/html",text:"text/plain",json:"application/json, text/javascript","*":"*/*"},contents:{xml:/xml/,html:/html/,json:/json/},responseFields:{xml:"responseXML",text:"responseText"},converters:{"* text":a.String,"text html":!0,"text json":h.parseJSON,"text xml":h.parseXML}},ajaxPrefilter:C(ga),ajaxTransport:C(Ra),ajax:function(a,c){function d(a,c,t,r){if(2!==x){x=
2;w&&clearTimeout(w);q=b;p=r||"";B.readyState=a?4:0;var v,I,A;if(t){r=e;var F=B,u=r.contents,C=r.dataTypes,E=r.responseFields,y,D,H,ea;for(D in E)D in t&&(F[E[D]]=t[D]);for(;"*"===C[0];)C.shift(),y===b&&(y=r.mimeType||F.getResponseHeader("content-type"));if(y)for(D in u)if(u[D]&&u[D].test(y)){C.unshift(D);break}if(C[0]in t)H=C[0];else{for(D in t){if(!C[0]||r.converters[D+" "+C[0]]){H=D;break}ea||(ea=D)}H=H||ea}H?(H!==C[0]&&C.unshift(H),t=t[H]):t=void 0}else t=b;if(200<=a&&300>a||304===a){if(e.ifModified){if(y=
B.getResponseHeader("Last-Modified"))h.lastModified[n]=y;if(y=B.getResponseHeader("Etag"))h.etag[n]=y}if(304===a)c="notmodified",v=!0;else try{y=e;y.dataFilter&&(t=y.dataFilter(t,y.dataType));var P=y.dataTypes;D={};var G,Z,ha=P.length,J,R=P[0],L,O,S,K,M;for(G=1;G<ha;G++){if(1===G)for(Z in y.converters)"string"===typeof Z&&(D[Z.toLowerCase()]=y.converters[Z]);L=R;R=P[G];if("*"===R)R=L;else if("*"!==L&&L!==R){O=L+" "+R;S=D[O]||D["* "+R];if(!S)for(K in M=b,D)if(J=K.split(" "),J[0]===L||"*"===J[0])if(M=
D[J[1]+" "+R]){K=D[K];!0===K?S=M:!0===M&&(S=K);break}S||M||h.error("No conversion from "+O.replace(" "," to "));!0!==S&&(t=S?S(t):M(K(t)))}}I=t;c="success";v=!0}catch(Q){c="parsererror",A=Q}}else if(A=c,!c||a)c="error",0>a&&(a=0);B.status=a;B.statusText=c;v?k.resolveWith(f,[I,c,B]):k.rejectWith(f,[B,c,A]);B.statusCode(m);m=b;z&&g.trigger("ajax"+(v?"Success":"Error"),[B,e,v?I:A]);l.resolveWith(f,[B,c]);z&&(g.trigger("ajaxComplete",[B,e]),--h.active||h.event.trigger("ajaxStop"))}}"object"===typeof a&&
(c=a,a=b);c=c||{};var e=h.ajaxSetup({},c),f=e.context||e,g=f!==e&&(f.nodeType||f instanceof h)?h(f):h.event,k=h.Deferred(),l=h._Deferred(),m=e.statusCode||{},n,r={},v={},p,A,q,w,u,x=0,z,C,B={readyState:0,setRequestHeader:function(a,b){if(!x){var c=a.toLowerCase();a=v[c]=v[c]||a;r[a]=b}return this},getAllResponseHeaders:function(){return 2===x?p:null},getResponseHeader:function(a){var c;if(2===x){if(!A)for(A={};c=Fb.exec(p);)A[c[1].toLowerCase()]=c[2];c=A[a.toLowerCase()]}return c===b?null:c},overrideMimeType:function(a){x||
(e.mimeType=a);return this},abort:function(a){a=a||"abort";q&&q.abort(a);d(0,a);return this}};k.promise(B);B.success=B.done;B.error=B.fail;B.complete=l.done;B.statusCode=function(a){if(a){var b;if(2>x)for(b in a)m[b]=[m[b],a[b]];else b=a[B.status],B.then(b,b)}return this};e.url=((a||e.url)+"").replace(Eb,"").replace(Ib,K[1]+"//");e.dataTypes=h.trim(e.dataType||"*").toLowerCase().split(sa);null==e.crossDomain&&(u=Pa.exec(e.url.toLowerCase()),e.crossDomain=!(!u||u[1]==K[1]&&u[2]==K[2]&&(u[3]||("http:"===
u[1]?80:443))==(K[3]||("http:"===K[1]?80:443))));e.data&&e.processData&&"string"!==typeof e.data&&(e.data=h.param(e.data,e.traditional));E(ga,e,c,B);if(2===x)return!1;z=e.global;e.type=e.type.toUpperCase();e.hasContent=!Hb.test(e.type);z&&0===h.active++&&h.event.trigger("ajaxStart");if(!e.hasContent&&(e.data&&(e.url+=(Oa.test(e.url)?"&":"?")+e.data),n=e.url,!1===e.cache)){u=h.now();var y=e.url.replace(Lb,"$1_="+u);e.url=y+(y===e.url?(Oa.test(e.url)?"&":"?")+"_="+u:"")}(e.data&&e.hasContent&&!1!==
e.contentType||c.contentType)&&B.setRequestHeader("Content-Type",e.contentType);e.ifModified&&(n=n||e.url,h.lastModified[n]&&B.setRequestHeader("If-Modified-Since",h.lastModified[n]),h.etag[n]&&B.setRequestHeader("If-None-Match",h.etag[n]));B.setRequestHeader("Accept",e.dataTypes[0]&&e.accepts[e.dataTypes[0]]?e.accepts[e.dataTypes[0]]+("*"!==e.dataTypes[0]?", */*; q=0.01":""):e.accepts["*"]);for(C in e.headers)B.setRequestHeader(C,e.headers[C]);if(e.beforeSend&&(!1===e.beforeSend.call(f,B,e)||2===
x))return B.abort(),!1;for(C in{success:1,error:1,complete:1})B[C](e[C]);if(q=E(Ra,e,c,B)){B.readyState=1;z&&g.trigger("ajaxSend",[B,e]);e.async&&0<e.timeout&&(w=setTimeout(function(){B.abort("timeout")},e.timeout));try{x=1,q.send(r,d)}catch(T){2>status?d(-1,T):h.error(T)}}else d(-1,"No Transport");return B},param:function(a,c){var d=[],e=function(a,b){b=h.isFunction(b)?b():b;d[d.length]=encodeURIComponent(a)+"="+encodeURIComponent(b)};c===b&&(c=h.ajaxSettings.traditional);if(h.isArray(a)||a.jquery&&
!h.isPlainObject(a))h.each(a,function(){e(this.name,this.value)});else for(var f in a)B(f,a[f],c,e);return d.join("&").replace(Db,"+")}});h.extend({active:0,lastModified:{},etag:{}});var Mb=h.now(),da=/(\=)\?(&|$)|\?\?/i;h.ajaxSetup({jsonp:"callback",jsonpCallback:function(){return h.expando+"_"+Mb++}});h.ajaxPrefilter("json jsonp",function(b,c,d){c="application/x-www-form-urlencoded"===b.contentType&&"string"===typeof b.data;if("jsonp"===b.dataTypes[0]||!1!==b.jsonp&&(da.test(b.url)||c&&da.test(b.data))){var e,
f=b.jsonpCallback=h.isFunction(b.jsonpCallback)?b.jsonpCallback():b.jsonpCallback,g=a[f],k=b.url,l=b.data,m="$1"+f+"$2";!1!==b.jsonp&&(k=k.replace(da,m),b.url===k&&(c&&(l=l.replace(da,m)),b.data===l&&(k+=(/\?/.test(k)?"&":"?")+b.jsonp+"="+f)));b.url=k;b.data=l;a[f]=function(a){e=[a]};d.always(function(){a[f]=g;if(e&&h.isFunction(g))a[f](e[0])});b.converters["script json"]=function(){e||h.error(f+" was not called");return e[0]};b.dataTypes[0]="json";return"script"}});h.ajaxSetup({accepts:{script:"text/javascript, application/javascript, application/ecmascript, application/x-ecmascript"},
...
e[l])}catch(m){}g.send(c.hasContent&&c.data||null);d=function(a,e){var l,m,n,r,v;try{if(d&&(e||4===g.readyState))if(d=b,k&&(g.onreadystatechange=h.noop,qa&&delete V[k]),e)4!==g.readyState&&g.abort();else{l=g.status;n=g.getAllResponseHeaders();r={};(v=g.responseXML)&&v.documentElement&&(r.xml=v);r.text=g.responseText;try{m=g.statusText}catch(p){m=""}l||!c.isLocal||c.crossDomain?1223===l&&(l=204):l=r.text?200:404}}catch(p){e||f(-1,p)}r&&f(l,m,r,n)};c.async&&4!==g.readyState?(k=++Nb,qa&&(V||(V={},h(a).unload(qa)),
V[k]=d),g.onreadystatechange=d):d()},abort:function(){d&&d(0,1)}}}});var ia={},J,Q,Ob=/^(?:toggle|show|hide)$/,Pb=/^([+\-]=)?([\d+.\-]+)([a-z%]*)$/i,W,ta=[["height","marginTop","marginBottom","paddingTop","paddingBottom"],["width","marginLeft","marginRight","paddingLeft","paddingRight"],["opacity"]],aa,ra=a.webkitRequestAnimationFrame||a.mozRequestAnimationFrame||a.oRequestAnimationFrame;h.fn.extend({show:function(a,b,c){if(a||0===a)return this.animate(P("show",3),a,b,c);c=0;for(var d=this.length;c<
d;c++)a=this[c],a.style&&(b=a.style.display,h._data(a,"olddisplay")||"none"!==b||(b=a.style.display=""),""===b&&"none"===h.css(a,"display")&&h._data(a,"olddisplay",ua(a.nodeName)));for(c=0;c<d;c++)if(a=this[c],a.style&&(b=a.style.display,""===b||"none"===b))a.style.display=h._data(a,"olddisplay")||"";return this},hide:function(a,b,c){if(a||0===a)return this.animate(P("hide",3),a,b,c);a=0;for(b=this.length;a<b;a++)this[a].style&&(c=h.css(this[a],"display"),"none"===c||h._data(this[a],"olddisplay")||
...
d);null!=b.left&&(l.left=b.left-f.left+k);"using"in b?b.using.call(a,l):e.css(l)}};h.fn.extend({position:function(){if(!this[0])return null;var a=this[0],b=this.offsetParent(),c=this.offset(),d=Sa.test(b[0].nodeName)?{top:0,left:0}:b.offset();c.top-=parseFloat(h.css(a,"marginTop"))||0;c.left-=parseFloat(h.css(a,"marginLeft"))||0;d.top+=parseFloat(h.css(b[0],"borderTopWidth"))||0;d.left+=parseFloat(h.css(b[0],"borderLeftWidth"))||0;return{top:c.top-d.top,left:c.left-d.left}},offsetParent:function(){return this.map(function(){for(var a=
this.offsetParent||x.body;a&&!Sa.test(a.nodeName)&&"static"===h.css(a,"position");)a=a.offsetParent;return a})}});h.each(["Left","Top"],function(a,c){var d="scroll"+c;h.fn[d]=function(c){var e,f;return c===b?(e=this[0],e?(f=ja(e))?f[a?"pageYOffset":"pageXOffset"]||h.support.boxModel&&f.document.documentElement[d]||f.document.body[d]:e[d]:null):this.each(function(){(f=ja(this))?f.scrollTo(a?h(f).scrollLeft():c,a?c:h(f).scrollTop()):this[d]=c})}});h.each(["Height","Width"],function(a,c){var d=c.toLowerCase();
...
0>b?a.length+b:b;a.push.apply(a,c);return a}function l(a){var b=typeof a;return"object"!==b?b:a===Math?"math":null===a?"null":Array.isArray(a)?"array":"[object Date]"===Object.prototype.toString.call(a)?"date":/^\/.*\//.test(a.toString())?"regexp":"object"}function m(b,c,n,p,q,w,u){q=q||[];var y=q.slice(0);if("undefined"!==typeof w){if(p&&p(y,w,{lhs:b,rhs:c}))return;y.push(w)}"regexp"===l(b)&&"regexp"===l(c)&&(b=b.toString(),c=c.toString());q=typeof b;w=typeof c;if("undefined"===q)"undefined"!==w&&
n(new e(y,c));else if("undefined"===w)n(new f(y,b));else if(l(b)!==l(c))n(new d(y,b,c));else if("[object Date]"===Object.prototype.toString.call(b)&&"[object Date]"===Object.prototype.toString.call(c)&&0!==b-c)n(new d(y,b,c));else if("object"===q&&null!==b&&null!==c&&b!==c){if(u=u||[],0>u.indexOf(b)){u.push(b);if(Array.isArray(b)){for(q=0;q<b.length;q++)q>=c.length?n(new g(y,q,new f(a,b[q]))):m(b[q],c[q],n,p,y,q,u);for(;q<c.length;)n(new g(y,q,new e(a,c[q++])))}else{q=Object.keys(b);var z=Object.keys(c);
q.forEach(function(a,d){var e=z.indexOf(a);0<=e?(m(b[a],c[a],n,p,y,a,u),z=k(z,e)):n(new f(y,a))});z.forEach(function(a){n(new e(y,c[a]))})}--u.length}}else b!==c&&("number"===q&&isNaN(b)&&isNaN(c)||n(new d(y,b,c)))}function n(b,c,d,e){e=e||[];m(b,c,function(a){a&&e.push(a)},d);return e.length?e:a}function p(a,b,c){if(c.path&&c.path.length){b=a[b];var d,e=c.path.length-1;for(d=0;d<e;d++)b=b[c.path[d]];switch(c.kind){case "A":p(b[c.path[d]],c.index,c.item);break;case "D":delete b[c.path[d]];break;case "E":case "N":b[c.path[d]]=
c.rhs}}else switch(c.kind){case "A":p(a[b],c.index,c.item);break;case "D":a=k(a,b);break;case "E":case "N":a[b]=c.rhs}return a}function w(a,b,c){if(a&&b&&c&&c.kind){b=-1;for(var d=c.path?c.path.length-1:0;++b<d;)"undefined"===typeof a[c.path[b]]&&(a[c.path[b]]="number"===typeof c.path[b]?[]:{}),a=a[c.path[b]];switch(c.kind){case "A":p(c.path?a[c.path[b]]:a,c.index,c.item);break;case "D":delete a[c.path[b]];break;case "E":case "N":a[c.path[b]]=c.rhs}}}function q(a,b,c){if(c.path&&c.path.length){b=
a[b];var d,e=c.path.length-1;for(d=0;d<e;d++)b=b[c.path[d]];switch(c.kind){case "A":q(b[c.path[d]],c.index,c.item);break;case "D":b[c.path[d]]=c.lhs;break;case "E":b[c.path[d]]=c.lhs;break;case "N":delete b[c.path[d]]}}else switch(c.kind){case "A":q(a[b],c.index,c.item);break;case "D":a[b]=c.lhs;break;case "E":a[b]=c.lhs;break;case "N":a=k(a,b)}return a}var u,y,z=[];u="object"===typeof global&&global?global:"undefined"!==typeof window?window:{};(y=u.DeepDiff)&&z.push(function(){"undefined"!==typeof y&&
u.DeepDiff===n&&(u.DeepDiff=y,y=a)});b(d,c);b(e,c);b(f,c);b(g,c);Object.defineProperties(n,{diff:{value:n,enumerable:!0},observableDiff:{value:m,enumerable:!0},applyDiff:{value:function(a,b,c){a&&b&&m(a,b,function(d){c&&!c(a,b,d)||w(a,b,d)})},enumerable:!0},applyChange:{value:w,enumerable:!0},revertChange:{value:function(a,b,c){if(a&&b&&c&&c.kind){var d;d=c.path.length-1;for(b=0;b<d;b++)"undefined"===typeof a[c.path[b]]&&(a[c.path[b]]={}),a=a[c.path[b]];switch(c.kind){case "A":q(a[c.path[b]],c.index,
c.item);break;case "D":a[c.path[b]]=c.lhs;break;case "E":a[c.path[b]]=c.lhs;break;case "N":delete a[c.path[b]]}}},enumerable:!0},isConflict:{value:function(){return"undefined"!==typeof y},enumerable:!0},noConflict:{value:function(){z&&(z.forEach(function(a){a()}),z=null);return n},enumerable:!0}});return n});
(function(a){var b={vertical:{x:!1,y:!0},horizontal:{x:!0,y:!1},both:{x:!0,y:!0},x:{x:!0,y:!1},y:{x:!1,y:!0}},c={duration:"fast",direction:"both"},d=/^(?:html)$/i,e=function(b){var c=a(window),e=d.test(b[0].nodeName),f;if(e)f={top:0,left:0,bottom:0,right:0};else{var n=b[0],p;p=document.defaultView&&document.defaultView.getComputedStyle?document.defaultView.getComputedStyle(n,null):n.currentStyle;var w=document.defaultView&&document.defaultView.getComputedStyle?!0:!1;f=parseFloat(w?p.borderTopWidth:
a.css(n,"borderTopWidth"))||0;var q=parseFloat(w?p.borderLeftWidth:a.css(n,"borderLeftWidth"))||0,u=parseFloat(w?p.borderBottomWidth:a.css(n,"borderBottomWidth"))||0,n=parseFloat(w?p.borderRightWidth:a.css(n,"borderRightWidth"))||0;f={top:f,left:q,bottom:u,right:n,vertical:f+u,horizontal:q+n}}c={top:(e?c:b).scrollTop(),left:(e?c:b).scrollLeft()};q={right:e?0:b.innerWidth()-b[0].clientWidth,bottom:e?0:b.innerHeight()-b[0].clientHeight};u=b[0].getBoundingClientRect();return{border:f,scroll:c,scrollbar:q,
...
k.scrollbar.bottom-n.rect.bottom,w=n.rect.left-(k.rect.left+k.border.left),n=k.rect.right-k.border.right-k.scrollbar.right-n.rect.right,q={};!0===f.direction.y&&(0>l?q.scrollTop=k.scroll.top+l:0<l&&0>p&&(q.scrollTop=k.scroll.top+Math.min(l,-p)));!0===f.direction.x&&(0>w?q.scrollLeft=k.scroll.left+w:0<w&&0>n&&(q.scrollLeft=k.scroll.left+Math.min(w,-n)));a.isEmptyObject(q)?a.isFunction(f.complete)&&f.complete.call(m[0]):(d.test(m[0].nodeName)&&(m=a("html,body")),m.animate(q,f.duration).eq(0).queue(function(b){a.isFunction(f.complete)&&
f.complete.call(m[0]);b()}))}return this}});var f={auto:!0,scroll:!0,visible:!1,hidden:!1};a.extend(a.expr[":"],{scrollable:function(a,c,e,m){c=b["string"===typeof e[3]&&e[3].toLowerCase()]||b.both;e=document.defaultView&&document.defaultView.getComputedStyle?document.defaultView.getComputedStyle(a,null):a.currentStyle;var n=f[e.overflowX.toLowerCase()]||!1,p=f[e.overflowY.toLowerCase()]||!1,w=d.test(a.nodeName);if(!n&&!p&&!w)return!1;a={height:{scroll:a.scrollHeight,client:a.clientHeight},width:{scroll:a.scrollWidth,
client:a.clientWidth},scrollableX:function(){return(n||w)&&this.width.scroll>this.width.client},scrollableY:function(){return(p||w)&&this.height.scroll>this.height.client}};return c.y&&a.scrollableY()||c.x&&a.scrollableX()}})})(jQuery);
"undefined"==typeof JooseX||JooseX.SimpleRequest||Class("JooseX.SimpleRequest",{have:{req:null},methods:{initialize:function(){this.req=window.XMLHttpRequest?new XMLHttpRequest:new ActiveXObject("Microsoft.XMLHTTP")},getText:function(a,b,c,d){var e=this.req,f,g;"string"!=typeof a?(f=a.headers,g=a.url,b=b||a.async,c=c||a.callback,d=d||a.scope):g=a;e.open("GET",g,b||!1);f&&Joose.O.eachOwn(f,function(a,b){e.setRequestHeader(b,a)});try{e.onreadystatechange=function(a){b&&4==e.readyState&&(200==e.status||
...
deferClearer:this.originalClearTimeout,interval:a.interval,callbackDelay:a.callbackDelay,observeTest:this,processor:function(g,n){for(var p=g.sourceIndex,q=g.targetIndex,w=Math.min(q-p,f)||1;p<=q;p+=w){var A=l[p],C=A[0],A=A[1],E=c.elementFromPoint(C,A);if(E){if(E.ownerDocument!==b)var B=c.$((E.ownerDocument.defaultView||E.ownerDocument.parentWindow).frameElement).offset(),C=C-B.left,A=A-B.top;if(E!==e){for(var D=d.length-1;0<=D;D--)if(B=d[D],c.nodeIsUnloaded(B))d.splice(D,1);else if(B!==E&&0===c.$(B).has(E).length){if(m.mouseEnterLeave)a.onPointerLeave(B,
$.extend({clientX:C,clientY:A,relatedTarget:E},k));d.splice(D,1)}if(e)a.onPointerOut(e,$.extend({clientX:C,clientY:A,relatedTarget:E},k));if(m.mouseEnterLeave&&-1==jQuery.inArray(E,d)){for(var B=[],D=E.ownerDocument.documentElement,H=E;H&&H!=D;)B.unshift(H),H=H.parentNode;for(D=0;D<B.length;D++)-1==jQuery.inArray(B[D],d)&&(a.onPointerEnter(B[D],$.extend({clientX:C,clientY:A,relatedTarget:e},k)),d.push(B[D]))}a.onPointerOver(E,$.extend({clientX:C,clientY:A,relatedTarget:e},k));e=E}a.onPointerMove(E,
$.extend({clientX:C,clientY:A},k),p<q)}}}}),p=0,w=l.length;p<w;p+=g)n.addStep({sourceIndex:p,targetIndex:Math.min(p+g-1,l.length-1)});var q=this.beginAsync();n.run(function(){c.endAsync(q);c.processCallbackFromTest(a.callback,null,a.scope||c)})},waitForTargetAndSyncMousePosition:function(a,b,c,d,e,f){var g,k="Array"!=this.typeOf(a),l=this.suppressPassedWaitForAssertion;this.suppressPassedWaitForAssertion=!0;this.chain({waitForAnimations:[]},k&&{waitForElementVisible:a},k&&this.autoScrollElementsIntoView?
...
!1,a.method,a.offset);var f=this,g=a.globalXY[0],k=a.globalXY[1],l="option"===a.el.nodeName.toLowerCase(),m=f.global.document,n=m.body.scrollTop,p=l?a.el:f.elementFromPoint(g,k,!1,a.el),w=!1,q=new Siesta.Util.Queue({deferer:this.originalSetTimeout,deferClearer:this.originalClearTimeout,interval:b?10:0,callbackDelay:f.afterActionDelay,observeTest:this,processor:function(a){var b=m.body?m.body.scrollTop-n:0,b=l?p:f.elementFromPoint(g,k-b,!1,p);!l&&a.recaptureTarget&&(p=b,w=!1);l||b==p||$.contains(b,
p)||$.contains(p,b)||(w=!0);if(!w||!a.cancelIfTargetChanged){var c=f.simulateEvent(b,a.event,d,a.suppressLog);"mousedown"==c.type?f.mouseState="down":"mouseup"==c.type&&(f.mouseState="up");a.focus&&f.mimicFocusOnMouseDown(b,c)}}});Joose.A.each(e,function(a){q.addStep(a)});var u=f.beginAsync();q.run(function(){f.endAsync(u);f.afterMouseInteraction();f.processCallbackFromTest(b,null,c||f)})},simulateMouseClick:function(a,b,c,d){this.processMouseClickSteps(a,b,c,d,[{event:"mousedown",suppressLog:!0,
...
(b=a);a!=b||g||k||(g=["25%","50%"],k=["75%","50%"]);var m=this.getNormalizedTopElementInfo(a,!0,"pinch: target1",g),n=this.getNormalizedTopElementInfo(b,!0,"pinch: target2",k);if(m&&n){var p=new Siesta.Util.Queue({deferer:this.originalSetTimeout,deferClearer:this.originalClearTimeout,interval:d?30:0,observeTest:this}),w,q,u=m.localXY[0]-n.localXY[0],y=m.localXY[1]-n.localXY[1],z=Math.sqrt(u*u+y*y);1>z&&(z=1);c=(z*c-z)/2;var u=Math.atan(y/u),r=Math.round(m.localXY[0]-c*Math.cos(u)),v=Math.round(m.localXY[1]-
c*Math.sin(u)),A=Math.round(n.localXY[0]+c*Math.cos(u)),C=Math.round(n.localXY[1]+c*Math.sin(u)),E=Joose.O.extend({},f);p.addStep({processor:function(){w=l.touchStart(null,null,f,m);q=l.touchStart(null,null,E,n)}});p.addAsyncStep({processor:function(a){var b=!1,c=!1;l.touchMove(w,r,v,function(){(b=!0,c)&&a.next()},null,f);l.touchMove(q,A,C,function(){c=!0;b&&c&&a.next()},null,E)}});p.addStep({processor:function(){l.touchEnd(w,f);l.touchEnd(q,E)}});var B=l.beginAsync();p.run(function(){l.endAsync(B);
...
("function"==typeof g||d.isPrimitive(g))){var z;a:{for(var r=c+"."+f,v=0;v<k.length;v++)if(k[v].test(r)){z=!0;break a}z=!1}z||e.push(c+"."+f)}}}catch(A){}return e};c.waitFor(function(){return f.Ext&&f.Ext.isReady},function(){var b=c.global,k=[];d.iterate(d.ClassManager.classes,function(a){if(a.match(/^Ext\./)){var c=g(f,a),d=g(b,a);if(c&&"undefined"!==typeof d){var e=l(c,d,a);k.push.apply(k,e);d.prototype&&(a=l(c.prototype,d.prototype,a+".prototype"),k.push.apply(k,a))}}});c.globalExtOverrides=k;
