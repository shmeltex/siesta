...
!0;return(new b(a,c)).c},create:function(b,c,d){if(!b)return(new c(b,d)).c;var e=this;if(/^\./.test(b))return this.executeIn(a.top,function(){return e.create(b.replace(/^\./,""),c,d)});for(var f=d||{},g=a.S.saneSplit(b,"."),q=this.getCurrent(),t=q==a.top?[]:a.S.saneSplit(q.meta.name,"."),v=0;v<g.length;v++){var w=g[v],x=v==g.length-1;if("meta"==w||"my"==w||!w)throw"Module name ["+b+"] may not include a part called 'meta' or 'my' or empty part.";var y=q[w];t.push(w);var C=t.join("."),z=!1;if("undefined"==
typeof y)x?(y=this.earlyCreate(C,c,f),z=!0):y=(new a.Namespace.Keeper(C)).c,q[w]=y;else if(x&&y&&y.meta)if(q=y.meta,c==a.Namespace.Keeper)q.extend(f);else if(q instanceof a.Namespace.Keeper)q.plant(this.earlyCreate(C,c,f)),z=!0;else throw Error("Double declaration of ["+C+"]");else if(x&&!(y&&y.meta&&y.meta.meta))throw"Trying to setup module "+C+" failed. There is already something: "+y;x&&this.prepareMeta(y.meta);z&&y.meta.construct(f);q=y}return q},prepareMeta:function(){},prepareProperties:function(a,
...
Class("Scope.Provider",{VERSION:0.12,has:{name:null,launchId:null,scope:null,seedingCode:null,seedingScript:null,preload:{is:"ro",init:Joose.I.Array},cleanupCallback:null,beforeCleanupCallback:null},methods:{isCSS:function(a){return/\.css(\?.*)?$/i.test(a)},isAlreadySetUp:function(){return Boolean(this.scope)},addPreload:function(a){if(this.isAlreadySetUp())throw Error("Can't use `addPreload` - scope is already setup. Use `runCode/runScript` instead");"string"==typeof a?a=this.isCSS(a)?{type:"css",
...
Role("Scope.Provider.Role.WithDOM",{requires:["getDocument","create","getPreload","isAlreadySetUp","setViewportSize"],has:{useStrictMode:!0,sourceURL:null,innerHtmlHead:null,innerHtmlBody:null,minViewportSize:null,parentWindow:function(){return window},scopeId:function(){return Math.round(1E10*Math.random())},attachToOnError:function(){return function(a,b,c,d){var e=a.onerror;e&&e.__SP_MANAGED__||(a.onerror=function(f,g,k){c=(a.opener||a.parent).Scope.Provider.__ONERROR__[b];if(!c.__CALLING__&&(c.__CALLING__=
!0,e&&e.apply(this,arguments),c.apply(this,arguments),c.__CALLING__=!1,!1!==d))return a.WebKitPoint?!1:!0},a.onerror.__SP_MANAGED__=!0)}},cachedOnError:null},override:{cleanup:function(){this.cachedOnError=null;try{this.scope.onerror=null}catch(a){}this.SUPERARG(arguments);this.scope=null}},methods:{cleanupHanlders:function(){var a=this.parentWindow.Scope.Provider,b=this.scopeId;delete a.__ONLOAD__[b];delete a.__ONERROR__[b];delete a.__FAILED_PRELOAD__[b]},getHead:function(){return this.getDocument().getElementsByTagName("head")[0]},
installOnErrorHandler:function(a){if(!this.isAlreadySetUp())throw"Scope should be already set up";this.attachToOnError(this.scope,this.scopeId,a)},addOnErrorHandler:function(a,b){a.__SP_MANAGED__=!0;this.cachedOnError=a;var c=this.scopeId;this.parentWindow.Scope.Provider.__ONERROR__[c]=a;c=";("+this.attachToOnError.toString()+")(window, "+c+", (window.opener || window.parent).Scope.Provider.__ONERROR__[ "+c+" ], "+b+");";this.isAlreadySetUp()?this.runCode(c):this.getPreload().unshift({type:"js",content:c,
unordered:!0})},addSeedingToPreload:function(){var a=this.getPreload();this.seedingCode&&a.unshift({type:"js",content:this.seedingCode});this.seedingScript&&a.push({type:"js",url:this.seedingScript})},setup:function(a){var b="v"=="\v"||Boolean(this.parentWindow.msWriteProfilerMark),c=!1;Joose.A.each(this.getPreload(),function(a){if("js"==a.type&&a.content&&!a.unordered)return c=!0,!1});var d=this,e=function(){a&&a(d,d.parentWindow.Scope.Provider.__FAILED_PRELOAD__[d.scopeId])};this.parentWindow.Scope.Provider.__FAILED_PRELOAD__[this.scopeId]=
{};this.sourceURL||b&&c?(this.addSeedingToPreload(),this.setupIncrementally(e)):(b||this.addSeedingToPreload(),this.setupWithDocWrite(e,b))},setupWithDocWrite:function(a,b){var c=[],d=this;Joose.A.each(this.getPreload(),function(a){if("js"==a.type)c.push(d.getScriptTagString(a.url,a.content));else if("css"==a.type)c.push(d.getLinkTagString(a.url,a.content));else throw"Incorrect preload descriptor "+a;});this.create();var e=this.scopeId;this.parentWindow.Scope.Provider.__ONLOAD__[e]=function(){var c=
function(){a&&a()};b?(d.seedingCode&&d.runCode(d.seedingCode),d.seedingScript?d.runScript(d.seedingScript,c):c()):c()};var f=this.getDocument();f.open();f.write([this.useStrictMode?"<!DOCTYPE html>":"",'<html style="width: 100%; height: 100%; margin : 0; padding : 0;"><head>',this.innerHtmlHead||"",c.join(""),"</head>",'<body style="margin : 0; padding : 0; width: 100%; height: 100%" onload="setTimeout(function () { (window.opener || window.parent).Scope.Provider.__ONLOAD__['+e+']() }, 0)">',this.innerHtmlBody||
"","</body></html>"].join(""));f.close();d.cachedOnError&&d.installOnErrorHandler(d.cachedOnError)},setupIncrementally:function(a){var b=this;this.create(function(){if(!b.sourceURL){var c=b.getDocument();if(b.innerHtmlHead){var d=b.getHead();try{d.innerHTML=b.innerHtmlHead}catch(e){var f=c.createElement("div");f.innerHTML=b.innerHtmlHead;for(var g=0;g<f.children.length;g++)d.appendChild(f.children[g])}}b.innerHtmlBody&&(c.body.innerHTML=b.innerHtmlBody)}var k=function(a,c){var d=function(){b.scope&&
k(a,c)};if(a.length){var e=a.shift();e.url?b.runScript(e.url,d):"js"==e.type?b.runCode(e.content,d):(b.addStyleTag(e.content),d())}else c&&c()};b.scope&&k(b.getPreload().slice(),a)})},getScriptTagString:function(a,b){var c='<script type="text/javascript"',d;d="(window.opener || window.parent).Scope.Provider.__FAILED_PRELOAD__[ scopeId ][ url ] = true".replace(/scopeId/,"'"+this.scopeId+"'").replace(/url/,"'"+a+"'");return c=a?c+(' src="'+a+'" onerror="'+d+'">\x3c/script>'):c+(">"+b.replace(/<\/script>/gi,
"\\x3C/script>")+"\x3c/script>")},getLinkTagString:function(a,b){if(a)return'<link href="'+a+'" rel="stylesheet" type="text/css" />';if(b)return"<style>"+b+"</style>"},loadCSS:function(a,b){var c=this.getDocument(),d=c.createElement("link");d.type="text/css";d.rel="stylesheet";d.href=a;this.getHead().appendChild(d);var e=!1,d=function(){e||(e=!0,clearTimeout(f),b&&b(),c.body.removeChild(g))},f=setTimeout(d,3E3),g=c.createElement("img");g.onerror=d;c.body.appendChild(g);g.src=a},runCode:function(a,
b){this.getHead().appendChild(this.createScriptTag(a));b&&b()},runScript:function(a,b){var c=this.scopeId;this.isCSS(a)?this.loadCSS(a,b):this.getHead().appendChild(this.createScriptTag(null,a,b,function(){this.onerror=null;var d=this.ownerDocument,d=d.defaultView||d.parentWindow;(d.opener||d.parent).Scope.Provider.__FAILED_PRELOAD__[c][a]=!0;b()}))},createScriptTag:function(a,b,c,d){var e=this.getDocument().createElement("script");e.setAttribute("type","text/javascript");b&&e.setAttribute("src",
...
q=function(d){if("readystatechange"!=d.type||"complete"==l.readyState)("load"==d.type?a:l)[p](s+d.type,q,!1),!c&&(c=!0)&&b.call(a,d.type||d)},t=function(){try{m.doScroll("left")}catch(a){setTimeout(t,50);return}q("poll")};if("complete"==l.readyState)b.call(a,"lazy");else{if(l.createEventObject&&m.doScroll){try{d=!a.frameElement}catch(v){}d&&t()}l[n](s+"DOMContentLoaded",q,!1);l[n](s+"readystatechange",q,!1);a[n](s+"load",q,!1)}};this.sourceURL?setTimeout(function(){d(c,a||function(){})},10):d(c,a||
...
(function(){function a(a){return 10>a?"0"+a:a}function b(a){e.lastIndex=0;return e.test(a)?'"'+a.replace(e,function(a){var b=k[a];return"string"===typeof b?b:"\\u"+("0000"+a.charCodeAt(0).toString(16)).slice(-4)})+'"':'"'+a+'"'}function c(a,d){var e,k,q,t,v=f,w,x=d[a];x&&("object"===typeof x&&"function"===typeof x.toJSON)&&(x=x.toJSON(a));"function"===typeof l&&(x=l.call(d,a,x));switch(typeof x){case "string":return b(x);case "number":return isFinite(x)?String(x):"null";case "boolean":case "null":return String(x);
case "object":if(!x)return"null";f+=g;w=[];if("[object Array]"===Object.prototype.toString.apply(x)){t=x.length;for(e=0;e<t;e+=1)w[e]=c(e,x)||"null";q=0===w.length?"[]":f?"[\n"+f+w.join(",\n"+f)+"\n"+v+"]":"["+w.join(",")+"]";f=v;return q}if(l&&"object"===typeof l)for(t=l.length,e=0;e<t;e+=1)"string"===typeof l[e]&&(k=l[e],(q=c(k,x))&&w.push(b(k)+(f?": ":":")+q));else for(k in x)Object.prototype.hasOwnProperty.call(x,k)&&(q=c(k,x))&&w.push(b(k)+(f?": ":":")+q);q=0===w.length?"{}":f?"{\n"+f+w.join(",\n"+
f)+"\n"+v+"}":"{"+w.join(",")+"}";f=v;return q}}"function"!==typeof Date.prototype.toJSON&&(Date.prototype.toJSON=function(b){return isFinite(this.valueOf())?this.getUTCFullYear()+"-"+a(this.getUTCMonth()+1)+"-"+a(this.getUTCDate())+"T"+a(this.getUTCHours())+":"+a(this.getUTCMinutes())+":"+a(this.getUTCSeconds())+"Z":null},String.prototype.toJSON=Number.prototype.toJSON=Boolean.prototype.toJSON=function(a){return this.valueOf()});var d=/[\u0000\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,
...
Role("Siesta.Util.Role.CanGetType",{methods:{typeOf:function(a){return Object.prototype.toString.call(a).slice(8,-1)}}});Role("Siesta.Util.Role.CanEscapeRegExp",{methods:{escapeRegExp:function(a){return a.replace(/[\-\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g,"\\$&")}}});
...
exception:"Exception",exceptionAnnotation:'Exception thrown while calling "destroy" method of',destroyFailed:"was not destroyed (probably destroy was canceled in the `beforedestroy` listener)",destroyPassed:"All passed components were destroyed ok"},"Siesta.Test.ExtJS.DataView":{view:"view",toRender:"to render"},"Siesta.Test.ExtJS.Element":{top:"top",left:"left",bottom:"bottom",right:"right"},"Siesta.Test.ExtJS.Grid":{waitForRowsVisible:"rows to show for panel with id"},"Siesta.Test.ExtJS.Observable":{hasListenerInvalid:"1st argument for `t.hasListener` should be an observable instance",
hasListenerPass:"Observable has listener for {eventName}",hasListenerFail:"Provided observable has no listeners for event",isFiredWithSignatureNotFired:'event was not fired during the test"',observableFired:"Observable fired",correctSignature:"with correct signature",incorrectSignature:"with incorrect signature"},"Siesta.Test.ExtJS.Store":{storesToLoad:"stores to load",failedToLoadStore:"Failed to load the store",URL:"URL"},"Siesta.Test.Action":{missingTestAction:"Action [{0}] requires `{1}` method in your test class"},
"Siesta.Test.BDD":{codeBodyMissing:"Code body is not provided for",codeBodyOf:"Code body of",missingFirstArg:"does not declare a test instance as 1st argument",iitFound:"t.iit should only be used during debugging",noObject:"No object to spy on"},"Siesta.Test.BDD.Spy":{spyingNotOnFunction:"Trying to create a spy over a non-function property"},"Siesta.Test.Browser":{popupsDisabled:"Failed to open the popup for url: {url}. Enable the popups in the browser settings.",noDomElementFound:"No DOM element found for CSS selector",
noActionTargetFound:"No action target found for",waitForEvent:"observable to fire its",event:"event",wrongFormat:"Wrong format for expected number of events",unrecognizedSignature:"Unrecognized signature for `firesOk`",observableFired:"Observable fired",observableFiredOk:"Observable fired expected number of",actualNbrEvents:"Actual number of events",expectedNbrEvents:"Expected number of events",events:"events",noElementFound:"Could not find any element at",targetElementOfAction:"Target element of action",
targetElementOfSomeAction:"Target element of some action",isNotVisible:"is not visible or not reachable",text:"text",toBePresent:"to be present",toNotBePresent:"to not be present",target:"target",toAppear:"to appear",targetMoved:"Moving target detected, retargeting initiated",alertMethodNotCalled:"Expected a call to alert()",focusLostWarning:"Focus has left the test window {url}",focusLostWarningLauncher:"Focus has left the test window {url}, it will be restarted. This behavior is controled with the --restart-on-blur option."},
...
codeWindowTitle:"Code",addNewTooltip:"Add a new step",removeAllPromptTitle:"Remove all?",removeAllPromptMessage:"Do you want to clear the recorded events?",Error:"Error",showSource:"Show source",showSourceInNewWindow:"Show source in new window",newRecording:"New recording...",pageUrl:"Page URL"},"Siesta.Recorder.UI.TargetColumn":{headerText:"Target / Value",by:"by",to:"to"}};
...
{got:a,need:c.get("aReValue")})},isFunction:function(a,b){var c=Siesta.Resource("Siesta.Test.More");"Function"==this.typeOf(a)?this.pass(b,{descTpl:c.get("isAFunction"),value:a}):this.fail(b,{got:a,need:c.get("aFunctionValue")})},is_deeply:function(a,b,c){this.isDeeply.apply(this,arguments)},isDeeply:function(a,b,c){if(this.typeOf(a)===this.typeOf(b)&&this.compareObjects(a,b)){var d=Siesta.Resource("Siesta.Test.More");this.pass(c,{descTpl:d.get("isDeeplyPassTpl"),obj1:a,obj2:b})}else this.fail(c,
{assertionName:"isDeeply",got:a,need:b})},isDeeplyStrict:function(a,b,c){if(this.typeOf(a)===this.typeOf(b)&&this.compareObjects(a,b,!0)){var d=Siesta.Resource("Siesta.Test.More");this.pass(c,{descTpl:d.get("isDeeplyStrictPassTpl"),obj1:a,obj2:b})}else this.fail(c,{assertionName:"isDeeplyStrict",got:a,need:b})},expectGlobal:function(){this.expectGlobals.apply(this,arguments)},expectGlobals:function(){this.expectedGlobals.push.apply(this.expectedGlobals,arguments)},isGlobalExpected:function(a,b){var c=
this;if(!b||b&&!b.expectedStrings)b||(b={}),Joose.O.extend(b,{expectedStrings:{},expectedRegExps:[]}),Joose.A.each(this.expectedGlobals.concat(this.browserGlobals),function(a){"RegExp"==c.typeOf(a)?b.expectedRegExps.push(a):b.expectedStrings[a]=!0});if(b.expectedStrings[a])return!0;if(Siesta.Harness.Browser.FeatureSupport().supports.imageWithIdCreatesGlobalEnumerable){var d=this.global.document.getElementById(a);if(d&&"img"==d.tagName.toLowerCase())return!0}for(d=0;d<b.expectedRegExps.length;d++)if(b.expectedRegExps[d].test(a))return!0;
return!1},forEachUnexpectedGlobal:function(a,b){b=b||this;var c={},d;for(d in this.global)if(!this.isGlobalExpected(d,c)&&!1===a.call(b,d))break},verifyGlobals:function(){var a=Siesta.Resource("Siesta.Test.More");if(this.disableGlobalsCheck)this.diag(a.get("globalCheckNotSupported"));else{this.expectGlobals.apply(this,arguments);this.diag(a.get("globalVariables"));var b=!1,c=0;this.forEachUnexpectedGlobal(function(d){this.fail(a.get("globalFound"),a.get("globalName")+": "+d+", "+a.get("value")+": "+
Siesta.Util.Serializer.stringify(this.global[d]));b=!0;return 50>c++});b||this.pass(a.get("noGlobalsFound"))}},startWaiting:function(a,b){var c=new Siesta.Result.Assertion({description:a,isWaitFor:!0,sourceLine:b});this.fireEvent("testupdate",this,c,this.getResults());return c},finalizeWaiting:function(a,b,c,d,e,f){a.completed=!0;b?this.suppressPassedWaitForAssertion||f?this.fireEvent("assertiondiscard",this,a):this.pass(c,d,a):(this.fail(c,d,a),e&&e())},waitFor:function(a,b,c,d,e){var f=Siesta.Resource("Siesta.Test.More"),
g=" "+f.get("conditionToBeFulfilled"),k="waitFor",l=this,m=l.getSourceLine(),n=l.originalSetTimeout,p=l.originalClearTimeout,s,q;if(1===arguments.length&&"Object"==this.typeOf(a)){var t=a;a=t.method;b=t.callback;c=t.scope;d=t.timeout;e=t.interval;g=t.description||g;k=t.assertionName||k;q=t.suppressAssertion;s=t.errback}t="Number"==this.typeOf(a);b=b||function(){};var g=t?a+" "+f.get("ms"):g,v,w=l.startWaiting(f.get("waitingFor")+" "+g,m);e=e||this.waitForPollInterval;d=d||this.waitForTimeout;var x=
this.beginAsync((t?a:d)+3*e,function(){y=!0;p(v);l.finalizeWaiting(w,!1,f.get("waitedTooLong")+": "+g,{assertionName:k,annotation:f.get("conditionNotFulfilled")+" "+d+f.get("ms")},s,q);return!0}),y=!1;this.on("beforetestfinalize",function(){y||(y=!0,l.finalizeWaiting(w,!1,f.get("waitingAborted"),null,null,q),l.endAsync(x),p(v))},null,{single:!0});if(t)v=n(function(){y=!0;l.finalizeWaiting(w,!0,f.get("Waited")+" "+a+" "+f.get("ms"),null,null,q);l.endAsync(x);l.processCallbackFromTest(b,[],c||l)},a);
else{var C,z=new Date,A=function(){var m=new Date-z;if(m>d)l.endAsync(x),l.finalizeWaiting(w,!1,f.get("waitedTooLong")+": "+g,{assertionName:k,annotation:f.get("conditionNotFulfilled")+" "+d+f.get("ms")},s,q),y=!0;else{try{C=a.call(c||l)}catch(p){l.endAsync(x);l.finalizeWaiting(w,!1,k+" "+f.get("checkerException"),{assertionName:k,got:p.toString(),gotDesc:f.get("Exception")},s,q);y=!0;return}null!=C&&!1!==C?(l.endAsync(x),y=!0,l.finalizeWaiting(w,!0,f.get("Waited")+" "+m+" "+f.get("msFor")+" "+g,
null,null,q),l.processCallbackFromTest(b,[C],c||l)):v=n(A,e)}};A()}return{force:function(){y||(y=!0,p(v),l.endAsync(x),l.finalizeWaiting(w,!0,f.get("forcedWaitFinalization")+" "+g,null,null,q),l.processCallbackFromTest(b,[],c||l))}}},waitForMs:function(){return this.waitFor.apply(this,arguments)},waitForFn:function(){return this.waitFor.apply(this,arguments)},analyzeChainStep:function(a){a=a.toString();var b=a.match(/function\s*[^(]*\(\s*(.*?)\s*(?:,|\))/)[1];return b?-1!=a.match(/\{([\s\S]*)\}/)[1].indexOf(b):
!1},chain:function(){var a=this.flattenArray(arguments),b=Siesta.Resource("Siesta.Test.More"),c=[];Joose.A.each(a,function(a){a&&c.push(a)});var a=c,d=a.length;if(d){var e=this,f=arguments.callee,g=new Siesta.Util.Queue({deferer:this.originalSetTimeout,deferClearer:this.originalClearTimeout,interval:f.hasOwnProperty("actionDelay")?f.actionDelay:this.actionDelay,observeTest:this});delete f.actionDelay;var k=e.getSourceLine(),l=[];Joose.A.each(a,function(a,c){var f=c==d-1;g.addAsyncStep({processor:function(d){var g=
function(f){if(!f)var g=e.beginAsync((a.timeout||e.defaultTimeout)+100,function(){e.fail(b.get("chainStepNotCompleted"),{sourceLine:k,annotation:b.get("stepNumber")+": "+(c+1)+" "+b.get("oneBased")+(k?"\n"+b.get("atLine")+": "+k:""),ownTextOnly:!0});return!0});return{next:function(){var p=arguments.callee;p.__CALLED__&&e.fail(b.get("calledMoreThanOnce",{num:c+1,line:k}));p.__CALLED__=!0;f||e.endAsync(g);l=Array.prototype.slice.call(arguments);a.desc&&e.pass(a.desc);d.next()},async:g}};if(a instanceof
Siesta.Test)e.launchSubTest(a,g(!0).next);else if("Function"==e.typeOf(a)||"Function"==e.typeOf(a.action)){var t="Function"==e.typeOf(a)?a:a.action,g=g(!1);l.unshift(f?function(){}:g.next);f||e.analyzeChainStep(t)||e.fail(b.get("stepFn")+" ["+t.toString()+"] "+b.get("notUsingNext"));if(e.transparentEx)t.apply(e,l);else{var v=e.getExceptionCatcher()(function(){t.apply(e,l)});void 0!==v&&e.fail(b.get("chainStepEx"),{annotation:e.stringifyException(v)})}f&&(e.endAsync(g.async),a.desc&&e.pass(a.desc))}else("String"==
...
Class("Siesta.Test",{does:[Siesta.Util.Role.CanFormatStrings,Siesta.Util.Role.CanGetType,Siesta.Util.Role.CanEscapeRegExp,Siesta.Test.More,Siesta.Test.Date,Siesta.Test.Function,Siesta.Test.BDD,JooseX.Observable],has:{name:null,url:{required:!0},urlExtractRegex:{is:"rwc",lazy:function(){return RegExp(this.url.replace(/([.*+?^${}()|[\]\/\\])/g,"\\$1")+":(\\d+)")}},assertPlanned:null,assertCount:0,isTodo:!1,results:{lazy:function(){return new Siesta.Result.SubTest({description:this.name||"Root",test:this})}},
run:null,startTestAnchor:null,exceptionCatcher:null,testErrorClass:null,generation:function(){return Math.random()},launchId:null,parent:null,harness:null,isReadyTimeout:1E4,failed:!1,failedException:null,failedExceptionType:null,startDate:null,endDate:null,lastActivityDate:null,contentManager:null,scopeProvider:null,global:null,reusingSandbox:!1,sandboxCleanup:!0,scriptScopeProvider:null,transparentEx:!1,needDone:!1,isDone:!1,defaultTimeout:15E3,subTestTimeout:null,timeout:null,timeoutsCount:function(){return{counter:1}},
...
getExceptionCatcher:function(){return this.exceptionCatcher},getTestErrorClass:function(){return this.testErrorClass},processCallbackFromTest:function(a,b,c){var d=this;if(!a)return!0;if(this.transparentEx)a.apply(c||this.global,b||[]);else{var e=this.getExceptionCatcher()(function(){a.apply(c||d.global,b||[])});if(e)return this.failWithException(e),!1}return!0},getStackTrace:function(a){if(Object(a)!==a||!a.stack)return null;var b=(a.stack+"").split("\n");a+="";for(var c=Siesta.Resource("Siesta.Test"),
d=[],e,f=0;f<b.length;f++)if(e=b[f]){if(!f)if(e!=a)d.push(a);else{d.push(e);continue}e=/@(.*?):(\d+):(\d+)$/.exec(e)||/\((.*?):(\d+):(\d+)\)$/.exec(e)||/at (.*?):(\d+):(\d+)$/.exec(e)||/(.*?):(\d+):(\d+)$/.exec(e);if(!e)return null;d.push("    "+c.get("atLine")+" "+e[2]+(e[3]?", "+c.get("character")+" "+e[3]:"")+", "+c.get("of")+" "+e[1])}return d.length?d:null},formatSourceLine:function(a){var b=Siesta.Resource("Siesta.Test");return a?b.get("atLine")+" "+a+" "+b.get("of")+" "+this.url:""},appendSpaces:function(a,
b){for(var c="";b--;)c+=" ";return a+c},eachAssertion:function(a,b){b=b||this;this.getResults().each(function(c){c instanceof Siesta.Result.Assertion&&a.call(b,c)})},eachSubTest:function(a,b){b=b||this;this.getResults().each(function(c){if(c instanceof Siesta.Result.SubTest&&!1===a.call(b,c.test))return!1})},eachChildTest:function(a,b){b=b||this;this.getResults().eachChild(function(c){if(c instanceof Siesta.Result.SubTest&&!1===a.call(b,c.test))return!1})},countKeys:function(a){var b=0;Joose.O.eachOwn(a,
function(){b++});return b},compareObjects:function(a,b,c,d,e){var f=Joose.O.isInstance(a)&&a.meta.does(Siesta.Test.Role.Placeholder),g=Joose.O.isInstance(b)&&b.meta.does(Siesta.Test.Role.Placeholder);if(c){if(a===b)return!0}else if(a==b)return!0;if(f&&g)return a.equalsTo(b);if(g)return b.equalsTo(a);if(f)return a.equalsTo(b);if(d)return!1;d=this.typeOf(a);f=this.typeOf(b);if(d!=f)return!1;var k=this;if("Object"==d||e)return this.countKeys(a)!=this.countKeys(b)?!1:!1===Joose.O.eachOwn(a,function(a,
d){if(!k.compareObjects(a,b[d],c))return!1})?!1:!0;if("Array"==d){if(a.length!=b.length)return!1;for(e=0;e<a.length;e++)if(!this.compareObjects(a[e],b[e],c))return!1;return!0}return"Function"==d?a.toString()==b.toString()&&(!c||this.compareObjects(a,b,c,!1,!0)):"RegExp"==d?a.source==b.source&&a.global==b.global&&a.ignoreCase==b.ignoreCase&&a.multiline==b.multiline&&(!c||this.compareObjects(a,b,c,!1,!0)):"Date"==d?!Boolean(a-b)&&(!c||this.compareObjects(a,b,c,!1,!0)):!1},ok:function(a,b){var c=Siesta.Resource("Siesta.Test");
a?this.pass(b,{descTpl:c.get("isTruthy"),value:a}):this.fail(b,{assertionName:"ok",got:a,annotation:c.get("needTruthy")})},notok:function(){this.notOk.apply(this,arguments)},notOk:function(a,b){var c=Siesta.Resource("Siesta.Test");a?this.fail(b,{assertionName:"notOk",got:a,annotation:c.get("needFalsy")}):this.pass(b,{descTpl:c.get("isFalsy"),value:a})},is:function(a,b,c){var d=Siesta.Resource("Siesta.Test");b&&a instanceof this.global.Date?this.isDateEqual(a,b,c):this.compareObjects(a,b,!1,!0)?this.pass(c,
{descTpl:d.get("isEqualTo"),got:a,expected:b}):this.fail(c,{assertionName:"is",got:a,need:b})},isnot:function(){this.isNot.apply(this,arguments)},isnt:function(){this.isNot.apply(this,arguments)},isNot:function(a,b,c){var d=Siesta.Resource("Siesta.Test");this.compareObjects(a,b,!1,!0)?this.fail(c,{assertionName:"isnt",got:a,need:b,needDesc:d.get("needNot")}):this.pass(c,{descTpl:d.get("isNotEqualTo"),got:a,expected:b})},isStrict:function(a,b,c){var d=Siesta.Resource("Siesta.Test");this.compareObjects(a,
b,!0,!0)?this.pass(c,{descTpl:d.get("isStrictlyEqual"),got:a,expected:b}):this.fail(c,{assertionName:"isStrict",got:a,need:b,needDesc:d.get("needStrictly")})},isntStrict:function(){this.isNotStrict.apply(this,arguments)},isNotStrict:function(a,b,c){var d=Siesta.Resource("Siesta.Test");this.compareObjects(a,b,!0,!0)?this.fail(c,{assertionName:"isntStrict",got:a,need:b,needDesc:d.get("needStrictlyNot")}):this.pass(c,{descTpl:d.get("isStrictlyNotEqual"),got:a,expected:b})},wait:function(a,b){var c=Siesta.Resource("Siesta.Test");
...
this.originalSetTimeout,c=this.originalClearTimeout||this.global.clearTimeout,d=0,e=Siesta.Resource("Siesta.Test");null==a&&Joose.O.each(this.timeoutIds,function(b,c){a=c;if(d++)throw Error(e.get("endAsyncMisuse"));});c(this.timeoutIds[a]);delete this.timeoutIds[a];var f=this;this.processed&&!this.isFinished()&&b(function(){f.finalize()},1)},clearTimeouts:function(){var a=this.originalClearTimeout;Joose.O.each(this.timeoutIds,function(b,c){a(b)});this.timeoutIds={}},processSubTestConfig:function(a){return Joose.O.extend({trait:Siesta.Test.Sub,
parent:this,isTodo:this.isTodo,transparentEx:this.transparentEx,waitForTimeout:this.waitForTimeout,waitForPollInterval:this.waitForPollInterval,defaultTimeout:this.defaultTimeout,timeout:this.subTestTimeout,subTestTimeout:this.subTestTimeout,global:this.global,url:this.url,scopeProvider:this.scopeProvider,harness:this.harness,generation:this.generation,launchId:this.launchId,overrideSetTimeout:this.overrideSetTimeout,originalSetTimeout:this.originalSetTimeout,originalClearTimeout:this.originalClearTimeout,
timeoutsCount:this.timeoutsCount,autoCheckGlobals:!1,needToCleanup:!1},a)},getSubTest:function(a,b,c){var d,e=Siesta.Resource("Siesta.Test");2==arguments.length||3==arguments.length?d={name:a,run:b,timeout:c}:1==arguments.length&&"Function"==this.typeOf(a)&&(d={name:"Sub test",run:a});d=d||a||{};null==d.timeout&&delete d.timeout;var f=d.name;if(!d.run)throw this.failWithException(e.get("codeBodyMissingForSubTest")+" ["+f+"]"),Error(e.get("codeBodyMissingForSubTest")+" ["+f+"]");if(!d.run.length)throw this.failWithException(e.get("codeBodyMissingTestArg").replace("{name}",
f)),Error(e.get("codeBodyMissingTestArg").replace("{name}",f));return new (d.meta||this.constructor)(this.processSubTestConfig(d))},launchSubTest:function(a,b){var c=this,d=Siesta.Resource("Siesta.Test"),e=a.timeout||this.subTestTimeout,f=this.beginAsync(e,function(){c.fail(d.get("Subtest")+" "+(a.name?"["+a.name+"]":"")+" "+d.get("failedToFinishWithin")+" "+e+" "+Siesta.Resource("Siesta.Test.More","ms"));c.restoreTimeoutOverrides();g.remove();a.finalize(!0);b&&b(a);return!0}),g=a.on("testfinalize",
function(){c.endAsync(f);c.restoreTimeoutOverrides();b&&b(a)});this.addResult(a.getResults());a.start()},todo:function(a,b,c){"Function"==this.typeOf(a)&&(a=[b,b=a][0]);a=this.getSubTest({name:a,run:b,isTodo:!0,transparentEx:!1});this.launchSubTest(a,c)},snooze:function(a,b,c){var d=Siesta.Resource("Siesta.Test");new Date>new Date(a)?b.call(this.global,this):this.todo(d.get("Snoozed until")+" "+new Date(a)+": "+(c||""),b)},subTest:function(a,b,c,d){a=this.getSubTest({name:a||Siesta.Resource("Siesta.Test",
"Subtest"),timeout:d,run:b});this.launchSubTest(a,c);return a},stringifyException:function(a,b){var c=a+"",d=(b||this.getStackTrace(a)||[]).join("\n");-1==d.indexOf(c)&&(d=c+d);return d},failWithException:function(a){var b=Siesta.Resource("Siesta.Test");this.failed=!0;this.failedException=a+"";this.failedExceptionType=this.typeOf(a);var c=this.getStackTrace(a);this.addResult(new Siesta.Result.Assertion({isException:!0,exceptionType:this.failedExceptionType,passed:!1,description:(this.parent?b.get("Subtest")+
" `"+this.name+"`":b.get("Test")+" ")+" "+b.get("threwException"),annotation:this.stringifyException(a,c)}));this.fireEvent("testfailedwithexception",this,a,c);this.finalize(!0)},restoreTimeoutOverrides:function(){this.overrideSetTimeout&&(this.global.setTimeout=this.overrideForSetTimeout,this.global.clearTimeout=this.overrideForClearTimeout)},start:function(a){var b=this,c=Siesta.Resource("Siesta.Test");if(this.startDate)throw c.get("testAlreadyStarted");this.startDate=new Date-0;this.fireEvent("teststart",
this);if(a&&a.length)Joose.A.each(a,function(a){if(a.isException)return b.failWithException(a.message),!1;b.fail(a.message)}),b.finalize(!0);else if(this.parent||this.reusingSandbox)this.launch();else{var d,e=function(a){var d=!1,e=setTimeout(function(){d=!0;b.launch(c.get("setupTookTooLong"))},b.isReadyTimeout);b.setup(function(){d||(clearTimeout(e),b.launch(a))},function(c){d||(clearTimeout(e),b.launch(a||c))})},f=b.isReady();if(f.ready)e();else var g=setTimeout(function(){clearInterval(k);e(d)},
b.isReadyTimeout),k=setInterval(function(){f=b.isReady();f.ready?(clearInterval(k),clearTimeout(g),e()):d=f.reason||d},100)}},setup:function(a,b){a.call(this)},tearDown:function(a,b){a.call(this)},earlySetup:function(a,b){a.call(this)},cleanupContextBeforeStart:function(){var a=this.global;this.forEachUnexpectedGlobal(function(b){try{delete a[b]}catch(c){}})},clearAsyncFrameGlobally:function(a){for(var b=this;b.parent;)b=b.parent;b.eachSubTest(function(b){if(b.hasAsyncFrameByTimeoutId(a))return b.overrideForClearTimeout(a),
!1})},launch:function(a){if(a){var b=Siesta.Resource("Siesta.Test");this.fail(b.get("errorBeforeTestStarted"),{annotation:a})}var c=this,d=this.global;a=this.scopeProvider;var e=this.originalSetTimeout,f=this.originalClearTimeout;this.overrideSetTimeout&&(this.reusingSandbox||a.runCode("var setTimeout, clearTimeout;"),d.setTimeout=this.overrideForSetTimeout=function(a,b){var d=c.timeoutsCount.counter++,g=e(function(){f(g);delete c.timeoutIds[d];c.processed&&!c.isFinished()&&e(function(){c.finalize()},
1);a()},b);"object"==typeof g?g.__index=d:c.idsToIndex[g]=d;return c.timeoutIds[d]=g},d.clearTimeout=this.overrideForClearTimeout=function(a){null!=a&&(c.hasAsyncFrameByTimeoutId(a)?(f(a),a=c.timeoutIdToIndex(a),null!=a&&delete c.timeoutIds[a],c.processed&&!c.isFinished()&&e(function(){c.finalize()},1)):c.clearAsyncFrameGlobally(a))});this.needToCleanup&&(a.beforeCleanupCallback=function(){c.isFinished()||c.finalize(!0);c.overrideSetTimeout&&(d.setTimeout=e,d.clearTimeout=f);d=e=f=null;c.eachSubTest(function(a){a.cleanup()})});
this.reusingSandbox&&(this.sandboxCleanup&&!this.parent)&&this.cleanupContextBeforeStart();var g=this.run;if(this.transparentEx)g(c);else var k=this.getExceptionCatcher()(function(){g(c)});this.afterLaunch(k)},cleanup:function(){this.scopeProvider=this.startTestAnchor=this.exceptionCatcher=this.testErrorClass=this.global=this.run=this.originalSetTimeout=this.originalClearTimeout=this.overrideForSetTimeout=this.overrideForClearTimeout=null;this.purgeListeners()},afterLaunch:function(a){a?this.failWithException(a):
this.finalize()},finalize:function(a){var b=this,c=Siesta.Resource("Siesta.Test");if(!b.finalizationStarted&&!b.isFinished())if(b.processed=!0,a&&(b.clearTimeouts(),b.eachChildTest(function(a){a.finalize(!0)})),Joose.O.isEmpty(b.timeoutIds)){if(!b.needDone&&!b.isDone){b.fireEvent("beforetestfinalizeearly",b);if(!Joose.O.isEmpty(b.timeoutIds))if(a)b.clearTimeouts();else return;b.onBeforeTestFinalize();b.fireEvent("beforetestfinalize",b)}b.finalizationStarted=!0;var d=function(a){a&&b.fail(a);b.endDate=
new Date-0;b.parent||b.addResult(new Siesta.Result.Summary({isFailed:b.isFailed(),description:b.getSummaryMessage()}));b.onTestFinalize();b.fireEvent("testfinalize",b);b.fireEvent("testendbubbling",b);b.callback&&b.callback();b.callback=null};if(b.parent||b.reusingSandbox)d();else{a=b.originalSetTimeout;var e=b.originalClearTimeout,f=!1,g=a(function(){f=!0;d(c.get("testTearDownTimeout"))},b.isReadyTimeout);b.tearDown(function(){e(g);f||d()},function(a){e(g);f||d(a)})}}else!b.__timeoutWarning&&(b.overrideSetTimeout&&
b.lastActivityDate&&new Date-b.lastActivityDate>2*b.defaultTimeout)&&(b.diag(c.get("testStillRunning")),b.warn(c.get("testNotFinalized").replace("{url}",b.url)),b.__timeoutWarning=!0)},onBeforeTestFinalize:function(){},onTestFinalize:function(){},getSummaryMessage:function(a){var b=[],c=this.getPassCount(),d=this.getFailCount(),e=this.assertPlanned,f=d+c;b.push("Passed: "+c);b.push("Failed: "+d);this.failed||(null!=e?(f<e&&b.push("Looks like you planned "+e+" tests, but ran only "+f),f>e&&b.push("Looks like you planned "+
e+" tests, but ran "+(f-e)+" extra tests, "+f+" total."),f!=e||d||b.push("All tests passed")):(c=Siesta.Resource("Siesta.Test"),this.isDoneCorrectly()||b.push(c.get("missingDoneCall")),this.isDoneCorrectly()&&!d&&b.push(c.get("allTestsPassed"))));return a?b.join(a):b},done:function(a){var b=this;if(a){var c=this.beginAsync(),d=this.originalSetTimeout;d(function(){b.endAsync(c);b.done()},a)}else this.fireEvent("beforetestfinalizeearly"),this.fireEvent("beforetestfinalize"),this.isDone=!0,this.processed&&
this.finalize()},isDoneCorrectly:function(){return!this.needDone||this.isDone},getAssertionCount:function(a){var b=0;this.eachAssertion(function(c){a&&c.isTodo||b++});return b},getPassCount:function(a){if(null!=this.$passCount&&!a)return this.$passCount;var b=0;this.eachAssertion(function(c){!c.passed||!a&&c.isTodo||b++});return a?b:this.$passCount=b},getTodoPassCount:function(){var a=0;this.eachAssertion(function(b){b.isTodo&&b.passed&&a++});return a},getTodoFailCount:function(){var a=0;this.eachAssertion(function(b){b.isTodo&&
!b.passed&&a++});return a},getFailCount:function(a){if(null!=this.$failCount&&!a)return this.$failCount;var b=0;this.eachAssertion(function(c){c.passed||!a&&c.isTodo||b++});return a?b:this.$failCount=b},getFailedAssertions:function(){var a=[];this.eachAssertion(function(b){b.isPassed()||a.push(b)});return a},isPassed:function(){var a=this.getPassCount(),b=this.getFailCount(),c=this.assertPlanned;return this.isFinished()&&!this.failed&&!b&&(null!=c&&a==c||null==c&&this.isDoneCorrectly())},isFailed:function(){var a=
this.getPassCount(),b=this.getFailCount(),c=this.assertPlanned;return this.failed||b||this.isFinished()&&(null!=c&&a!=c||null==c&&!this.isDoneCorrectly())},isFailedWithException:function(){return this.failed},isStarted:function(){return null!=this.startDate},isFinished:function(){return null!=this.endDate},getDuration:function(){return this.endDate-this.startDate},getBubbleTarget:function(){return this.parent||this.harness},warn:function(a){this.addResult(new Siesta.Result.Diagnostic({description:a,
...
arguments)},getRootTest:function(){for(var a=this;a.parent;)a=a.parent;return a}}});
...
", "+b+")"},getScopeProviderConfigFor:function(a,b){var c=Joose.O.copy(a.scopeProviderConfig||{});c.seedingCode=this.getSeedingCode(a,b);c.launchId=b;return c},keepTestResult:function(a){if(this.lastResultsByURL[a]){var b=-1;Joose.A.each(this.lastResultsURLs,function(c,d){if(c==a)return b=d,!1});this.lastResultsURLs.splice(b,1);this.lastResultsURLs.push(a)}else this.lastResultsURLs.push(a),this.lastResultsByURL[a]=!0,this.lastResultsURLs.length>this.keepNLastResults&&this.releaseTestResult()},releaseTestResult:function(){if(!(this.lastResultsURLs.length<=
this.keepNLastResults)){var a=this.lastResultsURLs.shift();delete this.lastResultsByURL[a];var b=this.getTestByURL(a);b&&b.isFinished()&&this.cleanupScopeForURL(a)}},isKeepingResultForURL:function(a){return this.lastResultsByURL[a]},setupScope:function(a,b){var c=a.url,d=this.scopesByURL[c],d=d&&d.launchId>b,e=new (eval(a.scopeProvider))(this.getScopeProviderConfigFor(a,b));if(d)return e;this.cleanupScopeForURL(c);this.keepTestResult(c);return this.scopesByURL[c]=e},cleanupScopeForURL:function(a){var b=
this.scopesByURL[a];b&&(delete this.scopesByURL[a],b.cleanup())},prepareScopeSeeding:function(a,b,c){b.testCode||this.cachePreload&&c.hasContentOf(b.url)?a.addPreload({type:"js",content:b.testCode||c.getContentOf(b.url)+"\n//# sourceURL="+b.url}):a.seedingScript=this.resolveURL(b.url,a,b)},normalizeURL:function(a){return a},resolveURL:function(a,b,c){return a},canUseCachedContent:function(a){return this.cachePreload&&a instanceof Siesta.Content.Resource.JavaScript},addCachedResourceToPreloads:function(a,
b,c){a.addPreload({type:"js",content:b.getContentOf(c)})},processURL:function(a,b,c,d,e,f){function g(){p.setup(function(b,g){k.onAfterScopePreload(b,l,t,g);g&&Joose.O.each(g,function(b,c){n.push({isException:!1,message:Siesta.Resource("Siesta.Harness","preloadHasFailed",{url:c})});k.isAutomated&&k.warn(Siesta.Resource("Siesta.Harness","preloadHasFailedForTest",{url:c,test:a.url}))});b.scope?k.isAutomated&&!Joose.O.isEmpty(g)?e():k.launchTest({testHolder:m,desc:a,scopeProvider:b,contentManager:c,
launchState:d,preloadErrors:n,onErrorHandler:s,startTestAnchor:b.scope.StartTest,noCleanup:f,reusingSandbox:!1},e):e()})}var k=this,l=a.url;delete d.notLaunchedByAutomationId[a.automationElementId];if(a.isMissing)e();else{var m={},n=[],p=this.setupScope(a,d.launchId);b=this.getDescriptorConfig(a,"transparentEx");var s=function(a,b,c,d,e){(d=m.test)&&d.isStarted()?(d.nbrExceptions++,d.failWithException(e||a+" "+b+" "+c)):n.push({isException:!0,message:e&&e.stack?e.stack+"":a+" "+b+" "+c})};p.addOnErrorHandler(s,
!b);a.preset.eachResource(function(b){c.hasContentOf(b)&&k.canUseCachedContent(b)?k.addCachedResourceToPreloads(p,c,b):(b=b.asDescriptor(),b.url&&(b.url=k.resolveURL(b.url,p,a)),p.addPreload(b))});k.prepareScopeSeeding(p,a,c);b=k.getDescriptorConfig(a,"testClass");"String"==k.typeOf(b)&&(b=Joose.S.strToClass(b));var q=k.getNewTestConfiguration(a,p,c,d),t=m.test=new b(q);this.onBeforeScopePreload(p,l,t);t.earlySetup(function(){g()},function(a){n.push({isException:!1,message:a});g()})}},launchTest:function(a,
b){var c=a.scopeProvider,d=a.desc,e=this,f=d.url;c.addOnErrorHandler(a.onErrorHandler,!this.getDescriptorConfig(d,"transparentEx"));var g=a.testHolder.test,k=a.startTestAnchor,l=k&&k.args,d=c.scope,m=a.noCleanup,n=a.cleanupUrl;Joose.O.extend(g,{startTestAnchor:k,exceptionCatcher:k.exceptionCatcher,testErrorClass:k.testErrorClass,global:d,originalSetTimeout:a.originalSetTimeout||d.setTimeout,originalClearTimeout:a.originalClearTimeout||d.clearTimeout,run:l&&("function"==typeof l[0]?l[0]:l[1]),reusingSandbox:a.reusingSandbox,
callback:function(){m||e.isKeepingResultForURL(f)||e.cleanupScopeForURL(n||f);b&&b()}});this.saveTestWithURL(f,g);k=function(){c.scope?(e.fireEvent("beforeteststart",g),g.isFinished()||g.start(a.preloadErrors),g=a=null):b()};a.reusingSandbox?k():c instanceof Scope.Provider.IFrame?d.setTimeout(k,10):setTimeout(k,50)},getNewTestConfiguration:function(a,b,c,d){for(var e=[],f=a.parent;f;)f.parent&&e.unshift(String(f.group)),f=f.parent;b={url:a.url,name:a.name,launchId:d.launchId,automationElementId:a.automationElementId,
groups:e,jUnitClass:this.getDescriptorConfig(a,"jUnitClass"),harness:this,expectedGlobals:this.cleanScopeGlobals.concat(this.getDescriptorConfig(a,"expectedGlobals")),autoCheckGlobals:this.getDescriptorConfig(a,"autoCheckGlobals"),disableGlobalsCheck:this.disableGlobalsCheck,scopeProvider:b,contentManager:c,transparentEx:this.getDescriptorConfig(a,"transparentEx"),needDone:this.getDescriptorConfig(a,"needDone"),overrideSetTimeout:this.getDescriptorConfig(a,"overrideSetTimeout"),defaultTimeout:this.getDescriptorConfig(a,
"defaultTimeout")*(d.increaseTimeout?2:1),subTestTimeout:this.getDescriptorConfig(a,"subTestTimeout")*(d.increaseTimeout?2:1),waitForTimeout:this.getDescriptorConfig(a,"waitForTimeout")*(d.increaseTimeout?3:1),isReadyTimeout:this.getDescriptorConfig(a,"isReadyTimeout"),sourceLineForAllAssertions:this.sourceLineForAllAssertions,sandboxCleanup:this.getDescriptorConfig(a,"sandboxCleanup"),config:this.getDescriptorConfig(a,"config"),failOnExclusiveSpecsWhenAutomated:this.getDescriptorConfig(a,"failOnExclusiveSpecsWhenAutomated")};
...
(function(a,b){function c(a,c,d){if(d===b&&1===a.nodeType)if(d="data-"+c.replace(Wa,"$1-$2").toLowerCase(),d=a.getAttribute(d),"string"===typeof d){try{d="true"===d?!0:"false"===d?!1:"null"===d?null:h.isNaN(d)?Xa.test(d)?h.parseJSON(d):d:parseFloat(d)}catch(e){}h.data(a,c,d)}else d=b;return d}function d(a){for(var b in a)if("toJSON"!==b)return!1;return!0}function e(a,c,d){var e=c+"defer",f=c+"queue",g=c+"mark",k=h.data(a,e,b,!0);!k||("queue"!==d&&h.data(a,f,b,!0)||"mark"!==d&&h.data(a,g,b,!0))||setTimeout(function(){h.data(a,
f,b,!0)||h.data(a,g,b,!0)||(h.removeData(a,e,!0),k.resolve())},0)}function f(){return!1}function g(){return!0}function k(a,c,d){var e=h.extend({},d[0]);e.type=a;e.originalEvent={};e.liveFired=b;h.event.handle.call(c,e);e.isDefaultPrevented()&&d[0].preventDefault()}function l(a){var b,c,d,e,f,g,k,l,m,n,p,q=[];e=[];f=h._data(this,"events");if(a.liveFired!==this&&f&&f.live&&!(a.target.disabled||a.button&&"click"===a.type)){a.namespace&&(p=RegExp("(^|\\.)"+a.namespace.split(".").join("\\.(?:.*\\.)?")+
"(\\.|$)"));a.liveFired=this;var s=f.live.slice(0);for(k=0;k<s.length;k++)f=s[k],f.origType.replace(ha,"")===a.type?e.push(f.selector):s.splice(k--,1);e=h(a.target).closest(e,a.currentTarget);l=0;for(m=e.length;l<m;l++)for(n=e[l],k=0;k<s.length;k++)if(f=s[k],n.selector===f.selector&&(!p||p.test(f.namespace))&&!n.elem.disabled){g=n.elem;d=null;if("mouseenter"===f.preType||"mouseleave"===f.preType)a.type=f.preType,(d=h(a.relatedTarget).closest(f.selector)[0])&&h.contains(g,d)&&(d=g);d&&d===g||q.push({elem:g,
handleObj:f,level:n.level})}l=0;for(m=q.length;l<m;l++){e=q[l];if(c&&e.level>c)break;a.currentTarget=e.elem;a.data=e.handleObj.data;a.handleObj=e.handleObj;p=e.handleObj.origHandler.apply(e.elem,arguments);if(!1===p||a.isPropagationStopped())if(c=e.level,!1===p&&(b=!1),a.isImmediatePropagationStopped())break}return b}}function m(a,b){return(a&&"*"!==a?a+".":"")+b.replace(Ya,"`").replace(Za,"&")}function n(a,b,c){b=b||0;if(h.isFunction(b))return h.grep(a,function(a,d){return!!b.call(a,d,a)===c});if(b.nodeType)return h.grep(a,
function(a,d){return a===b===c});if("string"===typeof b){var d=h.grep(a,function(a){return 1===a.nodeType});if($a.test(b))return h.filter(b,d,!c);b=h.filter(b,d)}return h.grep(a,function(a,d){return 0<=h.inArray(a,b)===c})}function p(a,b){if(1===b.nodeType&&h.hasData(a)){var c=h.expando,d=h.data(a),e=h.data(b,d);if(d=d[c]){var f=d.events,e=e[c]=h.extend({},d);if(f){delete e.handle;e.events={};for(var g in f)for(c=0,d=f[g].length;c<d;c++)h.event.add(b,g+(f[g][c].namespace?".":"")+f[g][c].namespace,
...
function q(a){return"getElementsByTagName"in a?a.getElementsByTagName("*"):"querySelectorAll"in a?a.querySelectorAll("*"):[]}function t(a){if("checkbox"===a.type||"radio"===a.type)a.defaultChecked=a.checked}function v(a){h.nodeName(a,"input")?t(a):"getElementsByTagName"in a&&h.grep(a.getElementsByTagName("input"),t)}function w(a,b){b.src?h.ajax({url:b.src,async:!1,dataType:"script"}):h.globalEval((b.text||b.textContent||b.innerHTML||"").replace(ab,"/*$0*/"));b.parentNode&&b.parentNode.removeChild(b)}
function x(a,b,c){var d="width"===b?a.offsetWidth:a.offsetHeight,e="width"===b?bb:cb;if(0<d)return"border"!==c&&h.each(e,function(){c||(d-=parseFloat(h.css(a,"padding"+this))||0);d="margin"===c?d+(parseFloat(h.css(a,c+this))||0):d-(parseFloat(h.css(a,"border"+this+"Width"))||0)}),d+"px";d=P(a,b,b);if(0>d||null==d)d=a.style[b]||0;d=parseFloat(d)||0;c&&h.each(e,function(){d+=parseFloat(h.css(a,"padding"+this))||0;"padding"!==c&&(d+=parseFloat(h.css(a,"border"+this+"Width"))||0);"margin"===c&&(d+=parseFloat(h.css(a,
c+this))||0)});return d+"px"}function y(a){return function(b,c){"string"!==typeof b&&(c=b,b="*");if(h.isFunction(c))for(var d=b.toLowerCase().split(va),e=0,f=d.length,g,k;e<f;e++)g=d[e],(k=/^\+/.test(g))&&(g=g.substr(1)||"*"),g=a[g]=a[g]||[],g[k?"unshift":"push"](c)}}function C(a,c,d,e,f,h){f=f||c.dataTypes[0];h=h||{};h[f]=!0;f=a[f];for(var g=0,k=f?f.length:0,l=a===ia,m;g<k&&(l||!m);g++)m=f[g](c,d,e),"string"===typeof m&&(!l||h[m]?m=b:(c.dataTypes.unshift(m),m=C(a,c,d,e,m,h)));!l&&m||h["*"]||(m=C(a,
c,d,e,"*",h));return m}function z(a,b,c,d){if(h.isArray(b))h.each(b,function(b,e){c||db.test(a)?d(a,e):z(a+"["+("object"===typeof e||h.isArray(e)?b:"")+"]",e,c,d)});else if(c||null==b||"object"!==typeof b)d(a,b);else for(var e in b)z(a+"["+e+"]",b[e],c,d)}function A(){try{return new a.XMLHttpRequest}catch(b){}}function F(){setTimeout(ga,0);return ba=h.now()}function ga(){ba=b}function M(a,b){var c={};h.each(wa.concat.apply([],wa.slice(0,b)),function(){c[this]=a});return c}function xa(a){if(!ja[a]){var b=
u.body,c=h("<"+a+">").appendTo(b),d=c.css("display");c.remove();if("none"===d||""===d)I||(I=u.createElement("iframe"),I.frameBorder=I.width=I.height=0),b.appendChild(I),U&&I.createElement||(U=(I.contentWindow||I.contentDocument).document,U.write(("CSS1Compat"===u.compatMode?"<!doctype html>":"")+"<html><body>"),U.close()),c=U.createElement(a),U.body.appendChild(c),d=h.css(c,"display"),b.removeChild(I);ja[a]=d}return ja[a]}function ka(a){return h.isWindow(a)?a:9===a.nodeType?a.defaultView||a.parentWindow:
!1}var u=a.document,eb=a.navigator,fb=a.location,h=function(){function c(){if(!d.isReady){try{u.documentElement.doScroll("left")}catch(a){setTimeout(c,1);return}d.ready()}}var d=function(a,b){return new d.fn.init(a,b,h)},e=a.jQuery,f=a.$,h,g=/^(?:[^<]*(<[\w\W]+>)[^>]*$|#([\w\-]*)$)/,k=/\S/,l=/^\s+/,m=/\s+$/,n=/\d/,p=/^<(\w+)\s*\/?>(?:<\/\1>)?$/,q=/^[\],:{}\s]*$/,s=/\\(?:["\\\/bfnrt]|u[0-9a-fA-F]{4})/g,t=/"[^"\\\n\r]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g,v=/(?:^|:|,)(?:\s*\[)+/g,x=
/(webkit)[ \/]([\w.]+)/,y=/(opera)(?:.*version)?[ \/]([\w.]+)/,w=/(msie) ([\w.]+)/,C=/(mozilla)(?:.*? rv:([\w.]+))?/,gb=/-([a-z])/ig,B=function(a,b){return b.toUpperCase()},la=eb.userAgent,ca,da,V,hb=Object.prototype.toString,ma=Object.prototype.hasOwnProperty,F=Array.prototype.push,z=Array.prototype.slice,A=String.prototype.trim,ya=Array.prototype.indexOf,za={};d.fn=d.prototype={constructor:d,init:function(a,c,e){var r;if(!a)return this;if(a.nodeType)return this.context=this[0]=a,this.length=1,this;
if("body"===a&&!c&&u.body)return this.context=u,this[0]=u.body,this.selector=a,this.length=1,this;if("string"===typeof a){r="<"===a.charAt(0)&&">"===a.charAt(a.length-1)&&3<=a.length?[null,a,null]:g.exec(a);if(!r||!r[1]&&c)return!c||c.jquery?(c||e).find(a):this.constructor(c).find(a);if(r[1])return e=(c=c instanceof d?c[0]:c)?c.ownerDocument||c:u,(a=p.exec(a))?d.isPlainObject(c)?(a=[u.createElement(a[1])],d.fn.attr.call(a,c,!0)):a=[e.createElement(a[1])]:(a=d.buildFragment([r[1]],[e]),a=(a.cacheable?
d.clone(a.fragment):a.fragment).childNodes),d.merge(this,a);if((c=u.getElementById(r[2]))&&c.parentNode){if(c.id!==r[2])return e.find(a);this.length=1;this[0]=c}this.context=u;this.selector=a;return this}if(d.isFunction(a))return e.ready(a);a.selector!==b&&(this.selector=a.selector,this.context=a.context);return d.makeArray(a,this)},selector:"",jquery:"1.6.2",length:0,size:function(){return this.length},toArray:function(){return z.call(this,0)},get:function(a){return null==a?this.toArray():0>a?this[this.length+
a]:this[a]},pushStack:function(a,b,c){var e=this.constructor();d.isArray(a)?F.apply(e,a):d.merge(e,a);e.prevObject=this;e.context=this.context;"find"===b?e.selector=this.selector+(this.selector?" ":"")+c:b&&(e.selector=this.selector+"."+b+"("+c+")");return e},each:function(a,b){return d.each(this,a,b)},ready:function(a){d.bindReady();da.done(a);return this},eq:function(a){return-1===a?this.slice(a):this.slice(a,+a+1)},first:function(){return this.eq(0)},last:function(){return this.eq(-1)},slice:function(){return this.pushStack(z.apply(this,
arguments),"slice",z.call(arguments).join(","))},map:function(a){return this.pushStack(d.map(this,function(b,c){return a.call(b,c,b)}))},end:function(){return this.prevObject||this.constructor(null)},push:F,sort:[].sort,splice:[].splice};d.fn.init.prototype=d.fn;d.extend=d.fn.extend=function(){var a,c,e,r,f,h=arguments[0]||{},g=1,D=arguments.length,k=!1;"boolean"===typeof h&&(k=h,h=arguments[1]||{},g=2);"object"===typeof h||d.isFunction(h)||(h={});D===g&&(h=this,--g);for(;g<D;g++)if(null!=(a=arguments[g]))for(c in a)e=
h[c],r=a[c],h!==r&&(k&&r&&(d.isPlainObject(r)||(f=d.isArray(r)))?(f?(f=!1,e=e&&d.isArray(e)?e:[]):e=e&&d.isPlainObject(e)?e:{},h[c]=d.extend(k,e,r)):r!==b&&(h[c]=r));return h};d.extend({noConflict:function(b){a.$===d&&(a.$=f);b&&a.jQuery===d&&(a.jQuery=e);return d},isReady:!1,readyWait:1,holdReady:function(a){a?d.readyWait++:d.ready(!0)},ready:function(a){if(!0===a&&!--d.readyWait||!0!==a&&!d.isReady){if(!u.body)return setTimeout(d.ready,1);d.isReady=!0;!0!==a&&0<--d.readyWait||(da.resolveWith(u,
[d]),d.fn.trigger&&d(u).trigger("ready").unbind("ready"))}},bindReady:function(){if(!da){da=d._Deferred();if("complete"===u.readyState)return setTimeout(d.ready,1);if(u.addEventListener)u.addEventListener("DOMContentLoaded",V,!1),a.addEventListener("load",d.ready,!1);else if(u.attachEvent){u.attachEvent("onreadystatechange",V);a.attachEvent("onload",d.ready);var b=!1;try{b=null==a.frameElement}catch(e){}u.documentElement.doScroll&&b&&c()}}},isFunction:function(a){return"function"===d.type(a)},isArray:Array.isArray||
function(a){return"array"===d.type(a)},isWindow:function(a){return a&&"object"===typeof a&&"setInterval"in a},isNaN:function(a){return null==a||!n.test(a)||isNaN(a)},type:function(a){return null==a?String(a):za[hb.call(a)]||"object"},isPlainObject:function(a){if(!a||("object"!==d.type(a)||a.nodeType||d.isWindow(a))||a.constructor&&!ma.call(a,"constructor")&&!ma.call(a.constructor.prototype,"isPrototypeOf"))return!1;for(var c in a);return c===b||ma.call(a,c)},isEmptyObject:function(a){for(var b in a)return!1;
return!0},error:function(a){throw a;},parseJSON:function(b){if("string"!==typeof b||!b)return null;b=d.trim(b);if(a.JSON&&a.JSON.parse)return a.JSON.parse(b);if(q.test(b.replace(s,"@").replace(t,"]").replace(v,"")))return(new Function("return "+b))();d.error("Invalid JSON: "+b)},parseXML:function(b,c,e){a.DOMParser?(e=new DOMParser,c=e.parseFromString(b,"text/xml")):(c=new ActiveXObject("Microsoft.XMLDOM"),c.async="false",c.loadXML(b));(e=c.documentElement)&&e.nodeName&&"parsererror"!==e.nodeName||
d.error("Invalid XML: "+b);return c},noop:function(){},globalEval:function(b){b&&k.test(b)&&(a.execScript||function(b){a.eval.call(a,b)})(b)},camelCase:function(a){return a.replace(gb,B)},nodeName:function(a,b){return a.nodeName&&a.nodeName.toUpperCase()===b.toUpperCase()},each:function(a,c,e){var r,f=0,h=a.length,g=h===b||d.isFunction(a);if(e)if(g)for(r in a){if(!1===c.apply(a[r],e))break}else for(;f<h&&!1!==c.apply(a[f++],e););else if(g)for(r in a){if(!1===c.call(a[r],r,a[r]))break}else for(;f<
h&&!1!==c.call(a[f],f,a[f++]););return a},trim:A?function(a){return null==a?"":A.call(a)}:function(a){return null==a?"":a.toString().replace(l,"").replace(m,"")},makeArray:function(a,b){var c=b||[];if(null!=a){var e=d.type(a);null==a.length||"string"===e||"function"===e||"regexp"===e||d.isWindow(a)?F.call(c,a):d.merge(c,a)}return c},inArray:function(a,b){if(ya)return ya.call(b,a);for(var c=0,d=b.length;c<d;c++)if(b[c]===a)return c;return-1},merge:function(a,c){var d=a.length,e=0;if("number"===typeof c.length)for(var r=
c.length;e<r;e++)a[d++]=c[e];else for(;c[e]!==b;)a[d++]=c[e++];a.length=d;return a},grep:function(a,b,c){var d=[],e;c=!!c;for(var r=0,f=a.length;r<f;r++)e=!!b(a[r],r),c!==e&&d.push(a[r]);return d},map:function(a,c,e){var r,f,h=[],g=0,D=a.length;if(a instanceof d||D!==b&&"number"===typeof D&&(0<D&&a[0]&&a[D-1]||0===D||d.isArray(a)))for(;g<D;g++)r=c(a[g],g,e),null!=r&&(h[h.length]=r);else for(f in a)r=c(a[f],f,e),null!=r&&(h[h.length]=r);return h.concat.apply([],h)},guid:1,proxy:function(a,c){if("string"===
typeof c){var e=a[c];c=a;a=e}if(!d.isFunction(a))return b;var r=z.call(arguments,2),e=function(){return a.apply(c,r.concat(z.call(arguments)))};e.guid=a.guid=a.guid||e.guid||d.guid++;return e},access:function(a,c,e,r,f,h){var g=a.length;if("object"===typeof c){for(var D in c)d.access(a,D,c[D],r,f,e);return a}if(e!==b){r=!h&&r&&d.isFunction(e);for(D=0;D<g;D++)f(a[D],c,r?e.call(a[D],D,f(a[D],c)):e,h);return a}return g?f(a[0],c):b},now:function(){return(new Date).getTime()},uaMatch:function(a){a=a.toLowerCase();
if(a.match(/trident/i)&&a.match(/rv.\d\d/))return{browser:"msie",version:"11.0"};a=x.exec(a)||y.exec(a)||w.exec(a)||0>a.indexOf("compatible")&&C.exec(a)||[];return{browser:a[1]||"",version:a[2]||"0"}},sub:function(){function a(b,c){return new a.fn.init(b,c)}d.extend(!0,a,this);a.superclass=this;a.fn=a.prototype=this();a.fn.constructor=a;a.sub=this.sub;a.fn.init=function(c,e){e&&(e instanceof d&&!(e instanceof a))&&(e=a(e));return d.fn.init.call(this,c,e,b)};a.fn.init.prototype=a.fn;var b=a(u);return a},
browser:{}});d.each("Boolean Number String Function Array Date RegExp Object".split(" "),function(a,b){za["[object "+b+"]"]=b.toLowerCase()});ca=d.uaMatch(la);ca.browser&&(d.browser[ca.browser]=!0,d.browser.version=ca.version);d.browser.webkit&&(d.browser.safari=/safari/i.test(la)&&!/chrome/i.test(la));k.test("\u00a0")&&(l=/^[\s\xA0]+/,m=/[\s\xA0]+$/);h=d(u);u.addEventListener?V=function(){u.removeEventListener("DOMContentLoaded",V,!1);d.ready()}:u.attachEvent&&(V=function(){"complete"===u.readyState&&
(u.detachEvent("onreadystatechange",V),d.ready())});return d}(),na="done fail isResolved isRejected promise then always pipe".split(" "),Aa=[].slice;h.extend({_Deferred:function(){var a=[],b,c,d,e={done:function(){if(!d){var c=arguments,f,g,D,k,l;b&&(l=b,b=0);f=0;for(g=c.length;f<g;f++)D=c[f],k=h.type(D),"array"===k?e.done.apply(e,D):"function"===k&&a.push(D);l&&e.resolveWith(l[0],l[1])}return this},resolveWith:function(e,f){if(!d&&!b&&!c){f=f||[];c=1;try{for(;a[0];)a.shift().apply(e,f)}finally{b=
...
"resolve"],fail:[c,"reject"]},function(a,c){var e=c[0],r=c[1],f;if(h.isFunction(e))b[a](function(){if((f=e.apply(this,arguments))&&h.isFunction(f.promise))f.promise().then(d.resolve,d.reject);else d[r](f)});else b[a](d[r])})}).promise()},promise:function(a){if(null==a){if(d)return d;d=a={}}for(var c=na.length;c--;)a[na[c]]=b[na[c]];return a}});b.done(c.cancel).fail(b.cancel);delete b.cancel;a&&a.call(b,b);return b},when:function(a){function b(a){return function(b){c[a]=1<arguments.length?Aa.call(arguments,
0):b;--f||g.resolveWith(g,Aa.call(c,0))}}var c=arguments,d=0,e=c.length,f=e,g=1>=e&&a&&h.isFunction(a.promise)?a:h.Deferred();if(1<e){for(;d<e;d++)c[d]&&h.isFunction(c[d].promise)?c[d].promise().then(b(d),g.reject):--f;f||g.resolveWith(g,c)}else g!==a&&g.resolveWith(g,e?[a]:[]);return g.promise()}});h.support=function(){var a=u.createElement("div"),b=u.documentElement,c,d,e,f,g,k;a.setAttribute("className","t");a.innerHTML="   <link/><table></table><a href='/a' style='top:1px;float:left;opacity:.55;'>a</a><input type='checkbox'/>";
c=a.getElementsByTagName("*");d=a.getElementsByTagName("a")[0];if(!c||!c.length||!d)return{};e=u.createElement("select");f=e.appendChild(u.createElement("option"));c=a.getElementsByTagName("input")[0];g={leadingWhitespace:3===a.firstChild.nodeType,tbody:!a.getElementsByTagName("tbody").length,htmlSerialize:!!a.getElementsByTagName("link").length,style:/top/.test(d.getAttribute("style")),hrefNormalized:"/a"===d.getAttribute("href"),opacity:/^0.55$/.test(d.style.opacity),cssFloat:!!d.style.cssFloat,
...
c=u.createElement("input");c.value="t";c.setAttribute("type","radio");g.radioValue="t"===c.value;c.setAttribute("checked","checked");a.appendChild(c);d=u.createDocumentFragment();d.appendChild(a.firstChild);g.checkClone=d.cloneNode(!0).cloneNode(!0).lastChild.checked;a.innerHTML="";a.style.width=a.style.paddingLeft="1px";e=u.getElementsByTagName("body")[0];d=u.createElement(e?"div":"body");f={visibility:"hidden",width:0,height:0,border:0,margin:0};e&&h.extend(f,{position:"absolute",left:-1E3,top:-1E3});
...
"";e[1].style.display="none";g.reliableHiddenOffsets=c&&0===e[0].offsetHeight;a.innerHTML="";u.defaultView&&u.defaultView.getComputedStyle&&(c=u.createElement("div"),c.style.width="0",c.style.marginRight="0",a.appendChild(c),g.reliableMarginRight=0===(parseInt((u.defaultView.getComputedStyle(c,null)||{marginRight:0}).marginRight,10)||0));d.innerHTML="";b.removeChild(d);if(a.attachEvent)for(k in{submit:1,change:1,focusin:1})b="on"+k,c=b in a,c||(a.setAttribute(b,"return;"),c="function"===typeof a[b]),
g[k+"Bubbles"]=c;d=d=e=f=e=c=a=c=null;return g}();h.boxModel=h.support.boxModel;var Xa=/^(?:\{.*\}|\[.*\])$/,Wa=/([a-z])([A-Z])/g;h.extend({cache:{},uuid:0,expando:"jQuery"+(h.fn.jquery+Math.random()).replace(/\D/g,""),noData:{embed:!0,object:"clsid:D27CDB6E-AE6D-11cf-96B8-444553540000",applet:!0},hasData:function(a){a=a.nodeType?h.cache[a[h.expando]]:a[h.expando];return!!a&&!d(a)},data:function(a,c,d,e){if(h.acceptData(a)){var f=h.expando,g="string"===typeof c,k=a.nodeType,l=k?h.cache:a,m=k?a[h.expando]:
...
n=a+"mark",p;g--;)if(p=h.data(f[g],l,b,!0)||(h.data(f[g],m,b,!0)||h.data(f[g],n,b,!0))&&h.data(f[g],l,h._Deferred(),!0))k++,p.done(d);d();return e.promise()}});var Ba=/[\n\t\r]/g,oa=/\s+/,ib=/\r/g,jb=/^(?:button|input)$/i,kb=/^(?:button|input|object|select|textarea)$/i,lb=/^a(?:rea)?$/i,Ca=/^(?:autofocus|autoplay|async|checked|controls|defer|disabled|hidden|loop|multiple|open|readonly|required|scoped|selected)$/i,mb=/\:|^on/,K,Da;h.fn.extend({attr:function(a,b){return h.access(this,a,b,!0,h.attr)},
...
function(){h.valHooks[this]={get:function(a){return null===a.getAttribute("value")?"on":a.value}}});h.each(["radio","checkbox"],function(){h.valHooks[this]=h.extend(h.valHooks[this],{set:function(a,b){if(h.isArray(b))return a.checked=0<=h.inArray(h(a).val(),b)}})});var ha=/\.(.*)$/,pa=/^(?:textarea|input|select)$/i,Ya=/\./g,Za=/ /g,nb=/[^\w\s.|`]/g,ob=function(a){return a.replace(nb,"\\$&")};h.event={add:function(a,c,d,e){if(3!==a.nodeType&&8!==a.nodeType){if(!1===d)d=f;else if(!d)return;var g,k;
d.handler&&(g=d,d=g.handler);d.guid||(d.guid=h.guid++);if(k=h._data(a)){var l=k.events,m=k.handle;l||(k.events=l={});m||(k.handle=m=function(a){return"undefined"===typeof h||a&&h.event.triggered===a.type?b:h.event.handle.apply(m.elem,arguments)});m.elem=a;c=c.split(" ");for(var n,p=0,q;n=c[p++];){k=g?h.extend({},g):{handler:d,data:e};-1<n.indexOf(".")?(q=n.split("."),n=q.shift(),k.namespace=q.slice(0).sort().join(".")):(q=[],k.namespace="");k.type=n;k.guid||(k.guid=d.guid);var s=l[n],t=h.event.special[n]||
{};s||(s=l[n]=[],t.setup&&!1!==t.setup.call(a,e,q,m)||(a.addEventListener?a.addEventListener(n,m,!1):a.attachEvent&&a.attachEvent("on"+n,m)));t.add&&(t.add.call(a,k),k.handler.guid||(k.handler.guid=d.guid));s.push(k);h.event.global[n]=!0}a=null}}},global:{},remove:function(a,c,d,e){if(3!==a.nodeType&&8!==a.nodeType){!1===d&&(d=f);var g,k,l=0,m,n,p,q,s,t,v=h.hasData(a)&&h._data(a),x=v&&v.events;if(v&&x)if(c&&c.type&&(d=c.handler,c=c.type),!c||"string"===typeof c&&"."===c.charAt(0))for(g in c=c||"",
x)h.event.remove(a,g+c);else{for(c=c.split(" ");g=c[l++];)if(q=g,m=0>g.indexOf("."),n=[],m||(n=g.split("."),g=n.shift(),p=RegExp("(^|\\.)"+h.map(n.slice(0).sort(),ob).join("\\.(?:.*\\.)?")+"(\\.|$)")),s=x[g])if(d){q=h.event.special[g]||{};for(k=e||0;k<s.length;k++)if(t=s[k],d.guid===t.guid){if(m||p.test(t.namespace))null==e&&s.splice(k--,1),q.remove&&q.remove.call(a,t);if(null!=e)break}if(0===s.length||null!=e&&1===s.length)q.teardown&&!1!==q.teardown.call(a,n)||h.removeEvent(a,g,v.handle),delete x[g]}else for(k=
0;k<s.length;k++)if(t=s[k],m||p.test(t.namespace))h.event.remove(a,q,t.handler,k),s.splice(k--,1);if(h.isEmptyObject(x)){if(c=v.handle)c.elem=null;delete v.events;delete v.handle;h.isEmptyObject(v)&&h.removeData(a,b,!0)}}}},customEvent:{getData:!0,setData:!0,changeData:!0},trigger:function(c,d,e,f){var g=c.type||c,k=[],l;0<=g.indexOf("!")&&(g=g.slice(0,-1),l=!0);0<=g.indexOf(".")&&(k=g.split("."),g=k.shift(),k.sort());if(e&&!h.event.customEvent[g]||h.event.global[g]){c="object"===typeof c?c[h.expando]?
...
fix:function(a){if(a[h.expando])return a;var c=a;a=h.Event(c);for(var d=this.props.length,e;d;)e=this.props[--d],a[e]=c[e];a.target||(a.target=a.srcElement||u);3===a.target.nodeType&&(a.target=a.target.parentNode);!a.relatedTarget&&a.fromElement&&(a.relatedTarget=a.fromElement===a.target?a.toElement:a.fromElement);null==a.pageX&&null!=a.clientX&&(d=a.target.ownerDocument||u,c=d.documentElement,d=d.body,a.pageX=a.clientX+(c&&c.scrollLeft||d&&d.scrollLeft||0)-(c&&c.clientLeft||d&&d.clientLeft||0),a.pageY=
...
g;this.stopPropagation()},isDefaultPrevented:f,isPropagationStopped:f,isImmediatePropagationStopped:f};var Ea=function(a){var b=a.relatedTarget,c=!1,d=a.type;a.type=a.data;b!==this&&(b&&(c=h.contains(this,b)),c||(h.event.handle.apply(this,arguments),a.type=d))},Fa=function(a){a.type=a.data;h.event.handle.apply(this,arguments)};h.each({mouseenter:"mouseover",mouseleave:"mouseout"},function(a,b){h.event.special[a]={setup:function(c){h.event.add(this,b,c&&c.selector?Fa:Ea,a)},teardown:function(a){h.event.remove(this,
b,a&&a.selector?Fa:Ea)}}});h.support.submitBubbles||(h.event.special.submit={setup:function(a,b){if(h.nodeName(this,"form"))return!1;h.event.add(this,"click.specialSubmit",function(a){var b=a.target,c=b.type;"submit"!==c&&"image"!==c||!h(b).closest("form").length||k("submit",this,arguments)});h.event.add(this,"keypress.specialSubmit",function(a){var b=a.target,c=b.type;"text"!==c&&"password"!==c||(!h(b).closest("form").length||13!==a.keyCode)||k("submit",this,arguments)})},teardown:function(a){h.event.remove(this,
".specialSubmit")}});if(!h.support.changeBubbles){var Z,Ga=function(a){var b=a.type,c=a.value;"radio"===b||"checkbox"===b?c=a.checked:"select-multiple"===b?c=-1<a.selectedIndex?h.map(a.options,function(a){return a.selected}).join("-"):"":h.nodeName(a,"select")&&(c=a.selectedIndex);return c},ea=function(a,c){var d=a.target,e,f;pa.test(d.nodeName)&&!d.readOnly&&(e=h._data(d,"_change_data"),f=Ga(d),"focusout"===a.type&&"radio"===d.type||h._data(d,"_change_data",f),e===b||f===e||null==e&&!f||(a.type=
"change",a.liveFired=b,h.event.trigger(a,c,d)))};h.event.special.change={filters:{focusout:ea,beforedeactivate:ea,click:function(a){var b=a.target,c=h.nodeName(b,"input")?b.type:"";("radio"===c||"checkbox"===c||h.nodeName(b,"select"))&&ea.call(this,a)},keydown:function(a){var b=a.target,c=h.nodeName(b,"input")?b.type:"";(13===a.keyCode&&!h.nodeName(b,"textarea")||32===a.keyCode&&("checkbox"===c||"radio"===c)||"select-multiple"===c)&&ea.call(this,a)},beforeactivate:function(a){a=a.target;h._data(a,
"_change_data",Ga(a))}},setup:function(a,b){if("file"===this.type)return!1;for(var c in Z)h.event.add(this,c+".specialChange",Z[c]);return pa.test(this.nodeName)},teardown:function(a){h.event.remove(this,".specialChange");return pa.test(this.nodeName)}};Z=h.event.special.change.filters;Z.focus=Z.beforeactivate}h.support.focusinBubbles||h.each({focus:"focusin",blur:"focusout"},function(a,b){function c(a){var d=h.event.fix(a);d.type=b;d.originalEvent={};h.event.trigger(d,null,d.target);d.isDefaultPrevented()&&
a.preventDefault()}var d=0;h.event.special[b]={setup:function(){0===d++&&u.addEventListener(a,c,!0)},teardown:function(){0===--d&&u.removeEventListener(a,c,!0)}}});h.each(["bind","one"],function(a,c){h.fn[c]=function(a,d,e){var f;if("object"===typeof a){for(var g in a)this[c](g,d,a[g],e);return this}if(2===arguments.length||!1===d)e=d,d=b;"one"===c?(f=function(a){h(this).unbind(a,f);return e.apply(this,arguments)},f.guid=e.guid||h.guid++):f=e;if("unload"===a&&"one"!==c)this.one(a,d,e);else{g=0;for(var r=
this.length;g<r;g++)h.event.add(this[g],a,f,d)}return this}});h.fn.extend({unbind:function(a,b){if("object"!==typeof a||a.preventDefault)for(var c=0,d=this.length;c<d;c++)h.event.remove(this[c],a,b);else for(c in a)this.unbind(c,a[c]);return this},delegate:function(a,b,c,d){return this.live(b,c,d,a)},undelegate:function(a,b,c){return 0===arguments.length?this.unbind("live"):this.die(b,null,c,a)},trigger:function(a,b){return this.each(function(){h.event.trigger(a,b,this)})},triggerHandler:function(a,
b){if(this[0])return h.event.trigger(a,b,this[0],!0)},toggle:function(a){var b=arguments,c=a.guid||h.guid++,d=0,e=function(c){var e=(h.data(this,"lastToggle"+a.guid)||0)%d;h.data(this,"lastToggle"+a.guid,e+1);c.preventDefault();return b[e].apply(this,arguments)||!1};for(e.guid=c;d<b.length;)b[d++].guid=c;return this.click(e)},hover:function(a,b){return this.mouseenter(a).mouseleave(b||a)}});var qa={focus:"focusin",blur:"focusout",mouseenter:"mouseover",mouseleave:"mouseout"};h.each(["live","die"],
function(a,c){h.fn[c]=function(a,d,e,g){var k=0,r,l,n=g||this.selector,p=g?this:h(this.context);if("object"===typeof a&&!a.preventDefault){for(r in a)p[c](r,d,a[r],n);return this}if("die"===c&&!a&&g&&"."===g.charAt(0))return p.unbind(g),this;if(!1===d||h.isFunction(d))e=d||f,d=b;for(a=(a||"").split(" ");null!=(g=a[k++]);)if(r=ha.exec(g),l="",r&&(l=r[0],g=g.replace(ha,"")),"hover"===g)a.push("mouseenter"+l,"mouseleave"+l);else if(r=g,qa[g]?(a.push(qa[g]+l),g+=l):g=(qa[g]||g)+l,"live"===c){l=0;for(var q=
p.length;l<q;l++)h.event.add(p[l],"live."+m(g,n),{data:d,selector:n,handler:e,origType:g,origHandler:e,preType:r})}else p.unbind("live."+m(g,n),e);return this}});h.each("blur focus focusin focusout load resize scroll unload click dblclick mousedown mouseup mousemove mouseover mouseout mouseenter mouseleave change select submit keydown keypress keyup error".split(" "),function(a,b){h.fn[b]=function(a,c){null==c&&(c=a,a=null);return 0<arguments.length?this.bind(b,a,c):this.trigger(b)};h.attrFn&&(h.attrFn[b]=
!0)});(function(){function a(b,c,d,e,f,g){f=0;for(var h=e.length;f<h;f++){var k=e[f];if(k){for(var r=!1,k=k[b];k;){if(k.sizcache===d){r=e[k.sizset];break}1!==k.nodeType||g||(k.sizcache=d,k.sizset=f);if(k.nodeName.toLowerCase()===c){r=k;break}k=k[b]}e[f]=r}}}function c(a,b,d,e,f,g){f=0;for(var h=e.length;f<h;f++){var k=e[f];if(k){for(var r=!1,k=k[a];k;){if(k.sizcache===d){r=e[k.sizset];break}if(1===k.nodeType)if(g||(k.sizcache=d,k.sizset=f),"string"!==typeof b){if(k===b){r=!0;break}}else if(0<n.filter(b,
[k]).length){r=k;break}k=k[a]}e[f]=r}}}var d=/((?:\((?:\([^()]+\)|[^()]+)+\)|\[(?:\[[^\[\]]*\]|['"][^'"]*['"]|[^\[\]'"]+)+\]|\\.|[^ >+~,(\[\\]+)+|[>+~])(\s*,\s*)?((?:.|\r|\n)*)/g,e=0,f=Object.prototype.toString,g=!1,k=!0,l=/\\/g,m=/\W/;[0,0].sort(function(){k=!1;return 0});var n=function(a,b,c,e){c=c||[];var g=b=b||u;if(1!==b.nodeType&&9!==b.nodeType)return[];if(!a||"string"!==typeof a)return c;var h,k,r,l,G,N=!0,m=n.isXML(b),E=[],ua=a;do if(d.exec(""),h=d.exec(ua))if(ua=h[3],E.push(h[1]),h[2]){l=
h[3];break}while(h);if(1<E.length&&q.exec(a))if(2===E.length&&p.relative[E[0]])k=C(E[0]+E[1],b);else for(k=p.relative[E[0]]?[b]:n(E.shift(),b);E.length;)a=E.shift(),p.relative[a]&&(a+=E.shift()),k=C(a,k);else if(!e&&(1<E.length&&9===b.nodeType&&!m&&p.match.ID.test(E[0])&&!p.match.ID.test(E[E.length-1]))&&(h=n.find(E.shift(),b,m),b=h.expr?n.filter(h.expr,h.set)[0]:h.set[0]),b)for(h=e?{expr:E.pop(),set:v(e)}:n.find(E.pop(),1!==E.length||"~"!==E[0]&&"+"!==E[0]||!b.parentNode?b:b.parentNode,m),k=h.expr?
n.filter(h.expr,h.set):h.set,0<E.length?r=v(k):N=!1;E.length;)h=G=E.pop(),p.relative[G]?h=E.pop():G="",null==h&&(h=b),p.relative[G](r,h,m);else r=[];r||(r=k);r||n.error(G||a);if("[object Array]"===f.call(r))if(N)if(b&&1===b.nodeType)for(a=0;null!=r[a];a++)r[a]&&(!0===r[a]||1===r[a].nodeType&&n.contains(b,r[a]))&&c.push(k[a]);else for(a=0;null!=r[a];a++)r[a]&&1===r[a].nodeType&&c.push(k[a]);else c.push.apply(c,r);else v(r,c);l&&(n(l,g,c,e),n.uniqueSort(c));return c};n.uniqueSort=function(a){if(y&&
(g=k,a.sort(y),g))for(var b=1;b<a.length;b++)a[b]===a[b-1]&&a.splice(b--,1);return a};n.matches=function(a,b){return n(a,null,null,b)};n.matchesSelector=function(a,b){return 0<n(b,null,null,[a]).length};n.find=function(a,b,c){var d;if(!a)return[];for(var e=0,f=p.order.length;e<f;e++){var g,h=p.order[e];if(g=p.leftMatch[h].exec(a)){var k=g[1];g.splice(1,1);if("\\"!==k.substr(k.length-1)&&(g[1]=(g[1]||"").replace(l,""),d=p.find[h](g,b,c),null!=d)){a=a.replace(p.match[h],"");break}}}d||(d="undefined"!==
typeof b.getElementsByTagName?b.getElementsByTagName("*"):[]);return{set:d,expr:a}};n.filter=function(a,c,d,e){for(var f,g,h=a,k=[],r=c,l=c&&c[0]&&n.isXML(c[0]);a&&c.length;){for(var G in p.filter)if(null!=(f=p.leftMatch[G].exec(a))&&f[2]){var N,m,D=p.filter[G];m=f[1];g=!1;f.splice(1,1);if("\\"!==m.substr(m.length-1)){r===k&&(k=[]);if(p.preFilter[G])if(f=p.preFilter[G](f,r,d,k,e,l),!f)g=N=!0;else if(!0===f)continue;if(f)for(var aa=0;null!=(m=r[aa]);aa++)if(m){N=D(m,f,aa,r);var E=e^!!N;d&&null!=N?
E?g=!0:r[aa]=!1:E&&(k.push(m),g=!0)}if(N!==b){d||(r=k);a=a.replace(p.match[G],"");if(!g)return[];break}}}if(a===h)if(null==g)n.error(a);else break;h=a}return r};n.error=function(a){throw"Syntax error, unrecognized expression: "+a;};var p=n.selectors={order:["ID","NAME","TAG"],match:{ID:/#((?:[\w\u00c0-\uFFFF\-]|\\.)+)/,CLASS:/\.((?:[\w\u00c0-\uFFFF\-]|\\.)+)/,NAME:/\[name=['"]*((?:[\w\u00c0-\uFFFF\-]|\\.)+)['"]*\]/,ATTR:/\[\s*((?:[\w\u00c0-\uFFFF\-]|\\.)+)\s*(?:(\S?=)\s*(?:(['"])(.*?)\3|(#?(?:[\w\u00c0-\uFFFF\-]|\\.)*)|)|)\s*\]/,
TAG:/^((?:[\w\u00c0-\uFFFF\*\-]|\\.)+)/,CHILD:/:(only|nth|last|first)-child(?:\(\s*(even|odd|(?:[+\-]?\d+|(?:[+\-]?\d*)?n\s*(?:[+\-]\s*\d+)?))\s*\))?/,POS:/:(nth|eq|gt|lt|first|last|even|odd)(?:\((\d*)\))?(?=[^\-]|$)/,PSEUDO:/:((?:[\w\u00c0-\uFFFF\-]|\\.)+)(?:\((['"]?)((?:\([^\)]+\)|[^\(\)]*)+)\2\))?/},leftMatch:{},attrMap:{"class":"className","for":"htmlFor"},attrHandle:{href:function(a){return a.getAttribute("href")},type:function(a){return a.getAttribute("type")}},relative:{"+":function(a,b){var c=
"string"===typeof b,d=c&&!m.test(b),c=c&&!d;d&&(b=b.toLowerCase());for(var d=0,e=a.length,f;d<e;d++)if(f=a[d]){for(;(f=f.previousSibling)&&1!==f.nodeType;);a[d]=c||f&&f.nodeName.toLowerCase()===b?f||!1:f===b}c&&n.filter(b,a,!0)},">":function(a,b){var c,d="string"===typeof b,e=0,f=a.length;if(d&&!m.test(b))for(b=b.toLowerCase();e<f;e++){if(c=a[e])c=c.parentNode,a[e]=c.nodeName.toLowerCase()===b?c:!1}else{for(;e<f;e++)(c=a[e])&&(a[e]=d?c.parentNode:c.parentNode===b);d&&n.filter(b,a,!0)}},"":function(b,
d,f){var g,h=e++,k=c;"string"!==typeof d||m.test(d)||(g=d=d.toLowerCase(),k=a);k("parentNode",d,h,b,g,f)},"~":function(b,d,f){var g,h=e++,k=c;"string"!==typeof d||m.test(d)||(g=d=d.toLowerCase(),k=a);k("previousSibling",d,h,b,g,f)}},find:{ID:function(a,b,c){if("undefined"!==typeof b.getElementById&&!c)return(a=b.getElementById(a[1]))&&a.parentNode?[a]:[]},NAME:function(a,b){if("undefined"!==typeof b.getElementsByName){for(var c=[],d=b.getElementsByName(a[1]),e=0,f=d.length;e<f;e++)d[e].getAttribute("name")===
...
d.nodeType&&(d.nodeIndex=++h);g.sizcache=f}d=a.nodeIndex-e;return 0===c?0===d:0===d%c&&0<=d/c}},ID:function(a,b){return 1===a.nodeType&&a.getAttribute("id")===b},TAG:function(a,b){return"*"===b&&1===a.nodeType||a.nodeName.toLowerCase()===b},CLASS:function(a,b){return-1<(" "+(a.className||a.getAttribute("class"))+" ").indexOf(b)},ATTR:function(a,b){var c=b[1],c=p.attrHandle[c]?p.attrHandle[c](a):null!=a[c]?a[c]:a.getAttribute(c),d=c+"",e=b[2],f=b[4];return null==c?"!="===e:"="===e?d===f:"*="===e?0<=
d.indexOf(f):"~="===e?0<=(" "+d+" ").indexOf(f):f?"!="===e?d!==f:"^="===e?0===d.indexOf(f):"$="===e?d.substr(d.length-f.length)===f:"|="===e?d===f||d.substr(0,f.length+1)===f+"-":!1:d&&!1!==c},POS:function(a,b,c,d){var e=p.setFilters[b[2]];if(e)return e(a,c,b,d)}}},q=p.match.POS,s=function(a,b){return"\\"+(b-0+1)},t;for(t in p.match)p.match[t]=RegExp(p.match[t].source+/(?![^\[]*\])(?![^\(]*\))/.source),p.leftMatch[t]=RegExp(/(^(?:.|\r|\n)*?)/.source+p.match[t].source.replace(/\\(\d+)/g,s));var v=
function(a,b){a=Array.prototype.slice.call(a,0);return b?(b.push.apply(b,a),b):a};try{Array.prototype.slice.call(u.documentElement.childNodes,0)[0].nodeType}catch(x){v=function(a,b){var c=0,d=b||[];if("[object Array]"===f.call(a))Array.prototype.push.apply(d,a);else if("number"===typeof a.length)for(var e=a.length;c<e;c++)d.push(a[c]);else for(;a[c];c++)d.push(a[c]);return d}}var y,w;u.documentElement.compareDocumentPosition?y=function(a,b){return a===b?(g=!0,0):a.compareDocumentPosition&&b.compareDocumentPosition?
...
b){h.fn[a]=function(c,d){var e=h.map(this,b,c),f=sb.call(arguments);pb.test(a)||(d=c);d&&"string"===typeof d&&(e=h.filter(d,e));e=1<this.length&&!tb[a]?h.unique(e):e;(1<this.length||rb.test(d))&&qb.test(a)&&(e=e.reverse());return this.pushStack(e,a,f.join(","))}});h.extend({filter:function(a,b,c){c&&(a=":not("+a+")");return 1===b.length?h.find.matchesSelector(b[0],a)?[b[0]]:[]:h.find.matches(a,b)},dir:function(a,c,d){var e=[];for(a=a[c];a&&9!==a.nodeType&&(d===b||1!==a.nodeType||!h(a).is(d));)1===
a.nodeType&&e.push(a),a=a[c];return e},nth:function(a,b,c,d){b=b||1;for(d=0;a&&(1!==a.nodeType||++d!==b);a=a[c]);return a},sibling:function(a,b){for(var c=[];a;a=a.nextSibling)1===a.nodeType&&a!==b&&c.push(a);return c}});var ub=/ jQuery\d+="(?:\d+|null)"/g,ra=/^\s+/,Ia=/<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/ig,Ja=/<([\w:]+)/,vb=/<tbody/i,wb=/<|&#?\w+;/,Ka=/<(?:script|object|embed|option|style)/i,La=/checked\s*(?:[^=]|=\s*.checked.)/i,xb=/\/(java|ecma)script/i,ab=/^\s*<!(?:\[CDATA\[|\-\-)/,
H={option:[1,"<select multiple='multiple'>","</select>"],legend:[1,"<fieldset>","</fieldset>"],thead:[1,"<table>","</table>"],tr:[2,"<table><tbody>","</tbody></table>"],td:[3,"<table><tbody><tr>","</tr></tbody></table>"],col:[2,"<table><tbody></tbody><colgroup>","</colgroup></table>"],area:[1,"<map>","</map>"],_default:[0,"",""]};H.optgroup=H.option;H.tbody=H.tfoot=H.colgroup=H.caption=H.thead;H.th=H.td;h.support.htmlSerialize||(H._default=[1,"div<div>","</div>"]);h.fn.extend({text:function(a){return h.isFunction(a)?
...
b?a:b;return this.map(function(){return h.clone(this,a,b)})},html:function(a){if(a===b)return this[0]&&1===this[0].nodeType?this[0].innerHTML.replace(ub,""):null;if("string"!==typeof a||Ka.test(a)||!h.support.leadingWhitespace&&ra.test(a)||H[(Ja.exec(a)||["",""])[1].toLowerCase()])h.isFunction(a)?this.each(function(b){var c=h(this);c.html(a.call(this,b,c.html()))}):this.empty().append(a);else{a=a.replace(Ia,"<$1></$2>");try{for(var c=0,d=this.length;c<d;c++)1===this[c].nodeType&&(h.cleanData(this[c].getElementsByTagName("*")),
...
!0)},domManip:function(a,c,d){var e,f,g,k=a[0],l=[];if(!h.support.checkClone&&3===arguments.length&&"string"===typeof k&&La.test(k))return this.each(function(){h(this).domManip(a,c,d,!0)});if(h.isFunction(k))return this.each(function(e){var f=h(this);a[0]=k.call(this,e,c?f.html():b);f.domManip(a,c,d)});if(this[0]){e=k&&k.parentNode;e=h.support.parentNode&&e&&11===e.nodeType&&e.childNodes.length===this.length?{fragment:e}:h.buildFragment(a,this,l);g=e.fragment;if(f=1===g.childNodes.length?g=g.firstChild:
g.firstChild){c=c&&h.nodeName(f,"tr");f=0;for(var m=this.length,n=m-1;f<m;f++)d.call(c?h.nodeName(this[f],"table")?this[f].getElementsByTagName("tbody")[0]||this[f].appendChild(this[f].ownerDocument.createElement("tbody")):this[f]:this[f],e.cacheable||1<m&&f<n?h.clone(g,!0,!0):g)}l.length&&h.each(l,w)}return this}});h.buildFragment=function(a,b,c){var d,e,f,g;b&&b[0]&&(g=b[0].ownerDocument||b[0]);g.createDocumentFragment||(g=u);1===a.length&&("string"===typeof a[0]&&512>a[0].length&&g===u&&"<"===
a[0].charAt(0)&&!Ka.test(a[0])&&(h.support.checkClone||!La.test(a[0])))&&(e=!0,(f=h.fragments[a[0]])&&1!==f&&(d=f));d||(d=g.createDocumentFragment(),h.clean(a,g,d,c));e&&(h.fragments[a[0]]=f?d:1);return{fragment:d,cacheable:e}};h.fragments={};h.each({appendTo:"append",prependTo:"prepend",insertBefore:"before",insertAfter:"after",replaceAll:"replaceWith"},function(a,b){h.fn[a]=function(c){var d=[];c=h(c);var e=1===this.length&&this[0].parentNode;if(e&&11===e.nodeType&&1===e.childNodes.length&&1===
c.length)return c[b](this[0]),this;for(var e=0,f=c.length;e<f;e++){var g=(0<e?this.clone(!0):this).get();h(c[e])[b](g);d=d.concat(g)}return this.pushStack(d,a,c.selector)}});h.extend({clone:function(a,b,c){var d=a.cloneNode(!0),e,f,g;if(!(h.support.noCloneEvent&&h.support.noCloneChecked||1!==a.nodeType&&11!==a.nodeType||h.isXMLDoc(a)))for(s(a,d),e=q(a),f=q(d),g=0;e[g];++g)s(e[g],f[g]);if(b&&(p(a,d),c))for(e=q(a),f=q(d),g=0;e[g];++g)p(e[g],f[g]);return d},clean:function(a,b,c,d){b=b||u;"undefined"===
typeof b.createElement&&(b=b.ownerDocument||b[0]&&b[0].ownerDocument||u);for(var e=[],f,g=0,k;null!=(k=a[g]);g++)if("number"===typeof k&&(k+=""),k){if("string"===typeof k)if(wb.test(k)){k=k.replace(Ia,"<$1></$2>");f=(Ja.exec(k)||["",""])[1].toLowerCase();var l=H[f]||H._default,m=l[0],n=b.createElement("div");for(n.innerHTML=l[1]+k+l[2];m--;)n=n.lastChild;if(!h.support.tbody)for(m=vb.test(k),l="table"!==f||m?"<table>"!==l[1]||m?[]:n.childNodes:n.firstChild&&n.firstChild.childNodes,f=l.length-1;0<=
f;--f)h.nodeName(l[f],"tbody")&&!l[f].childNodes.length&&l[f].parentNode.removeChild(l[f]);!h.support.leadingWhitespace&&ra.test(k)&&n.insertBefore(b.createTextNode(ra.exec(k)[0]),n.firstChild);k=n.childNodes}else k=b.createTextNode(k);var p;if(!h.support.appendChecked)if(k[0]&&"number"===typeof(p=k.length))for(f=0;f<p;f++)v(k[f]);else v(k);k.nodeType?e.push(k):e=h.merge(e,k)}if(c)for(a=function(a){return!a.type||xb.test(a.type)},g=0;e[g];g++)!d||!h.nodeName(e[g],"script")||e[g].type&&"text/javascript"!==
...
m,b.handle);b.handle&&(b.handle.elem=null)}g?delete l[h.expando]:l.removeAttribute&&l.removeAttribute(h.expando);delete d[c]}}});var Ma=/alpha\([^)]*\)/i,yb=/opacity=([^)]*)/,zb=/([A-Z]|^ms)/g,Na=/^-?\d+(?:px)?$/i,Ab=/^-?\d/,Bb=/^[+\-]=/,Cb=/[^+\-\.\de]+/g,Db={position:"absolute",visibility:"hidden",display:"block"},bb=["Left","Right"],cb=["Top","Bottom"],P,Oa,Pa;h.fn.css=function(a,c){return 2===arguments.length&&c===b?this:h.access(this,a,c,!0,function(a,c,d){return d!==b?h.style(a,c,d):h.css(a,
c)})};h.extend({cssHooks:{opacity:{get:function(a,b){if(b){var c=P(a,"opacity","opacity");return""===c?"1":c}return a.style.opacity}}},cssNumber:{fillOpacity:!0,fontWeight:!0,lineHeight:!0,opacity:!0,orphans:!0,widows:!0,zIndex:!0,zoom:!0},cssProps:{"float":h.support.cssFloat?"cssFloat":"styleFloat"},style:function(a,c,d,e){if(a&&3!==a.nodeType&&8!==a.nodeType&&a.style){var f,g=h.camelCase(c),k=a.style,l=h.cssHooks[g];c=h.cssProps[g]||g;if(d!==b){if(e=typeof d,!("number"===e&&isNaN(d)||null==d||("string"===
e&&Bb.test(d)&&(d=+d.replace(Cb,"")+parseFloat(h.css(a,c)),e="number"),"number"!==e||h.cssNumber[g]||(d+="px"),l&&"set"in l&&(d=l.set(a,d))===b)))try{k[c]=d}catch(m){}}else return l&&"get"in l&&(f=l.get(a,!1,e))!==b?f:k[c]}},css:function(a,c,d){var e,f;c=h.camelCase(c);f=h.cssHooks[c];c=h.cssProps[c]||c;"cssFloat"===c&&(c="float");if(f&&"get"in f&&(e=f.get(a,!0,d))!==b)return e;if(P)return P(a,c)},swap:function(a,b,c){var d={},e;for(e in b)d[e]=a.style[e],a.style[e]=b[e];c.call(a);for(e in b)a.style[e]=
d[e]}});h.curCSS=h.css;h.each(["height","width"],function(a,b){h.cssHooks[b]={get:function(a,c,d){var e;if(c){if(0!==a.offsetWidth)return x(a,b,d);h.swap(a,Db,function(){e=x(a,b,d)});return e}},set:function(a,b){if(Na.test(b)){if(b=parseFloat(b),0<=b)return b+"px"}else return b}}});h.support.opacity||(h.cssHooks.opacity={get:function(a,b){return yb.test((b&&a.currentStyle?a.currentStyle.filter:a.style.filter)||"")?parseFloat(RegExp.$1)/100+"":b?"1":""},set:function(a,b){var c=a.style,d=a.currentStyle;
c.zoom=1;var e=h.isNaN(b)?"":"alpha(opacity="+100*b+")",d=d&&d.filter||c.filter||"";c.filter=Ma.test(d)?d.replace(Ma,e):d+" "+e}});h(function(){h.support.reliableMarginRight||(h.cssHooks.marginRight={get:function(a,b){var c;h.swap(a,{display:"inline-block"},function(){c=b?P(a,"margin-right","marginRight"):a.style.marginRight});return c}})});u.defaultView&&u.defaultView.getComputedStyle&&(Oa=function(a,c){var d,e;c=c.replace(zb,"-$1").toLowerCase();if(!(e=a.ownerDocument.defaultView))return b;if(e=
e.getComputedStyle(a,null))d=e.getPropertyValue(c),""!==d||h.contains(a.ownerDocument.documentElement,a)||(d=h.style(a,c));return d});u.documentElement.currentStyle&&(Pa=function(a,b){var c,d=a.currentStyle&&a.currentStyle[b],e=a.runtimeStyle&&a.runtimeStyle[b],f=a.style;!Na.test(d)&&Ab.test(d)&&(c=f.left,e&&(a.runtimeStyle.left=a.currentStyle.left),f.left="fontSize"===b?"1em":d||0,d=f.pixelLeft+"px",f.left=c,e&&(a.runtimeStyle.left=e));return""===d?"auto":d});P=Oa||Pa;h.expr&&h.expr.filters&&(h.expr.filters.hidden=
function(a){var b=a.offsetHeight;return 0===a.offsetWidth&&0===b||!h.support.reliableHiddenOffsets&&"none"===(a.style.display||h.css(a,"display"))},h.expr.filters.visible=function(a){return!h.expr.filters.hidden(a)});var Eb=/%20/g,db=/\[\]$/,Qa=/\r?\n/g,Fb=/#.*$/,Gb=/^(.*?):[ \t]*([^\r\n]*)\r?$/mg,Hb=/^(?:color|date|datetime|email|hidden|month|number|password|range|search|tel|text|time|url|week)$/i,Ib=/^(?:GET|HEAD)$/,Jb=/^\/\//,Ra=/\?/,Kb=/<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi,Lb=
/^(?:select|textarea)/i,va=/\s+/,Mb=/([?&])_=[^&]*/,Sa=/^([\w\+\.\-]+:)(?:\/\/([^\/?#:]*)(?::(\d+))?)?/,Ta=h.fn.load,ia={},Ua={},J,L;try{J=fb.href}catch(Sb){J=u.createElement("a"),J.href="",J=J.href}L=Sa.exec(J.toLowerCase())||[];h.fn.extend({load:function(a,c,d){if("string"!==typeof a&&Ta)return Ta.apply(this,arguments);if(!this.length)return this;var e=a.indexOf(" ");if(0<=e){var f=a.slice(e,a.length);a=a.slice(0,e)}e="GET";c&&(h.isFunction(c)?(d=c,c=b):"object"===typeof c&&(c=h.param(c,h.ajaxSettings.traditional),
e="POST"));var g=this;h.ajax({url:a,type:e,dataType:"html",data:c,complete:function(a,b,c){c=a.responseText;a.isResolved()&&(a.done(function(a){c=a}),g.html(f?h("<div>").append(c.replace(Kb,"")).find(f):c));d&&g.each(d,[c,b,a])}});return this},serialize:function(){return h.param(this.serializeArray())},serializeArray:function(){return this.map(function(){return this.elements?h.makeArray(this.elements):this}).filter(function(){return this.name&&!this.disabled&&(this.checked||Lb.test(this.nodeName)||
Hb.test(this.type))}).map(function(a,b){var c=h(this).val();return null==c?null:h.isArray(c)?h.map(c,function(a,c){return{name:b.name,value:a.replace(Qa,"\r\n")}}):{name:b.name,value:c.replace(Qa,"\r\n")}}).get()}});h.each("ajaxStart ajaxStop ajaxComplete ajaxError ajaxSuccess ajaxSend".split(" "),function(a,b){h.fn[b]=function(a){return this.bind(b,a)}});h.each(["get","post"],function(a,c){h[c]=function(a,d,e,f){h.isFunction(d)&&(f=f||e,e=d,d=b);return h.ajax({type:c,url:a,data:d,success:e,dataType:f})}});
h.extend({getScript:function(a,c){return h.get(a,b,c,"script")},getJSON:function(a,b,c){return h.get(a,b,c,"json")},ajaxSetup:function(a,b){b?h.extend(!0,a,h.ajaxSettings,b):(b=a,a=h.extend(!0,h.ajaxSettings,b));for(var c in{context:1,url:1})c in b?a[c]=b[c]:c in h.ajaxSettings&&(a[c]=h.ajaxSettings[c]);return a},ajaxSettings:{url:J,isLocal:/^(?:about|app|app\-storage|.+\-extension|file|widget):$/.test(L[1]),global:!0,type:"GET",contentType:"application/x-www-form-urlencoded",processData:!0,async:!0,
accepts:{xml:"application/xml, text/xml",html:"text/html",text:"text/plain",json:"application/json, text/javascript","*":"*/*"},contents:{xml:/xml/,html:/html/,json:/json/},responseFields:{xml:"responseXML",text:"responseText"},converters:{"* text":a.String,"text html":!0,"text json":h.parseJSON,"text xml":h.parseXML}},ajaxPrefilter:y(ia),ajaxTransport:y(Ua),ajax:function(a,c){function d(a,c,r,p){if(2!==y){y=2;x&&clearTimeout(x);v=b;s=p||"";B.readyState=a?4:0;var G,q,D;if(r){p=e;var t=B,u=p.contents,
C=p.dataTypes,F=p.responseFields,z,A,O,H;for(A in F)A in r&&(t[F[A]]=r[A]);for(;"*"===C[0];)C.shift(),z===b&&(z=p.mimeType||t.getResponseHeader("content-type"));if(z)for(A in u)if(u[A]&&u[A].test(z)){C.unshift(A);break}if(C[0]in r)O=C[0];else{for(A in r){if(!C[0]||p.converters[A+" "+C[0]]){O=A;break}H||(H=A)}O=O||H}O?(O!==C[0]&&C.unshift(O),r=r[O]):r=void 0}else r=b;if(200<=a&&300>a||304===a){if(e.ifModified){if(z=B.getResponseHeader("Last-Modified"))h.lastModified[n]=z;if(z=B.getResponseHeader("Etag"))h.etag[n]=
z}if(304===a)c="notmodified",G=!0;else try{z=e;z.dataFilter&&(r=z.dataFilter(r,z.dataType));var M=z.dataTypes;A={};var Y,I,ga=M.length,K,Q=M[0],J,L,R,S,T;for(Y=1;Y<ga;Y++){if(1===Y)for(I in z.converters)"string"===typeof I&&(A[I.toLowerCase()]=z.converters[I]);J=Q;Q=M[Y];if("*"===Q)Q=J;else if("*"!==J&&J!==Q){L=J+" "+Q;R=A[L]||A["* "+Q];if(!R)for(S in T=b,A)if(K=S.split(" "),K[0]===J||"*"===K[0])if(T=A[K[1]+" "+Q]){S=A[S];!0===S?R=T:!0===T&&(R=S);break}R||T||h.error("No conversion from "+L.replace(" ",
" to "));!0!==R&&(r=R?R(r):T(S(r)))}}q=r;c="success";G=!0}catch(P){c="parsererror",D=P}}else if(D=c,!c||a)c="error",0>a&&(a=0);B.status=a;B.statusText=c;G?k.resolveWith(f,[q,c,B]):k.rejectWith(f,[B,c,D]);B.statusCode(m);m=b;w&&g.trigger("ajax"+(G?"Success":"Error"),[B,e,G?q:D]);l.resolveWith(f,[B,c]);w&&(g.trigger("ajaxComplete",[B,e]),--h.active||h.event.trigger("ajaxStop"))}}"object"===typeof a&&(c=a,a=b);c=c||{};var e=h.ajaxSetup({},c),f=e.context||e,g=f!==e&&(f.nodeType||f instanceof h)?h(f):
h.event,k=h.Deferred(),l=h._Deferred(),m=e.statusCode||{},n,p={},q={},s,t,v,x,u,y=0,w,F,B={readyState:0,setRequestHeader:function(a,b){if(!y){var c=a.toLowerCase();a=q[c]=q[c]||a;p[a]=b}return this},getAllResponseHeaders:function(){return 2===y?s:null},getResponseHeader:function(a){var c;if(2===y){if(!t)for(t={};c=Gb.exec(s);)t[c[1].toLowerCase()]=c[2];c=t[a.toLowerCase()]}return c===b?null:c},overrideMimeType:function(a){y||(e.mimeType=a);return this},abort:function(a){a=a||"abort";v&&v.abort(a);
d(0,a);return this}};k.promise(B);B.success=B.done;B.error=B.fail;B.complete=l.done;B.statusCode=function(a){if(a){var b;if(2>y)for(b in a)m[b]=[m[b],a[b]];else b=a[B.status],B.then(b,b)}return this};e.url=((a||e.url)+"").replace(Fb,"").replace(Jb,L[1]+"//");e.dataTypes=h.trim(e.dataType||"*").toLowerCase().split(va);null==e.crossDomain&&(u=Sa.exec(e.url.toLowerCase()),e.crossDomain=!(!u||u[1]==L[1]&&u[2]==L[2]&&(u[3]||("http:"===u[1]?80:443))==(L[3]||("http:"===L[1]?80:443))));e.data&&(e.processData&&
"string"!==typeof e.data)&&(e.data=h.param(e.data,e.traditional));C(ia,e,c,B);if(2===y)return!1;w=e.global;e.type=e.type.toUpperCase();e.hasContent=!Ib.test(e.type);w&&0===h.active++&&h.event.trigger("ajaxStart");if(!e.hasContent&&(e.data&&(e.url+=(Ra.test(e.url)?"&":"?")+e.data),n=e.url,!1===e.cache)){u=h.now();var z=e.url.replace(Mb,"$1_="+u);e.url=z+(z===e.url?(Ra.test(e.url)?"&":"?")+"_="+u:"")}(e.data&&e.hasContent&&!1!==e.contentType||c.contentType)&&B.setRequestHeader("Content-Type",e.contentType);
e.ifModified&&(n=n||e.url,h.lastModified[n]&&B.setRequestHeader("If-Modified-Since",h.lastModified[n]),h.etag[n]&&B.setRequestHeader("If-None-Match",h.etag[n]));B.setRequestHeader("Accept",e.dataTypes[0]&&e.accepts[e.dataTypes[0]]?e.accepts[e.dataTypes[0]]+("*"!==e.dataTypes[0]?", */*; q=0.01":""):e.accepts["*"]);for(F in e.headers)B.setRequestHeader(F,e.headers[F]);if(e.beforeSend&&(!1===e.beforeSend.call(f,B,e)||2===y))return B.abort(),!1;for(F in{success:1,error:1,complete:1})B[F](e[F]);if(v=C(Ua,
e,c,B)){B.readyState=1;w&&g.trigger("ajaxSend",[B,e]);e.async&&0<e.timeout&&(x=setTimeout(function(){B.abort("timeout")},e.timeout));try{y=1,v.send(p,d)}catch(A){2>status?d(-1,A):h.error(A)}}else d(-1,"No Transport");return B},param:function(a,c){var d=[],e=function(a,b){b=h.isFunction(b)?b():b;d[d.length]=encodeURIComponent(a)+"="+encodeURIComponent(b)};c===b&&(c=h.ajaxSettings.traditional);if(h.isArray(a)||a.jquery&&!h.isPlainObject(a))h.each(a,function(){e(this.name,this.value)});else for(var f in a)z(f,
a[f],c,e);return d.join("&").replace(Eb,"+")}});h.extend({active:0,lastModified:{},etag:{}});var Nb=h.now(),fa=/(\=)\?(&|$)|\?\?/i;h.ajaxSetup({jsonp:"callback",jsonpCallback:function(){return h.expando+"_"+Nb++}});h.ajaxPrefilter("json jsonp",function(b,c,d){c="application/x-www-form-urlencoded"===b.contentType&&"string"===typeof b.data;if("jsonp"===b.dataTypes[0]||!1!==b.jsonp&&(fa.test(b.url)||c&&fa.test(b.data))){var e,f=b.jsonpCallback=h.isFunction(b.jsonpCallback)?b.jsonpCallback():b.jsonpCallback,
g=a[f],k=b.url,l=b.data,m="$1"+f+"$2";!1!==b.jsonp&&(k=k.replace(fa,m),b.url===k&&(c&&(l=l.replace(fa,m)),b.data===l&&(k+=(/\?/.test(k)?"&":"?")+b.jsonp+"="+f)));b.url=k;b.data=l;a[f]=function(a){e=[a]};d.always(function(){a[f]=g;if(e&&h.isFunction(g))a[f](e[0])});b.converters["script json"]=function(){e||h.error(f+" was not called");return e[0]};b.dataTypes[0]="json";return"script"}});h.ajaxSetup({accepts:{script:"text/javascript, application/javascript, application/ecmascript, application/x-ecmascript"},
...
e[l])}catch(m){}g.send(c.hasContent&&c.data||null);d=function(a,e){var l,m,n,p,q;try{if(d&&(e||4===g.readyState))if(d=b,k&&(g.onreadystatechange=h.noop,sa&&delete W[k]),e)4!==g.readyState&&g.abort();else{l=g.status;n=g.getAllResponseHeaders();p={};(q=g.responseXML)&&q.documentElement&&(p.xml=q);p.text=g.responseText;try{m=g.statusText}catch(s){m=""}l||!c.isLocal||c.crossDomain?1223===l&&(l=204):l=p.text?200:404}}catch(t){e||f(-1,t)}p&&f(l,m,p,n)};c.async&&4!==g.readyState?(k=++Ob,sa&&(W||(W={},h(a).unload(sa)),
W[k]=d),g.onreadystatechange=d):d()},abort:function(){d&&d(0,1)}}}});var ja={},I,U,Pb=/^(?:toggle|show|hide)$/,Qb=/^([+\-]=)?([\d+.\-]+)([a-z%]*)$/i,X,wa=[["height","marginTop","marginBottom","paddingTop","paddingBottom"],["width","marginLeft","marginRight","paddingLeft","paddingRight"],["opacity"]],ba,ta=a.webkitRequestAnimationFrame||a.mozRequestAnimationFrame||a.oRequestAnimationFrame;h.fn.extend({show:function(a,b,c){if(a||0===a)return this.animate(M("show",3),a,b,c);c=0;for(var d=this.length;c<
d;c++)a=this[c],a.style&&(b=a.style.display,h._data(a,"olddisplay")||"none"!==b||(b=a.style.display=""),""===b&&"none"===h.css(a,"display")&&h._data(a,"olddisplay",xa(a.nodeName)));for(c=0;c<d;c++)if(a=this[c],a.style&&(b=a.style.display,""===b||"none"===b))a.style.display=h._data(a,"olddisplay")||"";return this},hide:function(a,b,c){if(a||0===a)return this.animate(M("hide",3),a,b,c);a=0;for(b=this.length;a<b;a++)this[a].style&&(c=h.css(this[a],"display"),"none"===c||h._data(this[a],"olddisplay")||
...
k.scrollbar.bottom-n.rect.bottom,s=n.rect.left-(k.rect.left+k.border.left),n=k.rect.right-k.border.right-k.scrollbar.right-n.rect.right,q={};!0===f.direction.y&&(0>l?q.scrollTop=k.scroll.top+l:0<l&&0>p&&(q.scrollTop=k.scroll.top+Math.min(l,-p)));!0===f.direction.x&&(0>s?q.scrollLeft=k.scroll.left+s:0<s&&0>n&&(q.scrollLeft=k.scroll.left+Math.min(s,-n)));a.isEmptyObject(q)?a.isFunction(f.complete)&&f.complete.call(m[0]):(d.test(m[0].nodeName)&&(m=a("html,body")),m.animate(q,f.duration).eq(0).queue(function(b){a.isFunction(f.complete)&&
...
this.fromOffset||this.offset,this.toOffset):b.touchDragBy(c,this.getBy(),function(){a(d||b.normalizeActionTarget(c))},null,this.options,this.dragOnly,this.fromOffset||this.offset)}}});Siesta.Test.ActionRegistry().registerAction("touchdrag",Siesta.Test.Action.TouchDrag);Class("Siesta.Test.Action.MouseDown",{isa:Siesta.Test.Action,does:Siesta.Test.Action.Role.HasTarget,has:{requiredTestMethod:"mouseDown"},methods:{process:function(){this.test.mouseDown(this.getTarget(),this.options,this.offset);this.next()}}});
Siesta.Test.ActionRegistry().registerAction("mouseDown",Siesta.Test.Action.MouseDown);Siesta.Test.ActionRegistry().registerAction("fingerDown",Siesta.Test.Action.MouseDown);Class("Siesta.Test.Action.MouseUp",{isa:Siesta.Test.Action,does:Siesta.Test.Action.Role.HasTarget,has:{requiredTestMethod:"mouseUp"},methods:{process:function(){this.test.mouseUp(this.getTarget(),this.options,this.offset);this.next()}}});Siesta.Test.ActionRegistry().registerAction("mouseUp",Siesta.Test.Action.MouseUp);
Siesta.Test.ActionRegistry().registerAction("fingerUp",Siesta.Test.Action.MouseUp);Class("Siesta.Test.Action.Click",{isa:Siesta.Test.Action,does:Siesta.Test.Action.Role.HasTarget,has:{requiredTestMethod:"click"},methods:{process:function(){this.test.click(this.getTarget(),this.next,null,this.options,this.offset)}}});Siesta.Test.ActionRegistry().registerAction("click",Siesta.Test.Action.Click);
Class("Siesta.Test.Action.DoubleClick",{isa:Siesta.Test.Action,does:Siesta.Test.Action.Role.HasTarget,has:{requiredTestMethod:"doubleClick"},methods:{process:function(){this.test.doubleClick(this.getTarget(),this.next,null,this.options,this.offset)}}});Siesta.Test.ActionRegistry().registerAction("doubleclick",Siesta.Test.Action.DoubleClick);Siesta.Test.ActionRegistry().registerAction("dblclick",Siesta.Test.Action.DoubleClick);
...
Class("Siesta.Test.Action.Type",{isa:Siesta.Test.Action,does:Siesta.Test.Action.Role.HasTarget,has:{requiredTestMethod:"type",text:"",options:null,clearExisting:!1},methods:{process:function(){this.target=this.target||this.test.activeElement();this.test.type(this.getTarget(),this.text,this.next,null,this.options,this.clearExisting)}}});Siesta.Test.ActionRegistry().registerAction("type",Siesta.Test.Action.Type);
...
this.fromOffset||this.offset,this.toOffset):b.dragBy(c,this.getBy(),function(){a(d||b.normalizeActionTarget(c))},null,this.options,this.dragOnly,this.fromOffset||this.offset)}}});Siesta.Test.ActionRegistry().registerAction("drag",Siesta.Test.Action.Drag);
...
a+=e.left,c+=e.top),b.doNotUpdateCurrentPosition||(this.currentPosition[0]=a,this.currentPosition[1]=c));return d},moveMouseTo:function(a,b,c,d){if(!a)throw"Trying to call moveMouseTo without a target";this.waitForTargetAndSyncMousePosition(a,d,function(){this.afterMouseInteraction();b.call(c||this)},[],!1)},moveCursorTo:function(a,b,c,d){this.moveMouseTo.apply(this,arguments)},moveMouseBy:function(a,b,c){this.moveCursorBy.apply(this,arguments)},moveCursorBy:function(a,b,c){if(!a)throw"Trying to call moveCursorBy without relative distances";
this.moveMouse(this.currentPosition,[this.currentPosition[0]+a[0],this.currentPosition[1]+a[1]],b,c)},moveMouse:function(a,b,c,d,e,f,g){var k=this;this.movePointerTemplate({xy:a,xy2:b,callback:c,scope:d,options:g||{},overEls:this.overEls,interval:!1!==f?this.dragDelay:0,callbackDelay:!1!==f?50:0,precision:e||k.dragPrecision,onVoidOverEls:function(){return k.overEls=[]},onPointerEnter:function(a,b,c){k.simulateEvent(a,"mouseenter",b,c)},onPointerLeave:function(a,b,c){k.simulateEvent(a,"mouseleave",
b,c)},onPointerOver:function(a,b,c){k.simulateEvent(a,"mouseover",b,c)},onPointerOut:function(a,b,c){k.simulateEvent(a,"mouseout",b,c)},onPointerMove:function(a,b,c){k.simulateEvent(a,"mousemove",b,c)}})},movePointerTemplate:function(a){var b=this.global.document,c=this,d=a.overEls,e=d[d.length-1];try{e&&e.tagName}catch(f){e=null,d=a.onVoidOverEls()}for(var g=a.precision,k=a.options||{},l=this.getPathBetweenPoints(a.xy,a.xy2),m=Siesta.Harness.Browser.FeatureSupport().supports,n=new Siesta.Util.Queue({deferer:this.originalSetTimeout,
deferClearer:this.originalClearTimeout,interval:a.interval,callbackDelay:a.callbackDelay,observeTest:this,processor:function(f,g){for(var n=f.targetIndex,p=f.sourceIndex;p<=n;p++){var q=l[p],s=c.elementFromPoint(q[0],q[1]);if(s){if(s.ownerDocument!==b){var z=c.$((s.ownerDocument.defaultView||s.ownerDocument.parentWindow).frameElement).offset();q[0]-=z.left;q[1]-=z.top}if(s!==e){for(var A=d.length-1;0<=A;A--)if(z=d[A],z!==s&&0===c.$(z).has(s).length){if(m.mouseEnterLeave)a.onPointerLeave(z,$.extend({clientX:q[0],
clientY:q[1],relatedTarget:s},k));d.splice(A,1)}if(e)a.onPointerOut(e,$.extend({clientX:q[0],clientY:q[1],relatedTarget:s},k));if(m.mouseEnterLeave&&-1==jQuery.inArray(s,d)){for(var z=[],A=s.ownerDocument.documentElement,F=s;F&&F!=A;)z.unshift(F),F=F.parentNode;for(A=0;A<z.length;A++)-1==jQuery.inArray(z[A],d)&&(a.onPointerEnter(z[A],$.extend({clientX:q[0],clientY:q[1],relatedTarget:e},k)),d.push(z[A]))}a.onPointerOver(s,$.extend({clientX:q[0],clientY:q[1],relatedTarget:e},k));e=s}a.onPointerMove(s,
$.extend({clientX:q[0],clientY:q[1]},k),p<n)}}}}),p=0,s=l.length;p<s;p+=g)n.addStep({sourceIndex:p,targetIndex:Math.min(p+g-1,l.length-1)});var q=this.beginAsync();n.run(function(){c.endAsync(q);c.processCallbackFromTest(a.callback,null,a.scope||c)})},focusOnClick:function(a){if(this.isTextInput(a))this.focus(a);else{var b=a.ownerDocument,c=b.body;if(c){for(;a&&a!=c&&a!=b;){if("on"==a.getAttribute("unselectable"))return;if(null!=a.getAttribute("tabIndex")){this.focus(a);return}a=a.parentNode}this.focus(c||
b.documentElement)}}},waitForTargetAndSyncMousePosition:function(a,b,c,d,e,f){var g,k="Array"!=this.typeOf(a),l=this.suppressPassedWaitForAssertion;this.suppressPassedWaitForAssertion=!0;this.chain({waitForAnimations:[]},k&&{waitForElementVisible:a},k&&this.autoScrollElementsIntoView?function(c){!0===this.scrollTargetIntoView(a,b)?this.waitFor(this.delayAfterScrollIntoView,c):c()}:null,function(d){g=this.getNormalizedTopElementInfo(a,!0,c.toString(),b).globalXY;this.moveCursorBetweenPoints&&!1!==
f?this.syncCursor(g,d):d()},!1!==e&&k&&function(c){this.waitForTarget(a,c,this,null,b)},function(m){var n=(m=this.getNormalizedTopElementInfo(a,!0,c.toString(),b))&&m.globalXY;!k||m&&g[0]===n[0]&&g[1]===n[1]?(this.suppressPassedWaitForAssertion=l,c.apply(this,d)):(this.diag(Siesta.Resource("Siesta.Test.Browser","targetMoved")),this.waitFor(100,function(){this.waitForTargetAndSyncMousePosition(a,b,c,d,e,f)}))})},afterMouseInteraction:function(){var a=this.overEls;if(a=a[a.length-1]){var b;try{b=a.ownerDocument}catch(c){a=
null,this.overEls=[]}b&&$.contains(a,b.body)||this.mouseOver(this.currentPosition)}},genericMouseClick:function(a,b,c,d,e,f,g){jQuery.isFunction(a)&&(c=b,b=a,a=null);a=a||this.currentPosition;!1!==g&&b?this.waitForTargetAndSyncMousePosition(a,f,this.genericMouseClick,[a,b,c,d,e,f,!1]):(d=d||{},(g=this.getNormalizedTopElementInfo(a,!0,e,f))?(g.originalEl=a,g.method=e,g.offset=f,d.clientX=null!=d.clientX?d.clientX:g.localXY[0],d.clientY=null!=d.clientY?d.clientY:g.localXY[1],this[e](g,b,c,d)):b&&b.call(c||
this))},click:function(a,b,c,d,e){this.genericMouseClick(a,b,c,d,"simulateMouseClick",e)},rightClick:function(a,b,c,d,e){this.genericMouseClick(a,b,c,d,"simulateRightClick",e)},doubleClick:function(a,b,c,d,e){this.genericMouseClick(a,b,c,d,"simulateDoubleClick",e)},mouseDown:function(a,b,c){var d=this.getNormalizedTopElementInfo(a,!1,"mouseDown",c);d?(b=b||{},b.clientX=null!=b.clientX?b.clientX:d.localXY[0],b.clientY=null!=b.clientY?b.clientY:d.localXY[1],a=a||d.el,this.simulateEvent(a,"mousedown",
...
"mouseover",b))},mouseOut:function(a,b){var c=this.getNormalizedTopElementInfo(a,!0);c&&(b=b||{},b.clientX=null!=b.clientX?b.clientX:c.localXY[0],b.clientY=null!=b.clientY?b.clientY:c.localXY[1],this.simulateEvent(a,"mouseout",b))},processMouseClickSteps:function(a,b,c,d,e){a.originalEl&&this.enableUnreachableClickWarning&&this.getNormalizedTopElementInfo(a.originalEl,!1,a.method,a.offset);var f=this,g=a.globalXY[0],k=a.globalXY[1],l=f.global.document,m=l.body.scrollTop,n=f.elementFromPoint(g,k,!1,
a.el),p=!1,s=new Siesta.Util.Queue({deferer:this.originalSetTimeout,deferClearer:this.originalClearTimeout,interval:b?10:0,callbackDelay:f.afterActionDelay,observeTest:this,processor:function(a){var b=f.elementFromPoint(g,k-(l.body?l.body.scrollTop-m:0),!1,n);a.reCaptureTheTarget&&(n=b,p=!1);b==n||($.contains(b,n)||$.contains(n,b))||(p=!0);if(!p||!a.cancelIfTargetChanged){var c=f.simulateEvent(b,a.event,d,a.suppressLog);!a.focus||"mousedown"==a.event&&f.isEventPrevented(c)||f.focusOnClick(b);$.browser.msie&&
(11>Number(/^(\d+)/.exec($.browser.version)[1])&&"click"===e[e.length-1].event&&"a"===b.tagName.toLowerCase()&&b.getAttribute("href")&&"click"===a.event)&&(a=b.getAttribute("href").match(/#(.*)/))&&(f.global.location.hash=a[1])}}});Joose.A.each(e,function(a){s.addStep(a)});var q=f.beginAsync();s.run(function(){f.endAsync(q);f.afterMouseInteraction();f.processCallbackFromTest(b,null,c||f)})},simulateMouseClick:function(a,b,c,d){this.processMouseClickSteps(a,b,c,d,[{event:"mousedown",suppressLog:!0,
focus:!0},{event:"mouseup",suppressLog:!0},{event:"click",suppressLog:!1,cancelIfTargetChanged:!0}])},simulateRightClick:function(a,b,c,d){d=d||{};d.button=2;this.processMouseClickSteps(a,b,c,d,[{event:"mousedown",suppressLog:!1,focus:!0},{event:"mouseup",suppressLog:!0},{event:"contextmenu",suppressLog:!1}])},simulateDoubleClick:function(a,b,c,d){this.processMouseClickSteps(a,b,c,d,[{event:"mousedown",suppressLog:!1,focus:!0},{event:"mouseup",suppressLog:!0},{event:"click",suppressLog:!1,cancelIfTargetChanged:!0},
{event:"mousedown",suppressLog:!1,reCaptureTheTarget:!0,focus:!0},{event:"mouseup",suppressLog:!0},{event:"click",suppressLog:!0,cancelIfTargetChanged:!0},{event:"dblclick",suppressLog:!1,cancelIfTargetChanged:!0}])},syncCursor:function(a,b,c){var d=this,e=this.currentPosition;c=c||[];a[0]!==e[0]||a[1]!==e[1]?this.moveMouse(e,a,function(){b&&b.apply(d,c)}):b&&b.apply(this,c)},drag:function(a,b,c,d,e,f){if(!a)throw"No drag source defined";b?this.dragTo(a,b,d,e,f):this.dragBy(a,c,d,e,f)},dragTo:function(a,
b,c,d,e,f,g,k,l){if(!b)throw"No drag target defined";a=a||this.currentPosition;e=e||{};!1!==l&&c?this.waitForTargetAndSyncMousePosition(a,g,this.dragTo,[a,b,c,d,e,f,g,k,!1]):(a=this.getNormalizedTopElementInfo(a,!0,"dragTo: Source",g),(b=this.getNormalizedTopElementInfo(b,!1,"dragTo: Target",k))?this.simulateDrag(a.globalXY,b.globalXY,function(){this.afterMouseInteraction();c.call(d||this)},null,e,f):this.processCallbackFromTest(c,null,d||this))},dragBy:function(a,b,c,d,e,f,g,k){if(!b)throw"No drag delta defined";
a=a||this.currentPosition;!1!==k&&c?this.waitForTargetAndSyncMousePosition(a,g,this.dragBy,[a,b,c,d,e,f,g,!1]):(a=this.getNormalizedTopElementInfo(a,!0,"dragBy: Source",g).globalXY,this.simulateDrag(a,[a[0]+b[0],a[1]+b[1]],function(){this.afterMouseInteraction();c.call(d||this)},null,e,f))},simulateDrag:function(a,b,c,d,e,f){var g=this;e=e||{};var k=g.elementFromPoint(a[0],a[1],!0);g.elementFromPoint(b[0],b[1],!0);var l=new Siesta.Util.Queue({deferer:this.originalSetTimeout,deferClearer:this.originalClearTimeout,
interval:g.dragDelay,callbackDelay:g.afterActionDelay,observeTest:this});l.addStep({processor:function(){g.simulateEvent(k,"mouseover",$.extend({clientX:a[0],clientY:a[1]},e))}});l.addStep({processor:function(){k=g.elementFromPoint(a[0],a[1],!0,k);g.simulateEvent(k,"mouseover",$.extend({clientX:a[0],clientY:a[1]},e))}});l.addStep({processor:function(){g.simulateEvent(k,"mousedown",$.extend({clientX:a[0],clientY:a[1]},e))}});l.addStep({isAsync:!0,processor:function(c){g.moveMouse(a,b,c.next,this,null,
!0,e)}});var m;l.addStep({processor:function(){m=g.elementFromPoint(b[0],b[1],!0);g.simulateEvent(m,"mouseover",$.extend({clientX:b[0],clientY:b[1]},e))}});f||(l.addStep({processor:function(){g.simulateEvent(m,"mouseup",$.extend({clientX:b[0],clientY:b[1]},e))}}),l.addStep({processor:function(){m===k&&g.simulateEvent(m,"click",$.extend({clientX:b[0],clientY:b[1]},e))}}));var n=this.beginAsync();l.run(function(){g.endAsync(n);g.processCallbackFromTest(c,null,d||g)})}}});
Singleton("Siesta.Test.Simulate.KeyCodes",{methods:{isNav:function(a){var b=this.keys;return 33<=a&&40>=a||a==b.RETURN||a==b.TAB||a==b.ESCAPE},isSpecial:function(a){return a===this.keys.BACKSPACE||16<=a&&20>=a||44<=a&&46>=a},fromCharCode:function(a,b){var c=this.keys,d;for(d in c)if(c[d]===a&&(!b||1<d.length))return d}},has:{keys:{init:{"\b":8,BACKSPACE:8,"\t":9,TAB:9,"\r":13,RETURN:13,ENTER:13,SHIFT:16,CTRL:17,ALT:18,"PAUSE-BREAK":19,CAPS:20,ESCAPE:27,"NUM-LOCK":144,"SCROLL-LOCK":145,PRINT:44,"PAGE-UP":33,
"PAGE-DOWN":34,END:35,HOME:36,LEFT:37,UP:38,RIGHT:39,DOWN:40,INSERT:45,DELETE:46," ":32,0:48,1:49,2:50,3:51,4:52,5:53,6:54,7:55,8:56,9:57,A:65,B:66,C:67,D:68,E:69,F:70,G:71,H:72,I:73,J:74,K:75,L:76,M:77,N:78,O:79,P:80,Q:81,R:82,S:83,T:84,U:85,V:86,W:87,X:88,Y:89,Z:90,NUM0:96,NUM1:97,NUM2:98,NUM3:99,NUM4:100,NUM5:101,NUM6:102,NUM7:103,NUM8:104,NUM9:105,"*":106,"+":107,"-":109,".":110,"/":111,";":186,"=":187,",":188,"-":189,".":190,"/":191,"`":192,"[":219,"\\":220,"]":221,"'":222,F1:112,F2:113,F3:114,
F4:115,F5:116,F6:117,F7:118,F8:119,F9:120,F10:121,F11:122,F12:123}}}});
Role("Siesta.Test.Simulate.Keyboard",{requires:["simulateEvent","getSimulateEventsWith","getElementAtCursor"],methods:{createKeyboardEvent:function(a,b,c){var d;b=$.extend({bubbles:!0,cancelable:!0,view:this.global,ctrlKey:!1,altKey:!1,shiftKey:!1,metaKey:!1,keyCode:0,charCode:0},b);c=c.ownerDocument;if(c.createEvent&&"dispatchEvent"==this.getSimulateEventsWith())try{d=c.createEvent("KeyEvents"),d.initKeyEvent(a,b.bubbles,b.cancelable,b.view,b.ctrlKey,b.altKey,b.shiftKey,b.metaKey,b.keyCode,b.charCode)}catch(e){d=
c.createEvent("Events"),d.initEvent(a,b.bubbles,b.cancelable),$.extend(d,{view:b.view,ctrlKey:b.ctrlKey,altKey:b.altKey,shiftKey:b.shiftKey,metaKey:b.metaKey,keyCode:b.keyCode,charCode:b.charCode})}else c.createEventObject&&(d=c.createEventObject(),$.extend(d,b));if($.browser.msie||$.browser.opera)d.keyCode=0<b.charCode?b.charCode:b.keyCode,d.charCode=void 0;return d},createTextEvent:function(a,b,c){a=c.ownerDocument;c=null;if(a.createEvent&&!$.browser.msie)try{if((c=a.createEvent("TextEvent"))&&
c.initTextEvent)return c.initTextEvent("textInput",!0,!0,this.global,b.text,0),c}catch(d){}return null},findNextFocusable:function(a,b){var c=this.$(a),d=this.$(":focus, :input, a[href], [tabindex], body",a.ownerDocument).not(":disabled").not(":hidden").not("a[href]:empty"),e=!1,f;"INPUT"===a.tagName&&("radio"===a.type&&""!==a.name)&&(e=!0,f="input[type=radio][name="+a.name.replace(/(!"#$%&'\(\)\*\+,\.\/:;<=>\?@\[\]^`\{\|\}~)/g,"\\\\$1")+"]");for(var g=[],k=0;k<d.length;k++){var l=d[k];l!=a&&-1==
l.getAttribute("tabIndex")||e&&$(l).is(f)||g.push(l)}var m=a.ownerDocument.body,n=a.getAttribute("tabIndex"),p=function(b){return b==a&&-1==n||b==m?0:b.getAttribute("tabIndex")||0};g.sort(function(a,b){var c=p(a),d=p(b);return c<d?-1:c>d?1:a==m?1:b==m?-1:0});c=$(g).index(c);return-1==c?null:g[(c+b)%g.length]},emulateTab:function(a,b){var c=this.findNextFocusable(a,b||1);c?this.focus(c):a.blur();return c},type:function(a,b,c,d,e,f){a=this.normalizeElement(a||this.activeElement());if(null==b)throw"Must supply a string to type";
var g=this;if(a.readOnly||a.disabled)g.processCallbackFromTest(c,null,d||g);else{f&&(a.value="");var k=(b+"").match(/(\[(?:\w|-)+\])|([\s\S])/g)||[],l=new Siesta.Util.Queue({deferer:this.originalSetTimeout,deferClearer:this.originalClearTimeout,interval:this.actionDelay,callbackDelay:this.afterActionDelay,observeTest:this,processor:function(b,c){var d=g.activeElement(!0,a,a);g.keyPress(d,b.key,e)}});l.addStep({processor:function(){g.focus(a)}});$.browser.msie&&l.addStep({processor:function(){g.focus(a)}});
jQuery.each(k,function(a,b){b=1==b.length?b:b.substring(1,b.length-1);k[a]=b;l.addStep({key:b})});k.length&&(b=Siesta.Test.Simulate.KeyCodes().keys[k[0].toUpperCase()],this.isReadableKey(b)&&(b=this.getSelectedText(a)))&&(a.value=a.value.replace(b,""));var m=this.beginAsync();l.run(function(){g.endAsync(m);g.processCallbackFromTest(c,null,d||g)})}},keyPress:function(a,b,c){a=this.normalizeElement(a);var d=Siesta.Test.Simulate.KeyCodes().keys,e=d[b.toUpperCase()]||0;c=c||{};c.readableKey=b;var f=this.isReadableKey(e),
g=f?b.charCodeAt(0):0;b=this.isTextInput(a);var k=this.isEditableNode(a),l=b||k,m=this.simulateEvent(a,"keydown",$.extend({charCode:0,keyCode:e},c),!0),m=this.isEventPrevented(m);a=this.activeElement(!0,a,a);var g=this.simulateEvent(a,"keypress",$.extend({charCode:g,keyCode:f?0:e},c),!1),n=this.isEventPrevented(g),g=Siesta.Harness.Browser.FeatureSupport().supports;m||(n||e!==d.TAB)||(a=this.emulateTab(a,c.shiftKey?-1:1)||a);!n&&(l&&e!=d.TAB)&&(l=this.harness.isPhantomJS,m="value"in a?"value":"innerHTML",
f&&(l||(k&&$.browser.msie&&(f=a.innerHTML,0===f.indexOf("&nbsp;")?a.innerHTML=f.substring(6):0===f.indexOf("<br>")&&(a.innerHTML=f.substring(4))),k&&!$.browser.msie?(f=a.innerHTML,8203===f.charCodeAt(f.length-1)&&(a.innerHTML=f.substring(0,f.length-1)),a.ownerDocument.execCommand("insertText",!1,c.readableKey)):this.simulateEvent(a,"textInput",{text:c.readableKey},!0)),f=a[m].length,k=a.getAttribute("maxlength"),null!=k&&(k=Number(k)),!b&&!$.browser.msie||(g.canSimulateKeyCharacters&&!l||f!==a[m].length||
f===k)||(a[m]+=c.readableKey)),e===d.BACKSPACE&&(!g.canSimulateBackspace&&0<a[m].length)&&(b||$.browser.msie?a[m]=a[m].substring(0,a[m].length-1):a.ownerDocument.execCommand("delete")),"value"!==m||(e!==d.ENTER||g.enterSubmitsForm)||(b=this.$(a).closest("form"),b.length&&b.submit()));b=a.nodeName&&a.nodeName.toLowerCase();"a"!=b&&"button"!=b||(e!==d.ENTER||g.enterOnAnchorTriggersClick)||this.simulateEvent(a,"click",{doNotUpdateCurrentPosition:!0},!0);this.simulateEvent(a,"keyup",$.extend({charCode:0,
keyCode:e},c),!0)},isTextInput:function(a){var b=a.nodeName&&a.nodeName.toLowerCase();a=a.type&&a.type.toLowerCase();return"textarea"===b||"input"===b&&("password"===a||"number"===a||"search"===a||"text"===a||"email"===a)},isEditableNode:function(a){return"on"===a.ownerDocument.designMode.toLowerCase()||"true"===a.contentEditable.toLowerCase()},isReadableKey:function(a){var b=Siesta.Test.Simulate.KeyCodes();return!b.isNav(a)&&!b.isSpecial(a)}}});
...
f,e));if(c=this.createEvent(b,c,a))c.synthetic=!0,this.dispatchEvent(a,b,c),d||this.fireEvent("eventsimulated",this,a,b,c);return e||c},createEvent:function(a,b,c){if((a=/^text(Input)$/.test(a)?this.createTextEvent(a,b,c):/^mouse(over|out|down|up|move|enter|leave)|contextmenu|(dbl)?click$/.test(a)||/^(ms)?pointer/i.test(a)?this.createMouseEvent(a,b,c):/^key(up|down|press)$/.test(a)?this.createKeyboardEvent(a,b,c):this.createHtmlEvent(a,b,c))&&$.browser.msie&&10<=Number($.browser.version)){var d=a.preventDefault;
d&&(a.preventDefault=function(){this.$defaultPrevented=!0;return d.apply(this,arguments)})}return a},createHtmlEvent:function(a,b,c){b=c.ownerDocument;if(b.createEvent&&"dispatchEvent"==this.getSimulateEventsWith())return b=b.createEvent("HTMLEvents"),b.initEvent(a,!1,!1),b;if(b.createEventObject)return b.createEventObject()},dispatchEvent:function(a,b,c){if(a.dispatchEvent&&"dispatchEvent"==this.getSimulateEventsWith())a.dispatchEvent(c);else if(a.fireEvent)try{a.fireEvent("on"+b,c)}catch(d){}else throw"Can't dispatch event: "+
b;return c}}});
...
(b=a);a!=b||(g||k)||(g=["25%","50%"],k=["75%","50%"]);var m=this.getNormalizedTopElementInfo(a,!0,"pinch: target1",g),n=this.getNormalizedTopElementInfo(b,!0,"pinch: target2",k);if(m&&n){var p=new Siesta.Util.Queue({deferer:this.originalSetTimeout,deferClearer:this.originalClearTimeout,interval:d?30:0,observeTest:this}),s,q,t=m.localXY[0]-n.localXY[0],v=m.localXY[1]-n.localXY[1],w=Math.sqrt(t*t+v*v);1>w&&(w=1);c=(w*c-w)/2;var t=Math.atan(v/t),x=Math.round(m.localXY[0]-c*Math.cos(t)),y=Math.round(m.localXY[1]-
c*Math.sin(t)),C=Math.round(n.localXY[0]+c*Math.cos(t)),z=Math.round(n.localXY[1]+c*Math.sin(t)),A=Joose.O.extend({},f);p.addStep({processor:function(){s=l.touchStart(null,null,f,m);q=l.touchStart(null,null,A,n)}});p.addAsyncStep({processor:function(a){var b=!1,c=!1;l.touchMove(s,x,y,function(){(b=!0)&&c&&a.next()},null,f);l.touchMove(q,C,z,function(){c=!0;b&&c&&a.next()},null,A)}});p.addStep({processor:function(){l.touchEnd(s,f);l.touchEnd(q,A)}});var F=l.beginAsync();p.run(function(){l.endAsync(F);
...
b||{});this.simulateTouchEventGeneric(c.currentEl||c.target,"end",b,{touchId:a})},touchMove:function(a,b,c,d,e,f){var g=this.activeTouches[a];if(!g)throw"Can't find active touch: "+a;var k=this,l=[];this.movePointerTemplate({xy:[g.clientX,g.clientY],xy2:[b,c],callback:d,scope:e,options:f||{},overEls:l,interval:this.dragDelay,callbackDelay:k.afterActionDelay,precision:k.dragPrecision,onVoidOverEls:function(){return l=[]},onPointerEnter:function(a,b,c){},onPointerLeave:function(a,b,c){},onPointerOver:function(a,
...
this.trimString(a.replace(/^(\s*>>)?/,""));var d=d.ComponentQuery.query(a),f=Siesta.Resource("Siesta.Test.ExtJSCore");!b&&1>d.length&&this.warn(f.get("noComponentMatch").replace("{component}",a));if(c.ignoreNonVisible){var g=[];Joose.A.each(d,function(a){(a.isVisible?a.isVisible():!a.isHidden())&&g.push(a)});d=g}1<d.length&&(e=!0,a=f.get("multipleComponentMatch").replace("{component}",a),this.harness.failOnMultipleComponentMatches?this.fail(a):this.warn(a));a=d[0]}return c.detailed?{comp:a,matchingMultiple:e}:
a},compToEl:function(a,b){var c=this.Ext();if(!a)return null;b=!1!==b;c.Editor&&(a instanceof c.Editor&&a.field)&&(a=a.field);if(c&&c.form&&c.form.Field&&b){if(a instanceof c.form.Field&&a.inputEl)return(c=a.el.down(".x-form-field"))&&c.dom||a.inputEl.dom||a.inputEl;if(c.form.HtmlEditor&&a instanceof c.form.HtmlEditor)return a.iframe||a.inputEl}c&&(c.field&&c.field.Field&&a instanceof c.field.Field&&b)&&(a=a.getComponent());return a.getEl?a.getEl():b&&a.input||a.el||a.element},normalizeElement:function(a,
b,c,d,e){if(!a)return null;if(a.nodeName)return a;var f=!1;this.getExt();var g=a,k,l=e&&e.stopAtComponentLevel;e=e&&e.hasOwnProperty("ignoreNonVisible")?e.ignoreNonVisible:!0;if("string"===typeof a){f=a.split("->");if(2===f.length&&(k=this.adjustScope(a),a=this.trimString(f[1]),!k||(a.match(/^\s*>>/)||a.match(/=>/))&&!this.Ext()))return this.resetScope(),null;if(a.match(/=>/))f=this.compositeQuery(a,null,b,e),a=f[0],f=1<f.length;else if(a.match(/^\s*>>/))f=this.normalizeComponent(a,b,{ignoreNonVisible:e,
detailed:!0}),a=f.comp,f=f.matchingMultiple;else return d=this.SUPER(a,b,c,d),k&&this.resetScope(),d;if(!b&&!a)throw d=Siesta.Resource("Siesta.Test.ExtJSCore").get("noComponentFound")+": "+g,this.warn(d),k&&this.resetScope(),d;}g=!1;this.isExtJSComponent(a)&&(l?g=!0:a=this.compToEl(a));a&&a.dom&&(l?g=!0:a=a.dom);a=g?a:this.SUPER(a,b,c);k&&this.resetScope();return d?{el:a,matchingMultiple:f}:a},normalizeActionTarget:function(a,b){return this.normalizeElement(a,b,!1,!1,{stopAtComponentLevel:!0})},knownBugIn:function(a,
b,c){var d=this.getExt(),d=d.versions.extjs||d.versions.touch,e=Siesta.Resource("Siesta.Test.ExtJSCore");this.harness.failKnownBugIn||d.isGreaterThan(a)?b.call(this.global,this):this.todo(e.get("knownBugIn")+" "+a+": "+(c||""),b)},requireOk:function(){var a=this,b=this.getExt(),c=Array.prototype.concat.apply([],arguments),d=Siesta.Resource("Siesta.Test.ExtJSCore"),e;"Function"==this.typeOf(c[c.length-1])&&(e=c.pop());var f=function(){a.endAsync(k);Joose.A.each(c,function(c){var e=b.ClassManager.get(c);
!e||"Function"!=a.typeOf(e)&&"Function"!=a.typeOf(e.self)?a.fail(d.get("Class")+": "+c+" "+d.get("wasNotLoaded")):a.pass(d.get("Class")+": "+c+" "+d.get("wasLoaded"))});a.processCallbackFromTest(e)},g=b.isIE?12E4:3E4,k=this.beginAsync(g+100),l=!1,m=this.originalSetTimeout,n=this.originalClearTimeout,p=m(function(){l=!0;f()},g);b.Loader.setConfig({enabled:!0});b.require(c,function(){n(p);l||f()})},clickComponentQuery:function(a,b,c){2==arguments.length&&"Function"==this.typeOf(arguments[1])&&(c=b,
b=this.Ext().ComponentQuery);1==arguments.length&&(b=this.Ext().ComponentQuery);var d=b.query(a);this.chainClick(d,function(){c&&c.call(this,d)})},clickCQ:function(){this.clickComponentQuery.apply(this,arguments)},compositeQuery:function(a,b,c,d){c=!1!==c;var e=this.Ext(),f=Siesta.Resource("Siesta.Test.ExtJSCore"),g=a.split("=>"),k;b=b||e.ComponentQuery;if(!b)return[];if(2>g.length)throw f.get("invalidCompositeQuery")+": "+a;if(g[0].match(/\.\w+\(/)){k=this.trimString(g[0]).split(" ");for(e=0;e<k.length;e++){var l=
this.trimString(k[e]).split(".");b=b.query(l[0])[0];1<l.length&&(l=l[1].substr(0,l[1].length-2),b=b[l]())}b=[b]}else b=b.query(g[0]);if(!b.length){if(c)return[];throw f.get("ComponentQuery")+" "+g[0]+" "+f.get("matchedNoCmp");}for(e=0;e<b.length;e++)if(k=b[e],k.rendered&&(!d||(k.isVisible?k.isVisible():!k.isHidden()))&&(k=this.compToEl(k,!1),k=Array.prototype.slice.call($(g[1],k.dom)),0<k.length))return k;if(c)return[];throw f.get("CompositeQuery")+" "+a+" "+f.get("matchedNoCmp");},cq:function(a){return this.Ext().ComponentQuery.query(a)},
...
b,!0).length?!1:!0},callback:c,scope:d,timeout:e,assertionName:"waitForCompositeQueryNotFound",description:" "+Siesta.Resource("Siesta.Test.ExtJS.Component","compositeQuery")+' "'+a+'" '+Siesta.Resource("Siesta.Test.ExtJS.Component","toReturnEmptyArray")})},waitForCQ:function(){return this.waitForComponentQuery.apply(this,arguments)},waitForCQNotFound:function(){return this.waitForComponentQueryNotFound.apply(this,arguments)},waitForComponentQueryNotFound:function(a,b,c,d,e){var f=Siesta.Resource("Siesta.Test.ExtJS.Component");
"Function"==this.typeOf(b)&&(e=d,d=c,c=b,b=this.getExt().ComponentQuery);return this.waitFor({method:function(){var c=b.query(a);return 0===c.length&&c},callback:c,scope:d,timeout:e,assertionName:"waitForComponentQueryNotFound",description:f.get("componentQuery")+": "+a+" "+f.get("toReturnEmpty")})},waitForCQVisible:function(){return this.waitForComponentQueryVisible.apply(this,arguments)},waitForCQNotVisible:function(){return this.waitForComponentQueryNotVisible.apply(this,arguments)},waitForComponentQueryVisible:function(a,
b,c,d,e){var f=this,g=Siesta.Resource("Siesta.Test.ExtJS.Component"),k=f.getExt();"Function"==this.typeOf(b)&&(e=d,d=c,c=b,b=k.ComponentQuery);return this.waitFor({method:function(){var c=b.query(a),d=!0;return 0<c.length?(Joose.A.each(c,function(a){if(!a.rendered||!f.isElementVisible(a))return d=!1}),d&&c):!1},callback:c,scope:d,timeout:e,assertionName:"waitForComponentQueryVisible",description:" "+g.get("componentQuery")+": "+a+" "+g.get("toReturnAVisibleComponent")})},waitForComponentQueryNotVisible:function(a,
b,c,d,e){var f=Siesta.Resource("Siesta.Test.ExtJS.Component"),g=this.getExt();"Function"==this.typeOf(b)&&(e=d,d=c,c=b,b=g.ComponentQuery);return this.waitFor({method:function(){var c=b.query(a),d=!0;return 0<c.length?(Joose.A.each(c,function(a){if(a.rendered&&!a.isHidden())return d=!1}),d&&c):!0},callback:c,scope:d,timeout:e,assertionName:"waitForComponentQueryVisible",description:" "+f.get("componentQuery")+": "+a+" "+f.get("toReturnHiddenCmp")})},waitForXType:function(a,b,c,d,e){return this.waitForComponentQuery(a,
b,c,d,e)},waitForComponent:function(a,b,c,d,e){var f=this.getExt();a=f.isString(a)?f.ClassManager.get(a).xtype:a.xtype;b&&(a+="[rendered]");return this.waitForXType(a,c,d,e)},hasSize:function(a,b,c,d){a=this.normalizeComponent(a);this.isDeeply(a.getSize(),{width:b,height:c},d)},hasPosition:function(a,b,c,d){a=this.normalizeComponent(a);this.isDeeply(a.getPosition(),[b,c],d)},destroysOk:function(a,b){var c=this.Ext(),d=Siesta.Resource("Siesta.Test.ExtJS.Component");"Array"!=this.typeOf(a)&&(a="String"==
this.typeOf(a)?this.Ext().ComponentQuery.query(a):[a]);if(a.length){var e,f=this.getExceptionCatcher()(function(){Joose.A.each(a,function(a){e=a;a.destroy()})});if(void 0!==f)this.fail(b,{assertionName:"destroysOk",got:f,gotDesc:d.get("exception"),annotation:d.get("exceptionAnnotation")+" "+e.id});else{var g=this;!1!==Joose.A.each(a,function(a){if(!a.isDestroyed&&a.destroy!=c.emptyFn)return g.fail(b,{assertionName:"destroysOk",annotation:d.get("Component")+" ["+a.id+"] "+d.get("destroyFailed")}),
!1})&&this.pass(b,{descTpl:d.get("destroyPassed")})}}else this.fail(b,{assertionName:"destroysOk",annotation:d.get("invalidDestroysOkInput")})}}});
Role("Siesta.Test.ExtJS.Grid",{requires:["waitFor","pass","fail","typeOf"],methods:{waitForRowsVisible:function(a,b,c,d){"function"===typeof a&&(d=c,c=b,b=a,a=this.cq1("tableview"));var e=this.normalizeComponent(a,!0),f=this;if(e||"string"!==typeof a){if(e.normalGrid){var g=e.normalGrid.getView().itemSelector;a=function(){if(e.rendered&&e.normalGrid.rendered&&e.lockedGrid.rendered){var a=this.$(g,e.lockedGrid.el.dom),b=this.$(g,e.normalGrid.el.dom);if(0<a.length&&0<b.length)return{lockedRows:a,normalRows:b}}}}else a=
e.getView&&e.getView()||e,g=a.itemSelector||a.rowSelector,a=function(){if(e.rendered){var a=this.$(g,e.el.dom);if(0<a.length)return a}};return this.waitFor({method:a,callback:function(){var a=f.beginAsync();f.global.setTimeout(function(){f.endAsync(a);b.call(c||f)},100)},timeout:d,assertionName:"waitForRowsVisible",description:" "+Siesta.Resource("Siesta.Test.ExtJS.Grid").get("waitForRowsVisible")+' "'+e.id+'"'})}return this.waitForCQ(a,function(a){this.waitForRowsVisible(a[0],b,c,d)},this)},getFirstRow:function(a){a=
this.normalizeComponent(a);return this.getRow(a,0)},getFirstCell:function(a){a=this.normalizeComponent(a);return this.getCell(a,0,0)},getRow:function(a,b){var c=(a=this.normalizeComponent(a))&&this.$(a.getView().itemSelector,a.el.dom)[b];return c&&this.Ext().get(c)},getCell:function(a,b,c){return(a=(b=(a=this.normalizeComponent(a))&&this.getRow(a,b))&&this.$(a.view.cellSelector,b.dom)[c])&&this.Ext().get(a)},getLastCellInRow:function(a,b){a=this.normalizeComponent(a);return this.getCell(a,b,a.headerCt.getColumnCount()-
1)},matchGridCellContent:function(a,b,c,d,e){a=this.normalizeComponent(a);a.getView();var f=this.Ext();a=this.getCell(a,b,c).child("."+f.baseCSSPrefix+"grid-cell-inner");var f="RegExp"==this.typeOf(d),g=a.dom.innerHTML;(f?d.test(g):-1!=g.indexOf(d))?this.pass(e,{descTpl:f?"Cell content {content} matches regexp {string}":"Cell content {content} has a string {string}",content:g,string:d}):this.fail(e,{assertionName:"matchGridCellContent",got:a.dom.innerHTML,gotDesc:"Cell content",need:d,needDesc:"String matching",
annotation:"Row index: "+b+", column index: "+c})},clickToEditCell:function(a,b,c,d,e){var f=this.getExt(),g=(a=this.normalizeComponent(a))&&a.editingPlugin;if(g&&g instanceof f.grid.plugin.CellEditing){var k=this;this[2==g.clicksToEdit?"doubleClick":"click"](this.getCell(a,b,c),function(){g.getActiveEditor()||g.startEditByPosition({row:b,column:c});k.waitForSelectorAtCursor(e||"input",d)})}else this.fail("No grid, or grid has no editing plugin, or its not a Ext.grid.plugin.CellEditing plugin"),d&&
d(null)}}});
...
Role("Siesta.Test.ExtJS.FormField",{methods:{fieldHasValue:function(a,b,c){a=this.normalizeComponent(a);this.is(a.getValue(),b,c)},hasValue:function(){this.fieldHasValue.apply(this,arguments)},isFieldEmpty:function(a,b){a=this.normalizeComponent(a);var c=a.getValue();this.ok(null===c||""===c,b)},isEmpty:function(){this.isFieldEmpty.apply(this,arguments)}}});
...
e.top-f.scrollTop()];c=this.normalizeOffset(c,a);e[0]+=c[0];e[1]+=c[1];!1===b&&(b=d.defaultView||d.parentWindow,b!==this.global&&(b=this.$(b.frameElement).offset(),e[0]+=b.left,e[1]+=b.top));return e},isElementVisible:function(a){if(a=this.normalizeElement(a)){try{if(window.SVGElement&&a instanceof this.global.SVGElement)return"none"!==a.style.display&&"hidden"!==a.style.visibility}catch(b){}return this.$(a).is(":visible")&&(!a.style||"hidden"!==a.style.visibility)}return!1},contentLike:function(a,
b,c){a=this.normalizeElement(a);this.like(a.innerHTML,b,c)},contentNotLike:function(a,b,c){a=this.normalizeElement(a);this.unlike(a.innerHTML,b,c)},waitForContentLike:function(a,b,c,d,e){var f=Siesta.Resource("Siesta.Test.Element");a=this.normalizeElement(a);return this.waitFor({method:function(){return a.innerHTML.match(b)},callback:c,scope:d,timeout:e,assertionName:"waitForContentLike",description:" "+f.get("elementContent")+' "'+b+'" '+f.get("toAppear")})},waitForContentNotLike:function(a,b,c,
d,e){var f=Siesta.Resource("Siesta.Test.Element");a=this.normalizeElement(a);return this.waitFor({method:function(){return!a.innerHTML.match(b)},callback:c,scope:d,timeout:e,assertionName:"waitForContentNotLike",description:" "+f.get("elementContent")+' "'+b+'" '+f.get("toDisappear")})},getRandomTypeString:function(a){for(var b=this.allowedCharacters,c=b.special.split("/"),d=b.punctuation,b=b.normal,e=c.length+d.length+b.length,f="",g=0;g<a;g++){var k=this.randomBetween(0,e-1);k<b.length?f+=b.substr(k,
1):(k-=b.length,k<d.length?f+=d.substr(k,1):(k-=d.length,f+="["+c[k]+"]"))}return f},monkeyTest:function(a,b,c,d,e){a=this.normalizeElement(a,!1,!0);this.suppressPassedWaitForAssertion=!0;"function"===typeof b?(d=b,e=c,c=""):"function"===typeof c&&(d=c,c="");b="number"===typeof b?b:30;var f=this.global,g=a==f.document.body,k=this,l=k.$(a).offset(),m=l.left+k.$(g?f:a).width(),n=l.top+k.$(g?f:a).height(),p=[],s=Siesta.Resource("Siesta.Test.Element"),q=new Siesta.Util.Queue({deferer:k.originalSetTimeout,
deferClearer:k.originalClearTimeout,interval:50,observeTest:this,processor:function(a){if(k.nbrExceptions||k.failed)k.warn(s.get("monkeyActionLog")+":"+JSON2.stringify(p)),q.abort();else{var b=k.beginAsync(null,function(a){a.fail(s.get("monkeyException"));k.warn(s.get("monkeyActionLog")+":"+JSON.stringify(p));return!0}),c=a.next;a.next=function(){k.endAsync(b);c()};a.action(a)}}});a=[];a.length=b;var t=function(a,b){var c=k.normalizeElement(a.xy);return c&&"a"==c.tagName.toLowerCase()?(p[a.logIndex]=
null,a.isDouble&&(p[a.logIndex-1]=null),a.next(),!0):!1};Joose.A.each(a,function(a,b){var c=[k.randomBetween(l.left,m),k.randomBetween(l.top,n)];switch(k.randomBetween(0,4)){case 0:p.push({click:c});q.addAsyncStep({action:function(a){k.waitForSelector("body",a.next)}});q.addAsyncStep({action:function(a){t(a)||k.click(a.xy,a.next)},xy:c,logIndex:p.length-1});break;case 1:p.push({doubleclick:c});q.addAsyncStep({action:function(a){k.waitForSelector("body",a.next)}});q.addAsyncStep({action:function(a){t(a)||
k.doubleClick(a.xy,a.next)},xy:c,logIndex:p.length-1});break;case 2:"oncontextmenu"in window?p.push({rightclick:c}):p.push({click:c});q.addAsyncStep({action:function(a){k.waitForSelector("body",a.next)}});q.addAsyncStep({action:function(a){"oncontextmenu"in window?k.rightClick(a.xy,a.next):t(a)||k.click(a.xy,a.next)},xy:c});break;case 3:var d=[k.randomBetween(l.left,m),k.randomBetween(l.top,n)];p.push({action:"drag",target:c,to:d});q.addAsyncStep({action:function(a){k.waitForSelector("body",a.next)}});
q.addAsyncStep({action:function(a){k.drag(a.dragFrom,a.dragTo,null,a.next)},dragFrom:c,dragTo:d});break;case 4:var e=k.getRandomTypeString(15);p.push({click:c});p.push({type:e});q.addAsyncStep({action:function(a){k.waitForSelector("body",a.next)}});q.addAsyncStep({action:function(a){t(a)||k.click(a.xy,function(){k.waitForSelector("body",function(){k.type(null,e,a.next)})})},xy:c,logIndex:p.length-1,isDouble:!0})}});var v=!1,w=function(){v=!0;k.nbrExceptions&&k.warn(s.get("monkeyActionLog")+":"+JSON.stringify(p));
k.is(k.nbrExceptions,0,c||s.get("monkeyNoExceptions"))};this.on("beforetestfinalizeearly",w);q.run(function(){v||(k.un("beforetestfinalizeearly",w),w());this.suppressPassedWaitForAssertion=!1;k.processCallbackFromTest(d,null,e||k)})},hasCls:function(a,b,c){var d=Siesta.Resource("Siesta.Test.Element");a=this.normalizeElement(a);this.$(a).hasClass(b)?this.pass(c,{descTpl:d.get("elementHasClass")+" {cls}",cls:b}):this.fail(c,{assertionName:"hasCls",got:a.className,gotDesc:d.get("elementClasses"),need:b,
needDesc:d.get("needClass")})},hasNotCls:function(a,b,c){var d=Siesta.Resource("Siesta.Test.Element");a=this.normalizeElement(a);this.$(a).hasClass(b)?this.fail(c,{assertionName:"hasNotCls",got:a.className,gotDesc:d.get("elementClasses"),annotation:d.get("elementHasClass")+" ["+b+"]"}):this.pass(c,{descTpl:d.get("elementHasNoClass")+" {cls}",cls:b})},hasStyle:function(a,b,c,d){var e=Siesta.Resource("Siesta.Test.Element");a=this.normalizeElement(a);this.$(a).css(b)===c?this.pass(d,{descTpl:e.get("hasStyleDescTpl"),
...
isInView:function(a,b){if(this.elementIsInView(a)){var c=Siesta.Resource("Siesta.Test.Element");this.pass(b,{descTpl:c.get("isInViewPassTpl")})}else this.fail(b,{assertionName:"isInView"})},elementIsInView:function(a){a=this.normalizeElement(a);var b=!1,c=this.$(a).offset();if(c)var b=$(this.global).scrollTop(),d=b+$(this.global).height(),c=c.top,b=c+$(a).height()>=b&&c<=d;return b},waitUntilInView:function(a,b,c,d){var e=this,f=Siesta.Resource("Siesta.Test.Element");this.waitFor({method:function(){var b=
this.normalizeElement(a,!0);if(b&&e.elementIsInView(b))return b},callback:b,scope:c,timeout:d,assertionName:"waitUntilInView",description:a.toString+" "+f.get("toAppearInTheViewport")})},focus:function(a){var b=a.getAttribute("tabIndex");try{null==b&&a.setAttribute("tabIndex",-1),a.focus()}catch(c){}finally{null==b?a.removeAttribute("tabIndex"):a.setAttribute("tabIndex",b)}},elementIsEmpty:function(a,b){if((a=this.normalizeElement(a))&&this.isElementEmpty(a)){var c=Siesta.Resource("Siesta.Test.Element");
...
"alertMethodNotCalled"))},launch:function(){var a=this,b=this.global;if(!a.parent){a.realAlert=b.alert;a.realConfirm=b.confirm;a.realPrompt=b.prompt;a.realPrint=b.print;a.realOpen=b.open;if(!a.harness.browserWindowHasFocus()&&!$.browser.safari)a.onWindowBlur();b.focus&&b.focus()}a.previousConfirm=b.confirm;a.previousPrompt=b.prompt;b.alert=b.print=function(){};b.confirm=function(){var b="boolean"===typeof a.nextConfirmValue?a.nextConfirmValue:!0;a.nextConfirmValue=null;return b};b.prompt=function(){var b=
a.nextPromptReturnValue||"";a.nextPromptReturnValue=null;return b};b.open=function(c){var d=a.realOpen.apply(b,arguments);d?a.popups.push({url:c,popup:d}):a.fail(Siesta.Resource("Siesta.Test.Browser","popupsDisabled",{url:c}));return d};this.SUPERARG(arguments)},onTestFinalize:function(){var a=this.global;this.parent?(a.confirm=this.realConfirm,a.prompt=this.realPrompt,a.alert=a.print=function(){}):(a.confirm=this.previousConfirm,a.prompt=this.previousPrompt,a.print=this.realPrint,a.alert=this.realAlert,
a.open=this.realOpen);this.SUPERARG(arguments)},onWindowBlur:function(a,b){this.restartOnBlur?this.fireEvent("focuslost"):this.warn(Siesta.Resource("Siesta.Test.Browser").get("focusLostWarning",{url:this.url}))},$:function(){return $.rebindWindowContext(this.global).apply(this.global,arguments)},isEventPrevented:function(a){return"Boolean"==this.typeOf(a.$defaultPrevented)?a.$defaultPrevented:"Boolean"==this.typeOf(a.defaultPrevented)?a.defaultPrevented:!1===a.returnValue},cleanupContextBeforeStart:function(){this.cleanupContextBeforeStartDom();
this.SUPER()},cleanupContextBeforeStartDom:function(){this.global.document.body.innerHTML=""},getElementPageRect:function(a,b){b=b||this.$(a);var c=b.offset();return new Siesta.Util.Rect({left:c.left,top:c.top,width:b.outerWidth(),height:b.outerHeight()})},elementHasScroller:function(a,b){b=b||this.$(a);var c=a.scrollWidth!=a.clientWidth&&"visible"!=b.css("overflow-x"),d=a.scrollHeight!=a.clientHeight&&"visible"!=b.css("overflow-y");return c||d?{x:c,y:d}:!1},hasForcedIframe:function(){return Boolean((this.isDOMForced||
this.forceDOMVisible)&&this.scopeProvider instanceof Scope.Provider.IFrame&&this.scopeProvider.iframe)},elementIsScrolledOut:function(a,b){for(var c=this.$(a),d=[],e=c,f=this.global.document.body;e=e.parent(),e.length&&e[0]!=f;){var g=this.elementHasScroller(e[0],e);g&&d.unshift({hasScroller:g,$el:e})}g=this.$(f);e=g.offset();e=new Siesta.Util.Rect({left:e.left+g.scrollLeft(),top:e.top+g.scrollTop(),width:this.$(this.global).width(),height:this.$(this.global).height()});for(f=0;f<d.length;f++){var g=
d[f].hasScroller,k=d[f].$el;g&&g.x&&(e=e.cropLeftRight(this.getElementPageRect(k[0],k)));if(e.isEmpty())return!0;g&&g.y&&(e=e.cropTopBottom(this.getElementPageRect(k[0],k)));if(e.isEmpty())return!0}d=this.getElementPageRect(c[0],c);g=e.intersect(d);if(g.isEmpty())return!0;b=this.normalizeOffset(b,c);return!g.contains(d.left+b[0],d.top+b[1])},scrollTargetIntoView:function(a,b){if("Array"!=this.typeOf(a)){a=this.normalizeElement(a,!0,null,!1);var c=this.isOffsetInsideElementBox(a,b);if(a&&this.isElementVisible(a)&&
c&&this.elementIsScrolledOut(a,b))return a.scrollIntoView(),this.$(a).scrollintoview({duration:0}),!0}},processSubTestConfig:function(){var a=this.SUPERARG(arguments),b=this;Joose.A.each("currentPosition actionDelay afterActionDelay dragDelay moveCursorBetweenPoints dragPrecision overEls realAlert realConfirm realPrompt realPrint realOpen popups".split(" "),function(c){a[c]=b[c]});a.simulateEventsWith=b.getSimulateEventsWith();return a},normalizeElement:function(a,b,c,d){if(a&&a.nodeName)return a;
var e=!1;if("String"===this.typeOf(a)){c=a;var e=this.adjustScope(a),f=this.$(0<=a.indexOf("->")?a.split("->")[1]:a);e&&this.resetScope();a=f[0];e=1<f.length;if(!b&&!a)throw a=Siesta.Resource("Siesta.Test.Browser","noDomElementFound")+": "+c,this.warn(a),a;}"Array"==this.typeOf(a)&&(a=this.elementFromPoint(a[0],a[1]));return d?{el:a,matchingMultiple:e}:a},normalizeActionTarget:function(a,b){return this.normalizeElement(a,b)},getPathBetweenPoints:function(a,b){if("number"!==typeof a[0]||"number"!==
typeof a[1]||"number"!==typeof b[0]||"number"!==typeof b[1]||isNaN(a[0])||isNaN(a[1])||isNaN(b[0])||isNaN(b[1]))throw"Incorrect arguments passed to getPathBetweenPoints";var c=[],d=Math.floor(a[0]),e=Math.floor(b[0]),f=Math.floor(a[1]),g=Math.floor(b[1]),k=Math.abs(e-d),l=Math.abs(g-f),m,n,p,s;m=d<e?1:-1;n=f<g?1:-1;for(p=k-l;d!==e||f!==g;)s=2*p,s>-l&&(p-=l,d+=m),s<k&&(p+=k,f+=n),c.push([d,f]);d=c[c.length-1];0<c.length&&(d[0]!==b[0]||d[1]!==b[1])&&c.push(b.slice());return c},randomBetween:function(a,
b){return Math.floor(a+Math.random()*(b-a+1))},valueIsArray:function(a){return"Array"==this.typeOf(a)},elementFromPoint:function(a,b,c,d,e){var f=this.global.document,g=f.elementFromPoint(a,b);g||(g=f.elementFromPoint(a,b));g=g||d||f.body;d=a;f=b;if("IFRAME"==g.nodeName.toUpperCase()&&!c)try{var k=g.contentWindow.document,l=this.$(g).offset();d=a-l.left;var f=b-l.top,m=k.elementFromPoint(d,f);m||(m=k.elementFromPoint(d,f));m=m||k.body;"HTML"===m.nodeName.toUpperCase()&&(m=k.body);g=m}catch(n){d=a,
f=b}return e?{el:g,localXY:[d,f],globalXY:[a,b]}:g},activeElement:function(a,b,c){c=c?c.ownerDocument||c:this.global.document;var d=c.activeElement;if(!d||!d.nodeName||!d.tagName||d===c.body&&a)d=b;return $(d).is("iframe")&&d.contentDocument&&d.contentDocument.body?this.activeElement(a,b,d.contentDocument):d||c.body},getElementAtCursor:function(){var a=this.currentPosition;return this.elementFromPoint(a[0],a[1])},waitForEvent:function(a,b,c,d,e){var f=!1,g=Siesta.Resource("Siesta.Test.Browser");this.addListenerToObservable(a,
b,function(){f=!0});return this.waitFor({method:function(){return f},callback:c,scope:d,timeout:e,assertionName:"waitForEvent",description:" "+g.get("waitForEvent")+' "'+b+'" '+g.get("event")})},addListenerToObservable:function(a,b,c,d){this.$(a).bind(b,c)},removeListenerFromObservable:function(a,b,c){this.$(a).unbind(b,c)},firesOk:function(a,b,c,d,e,f,g){var k=this,l=k.getSourceLine(),m=Siesta.Resource("Siesta.Test.Browser"),n=arguments.length,p;if(1==n)p=a.observable,b=a.events,n=a.during,f=a.desc||
a.description,g=a.callback,d="Number"==this.typeOf(n)?n:null,e="Function"==this.typeOf(n)?n:null;else if(5<=n)p=a,"String"==this.typeOf(b)&&(n={},n[b]=c,b=n);else if(3>=n&&"Object"==this.typeOf(b))p=a,f=c;else if(4>=n&&"String"==this.typeOf(b))p=a,n={},n[b]=c,b=n,f=d,d=null;else throw Error(m.get("unrecognizedSignature"));var s={},q={};Joose.O.each(b,function(a,b){s[b]=0;var c=q[b]=function(){s[b]++};k.addListenerToObservable(p,b,c)});var t=function(){Joose.O.each(b,function(a,b){k.removeListenerFromObservable(p,
b,q[b]);var c=s[b];k.verifyExpectedNumber(c,a)?k.pass(f,{descTpl:m.get("observableFired")+" "+c+" `"+b+"` "+m.get("events")}):k.fail(f,{assertionName:"firesOk",sourceLine:l,descTpl:m.get("observableFiredOk")+" `"+b+"` "+m.get("events"),got:c,gotDesc:m.get("actualNbrEvents"),need:a,needDesc:m.get("expectedNbrEvents")})})};if(d){var v=this.beginAsync(d+100),n=this.originalSetTimeout;n(function(){k.endAsync(v);t();k.processCallbackFromTest(g)},d)}else if(e)e(),t(),k.processCallbackFromTest(g);else this.on("beforetestfinalizeearly",
t)},willFireNTimes:function(a,b,c,d,e){this.firesOk(a,b,e?">="+c:c,d)},getObjectWithExpectedEvents:function(a,b){var c={};"Array"==this.typeOf(a)?Joose.A.each(a,function(a){c[a]=b}):c[a]=b;return c},wontFire:function(a,b,c){this.firesOk({observable:a,events:this.getObjectWithExpectedEvents(b,0),desc:c})},firesOnce:function(a,b,c){this.firesOk({observable:a,events:this.getObjectWithExpectedEvents(b,1),desc:c})},isntFired:function(){this.wontFire.apply(this,arguments)},firesAtLeastNTimes:function(a,
b,c,d){this.firesOk(a,b,">="+c,d)},isFiredWithSignature:function(a,b,c,d){var e,f=this,g=f.getSourceLine(),k=Siesta.Resource("Siesta.Test.ExtJS.Observable"),l=function(){f.removeListenerFromObservable(a,b,m);e||f.fail(b+" "+k.get("isFiredWithSignatureNotFired"))};f.on("beforetestfinalizeearly",l);var m=function(){f.un("beforetestfinalizeearly",l);var n=c.apply(f,arguments);!e&&n&&f.pass(d||k.get("observableFired")+" "+b+" "+k.get("correctSignature"),{sourceLine:g});n||(f.fail(d||k.get("observableFired")+
" "+b+" "+k.get("incorrectSignature"),{sourceLine:g}),f.removeListenerFromObservable(a,b,m));e=!0};f.addListenerToObservable(a,b,m)},getNormalizedTopElementInfo:function(a,b,c,d){var e,f;a=a||this.currentPosition;var g="Array"==this.typeOf(a);g?(f=a,e=this.elementFromPoint(a[0],a[1],!1,null,!0),a=e.el,e=e.localXY):a=this.normalizeElement(a,b);if(a||!b){if(!g){var k=Siesta.Resource("Siesta.Test.Browser");c="getNormalizedTopElementInfo: "+(c?k.get("targetElementOfAction")+" ["+c+"]":k.get("targetElementOfSomeAction"))+
" "+k.get("isNotVisible")+": "+(a.id?"#"+a.id:a);if(this.isElementVisible(a))b||(!this.isOffsetInsideElementBox(a,d)||this.elementIsTop(a,!0,d))||this.warn(c);else{this.fail(c);return}}if(!g&&(b=a.ownerDocument,k=Siesta.Resource("Siesta.Test.Browser"),e=this.getTargetCoordinate(a,!0,d),f=this.getTargetCoordinate(a,!1,d),a=b.elementFromPoint(e[0],e[1])||b.elementFromPoint(e[0],e[1])||b.body,!a)){this.fail("getNormalizedTopElementInfo: "+k.get("noElementFound")+" ["+e+"]");return}return{el:a,localXY:e,
globalXY:f,offset:this.getOffsetRelativeToEl(a,e)}}},getOffsetRelativeToEl:function(a,b){var c=this.getElementPageRect(a);return[b[0]-c.left,b[1]-c.top]},waitForTextPresent:function(a,b,c,d){var e=Siesta.Resource("Siesta.Test.Browser");return this.waitFor({method:function(){var b=this.global.document.body,c=":contains("+a+")";return 0<this.$(c,b).length||this.$(b).is(c)},callback:b,scope:c,timeout:d,assertionName:"waitForTextPresent",description:" "+e.get("text")+' "'+a+'" '+e.get("toBePresent")})},
waitForTextNotPresent:function(a,b,c,d){var e=Siesta.Resource("Siesta.Test.Browser");return this.waitFor({method:function(){var b=this.global.document.body,c=":contains("+a+")";return 0===this.$(c,b).length&&!this.$(b).is(c)},callback:b,scope:c,timeout:d,assertionName:"waitForTextNotPresent",description:" "+e.get("text")+' "'+a+'" '+e.get("toNotBePresent")})},waitForTarget:function(a,b,c,d,e){var f=this,g=Siesta.Resource("Siesta.Test.Browser");return this.waitFor({method:function(){var b=f.normalizeElement(a,
!0,!0,!1,{offset:e});return b&&e&&f.isElementVisible(b)&&!f.isOffsetInsideElementBox(b,e)?!0:b&&f.elementIsTop(b,!0,e)},callback:b,scope:c,timeout:d,assertionName:"waitForTarget",description:" "+g.get("target")+' "'+a+'" '+g.get("toAppear")})},setWindowSize:function(a,b){this.scopeProvider.setViewportSize(a,b)},getJUnitClass:function(){var a=this.getBrowserInfo(),a=a.name+a.version;return a+":"+this.SUPER()},adjustScope:function(a){if("String"==this.typeOf(a)&&(a=a.split("->"),2===a.length)){a=this.$(this.trimString(a[0]))[0];
if(!a||!a.contentWindow)return!1;this._global=this.global;this.global=a.contentWindow;return!0}return!1},resetScope:function(){this.global=this._global||this.global;this._global=null},screenshot:function(a,b){this.diag("Command: `screenshot` skipped - not running in Standard Package");this.processCallbackFromTest(b,["skipped"],this)},screenshotElement:function(a,b,c){this.diag("Command: `screenshot` skipped - not running in Standard Package");this.processCallbackFromTest(c,["skipped"],this)},setUrl:function(a,
b,c){if(!a)throw"Must provide a valid URL";this.global.location.href!==a?(this.waitForPageLoad(b,c),this.global.location.href=a):b.call(c||this)},expectAlertMessage:function(a,b){var c=this,d=this.global,e=d.alert;d.alert=function(b){("RegExp"==c.typeOf(a)?a.test(b):a==b)?c.pass("Expected alert message has been shown"):c.fail("Wrong alert message has been shown",{assertionName:"expectAlertMessage",got:b,gotDesc:"Message shown",need:a,needDesc:"Expected message"});d.alert=e};d.alert.__EXPECTED_ALERT__=
!0;this.processCallbackFromTest(b,null,this)},setNextConfirmReturnValue:function(a,b){this.nextConfirmValue=a;this.processCallbackFromTest(b,null,this)},setNextPromptReturnValue:function(a,b){this.nextPromptReturnValue=a;this.processCallbackFromTest(b,null,this)},waitForAnimations:function(a){a.call(this)},popupHasStartedLoading:function(a,b){return"about:blank"!=String(b).toLowerCase()&&"about:blank"==a.location.href?!1:!0},switchTo:function(a,b){var c=this;this.waitFor({method:function(){for(var a=
0;a<c.popups.length;a++)if(!c.popupHasStartedLoading(c.popups[a].popup,c.popups[a].url))return!1;return!0},suppressAssertion:!0,callback:function(){var c;a||(Joose.A.each(this.popups,function(a){if(!a.popup.closed)return c=a.popup,!1}),a=c);"String"==this.typeOf(a)&&(a={title:a});if("Object"==this.typeOf(a)){c=null;var e=a.title||a.url;"String"==this.typeOf(e)&&(e=RegExp("^"+this.escapeRegExp(e)+"$"));Joose.A.each(this.popups,function(b){b=b.popup;if(!b.closed&&(a.url&&e.test(b.location.href)||a.title&&
e.test(b.document&&b.document.title||"")))return c=b,!1});a=c}a&&a.self==a?(this.global=a,this.waitFor({suppressAssertion:!0,method:function(){return a.document&&"complete"==a.document.readyState},callback:b})):(this.fail("Can't resolve target win: "+a),this.processCallbackFromTest(b,null,this))}});return this.global},switchToMain:function(a){this.switchTo(this.scopeProvider.scope,a)}}});
...
("function"==typeof g||d.isPrimitive(g))){var w;a:{for(var x=c+"."+f,y=0;y<k.length;y++)if(k[y].test(x)){w=!0;break a}w=!1}w||e.push(c+"."+f)}}}catch(C){}return e};c.waitFor(function(){return f.Ext&&f.Ext.isReady},function(){var b=c.global,k=[];d.iterate(d.ClassManager.classes,function(a){if(a.match(/^Ext\./)){var c=g(f,a),d=g(b,a);if(c&&"undefined"!==typeof d){var e=l(c,d,a);k.push.apply(k,e);d.prototype&&(a=l(c.prototype,d.prototype,a+".prototype"),k.push.apply(k,a))}}});c.globalExtOverrides=k;
...
Class("Siesta.Harness.Browser",{isa:Siesta.Harness,has:{id:null,testClass:Siesta.Test.Browser,viewportClass:"Siesta.Harness.Browser.UI.Viewport",viewport:null,autoRun:!1,viewDOM:!1,domContainerRegion:"east",speedRun:!0,breakOnFail:!1,debuggerOnFail:!1,contentManagerClass:Siesta.Content.Manager.Browser,scopeProvider:"Scope.Provider.IFrame",disableCaching:!1,baseUrl:window.location.href.replace(/\?.*$/,"").replace(/\/[^/]*$/,"/"),baseHost:window.location.host,baseProtocol:window.location.protocol,forceDOMVisible:$.browser.msie,
runInPopup:!1,pageUrl:null,useStrictMode:!0,innerHtmlHead:null,innerHtmlBody:null,sandbox:!0,sandboxBoundaryByGroup:!0,sandboxCleanup:!0,uniqueCounter:0,valueToHashIndicies:Joose.I.Object,sandboxHashStructure:{lazy:"this.buildSandboxHashStructure"},runCore:"parallel",forcedRunCore:null,simulateEventsWith:{is:"rw",init:"dispatchEvent"},testOfForcedIFrame:null,autoScrollElementsIntoView:!0,enableUnreachableClickWarning:!0,maintainViewportSize:!0,viewportWidth:1024,viewportHeight:768,recorderConfig:null,
needUI:!0,stateful:!0,uiMask:null,uiMaskActive:!1,hostPageUrlStopsInheriting:function(){return this.buildHostPageUrlStopsInheriting()},rerunHotKey:"E",restartOnBlur:!1,focusChecker:{lazy:function(){var a=document.createElement("input");a.setAttribute("style","position : absolute; left : -1000px; top : -1000px");a.type="text";document.body.appendChild(a);return a}}},after:{onBeforeScopePreload:function(a,b){if(this.viewport)this.viewport.onBeforeScopePreload(a,b)},onTestSuiteStart:function(a,b,c){if(this.viewport)this.viewport.onTestSuiteStart(a,
b)},onTestSuiteEnd:function(a,b){if(this.viewport)this.viewport.onTestSuiteEnd(a,b);delete this.testOfForcedIFrame;this.uiMaskActive&&this.hideUiMask()},onTestStart:function(a){if(this.viewport)this.viewport.onTestStart(a);a.hasForcedIframe()?(this.testOfForcedIFrame&&this.hideForcedIFrame(this.testOfForcedIFrame),this.showForcedIFrame(a),this.testOfForcedIFrame=a):this.uiMaskActive&&this.hideUiMask()},onTestUpdate:function(a,b,c){if(this.viewport)this.viewport.onTestUpdate(a,b,c);b instanceof Siesta.Result.Diagnostic&&
b.isWarning&&this.needUI&&"undefined"!=typeof console&&console.warn&&console.warn(b+"")},onTestEnd:function(a){a.hasForcedIframe()&&this.hideForcedIFrame(a);a==this.testOfForcedIFrame&&(this.testOfForcedIFrame=null);if(this.viewport)this.viewport.onTestEnd(a);if(a=a.scopeProvider.wrapper)a.scrollLeft=a.scrollTop=0;document.body.scrollLeft=document.body.scrollTop=0},onTestFail:function(a,b,c){if(this.viewport)this.viewport.onTestFail(a,b,c)}},methods:{buildHostPageUrlStopsInheriting:function(){return{preload:!0,
innerHtmlHead:!0,innerHtmlBody:!0}},buildSandboxHashStructure:function(){return"preload alsoPreload hostPageUrl pageUrl useStrictMode overrideSetTimeout".split(" ")},createViewport:function(a){return Ext.create("Siesta.Harness.Browser.UI.Viewport",a)},canShowCursorForTest:function(a){return a.scopeProvider instanceof Scope.Provider.IFrame?this.testOfForcedIFrame?this.testOfForcedIFrame.isFromTheSameGeneration(a):Boolean(a.scopeProvider.wrapper):!1},configure:function(){this.SUPERARG(arguments);this.id=
this.title||window.location.href},start:function(){$.browser.opera&&(this.autoCheckGlobals=!1);$.browser.msie&&"9.0"!==$.browser.version&&!this.hasOwnProperty("runCore")&&(this.runCore="sequential");this.SUPERARG(arguments)},populateCleanScopeGlobals:function(a,b){$.browser.msie&&9>Number(/^(\d+)/.exec($.browser.version)[1])?(this.disableGlobalsCheck=!0,b()):this.SUPER("Scope.Provider.IFrame",b)},onUnload:function(){Joose.O.each(this.scopesByURL,function(a,b){a.cleanup()})},setup:function(a){var b=
this,c=this.SUPER;window.onunload=function(){b.onUnload()};window.focus();$(function(){Siesta.Harness.Browser.FeatureSupport();var d=b.hasOwnProperty("needUI")||!b.isAutomated?b.needUI:!1;"undefined"!=typeof Ext&&d?(b.autoLaunchTests=!1,Ext.onReady(function(){c.call(b,function(){b.viewport=b.createViewport({title:b.title,harness:b});a&&a()})})):c.call(b,a)})},getDescriptorConfig:function(a,b,c){if(!(b in this.hostPageUrlStopsInheriting))return this.SUPERARG(arguments);var d=a.testConfig,d=d&&d.hasOwnProperty(b)||
a.hasOwnProperty(b),e=this.lookUpValueInDescriptorTree(a,b);if(Boolean(this.getDescriptorConfig(a,"pageUrl",!0))&&"inherit"!=e)return d?e:[];do{if((e=(d=a.testConfig)&&d.hasOwnProperty(b))||a.hasOwnProperty(b))if(d=e?d[b]:a[b],"inherit"!=d)return d;a=a.parent}while(a&&a!=this);return c?void 0:this[b]},normalizeScopeProvider:function(a){this.SUPERARG(arguments);this.getDescriptorConfig(a,"runInPopup")&&(a.scopeProvider="Scope.Provider.Window")},getScopeProviderConfigFor:function(a,b){var c=this,d=
this.SUPERARG(arguments);d.cleanupDelay=0;d.name=a.title||a.url.replace(/(.*\/)?(.*)/,"$2");d.cls="tr-iframe";d.performWrap=!0;var e=document.createElement("div");e.className="tr-iframe-wrapper";e.innerHTML="<div class='tr-close fa fa-close'>&nbsp;</div><div class='tr-iframe-wrapper-inner'></div>";e.childNodes[0].onclick=function(){var b=c.getTestByURL(a.url);if(b){if(c.hideForcedIFrame(b),c.viewport)c.viewport.onManualCloseOfForcedIframe(b)}else this.parentElement.style.left="-10000px",this.parentElement.style.top=
"-10000px"};d.wrapper=e;d.iframeParentEl=e.childNodes[1];d.sourceURL=d.sourceURL||this.getDescriptorConfig(a,"pageUrl");d.minViewportSize=d.minViewportSize||{width:this.getDescriptorConfig(a,"viewportWidth"),height:this.getDescriptorConfig(a,"viewportHeight")};d.innerHtmlHead=this.getDescriptorConfig(a,"innerHtmlHead");d.innerHtmlBody=this.getDescriptorConfig(a,"innerHtmlBody");d.hasOwnProperty("useStrictMode")||(d.useStrictMode=this.getDescriptorConfig(a,"useStrictMode"));return d},getNewTestConfiguration:function(a,
b,c,d){var e=this,f=this.SUPERARG(arguments);this.getDescriptorConfig(a,"speedRun")&&Joose.O.extend(f,{actionDelay:1,dragPrecision:20,dragDelay:10});this.hasOwnProperty("simulateEventsWith")&&(f.simulateEventsWith=this.simulateEventsWith);Joose.A.each(["forceDOMVisible","autoScrollElementsIntoView","enableUnreachableClickWarning","restartOnBlur"],function(b){f[b]=e.getDescriptorConfig(a,b)});return f},assignUniqueTag:function(a,b){if(null==a)return"";if(a===Object(a))return a.__UNIQUE__?a.__UNIQUE__:
a.__UNIQUE__=(this.uniqueCounter++).toString(36);a+="";var c=this.valueToHashIndicies[b];c||(c=this.valueToHashIndicies[b]={});return c[a]?c[a]:c[a]=(this.uniqueCounter++).toString(36)},calculateSharedContextGroupHash:function(a){var b=this,c=this.getSandboxHashStructure(),d="";Joose.A.each(c,function(c){d+=b.assignUniqueTag(b.getDescriptorConfig(a,c),c)});this.sandboxBoundaryByGroup&&(d+=this.assignUniqueTag(a.parent));return d},sortDescriptors:function(a,b,c){var d=this,e=[],f=[],g=[],k={};Joose.A.each(a,
function(a){if(d.getDescriptorConfig(a,"sandbox"))"sequential"==(b||d.getDescriptorConfig(a,"runCore"))||d.getDescriptorConfig(a,"forceDOMVisible")?f.push(c?a.id:a):e.push(c?a.id:a);else{var m=d.calculateSharedContextGroupHash(a),n=k[m];n||(n=k[m]={groupHash:m,items:[]},g.push(n));n.items.push(c?a.id:a)}});return{sharedContextGroups:g,mustRunSequential:f,canRunParallel:e}},runCoreGeneral:function(a,b,c,d){var e=this,f=this.sortDescriptors(a,this.forcedRunCore,!1);e.runCoreSharedContext(f.sharedContextGroups,
b,c,function(){e.runCoreParallel(f.canRunParallel,b,c,function(){e.runCoreSequential(f.mustRunSequential,b,c,d)})})},runCoreSharedContext:function(a,b,c,d){var e=this,f=function(d,l,m,n){if(d.length){var p=d.shift(),s=0<d.length;l?e.processURL(p,p.index,b,c,function(){f(d,!1,e.scopesByURL[p.url],p)},s):e.processUrlShared(p,p.index,b,c,function(){f(d,!1,m,n)},s,m,n)}else g(a)},g=function(a){a.length?(a=a.shift(),f(a.items,!0)):d()};g(a)},processUrlShared:function(a,b,c,d,e,f,g,k){function l(){if(g.scope){var b=
m.getDescriptorConfig(a,"testClass");"String"==m.typeOf(b)&&(b=Joose.S.strToClass(b));var l=m.getNewTestConfiguration(a,g,c,d);n.test=new b(l);m.launchTest({testHolder:n,desc:a,scopeProvider:g,contentManager:c,launchState:d,preloadErrors:p,onErrorHandler:s,startTestAnchor:g.scope.StartTest,noCleanup:f,cleanupUrl:k.url,reusingSandbox:!0},e)}else e()}var m=this;if(a.isMissing)e();else{var n={},p=[];b=this.getDescriptorConfig(a,"transparentEx");var s=function(a,b,c,d,e){(d=n.test)&&d.isStarted()?(d.nbrExceptions++,
d.failWithException(e||a+" "+b+" "+c)):p.push(a+" "+b+" "+c)};g.addOnErrorHandler(s,!b);a.testCode||this.cachePreload&&c.hasContentOf(a.url)?g.runCode(a.testCode||c.getContentOf(a.url),l):g.runScript(this.resolveURL(a.url,g,a),l)}},normalizeURL:function(a){/^jsan:/.test(a)&&(a="/jsan/"+a.replace(/^jsan:/,"").replace(/\./g,"/")+".js");/\.js$/.test(a)||(/\//.test(a)||/\.css(\?.*)?$/i.test(a))||(a="../lib/"+a.replace(/\./g,"/")+".js");return a},normalizeDescriptor:function(a,b,c,d){a=this.SUPERARG(arguments);
!a.group&&a.jasmine&&(a.pageUrl=a.url,a.testCode=this.getJasmineTestCode(),a.preload=[]);return a},resolveURL:function(a,b,c){b&&b.sourceURL&&(a=this.absolutizeURL(a));this.disableCaching&&(/\?./.test(a)?a+="&disableCaching="+(new Date).getTime():/\?$/.test(a)||(a+="?disableCaching="+(new Date).getTime()));return a},absolutizeURL:function(a,b){if(/^((https?|file):)?\/\//.test(a))return a;if(/^\//.test(a))return this.baseProtocol+"//"+this.baseHost+a;b=b||this.baseUrl;b=b.replace(/\?.*$/,"").replace(/\/[^/]*$/,
"/");var c=this.absolutizeURL(b,this.baseUrl),c=c.replace(/\/?$/,"/");return c+a},getUiMask:function(){if(this.uiMask)return this.uiMask;var a=this.uiMask=document.createElement("div");a.className="tr-ui-mask";a.style.display="none";document.body.appendChild(a);return a},showUiMask:function(){this.getUiMask().style.display="block";this.uiMaskActive=!0},hideUiMask:function(){this.getUiMask().style.display="none";this.uiMaskActive=!1},showForcedIFrame:function(a){$.rebindWindowContext(window);a.isDOMForced=
!0;var b=a.scopeProvider.wrapper;$(b).addClass("tr-iframe-forced");$(b).removeClass("tr-iframe-hidden");$(b).center();a.fireEvent("testframeshow")},hideForcedIFrame:function(a){$.rebindWindowContext(window);a.isDOMForced=!1;a.forceDOMVisible=!1;var b=a.scopeProvider.wrapper;$(b).removeClass("tr-iframe-forced");$(b).addClass("tr-iframe-hidden");a.fireEvent("testframehide")},showForcedIFrameScreenshot:function(a){this.showUiMask();$.rebindWindowContext(window);a=a.scopeProvider.wrapper;$(a).addClass("tr-iframe-forced-screenshot");
$(a).removeClass("tr-iframe-forced");$(a).removeClass("tr-iframe-hidden")},hideForcedIFrameScreenshot:function(a){this.hideUiMask();$.rebindWindowContext(window);var b=a.scopeProvider.wrapper;$(b).removeClass("tr-iframe-forced-screenshot");a.isDOMForced&&($(b).addClass("tr-iframe-forced"),$(b).center())},getQueryParam:function(a){return this.my.getQueryParam(a,!0)},getJasmineTestCode:function(){return";("+function(){StartTest(function(a){a.expectGlobals("getJasmineRequireObj","jasmineRequire","jasmine",
"xdescribe","describe","xdescribe","fdescribe","it","xit","fit","spyOn","fail","jsApiReporter","beforeEach","afterEach","beforeAll","afterAll","expect","pending");window.jasmine?jasmine.SiestaReporter?jasmine.SiestaReporter.importResults(a):a.fail(a.resource("Siesta.Harness.Browser","noJasmineSiestaReporter")):a.fail(a.resource("Siesta.Harness.Browser","noJasmine"))})}.toString()+")();"},isStandardPackage:function(){return this.my.isStandardPackage(!0)},browserWindowHasFocus:function(){window.focus();
var a=this.getFocusChecker();a.focus();$.rebindWindowContext(window);return $(a).is(":focus")}},my:{methods:{isStandardPackage:function(a){a||this.staticDeprecationWarning("isStandardPackage");return Boolean(Siesta.Harness.Browser.Automation)},getQueryParam:function(a,b){b||this.staticDeprecationWarning("getQueryParam");var c=RegExp("(?:\\?|&)"+a+"=(.*?)(?:\\?|&|$)","i").exec(window.location.search);return c?c[1]:null}}}});
...
isEventSupported:function(a,b){var c;if(!a)return!1;b&&"string"!==typeof b||(b=document.createElement(b||"div"));a="on"+a;c=a in b;c||(b.setAttribute||(b=document.createElement("div")),b.setAttribute(a,""),c="function"===typeof b[a],void 0!==b[a]&&(b[a]=void 0),b.removeAttribute(a));return c}}});
...
markFilteredNodes:function(a,b){var c=this,d=this.currentFilterGeneration,e={},f=this.getRootNode(),g=this.rootVisible,k=function(a){for(a=a.parentNode;a&&!e[a.internalId];)e[a.internalId]=!0,a=a.parentNode},l=b.filter,m=b.scope||this,n=b.shallow,p=b.checkParents||n,s=b.fullMatchingParents,q=b.onlyParents||s;if(q&&p)throw Error("Can't combine `onlyParents` and `checkParents` options");g&&(e[f.internalId]=!0);var t=function(a){if(!a.hidden){var b,c,d;if(a.data.leaf)l.call(m,a,e)&&(e[a.internalId]=
!0,k(a));else if(q){b=l.call(m,a);c=a.childNodes;d=c.length;if(b&&(e[a.internalId]=!0,k(a),s)){a.cascadeBy(function(a){e[a.internalId]=!0});return}for(a=0;a<d;a++)b&&c[a].data.leaf?e[c[a].internalId]=!0:c[a].data.leaf||t(c[a])}else if(p&&(b=l.call(m,a,e))&&(e[a.internalId]=!0,k(a)),!p||!n||n&&(b||a==f&&!g))for(c=a.childNodes,d=c.length,a=0;a<d;a++)t(c[a])}};t(a);f.cascadeBy(function(a){e[a.internalId]&&(a.__filterGen=d,c.allowExpandCollapseWhileFiltered&&!a.data.leaf&&a.expand())})},filterTreeBy:function(a,
...
1,t=!1;for(c=0;c<b.length;c++)if(!(b[c].hidden||l&&b[c].__filterGen!=m)&&k.call(this,b[c])){for(c=a;c.parentNode;){d=c;do d=d.nextSibling;while(d&&(d.hidden||l&&d.__filterGen!=m));if(d){t=!0;e=f.indexOf(d);break}else c=c.parentNode}t||(e=f.getCount());f.removeAt(g,e-g);break}return!1};this.callParent(arguments);g.contains=k},handleNodeExpand:function(a,b,c){for(var d=[],e=this.isTreeFiltered(),f=this.currentFilterGeneration,g=0;g<b.length;g++){var k=b[g];e&&k.__filterGen!=f||k.hidden||(d[d.length]=
...
bufferTime:30,resolveTarget:function(a){throw"resolveTarget API method must be provided by owner";},getIndicatorEl:function(){return this.boxIndicatorEl},getExt:function(){return this.window.Ext},start:function(a,b){a=a||this.window;if(!a)throw"Must provide a window context for the inspector";this.window=a;var c=this.getExt(),d=b||a.document.body;this.boxIndicatorEl=this.boxIndicatorEl||Ext.fly(d).createChild({cls:"target-inspector-box",children:{tag:"a",cls:"target-inspector-label",target:"_blank"}});
c&&c.getBody&&(this.toggleMouseMoveListener(!0),c.getBody().on("click",this.onInspectionClick,{me:this}));this.fireEvent("start",this);this.active=!0},stop:function(a){if(this.active){this.active=!1;var b=this.getExt();Ext.destroy(this.boxIndicatorEl);this.boxIndicatorEl=null;a||this.fireEvent("stop",this);b&&b.getBody&&(this.toggleMouseMoveListener(!1),b.getBody().un("click",this.onInspectionClick,{me:this}));this.inspectedComponent=this.inspectedComponentXType=null}},toggleMouseMoveListener:function(a){var b=
...
animCollapse:!1,padding:10,test:null,testListeners:null,maintainViewportSize:!0,canManageDOM:!0,suspendAfterLayoutAlign:!1,inspector:null,initComponent:function(){var a=this;this.testListeners=[];this.title=Siesta.Resource("Siesta.Harness.Browser.UI.DomContainer","title");Ext.apply(this,{dockedItems:this.consoleCt={xtype:"component",dock:"bottom",hidden:!0,height:20,cls:"domcontainer-console",renderTpl:'<div><input type="text" /></div>'}});this.callParent();this.on({afterlayout:this.onAfterLayout,
expand:this.onExpand,collapse:this.onCollapse,scope:this});this.inspector=new Siesta.Harness.Browser.UI.ComponentInspector({resolveTarget:function(b){return a.test.normalizeElement(b)}});this.inspector.on({start:this.onInspectionStart,stop:this.onInspectionStop,scope:this});this.relayEvents(this.inspector,["start","stop"],"inspection")},afterRender:function(){this.callParent(arguments);var a=this.consoleInput=this.el.down(".domcontainer-console input");this.inspector.on("targethover",function(b,c){a.dom.value=
'Ext.getCmp("'+c.id+'").'});this.inspector.on("targetselected",function(b,c){a.focus(!0)});a.on({keyup:function(b,c){var d=a.dom.value;if(b.getKey()===b.ENTER&&d){var e=this.getIFrame();try{var f=e.contentWindow.eval(d);window.console&&console.log(f)}catch(g){window.console&&console.log(g.message)}}},scope:this})},setCanManageDOM:function(a){(this.canManageDOM=a)&&!this.hidden&&this.alignIFrame()},getIFrameWrapper:function(a){var b=this.test;return b?(this.canManageDOM||a)&&b.scopeProvider&&b.scopeProvider.wrapper||
...
inspecting:!1,toggleInspectionMode:function(a){this.test&&(a?this.startInspection():this.stopInspection())},startInspection:function(a){if(this.test&&this.test.global){this.inspector.start(this.test.global,this.getIFrameWrapper());var b=Ext.get(this.getIFrameWrapper());b.un("mouseout",this.onMouseLeave,this);b.on("mouseout",this.onMouseLeave,this);!1!==a&&(this.consoleCt instanceof Ext.Component||(this.consoleCt=Ext.widget(this.consoleCt)),this.consoleCt.show());this.addCls("inspection-mode")}},stopInspection:function(){this.inspector.stop();
this.removeCls("inspection-mode");this.consoleCt.rendered&&this.consoleCt.hide()},onMouseLeave:function(a,b){this.el.contains(a.relatedTarget)||Ext.fly(this.getIFrameWrapper()).contains(a.relatedTarget)||this.stopInspection()},onInspectionStart:function(){var a=Ext.get(this.getIFrameWrapper());if(a)a.on("mouseout",this.onMouseLeave,this)},onInspectionStop:function(){var a=Ext.get(this.getIFrameWrapper());a&&a.un("mouseout",this.onMouseLeave,this)},clearHighlight:function(){this.stopInspection()},
highlightTarget:function(a,b){this.inspector.active||this.startInspection();this.inspector.highlightTarget(a,b)}}),Ext.define("Siesta.Harness.Browser.UI.MouseVisualizer",{cursorEl:null,onEventSimulatedListener:null,onTestFinishedListener:null,harness:null,currentTest:null,currentContainer:null,supportsTransitions:null,clickEvents:{click:0,dblclick:0,touchstart:0,touchend:0,mousedown:0,contextmenu:0},constructor:function(a){a=a||{};Ext.apply(this,a);this.supportsTransitions=Ext.feature&&Ext.feature.has.CssAnimations;
delete this.harness;this.setHarness(a.harness)},getCursorEl:function(){if(this.cursorEl)return this.cursorEl;var a=this.currentContainer;if(!a)throw"Need container for cursor";return this.cursorEl=Ext.fly(a).down(".ghost-cursor")||Ext.fly(a).createChild({tag:"div",cls:"ghost-cursor fa fa-mouse-pointer"})},setHarness:function(a){this.harness&&(this.harness.un("testframeshow",this.onTestFrameShow,this),this.harness.un("testframehide",this.onTestFrameHide,this));if(this.harness=a)a.on("testframeshow",
this.onTestFrameShow,this),a.on("testframehide",this.onTestFrameHide,this),a.on("recorderplay",this.onRecorderPlay,this)},reset:function(){this.onEventSimulatedListener&&(this.onEventSimulatedListener.remove(),this.onEventSimulatedListener=null);this.onTestFinishedListener&&(this.onTestFinishedListener.remove(),this.onTestFinishedListener=null);this.currentContainer=this.currentTest=this.cursorEl=null},onTestFrameShow:function(a){this.beginCursorVisusalization(a.source)},onRecorderPlay:function(a,
b){this.beginCursorVisusalization(b)},beginCursorVisusalization:function(a){a!=this.currentTest&&(this.reset(),this.currentTest=a,this.harness.canShowCursorForTest(a)&&(this.currentContainer=a.scopeProvider.wrapper.childNodes[1],this.onEventSimulatedListener=a.on("eventsimulated",this.onEventSimulated,this),this.onTestFinishedListener=a.on("testfinalize",this.onTestFinished,this)))},onTestFrameHide:function(a){this.cleanupCursor();this.reset()},cleanupCursor:function(a,b){a=a||this.cursorEl;if(b=
b||this.currentContainer){try{Ext.fly(a).remove()}catch(c){}try{Ext.select(".ghost-cursor-click-indicator-big",!1,b).remove()}catch(d){}}},onTestFinished:function(a,b){var c=this.cursorEl,d=this.currentContainer;this.reset();if(c){var e=this;c.addCls("ghost-cursor-hidden");setTimeout(function(){e.cleanupCursor(c,d)},2E3)}},onEventSimulated:function(a,b,c,d,e){d.match(/touch|mouse|click|contextmenu/)&&(Ext.isNumber(e.clientX)&&Ext.isNumber(e.clientY))&&this.currentContainer&&(a=b.currentPosition[0],
b=b.currentPosition[1],this.updateGhostCursor(d,a,b),this.supportsTransitions&&d in this.clickEvents&&this.showClickIndicator(d,a,b))},showClickIndicator:function(a,b,c){var d=Ext.fly(this.currentContainer).createChild({cls:"ghost-cursor-click-indicator ",style:"left:"+b+"px;top:"+c+"px"});setTimeout(function(){d.addCls("ghost-cursor-click-indicator-big")},20)},updateGhostCursor:function(a,b,c){var d=this.getCursorEl();b="translate3d("+b+"px, "+c+"px, 0px)";d.setStyle({"-webkit-transform":b,"-moz-transform":b,
"-o-transform":b,transform:b});switch(a){case "touchstart":case "mousedown":d.addCls("ghost-cursor-press");break;case "dblclick":d.addCls("ghost-cursor-press");Ext.Function.defer(d.removeCls,40,d,["ghost-cursor-press"]);break;case "touchend":case "mouseup":case "click":d.removeCls("ghost-cursor-press")}}}),Ext.define("Siesta.Harness.Browser.UI.AssertionGrid",{alias:"widget.assertiongrid",extend:"Ext.tree.Panel",mixins:["Siesta.Harness.Browser.UI.CanFillAssertionsStore"],cls:"siesta-assertion-grid",
enableColumnHide:!1,enableColumnMove:!1,enableColumnResize:!1,sortableColumns:!1,useArrows:!0,border:!1,minWidth:100,trackMouseOver:!1,autoScrollToBottom:!0,hideHeaders:!0,rowLines:!1,isStandalone:!1,rootVisible:!1,collapseDirection:"left",test:null,testListeners:null,viewType:"filterabletreeview",lines:!1,disableSelection:!0,bufferedRenderer:!1,initComponent:function(){this.testListeners=[];this.store||(this.store=new Siesta.Harness.Browser.Model.AssertionTreeStore({proxy:"memory",root:{id:"__ROOT__",
expanded:!0,loaded:!0}}));Ext.apply(this,{columns:[{xtype:"assertiontreecolumn"}],viewConfig:{enableTextSelection:!0,stripeRows:!1,markDirty:!1,animate:!1,trackOver:!1,store:new Ext.data.Store({fields:[],data:[]}),deferInitialRefresh:!1,getRowClass:this.getRowClass}});this.callParent(arguments);this.getView().on("itemadd",this.onMyItemAdd,this)},onMyItemAdd:function(a){!this.test.isFinished()&&this.autoScrollToBottom&&this.ensureVisible(a[0])},getRowClass:function(a,b,c,d){b=a.getResult();c="";switch(b.meta.name){case "Siesta.Result.Diagnostic":return"tr-diagnostic-row "+
(b.isWarning?"tr-warning-row":"");case "Siesta.Result.Summary":return"tr-summary-row "+(b.isFailed?" tr-summary-failure":"");case "Siesta.Result.SubTest":return c="tr-subtest-row tr-subtest-row-"+a.get("folderStatus"),"describe"==b.test.specType&&(c+=" tr-subtest-row-describe"),"it"==b.test.specType&&(c+=" tr-subtest-row-it"),c;case "Siesta.Result.Assertion":return c+="tr-assertion-row ",c=b.isWaitFor?c+("tr-waiting-row "+(b.completed?b.passed?"tr-waiting-row-passed":"tr-assertion-row-failed tr-waiting-row-failed":
"")):b.isException?c+(b.isTodo?"tr-exception-todo-row":"tr-exception-row"):b.isTodo?c+(b.passed?"tr-todo-row-passed":"tr-todo-row-failed"):c+(b.passed?"tr-assertion-row-passed":"tr-assertion-row-failed");default:throw"Unknown result class";}},showTest:function(a,b){this.test&&(Joose.A.each(this.testListeners,function(a){a.remove()}),this.testListeners=[]);this.test=a;this.testListeners=[].concat(this.isStandalone?[a.on("testupdate",this.onTestUpdate,this),a.on("testendbubbling",this.onEveryTestEnd,
this),a.on("assertiondiscard",this.onAssertionDiscarded,this)]:[]);Ext.suspendLayouts();b?this.reconfigure(b):this.store.removeAll();Ext.resumeLayouts()},onTestUpdate:function(a,b,c,d){this.processNewResult(this.store,b,c,d)},onEveryTestEnd:function(a,b){this.processEveryTestEnd(this.store,b)},onAssertionDiscarded:function(a,b,c){this.store.getNodeById(c.id).remove()},bindStore:function(a,b,c){this.callParent(arguments);(this.store=a)&&a.nodeStore&&(this.getView().dataSource=a.nodeStore,this.getView().bindStore(a,
b,c))},destroy:function(){Joose.A.each(this.testListeners,function(a){a.remove()});this.testListeners=[];this.test=null;this.callParent(arguments)},setInitializing:function(a){a?this.getView().addCls("siesta-test-initializing"):this.getView().removeCls("siesta-test-initializing")}}),Ext.define("Siesta.Harness.Browser.UI.AssertionTreeColumn",{extend:"Ext.tree.Column",alias:"widget.assertiontreecolumn",imgWithOffsetText:'<img src="{1}" class="{0}" style="left:{2}px" />',tdCls:"tr-tree-column",resultTpl:null,
dataIndex:"folderStatus",flex:1,menuDisabled:!0,sortable:!1,descriptionTpl:'<span class="assertion-text">{text}</span>',initComponent:function(){this.descriptionTpl=this.descriptionTpl instanceof Ext.XTemplate?this.descriptionTpl:new Ext.XTemplate(this.descriptionTpl);Ext.apply(this,{scope:this});this.callParent(arguments)},renderer:function(a,b,c,d,e,f){b="";b=c.data.result;a=b.annotation;if(b instanceof Siesta.Result.Summary)return c.data.result.description.join("<br>");b=this.descriptionTpl.apply({text:Ext.String.htmlEncode(b.isWarning?
"WARN: "+b.description:b.description)});a&&(b+='<pre title="'+a.replace(/"/g,"'")+'" style="margin-left:'+16*c.data.depth+'px" class="tr-assert-row-annontation">'+Ext.String.htmlEncode(a)+"</pre>");return b},treeRenderer:function(a,b,c){var d=c.getResult();d instanceof Siesta.Result.Assertion?c.data.iconCls=d.isWaitFor?d.completed?"fa-clock-o":"fa-spinner fa-spin":d.isException?"fa-flag":d.passed?"fa-check":"fa-bug":d instanceof Siesta.Result.SubTest&&("working"===c.get("folderStatus")?c.data.iconCls=
"fa-spinner fa-spin":c.data.iconCls="");return this.callParent(arguments)}}),Ext.define("Siesta.Harness.Browser.UI.TestNameColumn",{extend:"Ext.tree.Column",xtype:"testnamecolumn",sortable:!1,dataIndex:"title",menuDisabled:!0,flex:1,tdCls:"test-name-cell",scope:this,filterGroups:null,store:null,initComponent:function(){var a=Siesta.Resource("Siesta.Harness.Browser.UI.TestGrid");Ext.apply(this,{items:[{xtype:"treefilter",emptyText:a.get("filterTestsText"),margins:"0 0 0 10",itemId:"trigger",filterGroups:this.filterGroups,
filterField:"title",store:this.store,tipText:a.get("filterFieldTooltip")}]});this.callParent(arguments)},treeRenderer:function(a,b,c){b.tdCls="test-name-cell-"+(c.data.leaf?"leaf":"parent");if(c.isLeaf()){var d=c.get("test");d?c.get("isFailed")?c.data.iconCls="siesta-test-failed fa-flag":c.get("isRunning")&&!d.isFinished()?c.data.iconCls="fa-flash siesta-running-not-finished":d.isFinished()?d.isPassed()?c.data.iconCls="fa-check siesta-test-passed":c.data.iconCls="fa-bug siesta-test-failed":c.data.iconCls=
"fa-hourglass-o siesta-test-starting":c.get("isMissing")?c.data.iconCls="fa-close siesta-test-file-missing":c.get("isStarting")?c.data.iconCls="fa-hourglass-o siesta-test-starting":c.data.iconCls="fa-file-o siesta-test-file"}else d=c.get("folderStatus"),c.data.iconCls="working"==d?" fa-hourglass-o siesta-folder-running":"green"==d?" fa-check siesta-folder-pass":"red"==d?" fa-bug siesta-folder-fail":"";return this.callParent(arguments)},renderer:function(a,b,c){return a}}),Ext.define("Siesta.Harness.Browser.UI.TestGridController",
{extend:"Ext.app.ViewController",alias:"controller.testgrid",control:{"#":{collapse:"onCollapse",expand:"onExpand"},"#tool-menu [option]":{click:"onMenuItemClick"},"[actionName^=run]":{click:"onRunBtnClicked"},"[actionName=show-coverage]":{click:"onShowCoverageReport"},"#aboutSiesta":{click:"onAboutSiesta"}},onCollapse:function(){Ext.getBody().down(".logo-link").hide()},onExpand:function(){Ext.getBody().down(".logo-link").show()},onShowCoverageReport:function(){this.getView().fireEvent("showcoverageinfo",
...
border:!1,cls:"tr-testgrid",iconCls:"tr-status-neutral-small",width:340,collapsible:!0,expanded:!0,viewType:"filterabletreeview",enableColumnMove:!1,lines:!1,filter:null,filterGroups:!1,resultSummary:null,stateConfig:null,showSizeControls:!1,coverageReportButton:null,initComponent:function(){var a=this,b=Siesta.Resource("Siesta.Harness.Browser.UI.TestGrid"),c=this.stateConfig;Ext.apply(this,{title:b.get("title"),viewConfig:{enableTextSelection:!0,toggleOnDblClick:!1,markDirty:!1,trackOver:!1,getRowClass:function(a){if(a.get("descriptor").isSystemDescriptor)return"siesta-system-descriptor"},
shouldUpdateCell:function(a,b,c){return"passCount"===b.dataIndex&&c&&!Ext.Array.contains(c,"passCount")&&!Ext.Array.contains(c,"todoPassCount")||"failCount"===b.dataIndex&&c&&!Ext.Array.contains(c,"failCount")&&!Ext.Array.contains(c,"todoFailCount")?0:Ext.tree.View.prototype.shouldUpdateCell.apply(this,arguments)}},columns:{createFocusableContainerKeyNav:Ext.emptyFn,items:[{xtype:"testnamecolumn",store:this.store},{header:b.get("passText"),width:50,sortable:!1,tdCls:"x-unselectable",menuDisabled:!0,
dataIndex:"passCount",align:"center",renderer:this.passedColumnRenderer,scope:this},{header:b.get("failText"),width:50,sortable:!1,tdCls:"x-unselectable",menuDisabled:!0,dataIndex:"failCount",align:"center",renderer:this.failedColumnRenderer,scope:this}]},bbar:{xtype:"toolbar",cls:"main-bbar siesta-toolbar",border:!1,height:45,defaults:{scale:"large",width:30,tooltipType:"title"},items:[{glyph:61515,cls:"run-checked",text:'<span class="subicon fa-check"></span>',tooltip:b.get("runCheckedText"),actionName:"run-checked"},
...
a.layout.setActiveItem(this.slots.grid):a.layout.setActiveItem(this.recorderPanel)},afterRender:function(){this.callParent(arguments);this.testTitle=this.down("#resultpanel-testtitle");this.child("bordersplitter").tracker.tolerance=0}}),Ext.define("Siesta.Harness.Browser.UI.AboutWindow",{extend:"Ext.Window",id:"aboutwindow",bodyPadding:20,modal:!0,width:500,height:380,closeAction:"destroy",bodyStyle:"background: #fff",autoScroll:!0,initComponent:function(){this.title=Siesta.Resource("Siesta.Harness.Browser.UI.AboutWindow",
"titleText").replace("{VERSION}",Siesta.meta.VERSION||"1.0.0");this.html=Siesta.Resource("Siesta.Harness.Browser.UI.AboutWindow","bodyText");this.buttons={padding:"10 13",style:"background: transparent",items:[{hidden:!Siesta.Harness.Browser.Automation,text:Siesta.Resource("Siesta.Harness.Browser.UI.AboutWindow","upgradeText"),handler:function(){window.open("http://bryntum.com/store/siesta")}},{text:Siesta.Resource("Siesta.Harness.Browser.UI.AboutWindow","closeText"),handler:function(){this.up("window").close()}}]};
this.callParent(arguments)}}),Ext.define("Siesta.Harness.Browser.UI.VersionUpdateButton",{extend:"Ext.Button",xtype:"versionupdatebutton",text:Siesta.Resource("Siesta.Harness.Browser.UI.VersionUpdateButton","newUpdateText"),action:"upgrade-siesta",hidden:!0,latestVersion:null,scale:"medium",constructor:function(){this.callParent(arguments);this.scope=this;Siesta.meta.VERSION&&!window.location.href.match("^https")&&this.fetchVersionInfo()},fetchVersionInfo:function(){Ext.data.JsonP.request({url:"//bryntum.com/siesta_version",
params:{v:Siesta.meta.VERSION},scope:this,callback:this.onRequestCompleted})},onRequestCompleted:function(a,b){a&&(b&&b.name&&(new Ext.Version(b.name)).isGreaterThan(Siesta.meta.VERSION||"1.0.0"))&&(this.latestVersion=b.name,this.show())},handler:function(){var a=Siesta.Resource("Siesta.Harness.Browser.UI.VersionUpdateButton"),b=new Ext.Window({cls:"changelog-window",title:a.get("updateWindowTitleText")+(Siesta.meta.VERSION||"1.0.0"),bodyPadding:5,modal:!0,width:500,height:380,closeAction:"destroy",
plain:!0,autoScroll:!0,buttons:{padding:"10 13",style:"background: transparent",items:[{cls:"light-button",href:"http://www.bryntum.com/products/siesta/download-lite",hrefTarget:"_blank",scale:"medium",text:a.get("downloadText")+this.latestVersion+a.get("liteText")},{cls:"light-button",href:"http://bryntum.com/customerzone",hrefTarget:"_blank",scale:"medium",text:a.get("downloadText")+this.latestVersion+a.get("standardText")},{text:a.get("cancelText"),scale:"medium",handler:function(){b.close()}}]}});
b.show();b.body.mask(a.get("loadingChangelogText"));Ext.Ajax.request({useDefaultXhrHeader:!1,url:"http://bryntum.com/changelogs/_siesta.php",callback:function(a,d,e){b.body.unmask();d&&e&&e.responseText?b.body.update(e.responseText):b.body.update(Siesta.Resource("Siesta.Harness.Browser.UI.VersionUpdateButton","changelogLoadFailedText"))}})}}),Ext.define("Siesta.Harness.Browser.UI.Header",{extend:"Ext.Component",xtype:"siesta-header",cls:"siesta-header",afterRender:function(){var a=Siesta.Resource("Siesta.Harness.Browser.UI.Viewport");
this.callParent(arguments);this.getEl().createChild([{tag:"a",cls:"logo-link",href:"#",cn:[{tag:"span",html:Siesta.meta.VERSION||"1.0.0",cls:"tr-version-indicator"}]},{tag:"div",cls:"right-top-area",cn:[{tag:"a",id:"bryntum-logo",href:"http://bryntum.com/",target:"_blank",cls:"bryntum-logo"},{tag:"a",cls:"apidocs-link",href:a.get("apiLinkUrl"),target:"_blank",html:a.get("apiLinkText")}]},{tag:"div",id:"update-ct"}])}}),Ext.define("Siesta.Harness.Browser.UI.ViewportController",{extend:"Ext.app.ViewController",
alias:"controller.viewport",control:{testgrid:{selectionchange:"onTestGridSelectionChange",checkchange:"onTestGridCheckChange",itemcontextmenu:"onTestFileContextMenu",itemdblclick:"onTestFileDoubleClick",showcoverageinfo:"showCoverageReport",resize:"onTestGridResize",optionchange:"onTestGridOptionChange",buttonclick:"onTestGridToolbarClick",framesizechange:"onFrameSizeChange"},"testgridcontextmenu #uncheckOthers":{click:"uncheckOthers"},"testgridcontextmenu #runThis":{click:"runThisFile"},"testgridcontextmenu #uncheckAll":{click:"uncheckAll"},
"testgridcontextmenu #checkAll":{click:"checkAll"},"testgridcontextmenu #expandAll":{click:"expandAll"},"testgridcontextmenu #collapseAll":{click:"collapseAll"},"testgridcontextmenu #filterToCurrentGroup":{click:"filterToCurrentGroup"},"testgridcontextmenu #filterToFailed":{click:"filterToFailed"},"testgridcontextmenu #viewSource":{click:"viewSource"},resultpanel:{viewdomchange:"onDomPanelVisibilityChange",rerun:"rerunTest"},coveragereport:{backtomainui:"onCoverageReportBackToMainUI"}},filterToFailed:function(){var a=
this.getView(),b=[];a.forEachTestFile(function(a){var d=a.get("test");d&&d.isFailed()&&b.push(a.get("title"))});b.length&&a.slots.filesTree.setFilterValue(b.join(" | "))},filterToCurrentGroup:function(){var a=this.getView(),b=a.currentFile.get("descriptor");b.parent&&a.slots.filesTree.setFilterValue(b.parent.group+">")},onTestGridSelectionChange:function(a,b){if(b.length){var c=this.getView(),d=b[0],e=d.get("test");e&&c.slots.resultPanel.showTest(e,d.get("assertionsStore"));c.selectedURL=d.getId();
c.saveState()}},onTestGridCheckChange:function(a,b){this.getView().setNodeChecked(a,b)},onTestFileContextMenu:function(a,b,c,d,e){a=this.getView();a.currentFile=b;a.contextMenu||(a.contextMenu=new Siesta.Harness.Browser.UI.TestGridContextMenu);a.contextMenu.showAt(e.getXY());e.preventDefault()},onTestFileDoubleClick:function(a,b){var c=this.getView(),d=c.testsStore;if(d.isTreeFiltered()&&!b.isLeaf()){var e=[];b.cascadeBy(function(a){a!=b&&(a.isLeaf()&&d.isNodeFilteredIn(a))&&e.push(a.get("descriptor"))});
c.harness.launch(e)}else c.launchTest(b)},showCoverageReport:function(){var a=this.getView(),b=a.slots.resultPanel,c=b.slots.cardContainer,d=b.slots.coverageReport;d.loadHtmlReport(a.harness.generateCoverageHtmlReport(!1));if(c.getLayout().getActiveItem()!==d)b.hideIFrame(),b.slots.domContainer.collapse(),c.getLayout().setActiveItem(d);else this.onCoverageReportBackToMainUI()},onTestGridResize:function(){this.getView().slots.resultPanel.ensureLayout()},onTestGridOptionChange:function(a,b,c){a=this.getView();
a.setOption(b,c);a.saveState()},onTestGridToolbarClick:function(a,b,c){a=this.getView();switch(c){case "run-checked":a.runChecked();break;case "run-failed":a.runFailed();break;case "run-all":a.runAll();break;case "stop":a.stopSuite(b)}},onFrameSizeChange:function(a,b,c,d){a=this.getView();d||(d=b,b=c,c=d);$(".tr-iframe").width(b);$(".tr-iframe").height(c);a.harness.viewportHeight=c;a.harness.viewportWidth=b},uncheckOthers:function(){var a=this.getView(),b=a.currentFile;a.uncheckAllExcept(b);a.setNodeChecked(b,
!0)},runThisFile:function(){var a=this.getView();a.harness.launch([a.currentFile.get("descriptor")])},uncheckAll:function(){this.getView().uncheckAllExcept()},checkAll:function(){var a=this.getView();a.testsStore.forEach(function(b){a.setNodeChecked(b,!0,!0)})},expandAll:function(){this.getView().slots.filesTree.expandAll()},collapseAll:function(){this.getView().slots.filesTree.collapseAll()},viewSource:function(){var a=this.getView().currentFile,b=a.get("test"),c=window.open(null,"siesta-source"),
d=c.document.documentElement.getElementsByTagName("head")[0],e=c.document.body;d.innerHTML="<title>"+a.get("title")+"</title>";b?e.innerHTML="<pre>"+b.getSource()+"</pre>":$.ajax(a.get("url"),{success:function(a){e.innerHTML="<pre>"+a+"</pre>"}})},onDomPanelVisibilityChange:function(a,b){var c=this.getView();c.setOption("viewDOM",b);c.saveState()},rerunTest:function(){this.getView().rerunTest()},onCoverageReportBackToMainUI:function(){var a=this.getView().slots.resultPanel;a.slots.cardContainer.getLayout().setActiveItem(0);
a.alignIFrame()}}),Ext.supports&&(Ext.supports.TouchEvents&&!Ext.supports.Touch)&&(Ext.supports.Touch=!1,Ext.supports.touchScroll=!1),Ext.define("Siesta.Harness.Browser.UI.Viewport",{extend:"Ext.container.Viewport",mixins:["Siesta.Harness.Browser.UI.CanFillAssertionsStore"],controller:"viewport",requires:"Ext.state.LocalStorageProvider Ext.state.CookieProvider ExtX.Reference.Slot Siesta.Harness.Browser.UI.TestGrid Siesta.Harness.Browser.UI.ResultPanel Siesta.Harness.Browser.UI.MouseVisualizer Siesta.Harness.Browser.UI.Header".split(" "),
title:null,harness:null,stateful:!1,layout:"border",selection:null,selectedURL:null,filter:null,filterGroups:!1,testsStore:null,contextMenu:null,mouseVisualizer:null,enableVersionCheck:!0,collapsedNodes:null,headerXType:"siesta-header",showSizeControls:!1,expectedExtJSVersion:"6.0.1.250",viewportSizes:[[640,480],[800,600],[1024,768],[1920,1080],[2048,1536]],initComponent:function(){var a=this.harness;Ext.getBody().addCls("siesta");Ext.getBody().on("keydown",this.onBodyKeyDown,this);Ext.setGlyphFontFamily("FontAwesome");
