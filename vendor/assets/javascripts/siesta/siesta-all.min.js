...
!0;return(new b(a,c)).c},create:function(b,c,d){if(!b)return(new c(b,d)).c;var e=this;if(/^\./.test(b))return this.executeIn(a.top,function(){return e.create(b.replace(/^\./,""),c,d)});for(var f=d||{},g=a.S.saneSplit(b,"."),r=this.getCurrent(),u=r==a.top?[]:a.S.saneSplit(r.meta.name,"."),w=0;w<g.length;w++){var z=g[w],q=w==g.length-1;if("meta"==z||"my"==z||!z)throw"Module name ["+b+"] may not include a part called 'meta' or 'my' or empty part.";var x=r[z];u.push(z);var y=u.join("."),B=!1;if("undefined"==
typeof x)q?(x=this.earlyCreate(y,c,f),B=!0):x=(new a.Namespace.Keeper(y)).c,r[z]=x;else if(q&&x&&x.meta)if(r=x.meta,c==a.Namespace.Keeper)r.extend(f);else if(r instanceof a.Namespace.Keeper)r.plant(this.earlyCreate(y,c,f)),B=!0;else throw Error("Double declaration of ["+y+"]");else if(q&&!(x&&x.meta&&x.meta.meta))throw"Trying to setup module "+y+" failed. There is already something: "+x;q&&this.prepareMeta(x.meta);B&&x.meta.construct(f);r=x}return r},prepareMeta:function(){},prepareProperties:function(a,
...
Role("JooseX.Namespace.Depended.Transport.XHRAsync",{requires:["handleLoad"],override:{load:function(a,b,c){var d=new JooseX.SimpleRequest;try{d.getText(a,!0,function(d,e){d?b(e,a):c(this+" not found")})}catch(e){c(e)}}}});
...
Class("Scope.Provider",{has:{name:null,launchId:null,scope:null,seedingCode:null,seedingScript:null,preload:{is:"ro",init:Joose.I.Array},cleanupCallback:null,beforeCleanupCallback:null},methods:{isCSS:function(a){return/\.css(\?.*)?$/i.test(a)},isAlreadySetUp:function(){return Boolean(this.scope)},addPreload:function(a){if(this.isAlreadySetUp())throw Error("Can't use `addPreload` - scope is already setup. Use `runCode/runScript` instead");"string"==typeof a?a=this.isCSS(a)?{type:"css",url:a}:{type:"js",
...
else{var f=a.onerror;f&&f.__SP_MANAGED__||(a.onerror=function(b,e,l){if(!c.__CALLING__&&(c.__CALLING__=!0,f&&f.apply(this,arguments),c.apply(this,arguments),c.__CALLING__=!1,!1!==d))return a.WebKitPoint?!1:!0},a.onerror.__SP_MANAGED__=!0)}}},cachedOnError:null},override:{cleanup:function(){var a=this.cachedOnError;this.cachedOnError=null;try{var b=this.scope;b.ErrorEvent&&b.ErrorEvent.__SIESTA_HOOK_INSTALLED__&&b.removeEventListener("error",a);b.onerror=null}catch(c){}this.SUPERARG(arguments);this.scope=
null}},methods:{cleanupHanlders:function(){var a=this.parentWindow.Scope.Provider,b=this.scopeId;delete a.__ONLOAD__[b];delete a.__ONERROR__[b];delete a.__FAILED_PRELOAD__[b]},getHead:function(){return this.getDocument().getElementsByTagName("head")[0]},installOnErrorHandler:function(a){if(!this.isAlreadySetUp())throw"Scope should be already set up";this.attachToOnError(this.scope,this.scopeId,a,!1,this.failOnResourceLoadError)},addOnErrorHandler:function(a,b){a.__SP_MANAGED__=!0;this.cachedOnError=
a;var c=this.scopeId;this.parentWindow.Scope.Provider.__ONERROR__[c]=a;c=";("+this.attachToOnError.toString()+")(window, "+c+", (window.opener || window.parent).Scope.Provider.__ONERROR__[ "+c+" ], "+b+", "+this.failOnResourceLoadError+");";this.isAlreadySetUp()?this.runCode(c):this.getPreload().unshift({type:"js",content:c,unordered:!0})},addSeedingToPreload:function(){var a=this.getPreload();this.seedingCode&&a.unshift({type:"js",content:this.seedingCode});this.seedingScript&&a.push({type:"js",
url:this.seedingScript})},setup:function(a){var b="v"=="\v"||Boolean(this.parentWindow.msWriteProfilerMark),c=!1;Joose.A.each(this.getPreload(),function(a){if("js"==a.type&&a.content&&!a.unordered)return c=!0,!1});var d=this,e=function(){a&&a(d,d.parentWindow.Scope.Provider.__FAILED_PRELOAD__[d.scopeId])};this.parentWindow.Scope.Provider.__FAILED_PRELOAD__[this.scopeId]={};this.sourceURL||b&&c?(this.addSeedingToPreload(),this.setupIncrementally(e)):(b||this.addSeedingToPreload(),this.setupWithDocWrite(e,
b))},setupWithDocWrite:function(a,b){var c=[],d=this;Joose.A.each(this.getPreload(),function(a){if("js"==a.type)c.push(d.getScriptTagString(a.url,a.content));else if("css"==a.type)c.push(d.getLinkTagString(a.url,a.content));else throw"Incorrect preload descriptor "+a;});this.create();var e=this.scopeId;this.parentWindow.Scope.Provider.__ONLOAD__[e]=function(){var c=function(){a&&a()};b?(d.seedingCode&&d.runCode(d.seedingCode),d.seedingScript?d.runScript(d.seedingScript,c):c()):c()};var f=this.getDocument();
f.open();f.write([this.useStrictMode?"<!DOCTYPE html>":"",'<html style="width: 100%; height: 100%; margin : 0; padding : 0;"><head>',this.innerHtmlHead||"",c.join(""),"</head>",'<body style="margin : 0; padding : 0; width: 100%; height: 100%" onload="setTimeout(function () { (window.opener || window.parent).Scope.Provider.__ONLOAD__['+e+']() }, 0)">',this.innerHtmlBody||"","</body></html>"].join(""));f.close();d.cachedOnError&&d.installOnErrorHandler(d.cachedOnError)},setupIncrementally:function(a){var b=
this;this.create(function(){if(!b.sourceURL){var c=b.getDocument();if(b.innerHtmlHead){var d=b.getHead();try{d.innerHTML=b.innerHtmlHead}catch(e){var f=c.createElement("div");f.innerHTML=b.innerHtmlHead;for(var g=0;g<f.children.length;g++)d.appendChild(f.children[g])}}b.innerHtmlBody&&(c.body.innerHTML=b.innerHtmlBody)}var k=function(a,c){var d=function(){b.scope&&k(a,c)};if(a.length){var e=a.shift();e.url?b.runScript(e.url,d):"js"==e.type?b.runCode(e.content,d):(b.addStyleTag(e.content),d())}else c&&
c()};b.scope&&k(b.getPreload().slice(),a)})},getScriptTagString:function(a,b){var c='<script type="text/javascript"',d;d="(window.opener || window.parent).Scope.Provider.__FAILED_PRELOAD__[ scopeId ][ url ] = true".replace(/scopeId/,"'"+this.scopeId+"'").replace(/url/,"'"+a+"'");return c=a?c+(' src="'+a+'" onerror="'+d+'">\x3c/script>'):c+(">"+b.replace(/<\/script>/gi,"\\x3C/script>")+"\x3c/script>")},getLinkTagString:function(a,b){if(a)return'<link href="'+a+'" rel="stylesheet" type="text/css" />';
if(b)return"<style>"+b+"</style>"},loadCSS:function(a,b){var c=this.getDocument(),d=c.createElement("link");d.type="text/css";d.rel="stylesheet";d.href=a;this.getHead().appendChild(d);var e=!1,d=function(){e||(e=!0,clearTimeout(f),b&&b(),c.body.removeChild(g))},f=setTimeout(d,3E3),g=c.createElement("img");g.onerror=d;c.body.appendChild(g);g.src=a},runCode:function(a,b){this.getHead().appendChild(this.createScriptTag(a));b&&b()},runScript:function(a,b){var c=this.scopeId;this.isCSS(a)?this.loadCSS(a,
b):this.getHead().appendChild(this.createScriptTag(null,a,b,function(){this.onerror=null;var d=this.ownerDocument,d=d.defaultView||d.parentWindow;(d.opener||d.parent).Scope.Provider.__FAILED_PRELOAD__[c][a]=!0;b()}))},createScriptTag:function(a,b,c,d){var e=this.getDocument().createElement("script");e.setAttribute("type","text/javascript");b&&e.setAttribute("src",b);a&&(e.text=a);c&&(e.onload=e.onreadystatechange=function(){if(!e.readyState||"loaded"==e.readyState||"complete"==e.readyState||4==e.readyState&&
200==e.status)e.onload=e.onreadystatechange=null,"v"=="\v"?setTimeout(c,0):c()});d&&(e.onerror=d);return e},addStyleTag:function(a){var b=this.getDocument(),c=b.createElement("style");c.setAttribute("type","text/css");b.getElementsByTagName("head")[0].appendChild(c);c.styleSheet?c.styleSheet.cssText=a:c.appendChild(b.createTextNode(a))}}});
...
"Please enable popups for the host with this test suite running: "+this.parentWindow.location.host;"v"!="\v"&&!Boolean(this.parentWindow.msWriteProfilerMark)||this.sourceURL||(b=this.getDocument(),b.open(),b.write(""),b.close());this.cachedOnError&&this.installOnErrorHandler(this.cachedOnError);var d=function(a,b){var c=!1,d=!0,l=a.document,m=l.documentElement,n=l.addEventListener?"addEventListener":"attachEvent",p=l.addEventListener?"removeEventListener":"detachEvent",s=l.addEventListener?"":"on",
r=function(d){if("readystatechange"!=d.type||"complete"==l.readyState)("load"==d.type?a:l)[p](s+d.type,r,!1),!c&&(c=!0)&&b.call(a,d.type||d)},u=function(){try{m.doScroll("left")}catch(a){setTimeout(u,50);return}r("poll")};if("complete"==l.readyState)b.call(a,"lazy");else{if(l.createEventObject&&m.doScroll){try{d=!a.frameElement}catch(w){}d&&u()}l[n](s+"DOMContentLoaded",r,!1);l[n](s+"readystatechange",r,!1);a[n](s+"load",r,!1)}};this.sourceURL?setTimeout(function(){d(c,a||function(){})},10):d(c,a||
...
(function(){function a(a){return 10>a?"0"+a:a}function b(a){e.lastIndex=0;return e.test(a)?'"'+a.replace(e,function(a){var b=k[a];return"string"===typeof b?b:"\\u"+("0000"+a.charCodeAt(0).toString(16)).slice(-4)})+'"':'"'+a+'"'}function c(a,d){var e,k,r,u,w=f,z,q=d[a];q&&("object"===typeof q&&"function"===typeof q.toJSON)&&(q=q.toJSON(a));"function"===typeof l&&(q=l.call(d,a,q));switch(typeof q){case "string":return b(q);case "number":return isFinite(q)?String(q):"null";case "boolean":case "null":return String(q);
case "object":if(!q)return"null";f+=g;z=[];if("[object Array]"===Object.prototype.toString.apply(q)){u=q.length;for(e=0;e<u;e+=1)z[e]=c(e,q)||"null";r=0===z.length?"[]":f?"[\n"+f+z.join(",\n"+f)+"\n"+w+"]":"["+z.join(",")+"]";f=w;return r}if(l&&"object"===typeof l)for(u=l.length,e=0;e<u;e+=1)"string"===typeof l[e]&&(k=l[e],(r=c(k,q))&&z.push(b(k)+(f?": ":":")+r));else for(k in q)Object.prototype.hasOwnProperty.call(q,k)&&(r=c(k,q))&&z.push(b(k)+(f?": ":":")+r);r=0===z.length?"{}":f?"{\n"+f+z.join(",\n"+
...
b,c,!1,!0)):"Date"==d?!Boolean(a-b)&&(!c||this.compareObjects(a,b,c,!1,!0)):!1}}});Role("Siesta.Util.Role.CanEscapeRegExp",{methods:{escapeRegExp:function(a){return a.replace(/[\-\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g,"\\$&")}}});!function(){var a=1;Role("Siesta.Util.Role.HasUniqueGeneratedId",{has:{id:{is:"ro",init:function(){return a++}}}})}();
...
(a+="\n"+this.annotation);return a},toJSON:function(){var a=this,b={type:this.meta.name,passed:this.passed,index:this.index,description:String(this.description)||"No description"};this.annotation&&(b.annotation=String(this.annotation));Joose.A.each(["isTodo","isWaitFor","isException","sourceLine","name"],function(c){a[c]&&(b[c]=a[c])});this.isException&&(b.exceptionType=this.exceptionType);return b}}});
Class("Siesta.Result.SubTest",{isa:Siesta.Result,has:{test:null},methods:{isWorking:function(){return!this.test.isFinished()},toJSON:function(){var a=this.test,b=!(a instanceof Object),c={type:this.meta.name,name:a.name,startDate:a.startDate,endDate:a.endDate||new Date-0,passed:b?null:a.isPassed()};a.parent||(c.automationElementId=a.automationElementId,c.url=a.url,c.jUnitClass=a.getJUnitClass(),c.groups=a.groups);a.specType&&(c.bddSpecType=a.specType);var d=!1,e=[];Joose.A.each(this.children,function(a){if(a instanceof
Siesta.Result.Assertion||a instanceof Siesta.Result.Diagnostic||a instanceof Siesta.Result.SubTest)a=a.toJSON(),a.passed||a.isTodo||(d=!0),e.push(a)});c.assertions=e;b&&(c.passed=!(d||a.failed||!a.endDate));return c}}});
...
" "+(e?l.get("atLeast"):l.get("exactly"))+" "})});a=b[g];b[g]=function(){k++;return a.apply(this,arguments)}},isntCalled:function(a,b,c){this.isCalledNTimes(a,b,0,c)},getPropertyName:function(a,b){for(var c in a)if(a[c]===b)return c},methodIsCalledNTimes:function(a,b,c,d,e){var f=this,g=0,k=Siesta.Resource("Siesta.Test.Function");d=d?d+" ":"";try{"String"==f.typeOf(b)&&(b=f.global.eval(b))}catch(l){f.fail(d,{assertionName:"isMethodCalled",annotation:k.get("exceptionEvalutingClass").replace("{e}",
l)+"["+b+"]"});return}b=b.prototype;var m="string"===typeof a?a:f.getPropertyName(b,a);f.on("beforetestfinalizeearly",function(){g===c||e&&g>c?f.pass(d||m+" "+k.get("methodCalledExactly").replace("{n}",c)):f.fail(d||m,{assertionName:"methodIsCalledNTimes "+m,got:g,need:c,needDesc:k.get("Need")+" "+(e?k.get("atLeast"):k.get("exactly"))+" "})});a=b[m];b[m]=function(){g++;return a.apply(this,arguments)}},methodIsCalled:function(a,b,c){this.methodIsCalledNTimes(a,b,1,c,!0)},methodIsntCalled:function(a,
...
b,c,d,e,f){a.completed=!0;b?this.suppressPassedWaitForAssertion||f?this.fireEvent("assertiondiscard",this,a):this.pass(c,d,a):(this.fail(c,d,a),e&&e())},waitFor:function(a,b,c,d,e){var f=Siesta.Resource("Siesta.Test.More"),g=" "+f.get("conditionToBeFulfilled"),k="waitFor",l=this,m=l.getSourceLine(),n=l.originalSetTimeout,p=l.originalClearTimeout,s,r;if(1===arguments.length&&"Object"==this.typeOf(a)){var u=a;a=u.method;b=u.callback;c=u.scope;d=u.timeout;e=u.interval;g=u.description||g;k=u.assertionName||
k;r=u.suppressAssertion;s=u.errback}u="Number"==this.typeOf(a);b=b||function(){};var g=u?a+" "+f.get("ms"):g,w,z=l.startWaiting(f.get("waitingFor")+" "+g,m);e=e||this.waitForPollInterval;d=d||this.waitForTimeout;var q=this.beginAsync((u?a:d)+3*e,function(){x=!0;p(w);l.finalizeWaiting(z,!1,f.get("waitedTooLong")+": "+g,{assertionName:k,annotation:f.get("conditionNotFulfilled")+" "+d+f.get("ms")},s,r);return!0}),x=!1;this.on("beforetestfinalize",function(){x||(x=!0,l.finalizeWaiting(z,!1,f.get("waitingAborted"),
null,null,r),l.endAsync(q),p(w))},null,{single:!0});if(u){if(0>a)throw"Cannot wait for a negative amount of time";w=n(function(){x=!0;l.finalizeWaiting(z,!0,f.get("Waited")+" "+a+" "+f.get("ms"),null,null,r||0===a);l.endAsync(q);l.processCallbackFromTest(b,[],c||l)},a)}else{var y,B=new Date,A=function(){var m=new Date-B;if(m>d)l.endAsync(q),l.finalizeWaiting(z,!1,f.get("waitedTooLong")+": "+g,{assertionName:k,annotation:f.get("conditionNotFulfilled")+" "+d+f.get("ms")},s,r),x=!0;else{try{y=a.call(c||
l)}catch(p){l.endAsync(q);l.finalizeWaiting(z,!1,k+" "+f.get("checkerException"),{assertionName:k,got:p.toString(),gotDesc:f.get("Exception")},s,r);x=!0;return}null!=y&&!1!==y?(l.endAsync(q),x=!0,l.finalizeWaiting(z,!0,f.get("Waited")+" "+m+" "+f.get("msFor")+" "+g,null,null,r||0===m),l.processCallbackFromTest(b,[y],c||l)):w=n(A,e)}};A()}return{force:function(){x||(x=!0,p(w),l.endAsync(q),l.finalizeWaiting(z,!0,f.get("forcedWaitFinalization")+" "+g,null,null,r),l.processCallbackFromTest(b,[],c||l))}}},
...
deferClearer:this.originalClearTimeout,interval:f.hasOwnProperty("actionDelay")?f.actionDelay:this.actionDelay,observeTest:this});delete f.actionDelay;var k=e.getSourceLine(),l=[];Joose.A.each(a,function(a,c){var f=c==d-1;g.addAsyncStep({processor:function(d){var g=function(f){if(!f)var g=e.beginAsync((a.timeout||e.defaultTimeout)+100,function(){e.fail(b.get("chainStepNotCompleted"),{sourceLine:k,annotation:b.get("stepNumber")+": "+(c+1)+" "+b.get("oneBased")+(k?"\n"+b.get("atLine")+": "+k:""),ownTextOnly:!0});
return!0});return{next:function(){var p=arguments.callee;p.__CALLED__&&e.fail(b.get("calledMoreThanOnce",{num:c+1,line:k}));p.__CALLED__=!0;f||e.endAsync(g);l=Array.prototype.slice.call(arguments);a.desc&&e.pass(a.desc);d.next()},async:g}};if(a instanceof Siesta.Test)e.launchSubTest(a,g(!0).next);else if("Function"==e.typeOf(a)||"Function"==e.typeOf(a.action)){var u="Function"==e.typeOf(a)?a:a.action,g=g(!1);l.unshift(f?function(){}:g.next);f||e.analyzeChainStep(u)||e.fail(b.get("stepFn")+" ["+u.toString()+
"] "+b.get("notUsingNext"));if(e.transparentEx)u.apply(e,l);else{var w=e.getExceptionCatcher()(function(){u.apply(e,l)});void 0!==w&&e.fail(b.get("chainStepEx"),{annotation:e.stringifyException(w)})}f&&(e.endAsync(g.async),a.desc&&e.pass(a.desc))}else("String"==e.typeOf(a)?new Siesta.Test.Action.Eval({actionString:a,next:g(!1).next,test:e}):Siesta.Test.ActionRegistry().create(a,e,l,g)).process()}})});g.run()}},chainForArray:function(a,b,c,d){var e=this,f=[];Joose.A[d?"eachR":"each"](a,function(a,
c){var d=b.call(e,a,c);"Array"==e.typeOf(d)?f.push.apply(f,d):d&&f.push(d)});c&&f.push(function(){e.processCallbackFromTest(c)});this.chain(f)},verifyExpectedNumber:function(a,b){var c="==";if("String"==this.typeOf(b)){var d=/([<>=]=?)\s*(\d+)/.exec(b),c=Siesta.Resource("Siesta.Test.Browser");if(!d)throw Error(c.get("wrongFormat")+": "+b);c=d[1];b=Number(d[2])}switch(c){case "==":return a==b;case "<=":return a<=b;case ">=":return a>=b;case "<":return a<b;case ">":return a>b}},getMaximalTimeout:function(){return Math.max(this.waitForTimeout,
this.defaultTimeout,this.subTestTimeout,this.timeout||0,this.isReadyTimeout)}},after:{onBeforeTestFinalize:function(){!this.autoCheckGlobals||(this.isFailed()||this.parent)||this.verifyGlobals()}}});Role("Siesta.Test.Role.Placeholder",{requires:["equalsTo"]});
...
Class("Siesta.Test",{does:[Siesta.Util.Role.CanFormatStrings,Siesta.Util.Role.CanGetType,Siesta.Util.Role.CanCompareObjects,Siesta.Util.Role.CanEscapeRegExp,Siesta.Test.More,Siesta.Test.Date,Siesta.Test.Function,Siesta.Test.BDD,JooseX.Observable,Siesta.Util.Role.HasUniqueGeneratedId],has:{name:null,url:{required:!0},urlExtractRegex:{is:"rwc",lazy:function(){return RegExp(this.url.replace(/([.*+?^${}()|[\]\/\\])/g,"\\$1")+":(\\d+)")}},assertPlanned:null,assertCount:0,isTodo:!1,results:{lazy:function(){return new Siesta.Result.SubTest({description:this.name||
"Root",test:this})}},run:null,startTestAnchor:null,exceptionCatcher:null,testErrorClass:null,generation:function(){return Math.random()},launchId:null,parent:null,harness:null,isReadyTimeout:1E4,failed:!1,failedException:null,failedExceptionType:null,startDate:null,endDate:null,lastActivityDate:null,contentManager:null,scopeProvider:null,global:null,reusingSandbox:!1,sandboxCleanup:!0,scriptScopeProvider:null,transparentEx:!1,needDone:!1,isDone:!1,defaultTimeout:15E3,subTestTimeout:null,timeout:null,
timeoutsCount:function(){return{counter:1}},timeoutIds:Joose.I.Object,idsToIndex:Joose.I.Object,waitTitles:Joose.I.Object,processed:!1,finalizationStarted:!1,callback:null,nbrExceptions:0,testEndReported:!1,needToCleanup:!0,overrideSetTimeout:!1,overrideForSetTimeout:null,overrideForClearTimeout:null,originalSetTimeout:null,originalClearTimeout:null,sourceLineForAllAssertions:!1,$passCount:null,$failCount:null,actionableMethods:{lazy:"buildActionableMethods"},jUnitClass:null,groups:null,automationElementId:null,
enableCodeCoverage:!1,config:null},methods:{initialize:function(){this.on("teststart",function(a){this.parent&&a.stopPropagation()});this.on("testfinalize",function(a){this.parent&&a.stopPropagation()});this.on("beforetestfinalize",function(a){this.parent&&a.stopPropagation()});this.on("beforetestfinalizeearly",function(a){this.parent&&a.stopPropagation()});this.subTestTimeout=this.subTestTimeout||2*this.defaultTimeout;this.config&&Joose.O.extend(this,this.config)},isReady:function(){var a=Siesta.Resource("Siesta.Test");
this.run=this.run||this.getStartTestAnchor().args&&this.getStartTestAnchor().args[0];return{ready:"Function"==this.typeOf(this.run),reason:a.get("noCodeProvidedToTest")}},isFromTheSameGeneration:function(a){return this.generation==a.generation},toString:function(){return this.url},plan:function(a){if(null!=this.assertPlanned)throw Error("Test plan can't be changed");this.assertPlanned=a},addResult:function(a){var b=a instanceof Siesta.Result.Assertion;b&&(a.isTodo=this.isTodo);if(b&&((this.isDone||
this.isFinished())&&!a.isTodo)&&!this.testEndReported){this.testEndReported=!0;var c=Siesta.Resource("Siesta.Test");this.fail(c.get("addingAssertionsAfterDone"))}b&&!a.index&&(a.index=++this.assertCount);this.getResults().push(a);this.$passCount=this.$failCount=null;this.fireEvent("testupdate",this,a,this.getResults());this.lastActivityDate=new Date},diag:function(a,b){this.addResult(new Siesta.Result.Diagnostic({description:String(a||"")}));b&&b()},pass:function(a,b,c){b&&"String"!=this.typeOf(b)&&
(!a&&b.descTpl&&(a=this.formatString(b.descTpl,b)),b=b.annotation);c&&(c.passed=!0,c.description=String(a||""),c.annotation=b);this.addResult(c||new Siesta.Result.Assertion({passed:!0,annotation:String(b||""),description:String(a||""),sourceLine:c&&c.sourceLine||b&&b.sourceLine||this.sourceLineForAllAssertions&&this.getSourceLine()||null}))},fail:function(a,b,c){var d=c&&c.sourceLine||b&&b.sourceLine||this.getSourceLine(),e="";if(b&&"String"!=this.typeOf(b)){!a&&b.descTpl&&(a=this.formatString(b.descTpl,
b));var f=[],g=b,k=g.hasOwnProperty("got"),l=g.hasOwnProperty("need"),m=g.gotDesc||"Got",n=g.needDesc||"Need",e=g.assertionName;b=g.annotation;g.ownTextOnly||!e&&!d||f.push("Failed assertion "+(e?"`"+e+"` ":"")+this.formatSourceLine(d));if(k&&l)var p=Math.max(m.length,n.length),m=this.appendSpaces(m,p-m.length+1),n=this.appendSpaces(n,p-n.length+1);k&&f.push(m+": "+Siesta.Util.Serializer.stringify(g.got));l&&f.push(n+": "+Siesta.Util.Serializer.stringify(g.need));b&&f.push(b);b=f.join("\n")}c&&(c.name=
e,c.passed=!1,c.annotation=b,c.description=a);this.addResult(c||new Siesta.Result.Assertion({name:e,passed:!1,sourceLine:d,annotation:String(b||""),description:String(a||"")}));if(!this.isTodo&&(this.harness.debuggerOnFail&&eval("debugger"),this.harness.breakOnFail))throw a=Siesta.Resource("Siesta.Test"),this.finalize(!0),a.get("testFailedAndAborted");},exit:function(a,b){0<arguments.length&&this.fail(a,b);this.finalize(!0);throw"__SIESTA_TEST_EXIT_EXCEPTION__";},getSource:function(){return this.contentManager.getContentOf(this.url)},
getSourceLine:function(){try{throw Error();}catch(a){if(a.stack){var b=a.stack.match(this.urlExtractRegex());if(b)return b[1]}return null}},getStartTestAnchor:function(){return this.startTestAnchor},getExceptionCatcher:function(){return this.exceptionCatcher},getTestErrorClass:function(){return this.testErrorClass},processCallbackFromTest:function(a,b,c){var d=this;if(!a)return!0;if(this.transparentEx)a.apply(c||this.global,b||[]);else{var e=this.getExceptionCatcher()(function(){a.apply(c||d.global,
b||[])});if(e)return this.failWithException(e),!1}return!0},getStackTrace:function(a){if(Object(a)!==a||!a.stack)return null;var b=(a.stack+"").split("\n");a+="";for(var c=Siesta.Resource("Siesta.Test"),d=[],e,f=0;f<b.length;f++)if(e=b[f]){if(!f)if(e!=a)d.push(a);else{d.push(e);continue}e=/@(.*?):(\d+):(\d+)$/.exec(e)||/\((.*?):(\d+):(\d+)\)$/.exec(e)||/at (.*?):(\d+):(\d+)$/.exec(e)||/(.*?):(\d+):(\d+)$/.exec(e);if(!e)return null;d.push("    "+c.get("atLine")+" "+e[2]+(e[3]?", "+c.get("character")+
" "+e[3]:"")+", "+c.get("of")+" "+e[1])}return d.length?d:null},formatSourceLine:function(a){var b=Siesta.Resource("Siesta.Test");return a?b.get("atLine")+" "+a+" "+b.get("of")+" "+this.url:""},appendSpaces:function(a,b){for(var c="";b--;)c+=" ";return a+c},eachAssertion:function(a,b){b=b||this;this.getResults().each(function(c){c instanceof Siesta.Result.Assertion&&a.call(b,c)})},eachSubTest:function(a,b){b=b||this;this.getResults().each(function(c){if(c instanceof Siesta.Result.SubTest&&!1===a.call(b,
c.test))return!1})},eachChildTest:function(a,b){b=b||this;this.getResults().eachChild(function(c){if(c instanceof Siesta.Result.SubTest&&!1===a.call(b,c.test))return!1})},ok:function(a,b){var c=Siesta.Resource("Siesta.Test");a?this.pass(b,{descTpl:c.get("isTruthy"),value:a}):this.fail(b,{assertionName:"ok",got:a,annotation:c.get("needTruthy")})},notok:function(){this.notOk.apply(this,arguments)},notOk:function(a,b){var c=Siesta.Resource("Siesta.Test");a?this.fail(b,{assertionName:"notOk",got:a,annotation:c.get("needFalsy")}):
this.pass(b,{descTpl:c.get("isFalsy"),value:a})},is:function(a,b,c){var d=Siesta.Resource("Siesta.Test");b&&a instanceof this.global.Date?this.isDateEqual(a,b,c):this.compareObjects(a,b,!1,!0)?this.pass(c,{descTpl:d.get("isEqualTo"),got:a,expected:b}):this.fail(c,{assertionName:"is",got:a,need:b})},isnot:function(){this.isNot.apply(this,arguments)},isnt:function(){this.isNot.apply(this,arguments)},isNot:function(a,b,c){var d=Siesta.Resource("Siesta.Test");this.compareObjects(a,b,!1,!0)?this.fail(c,
{assertionName:"isnt",got:a,need:b,needDesc:d.get("needNot")}):this.pass(c,{descTpl:d.get("isNotEqualTo"),got:a,expected:b})},isStrict:function(a,b,c){var d=Siesta.Resource("Siesta.Test");this.compareObjects(a,b,!0,!0)?this.pass(c,{descTpl:d.get("isStrictlyEqual"),got:a,expected:b}):this.fail(c,{assertionName:"isStrict",got:a,need:b,needDesc:d.get("needStrictly")})},isntStrict:function(){this.isNotStrict.apply(this,arguments)},isNotStrict:function(a,b,c){var d=Siesta.Resource("Siesta.Test");this.compareObjects(a,
b,!0,!0)?this.fail(c,{assertionName:"isntStrict",got:a,need:b,needDesc:d.get("needStrictlyNot")}):this.pass(c,{descTpl:d.get("isStrictlyNotEqual"),got:a,expected:b})},wait:function(a,b){var c=Siesta.Resource("Siesta.Test");if(this.waitTitles.hasOwnProperty(a))throw Error(c.get("alreadyWaiting")+" ["+a+"]");return this.waitTitles[a]=this.beginAsync(b)},endWait:function(a){var b=Siesta.Resource("Siesta.Test");if(!this.waitTitles.hasOwnProperty(a))throw Error(b.get("noOngoingWait")+" ["+a+"]");this.endAsync(this.waitTitles[a]);
delete this.waitTitles[a]},beginAsync:function(a,b){a=a||this.defaultTimeout;a>this.getMaximalTimeout()&&this.fireEvent("maxtimeoutchanged",a);var c=Siesta.Resource("Siesta.Test"),d=this,e=this.originalSetTimeout,f=this.timeoutsCount.counter++,e=e(function(){d.hasAsyncFrame(f)&&(b&&b.call(d,d)||d.fail(c.get("noMatchingEndAsync")+" "+a+" "+Siesta.Resource("Siesta.Test.More","ms")),d.endAsync(f))},a);this.timeoutIds[f]=e;return f},timeoutIdToIndex:function(a){return"object"==typeof a?a.__index:this.idsToIndex[a]},
hasAsyncFrame:function(a){return this.timeoutIds.hasOwnProperty(a)},hasAsyncFrameByTimeoutId:function(a){return this.timeoutIds.hasOwnProperty(this.timeoutIdToIndex(a))},endAsync:function(a){var b=this.originalSetTimeout,c=this.originalClearTimeout||this.global.clearTimeout,d=0,e=Siesta.Resource("Siesta.Test");null==a&&Joose.O.each(this.timeoutIds,function(b,c){a=c;if(d++)throw Error(e.get("endAsyncMisuse"));});c(this.timeoutIds[a]);delete this.timeoutIds[a];var f=this;this.processed&&!this.isFinished()&&
b(function(){f.finalize()},1)},clearTimeouts:function(){var a=this.originalClearTimeout;Joose.O.each(this.timeoutIds,function(b,c){a(b)});this.timeoutIds={}},processSubTestConfig:function(a){return Joose.O.extend({trait:Siesta.Test.Sub,parent:this,isTodo:this.isTodo,transparentEx:this.transparentEx,waitForTimeout:this.waitForTimeout,waitForPollInterval:this.waitForPollInterval,defaultTimeout:this.defaultTimeout,timeout:this.subTestTimeout,subTestTimeout:this.subTestTimeout,global:this.global,url:this.url,
scopeProvider:this.scopeProvider,harness:this.harness,generation:this.generation,launchId:this.launchId,overrideSetTimeout:this.overrideSetTimeout,originalSetTimeout:this.originalSetTimeout,originalClearTimeout:this.originalClearTimeout,timeoutsCount:this.timeoutsCount,autoCheckGlobals:!1,needToCleanup:!1},a)},getSubTest:function(a,b,c){var d,e=Siesta.Resource("Siesta.Test");2==arguments.length||3==arguments.length?d={name:a,run:b,timeout:c}:1==arguments.length&&"Function"==this.typeOf(a)&&(d={name:"Sub test",
...
isTodo:!0,transparentEx:!1});this.launchSubTest(a,c)},snooze:function(a,b,c){var d=Siesta.Resource("Siesta.Test");new Date>new Date(a)?b.call(this.global,this):this.todo(d.get("Snoozed until")+" "+new Date(a)+": "+(c||""),b)},subTest:function(a,b,c,d){a=this.getSubTest({name:a||Siesta.Resource("Siesta.Test","Subtest"),timeout:d,run:b});this.launchSubTest(a,c);return a},stringifyException:function(a,b){var c=a+"",d=(b||this.getStackTrace(a)||[]).join("\n");-1==d.indexOf(c)&&(d=c+d);return d},failWithException:function(a,
b){var c=Siesta.Resource("Siesta.Test");this.failed=!0;this.failedException=a+"";this.failedExceptionType=this.typeOf(a);var d=this.getStackTrace(a);this.addResult(new Siesta.Result.Assertion({isException:!0,exceptionType:this.failedExceptionType,passed:!1,description:b?b:(this.parent?c.get("Subtest")+" `"+this.name+"`":c.get("Test")+" ")+" "+c.get("threwException"),annotation:this.stringifyException(a,d)}));this.fireEvent("testfailedwithexception",this,a,d);this.finalize(!0)},restoreTimeoutOverrides:function(){this.overrideSetTimeout&&
(this.global.setTimeout=this.overrideForSetTimeout,this.global.clearTimeout=this.overrideForClearTimeout)},start:function(a){var b=this,c=Siesta.Resource("Siesta.Test");if(this.startDate)throw c.get("testAlreadyStarted");this.startDate=new Date-0;this.fireEvent("teststart",this);if(a&&a.length)return Joose.A.each(a,function(a){if(a.isException)return b.failWithException(a.message),!1;b.fail(a.message)}),b.finalize(!0),!0;if(this.parent||this.reusingSandbox)this.launch();else{var d,e=function(a){var d=
!1,e=setTimeout(function(){d=!0;b.launch(c.get("setupTookTooLong"))},b.isReadyTimeout);b.setup(function(){d||(clearTimeout(e),b.launch(a))},function(c){d||(clearTimeout(e),b.launch(a||c))})},f=b.isReady();if(f.ready)e();else var g=setTimeout(function(){clearInterval(k);e(d)},b.isReadyTimeout),k=setInterval(function(){f=b.isReady();f.ready?(clearInterval(k),clearTimeout(g),e()):d=f.reason||d},100)}},setup:function(a,b){a.call(this)},tearDown:function(a,b){a.call(this)},earlySetup:function(a,b){a.call(this)},
cleanupContextBeforeStart:function(){var a=this.global;this.forEachUnexpectedGlobal(function(b){try{delete a[b]}catch(c){}})},clearAsyncFrameGlobally:function(a){for(var b=this;b.parent;)b=b.parent;b.eachSubTest(function(b){if(b.hasAsyncFrameByTimeoutId(a))return b.overrideForClearTimeout(a),!1})},launch:function(a){if(a){var b=Siesta.Resource("Siesta.Test");this.fail(b.get("errorBeforeTestStarted"),{annotation:a})}var c=this,d=this.global;a=this.scopeProvider;var e=this.originalSetTimeout,f=this.originalClearTimeout;
this.overrideSetTimeout&&(this.reusingSandbox||a.runCode("var setTimeout, clearTimeout;"),d.setTimeout=this.overrideForSetTimeout=function(a,b){var d=c.timeoutsCount.counter++,g=e(function(){f(g);delete c.timeoutIds[d];c.processed&&!c.isFinished()&&e(function(){c.finalize()},1);a()},b);"object"==typeof g?g.__index=d:c.idsToIndex[g]=d;return c.timeoutIds[d]=g},d.clearTimeout=this.overrideForClearTimeout=function(a){null!=a&&(c.hasAsyncFrameByTimeoutId(a)?(f(a),a=c.timeoutIdToIndex(a),null!=a&&delete c.timeoutIds[a],
c.processed&&!c.isFinished()&&e(function(){c.finalize()},1)):c.clearAsyncFrameGlobally(a))});this.needToCleanup&&(a.beforeCleanupCallback=function(){c.isFinished()||c.finalize(!0);c.overrideSetTimeout&&(d.setTimeout=e,d.clearTimeout=f);d=e=f=null;c.eachSubTest(function(a){a.cleanup()})});this.reusingSandbox&&(this.sandboxCleanup&&!this.parent)&&this.cleanupContextBeforeStart();var g=this.run;if(this.transparentEx)g(c);else var k=this.getExceptionCatcher()(function(){g(c)});this.afterLaunch(k)},cleanup:function(){this.scopeProvider=
this.startTestAnchor=this.exceptionCatcher=this.testErrorClass=this.global=this.run=this.originalSetTimeout=this.originalClearTimeout=this.overrideForSetTimeout=this.overrideForClearTimeout=null;this.purgeListeners()},afterLaunch:function(a){a?this.failWithException(a):this.finalize()},finalize:function(a){var b=this,c=Siesta.Resource("Siesta.Test");if(!b.finalizationStarted&&!b.isFinished())if(b.processed=!0,a&&(b.clearTimeouts(),b.eachChildTest(function(a){a.finalize(!0)})),!Joose.O.isEmpty(b.timeoutIds))!b.__timeoutWarning&&
(b.overrideSetTimeout&&b.lastActivityDate&&new Date-b.lastActivityDate>2*b.defaultTimeout)&&(b.diag(c.get("testStillRunning")),b.warn(c.get("testNotFinalized").replace("{url}",b.url)),b.__timeoutWarning=!0);else if(b.isDone||!1!==b.doDone(a)){b.finalizationStarted=!0;var d=function(a){a&&b.fail(a);b.endDate=new Date-0;b.parent||b.addResult(new Siesta.Result.Summary({isFailed:b.isFailed(),description:b.getSummaryMessage()}));b.onTestFinalize();b.fireEvent("testfinalize",b);b.fireEvent("testendbubbling",
b);b.callback&&b.callback();b.callback=null};if(b.parent||b.reusingSandbox)d();else{a=b.originalSetTimeout;var e=b.originalClearTimeout,f=!1,g=a(function(){f=!0;d(c.get("testTearDownTimeout"))},b.isReadyTimeout);b.tearDown(function(){e(g);f||d()},function(a){e(g);f||d(a)})}}},onBeforeTestFinalize:function(){},onTestFinalize:function(){},getSummaryMessage:function(a){var b=[],c=this.getPassCount(),d=this.getFailCount(),e=this.assertPlanned,f=d+c;b.push("Passed: "+c);b.push("Failed: "+d);this.failed||
(null!=e?(f<e&&b.push("Looks like you planned "+e+" tests, but ran only "+f),f>e&&b.push("Looks like you planned "+e+" tests, but ran "+(f-e)+" extra tests, "+f+" total."),f!=e||d||b.push("All tests passed")):(c=Siesta.Resource("Siesta.Test"),this.isDoneCorrectly()||b.push(c.get("missingDoneCall")),this.isDoneCorrectly()&&!d&&b.push(c.get("allTestsPassed"))));return a?b.join(a):b},done:function(a){var b=this;if(a){var c=this.beginAsync(),d=this.originalSetTimeout;d(function(){b.endAsync(c);b.done()},
a)}else this.doDone(!1),this.processed&&this.finalize()},doDone:function(a){this.fireEvent("beforetestfinalizeearly",this);if(!Joose.O.isEmpty(this.timeoutIds))if(a)this.clearTimeouts();else return!1;this.onBeforeTestFinalize();this.fireEvent("beforetestfinalize",this);this.isDone=!0},isDoneCorrectly:function(){return!this.needDone||this.isDone},getAssertionCount:function(a){var b=0;this.eachAssertion(function(c){a&&c.isTodo||b++});return b},getPassCount:function(a){if(null!=this.$passCount&&!a)return this.$passCount;
var b=0;this.eachAssertion(function(c){!c.passed||!a&&c.isTodo||b++});return a?b:this.$passCount=b},getTodoPassCount:function(){var a=0;this.eachAssertion(function(b){b.isTodo&&b.passed&&a++});return a},getTodoFailCount:function(){var a=0;this.eachAssertion(function(b){b.isTodo&&!b.passed&&a++});return a},getFailCount:function(a){if(null!=this.$failCount&&!a)return this.$failCount;var b=0;this.eachAssertion(function(c){c.passed||!a&&c.isTodo||b++});return a?b:this.$failCount=b},getFailedAssertions:function(){var a=
[];this.eachAssertion(function(b){b.isPassed()||a.push(b)});return a},isPassed:function(){var a=this.getPassCount(),b=this.getFailCount(),c=this.assertPlanned;return this.isFinished()&&!this.failed&&!b&&(null!=c&&a==c||null==c&&this.isDoneCorrectly())},isFailed:function(){var a=this.getPassCount(),b=this.getFailCount(),c=this.assertPlanned;return this.failed||b||this.isFinished()&&(null!=c&&a!=c||null==c&&!this.isDoneCorrectly())},isFailedWithException:function(){return this.failed},isStarted:function(){return null!=
this.startDate},isFinished:function(){return null!=this.endDate},getDuration:function(){return this.endDate-this.startDate},getBubbleTarget:function(){return this.parent||this.harness},warn:function(a){this.addResult(new Siesta.Result.Diagnostic({description:a,isWarning:!0}))},flattenArray:function(a){var b=this,c=[];Joose.A.each(a,function(a){"Array"==b.typeOf(a)?c.push.apply(c,b.flattenArray(a)):c.push(a)});return c},trimString:function(a){return String(a).replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g,
"")},buildActionableMethods:function(){var a={};this.meta.getMethods().each(function(b,c){a[c.toLowerCase()]=c});return a},getJUnitClass:function(){return this.jUnitClass||this.meta.name||"Siesta.Test"},resource:function(){return Siesta.Resource.apply(Siesta.Resource,arguments)},getRootTest:function(){for(var a=this;a.parent;)a=a.parent;return a}}});
...
f="";l.fail(d+" "+(m.target?m.target.outerHTML:e));return}d=m.message;e="";f=0}l&&l.isStarted()?(l.nbrExceptions++,l.failWithException(k||d+" "+e+" "+f)):b&&b.push({isException:!0,message:k&&k.stack?k.stack+"":d+" "+e+" "+f})}},processURL:function(a,b,c,d,e,f){function g(){s.setup(function(b,g){k.onAfterScopePreload(b,l,u,g);g&&Joose.O.each(g,function(a,b){n.push({isException:!1,message:Siesta.Resource("Siesta.Harness","preloadHasFailed",{url:b})})});b.scope?k.launchTest({testHolder:m,desc:a,scopeProvider:b,
contentManager:c,launchState:d,preloadErrors:n,onErrorHandler:p,startTestAnchor:b.scope.StartTest,noCleanup:f,reusingSandbox:!1},e):e()})}var k=this,l=a.url;if(a.isMissing)e();else{var m={},n=[],p=this.getOnErrorHandler(m,n),s=this.setupScope(a,d.launchId);b=this.getDescriptorConfig(a,"transparentEx");s.addOnErrorHandler(p,!b);a.preset.eachResource(function(b){c.hasContentOf(b)&&k.canUseCachedContent(b,a)?k.addCachedResourceToPreloads(s,c,b,a):(b=b.asDescriptor(),b.url&&(b.url=k.resolveURL(b.url,
s,a)),s.addPreload(b))});k.prepareScopeSeeding(s,a,c);b=k.getDescriptorConfig(a,"testClass");"String"==k.typeOf(b)&&(b=Joose.S.strToClass(b));var r=k.getNewTestConfiguration(a,s,c,d),u=m.test=new b(r);this.onBeforeScopePreload(s,l,u);u.earlySetup(function(){g()},function(a){n.push({isException:!1,message:a});g()})}},launchTest:function(a,b){var c=a.scopeProvider,d=a.desc,e=this,f=d.url;c.addOnErrorHandler(a.onErrorHandler,!this.getDescriptorConfig(d,"transparentEx"));var g=a.testHolder.test,k=a.startTestAnchor,
l=k&&k.args,m=c.scope,n=a.noCleanup,p=a.cleanupUrl;Joose.O.extend(g,{startTestAnchor:k,exceptionCatcher:k.exceptionCatcher,testErrorClass:k.testErrorClass,global:m,originalSetTimeout:a.originalSetTimeout||m.setTimeout,originalClearTimeout:a.originalClearTimeout||m.clearTimeout,run:l&&("function"==typeof l[0]?l[0]:l[1]),reusingSandbox:a.reusingSandbox,callback:function(){n||e.isKeepingResultForURL(f)||e.cleanupScopeForURL(p||f);b&&b()}});this.saveTestWithURL(f,g);k=function(){c.scope?(e.fireEvent("beforeteststart",
g),g.isFinished()||!0!==g.start(a.preloadErrors)&&delete a.launchState.notLaunchedByAutomationId[d.automationElementId],g=a=null):b()};a.reusingSandbox?k():c instanceof Scope.Provider.IFrame?m.setTimeout(k,10):setTimeout(k,50)},getNewTestConfiguration:function(a,b,c,d){for(var e=[],f=a.parent;f;)f.parent&&e.unshift(String(f.group)),f=f.parent;b={url:a.url,name:a.name,launchId:d.launchId,automationElementId:a.automationElementId,groups:e,jUnitClass:this.getDescriptorConfig(a,"jUnitClass"),harness:this,
expectedGlobals:this.cleanScopeGlobals.concat(this.getDescriptorConfig(a,"expectedGlobals")),autoCheckGlobals:this.getDescriptorConfig(a,"autoCheckGlobals"),disableGlobalsCheck:this.disableGlobalsCheck,scopeProvider:b,contentManager:c,transparentEx:this.getDescriptorConfig(a,"transparentEx"),needDone:this.getDescriptorConfig(a,"needDone"),overrideSetTimeout:this.getDescriptorConfig(a,"overrideSetTimeout"),defaultTimeout:this.getDescriptorConfig(a,"defaultTimeout")*(d.increaseTimeout?2:1),subTestTimeout:this.getDescriptorConfig(a,
"subTestTimeout")*(d.increaseTimeout?2:1),waitForTimeout:this.getDescriptorConfig(a,"waitForTimeout")*(d.increaseTimeout?3:1),isReadyTimeout:this.getDescriptorConfig(a,"isReadyTimeout"),sourceLineForAllAssertions:this.sourceLineForAllAssertions,sandboxCleanup:this.getDescriptorConfig(a,"sandboxCleanup"),config:this.getDescriptorConfig(a,"config"),failOnExclusiveSpecsWhenAutomated:this.getDescriptorConfig(a,"failOnExclusiveSpecsWhenAutomated"),enableCodeCoverage:this.getDescriptorConfig(a,"enableCodeCoverage")};
(a.testConfig||a.config)&&Joose.O.extend(b,a.testConfig||a.config);return b},getScriptDescriptor:function(a){return this.descriptorsById[a]},getTestByURL:function(a){return this.testsByURL[a]},saveTestWithURL:function(a,b){this.testsByURL[a]=b},deleteTestByURL:function(a){var b=this.testsByURL[a];if(b){try{b.finalize(!0)}catch(c){}this.cleanupScopeForURL(a)}delete this.testsByURL[a]},allPassed:function(){var a=!0,b=this;Joose.A.each(this.flattenDescriptors(this.descriptors),function(c){if(c.isMissing)return a=
!1;if(c=b.getTestByURL(c.url))if(a=a&&c.isPassed(),!a)return!1});return a},flattenArray:function(a){var b=this,c=[];Joose.A.each(a,function(a){"Array"==b.typeOf(a)?c.push.apply(c,b.flattenArray(a)):c.push(a)});return c}},my:{has:{HOST:null,instance:null},methods:{staticDeprecationWarning:function(a){a=Siesta.Resource("Siesta.Harness","staticDeprecationWarning",{methodName:a,harnessClass:this.HOST+""});"undefined"!=typeof console&&console.warn(a)},configure:function(a){this.staticDeprecationWarning("configure");
return(this.instance=new this.HOST).configure(a)},start:function(){this.staticDeprecationWarning("start");return this.instance.start.apply(this.instance,arguments)},on:function(){this.staticDeprecationWarning("on");return this.instance.on.apply(this.instance,arguments)}}}});
...
(function(a,b){function c(a,c,d){if(d===b&&1===a.nodeType)if(d="data-"+c.replace(Sa,"$1-$2").toLowerCase(),d=a.getAttribute(d),"string"===typeof d){try{d="true"===d?!0:"false"===d?!1:"null"===d?null:h.isNaN(d)?Ta.test(d)?h.parseJSON(d):d:parseFloat(d)}catch(e){}h.data(a,c,d)}else d=b;return d}function d(a){for(var b in a)if("toJSON"!==b)return!1;return!0}function e(a,c,d){var e=c+"defer",f=c+"queue",g=c+"mark",k=h.data(a,e,b,!0);!k||("queue"!==d&&h.data(a,f,b,!0)||"mark"!==d&&h.data(a,g,b,!0))||setTimeout(function(){h.data(a,
f,b,!0)||h.data(a,g,b,!0)||(h.removeData(a,e,!0),k.resolve())},0)}function f(){return!1}function g(){return!0}function k(a,c,d){var e=h.extend({},d[0]);e.type=a;e.originalEvent={};e.liveFired=b;h.event.handle.call(c,e);e.isDefaultPrevented()&&d[0].preventDefault()}function l(a){var b,c,d,e,f,g,k,l,m,n,q,p=[];e=[];f=h._data(this,"events");if(a.liveFired!==this&&f&&f.live&&!(a.target.disabled||a.button&&"click"===a.type)){a.namespace&&(q=RegExp("(^|\\.)"+a.namespace.split(".").join("\\.(?:.*\\.)?")+
"(\\.|$)"));a.liveFired=this;var x=f.live.slice(0);for(k=0;k<x.length;k++)f=x[k],f.origType.replace(ga,"")===a.type?e.push(f.selector):x.splice(k--,1);e=h(a.target).closest(e,a.currentTarget);l=0;for(m=e.length;l<m;l++)for(n=e[l],k=0;k<x.length;k++)if(f=x[k],n.selector===f.selector&&(!q||q.test(f.namespace))&&!n.elem.disabled){g=n.elem;d=null;if("mouseenter"===f.preType||"mouseleave"===f.preType)a.type=f.preType,(d=h(a.relatedTarget).closest(f.selector)[0])&&h.contains(g,d)&&(d=g);d&&d===g||p.push({elem:g,
handleObj:f,level:n.level})}l=0;for(m=p.length;l<m;l++){e=p[l];if(c&&e.level>c)break;a.currentTarget=e.elem;a.data=e.handleObj.data;a.handleObj=e.handleObj;q=e.handleObj.origHandler.apply(e.elem,arguments);if(!1===q||a.isPropagationStopped())if(c=e.level,!1===q&&(b=!1),a.isImmediatePropagationStopped())break}return b}}function m(a,b){return(a&&"*"!==a?a+".":"")+b.replace(Ua,"`").replace(Va,"&")}function n(a,b,c){b=b||0;if(h.isFunction(b))return h.grep(a,function(a,d){return!!b.call(a,d,a)===c});if(b.nodeType)return h.grep(a,
function(a,d){return a===b===c});if("string"===typeof b){var d=h.grep(a,function(a){return 1===a.nodeType});if(Wa.test(b))return h.filter(b,d,!c);b=h.filter(b,d)}return h.grep(a,function(a,d){return 0<=h.inArray(a,b)===c})}function p(a,b){if(1===b.nodeType&&h.hasData(a)){var c=h.expando,d=h.data(a),e=h.data(b,d);if(d=d[c]){var f=d.events,e=e[c]=h.extend({},d);if(f){delete e.handle;e.events={};for(var g in f)for(c=0,d=f[g].length;c<d;c++)h.event.add(b,g+(f[g][c].namespace?".":"")+f[g][c].namespace,
f[g][c],f[g][c].data)}}}}function s(a,b){var c;if(1===b.nodeType){b.clearAttributes&&b.clearAttributes();b.mergeAttributes&&b.mergeAttributes(a);c=b.nodeName.toLowerCase();if("object"===c)b.outerHTML=a.outerHTML;else if("input"===c&&("checkbox"===a.type||"radio"===a.type))a.checked&&(b.defaultChecked=b.checked=a.checked),b.value!==a.value&&(b.value=a.value);else if("option"===c)b.selected=a.defaultSelected;else if("input"===c||"textarea"===c)b.defaultValue=a.defaultValue;b.removeAttribute(h.expando)}}
function r(a){return"getElementsByTagName"in a?a.getElementsByTagName("*"):"querySelectorAll"in a?a.querySelectorAll("*"):[]}function u(a){if("checkbox"===a.type||"radio"===a.type)a.defaultChecked=a.checked}function w(a){h.nodeName(a,"input")?u(a):"getElementsByTagName"in a&&h.grep(a.getElementsByTagName("input"),u)}function z(a,b){b.src?h.ajax({url:b.src,async:!1,dataType:"script"}):h.globalEval((b.text||b.textContent||b.innerHTML||"").replace(Xa,"/*$0*/"));b.parentNode&&b.parentNode.removeChild(b)}
function q(a,b,c){var d="width"===b?a.offsetWidth:a.offsetHeight,e="width"===b?Ya:Za;if(0<d)return"border"!==c&&h.each(e,function(){c||(d-=parseFloat(h.css(a,"padding"+this))||0);d="margin"===c?d+(parseFloat(h.css(a,c+this))||0):d-(parseFloat(h.css(a,"border"+this+"Width"))||0)}),d+"px";d=N(a,b,b);if(0>d||null==d)d=a.style[b]||0;d=parseFloat(d)||0;c&&h.each(e,function(){d+=parseFloat(h.css(a,"padding"+this))||0;"padding"!==c&&(d+=parseFloat(h.css(a,"border"+this+"Width"))||0);"margin"===c&&(d+=parseFloat(h.css(a,
c+this))||0)});return d+"px"}function x(a){return function(b,c){"string"!==typeof b&&(c=b,b="*");if(h.isFunction(c))for(var d=b.toLowerCase().split(sa),e=0,f=d.length,g,k;e<f;e++)g=d[e],(k=/^\+/.test(g))&&(g=g.substr(1)||"*"),g=a[g]=a[g]||[],g[k?"unshift":"push"](c)}}function y(a,c,d,e,f,h){f=f||c.dataTypes[0];h=h||{};h[f]=!0;f=a[f];for(var g=0,k=f?f.length:0,l=a===ha,m;g<k&&(l||!m);g++)m=f[g](c,d,e),"string"===typeof m&&(!l||h[m]?m=b:(c.dataTypes.unshift(m),m=y(a,c,d,e,m,h)));!l&&m||h["*"]||(m=y(a,
c,d,e,"*",h));return m}function B(a,b,c,d){if(h.isArray(b))h.each(b,function(b,e){c||$a.test(a)?d(a,e):B(a+"["+("object"===typeof e||h.isArray(e)?b:"")+"]",e,c,d)});else if(c||null==b||"object"!==typeof b)d(a,b);else for(var e in b)B(a+"["+e+"]",b[e],c,d)}function A(){try{return new a.XMLHttpRequest}catch(b){}}function E(){setTimeout(M,0);return Z=h.now()}function M(){Z=b}function C(a,b){var c={};h.each(ta.concat.apply([],ta.slice(0,b)),function(){c[this]=a});return c}function aa(a){if(!ia[a]){var b=
v.body,c=h("<"+a+">").appendTo(b),d=c.css("display");c.remove();if("none"===d||""===d)H||(H=v.createElement("iframe"),H.frameBorder=H.width=H.height=0),b.appendChild(H),S&&H.createElement||(S=(H.contentWindow||H.contentDocument).document,S.write(("CSS1Compat"===v.compatMode?"<!doctype html>":"")+"<html><body>"),S.close()),c=S.createElement(a),S.body.appendChild(c),d=h.css(c,"display"),b.removeChild(H);ia[a]=d}return ia[a]}function Q(a){return h.isWindow(a)?a:9===a.nodeType?a.defaultView||a.parentWindow:
!1}var v=a.document,ab=a.navigator,bb=a.location,h=function(){function c(){if(!d.isReady){try{v.documentElement.doScroll("left")}catch(a){setTimeout(c,1);return}d.ready()}}var d=function(a,b){return new d.fn.init(a,b,h)},e=a.jQuery,f=a.$,h,g=/^(?:[^<]*(<[\w\W]+>)[^>]*$|#([\w\-]*)$)/,k=/\S/,l=/^\s+/,m=/\s+$/,n=/\d/,q=/^<(\w+)\s*\/?>(?:<\/\1>)?$/,x=/^[\],:{}\s]*$/,p=/\\(?:["\\\/bfnrt]|u[0-9a-fA-F]{4})/g,y=/"[^"\\\n\r]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g,r=/(?:^|:|,)(?:\s*\[)+/g,s=
/(webkit)[ \/]([\w.]+)/,u=/(opera)(?:.*version)?[ \/]([\w.]+)/,w=/(msie) ([\w.]+)/,z=/(mozilla)(?:.*? rv:([\w.]+))?/,cb=/-([a-z])/ig,db=function(a,b){return b.toUpperCase()},ja=ab.userAgent,ba,ca,T,eb=Object.prototype.toString,ka=Object.prototype.hasOwnProperty,B=Array.prototype.push,A=Array.prototype.slice,E=String.prototype.trim,C=Array.prototype.indexOf,ua={};d.fn=d.prototype={constructor:d,init:function(a,c,e){var t;if(!a)return this;if(a.nodeType)return this.context=this[0]=a,this.length=1,this;
if("body"===a&&!c&&v.body)return this.context=v,this[0]=v.body,this.selector=a,this.length=1,this;if("string"===typeof a){t="<"===a.charAt(0)&&">"===a.charAt(a.length-1)&&3<=a.length?[null,a,null]:g.exec(a);if(!t||!t[1]&&c)return!c||c.jquery?(c||e).find(a):this.constructor(c).find(a);if(t[1])return e=(c=c instanceof d?c[0]:c)?c.ownerDocument||c:v,(a=q.exec(a))?d.isPlainObject(c)?(a=[v.createElement(a[1])],d.fn.attr.call(a,c,!0)):a=[e.createElement(a[1])]:(a=d.buildFragment([t[1]],[e]),a=(a.cacheable?
d.clone(a.fragment):a.fragment).childNodes),d.merge(this,a);if((c=v.getElementById(t[2]))&&c.parentNode){if(c.id!==t[2])return e.find(a);this.length=1;this[0]=c}this.context=v;this.selector=a;return this}if(d.isFunction(a))return e.ready(a);a.selector!==b&&(this.selector=a.selector,this.context=a.context);return d.makeArray(a,this)},selector:"",jquery:"1.6.2",length:0,size:function(){return this.length},toArray:function(){return A.call(this,0)},get:function(a){return null==a?this.toArray():0>a?this[this.length+
a]:this[a]},pushStack:function(a,b,c){var e=this.constructor();d.isArray(a)?B.apply(e,a):d.merge(e,a);e.prevObject=this;e.context=this.context;"find"===b?e.selector=this.selector+(this.selector?" ":"")+c:b&&(e.selector=this.selector+"."+b+"("+c+")");return e},each:function(a,b){return d.each(this,a,b)},ready:function(a){d.bindReady();ca.done(a);return this},eq:function(a){return-1===a?this.slice(a):this.slice(a,+a+1)},first:function(){return this.eq(0)},last:function(){return this.eq(-1)},slice:function(){return this.pushStack(A.apply(this,
arguments),"slice",A.call(arguments).join(","))},map:function(a){return this.pushStack(d.map(this,function(b,c){return a.call(b,c,b)}))},end:function(){return this.prevObject||this.constructor(null)},push:B,sort:[].sort,splice:[].splice};d.fn.init.prototype=d.fn;d.extend=d.fn.extend=function(){var a,c,e,t,f,h=arguments[0]||{},g=1,D=arguments.length,k=!1;"boolean"===typeof h&&(k=h,h=arguments[1]||{},g=2);"object"===typeof h||d.isFunction(h)||(h={});D===g&&(h=this,--g);for(;g<D;g++)if(null!=(a=arguments[g]))for(c in a)e=
h[c],t=a[c],h!==t&&(k&&t&&(d.isPlainObject(t)||(f=d.isArray(t)))?(f?(f=!1,e=e&&d.isArray(e)?e:[]):e=e&&d.isPlainObject(e)?e:{},h[c]=d.extend(k,e,t)):t!==b&&(h[c]=t));return h};d.extend({noConflict:function(b){a.$===d&&(a.$=f);b&&a.jQuery===d&&(a.jQuery=e);return d},isReady:!1,readyWait:1,holdReady:function(a){a?d.readyWait++:d.ready(!0)},ready:function(a){if(!0===a&&!--d.readyWait||!0!==a&&!d.isReady){if(!v.body)return setTimeout(d.ready,1);d.isReady=!0;!0!==a&&0<--d.readyWait||(ca.resolveWith(v,
[d]),d.fn.trigger&&d(v).trigger("ready").unbind("ready"))}},bindReady:function(){if(!ca){ca=d._Deferred();if("complete"===v.readyState)return setTimeout(d.ready,1);if(v.addEventListener)v.addEventListener("DOMContentLoaded",T,!1),a.addEventListener("load",d.ready,!1);else if(v.attachEvent){v.attachEvent("onreadystatechange",T);a.attachEvent("onload",d.ready);var b=!1;try{b=null==a.frameElement}catch(e){}v.documentElement.doScroll&&b&&c()}}},isFunction:function(a){return"function"===d.type(a)},isArray:Array.isArray||
function(a){return"array"===d.type(a)},isWindow:function(a){return a&&"object"===typeof a&&"setInterval"in a},isNaN:function(a){return null==a||!n.test(a)||isNaN(a)},type:function(a){return null==a?String(a):ua[eb.call(a)]||"object"},isPlainObject:function(a){if(!a||("object"!==d.type(a)||a.nodeType||d.isWindow(a))||a.constructor&&!ka.call(a,"constructor")&&!ka.call(a.constructor.prototype,"isPrototypeOf"))return!1;for(var c in a);return c===b||ka.call(a,c)},isEmptyObject:function(a){for(var b in a)return!1;
return!0},error:function(a){throw a;},parseJSON:function(b){if("string"!==typeof b||!b)return null;b=d.trim(b);if(a.JSON&&a.JSON.parse)return a.JSON.parse(b);if(x.test(b.replace(p,"@").replace(y,"]").replace(r,"")))return(new Function("return "+b))();d.error("Invalid JSON: "+b)},parseXML:function(b,c,e){a.DOMParser?(e=new DOMParser,c=e.parseFromString(b,"text/xml")):(c=new ActiveXObject("Microsoft.XMLDOM"),c.async="false",c.loadXML(b));(e=c.documentElement)&&e.nodeName&&"parsererror"!==e.nodeName||
d.error("Invalid XML: "+b);return c},noop:function(){},globalEval:function(b){b&&k.test(b)&&(a.execScript||function(b){a.eval.call(a,b)})(b)},camelCase:function(a){return a.replace(cb,db)},nodeName:function(a,b){return a.nodeName&&a.nodeName.toUpperCase()===b.toUpperCase()},each:function(a,c,e){var t,f=0,h=a.length,g=h===b||d.isFunction(a);if(e)if(g)for(t in a){if(!1===c.apply(a[t],e))break}else for(;f<h&&!1!==c.apply(a[f++],e););else if(g)for(t in a){if(!1===c.call(a[t],t,a[t]))break}else for(;f<
h&&!1!==c.call(a[f],f,a[f++]););return a},trim:E?function(a){return null==a?"":E.call(a)}:function(a){return null==a?"":a.toString().replace(l,"").replace(m,"")},makeArray:function(a,b){var c=b||[];if(null!=a){var e=d.type(a);null==a.length||"string"===e||"function"===e||"regexp"===e||d.isWindow(a)?B.call(c,a):d.merge(c,a)}return c},inArray:function(a,b){if(C)return C.call(b,a);for(var c=0,d=b.length;c<d;c++)if(b[c]===a)return c;return-1},merge:function(a,c){var d=a.length,e=0;if("number"===typeof c.length)for(var t=
c.length;e<t;e++)a[d++]=c[e];else for(;c[e]!==b;)a[d++]=c[e++];a.length=d;return a},grep:function(a,b,c){var d=[],e;c=!!c;for(var t=0,f=a.length;t<f;t++)e=!!b(a[t],t),c!==e&&d.push(a[t]);return d},map:function(a,c,e){var t,f,h=[],g=0,D=a.length;if(a instanceof d||D!==b&&"number"===typeof D&&(0<D&&a[0]&&a[D-1]||0===D||d.isArray(a)))for(;g<D;g++)t=c(a[g],g,e),null!=t&&(h[h.length]=t);else for(f in a)t=c(a[f],f,e),null!=t&&(h[h.length]=t);return h.concat.apply([],h)},guid:1,proxy:function(a,c){if("string"===
typeof c){var e=a[c];c=a;a=e}if(!d.isFunction(a))return b;var t=A.call(arguments,2),e=function(){return a.apply(c,t.concat(A.call(arguments)))};e.guid=a.guid=a.guid||e.guid||d.guid++;return e},access:function(a,c,e,t,f,h){var g=a.length;if("object"===typeof c){for(var D in c)d.access(a,D,c[D],t,f,e);return a}if(e!==b){t=!h&&t&&d.isFunction(e);for(D=0;D<g;D++)f(a[D],c,t?e.call(a[D],D,f(a[D],c)):e,h);return a}return g?f(a[0],c):b},now:function(){return(new Date).getTime()},uaMatch:function(a){a=a.toLowerCase();
if(a.match(/trident/i)&&a.match(/rv.\d\d/))return{browser:"msie",version:"11.0"};a=s.exec(a)||u.exec(a)||w.exec(a)||0>a.indexOf("compatible")&&z.exec(a)||[];return{browser:a[1]||"",version:a[2]||"0"}},sub:function(){function a(b,c){return new a.fn.init(b,c)}d.extend(!0,a,this);a.superclass=this;a.fn=a.prototype=this();a.fn.constructor=a;a.sub=this.sub;a.fn.init=function(c,e){e&&(e instanceof d&&!(e instanceof a))&&(e=a(e));return d.fn.init.call(this,c,e,b)};a.fn.init.prototype=a.fn;var b=a(v);return a},
browser:{}});d.each("Boolean Number String Function Array Date RegExp Object".split(" "),function(a,b){ua["[object "+b+"]"]=b.toLowerCase()});ba=d.uaMatch(ja);ba.browser&&(d.browser[ba.browser]=!0,d.browser.version=ba.version);d.browser.webkit&&(d.browser.safari=/safari/i.test(ja)&&!/chrome/i.test(ja));k.test("\u00a0")&&(l=/^[\s\xA0]+/,m=/[\s\xA0]+$/);h=d(v);v.addEventListener?T=function(){v.removeEventListener("DOMContentLoaded",T,!1);d.ready()}:v.attachEvent&&(T=function(){"complete"===v.readyState&&
(v.detachEvent("onreadystatechange",T),d.ready())});return d}(),la="done fail isResolved isRejected promise then always pipe".split(" "),va=[].slice;h.extend({_Deferred:function(){var a=[],b,c,d,e={done:function(){if(!d){var c=arguments,f,g,D,k,l;b&&(l=b,b=0);f=0;for(g=c.length;f<g;f++)D=c[f],k=h.type(D),"array"===k?e.done.apply(e,D):"function"===k&&a.push(D);l&&e.resolveWith(l[0],l[1])}return this},resolveWith:function(e,f){if(!d&&!b&&!c){f=f||[];c=1;try{for(;a[0];)a.shift().apply(e,f)}finally{b=
[e,f],c=0}}return this},resolve:function(){e.resolveWith(this,arguments);return this},isResolved:function(){return!(!c&&!b)},cancel:function(){d=1;a=[];return this}};return e},Deferred:function(a){var b=h._Deferred(),c=h._Deferred(),d;h.extend(b,{then:function(a,c){b.done(a).fail(c);return this},always:function(){return b.done.apply(b,arguments).fail.apply(this,arguments)},fail:c.done,rejectWith:c.resolveWith,reject:c.resolve,isRejected:c.isResolved,pipe:function(a,c){return h.Deferred(function(d){h.each({done:[a,
"resolve"],fail:[c,"reject"]},function(a,c){var e=c[0],t=c[1],f;if(h.isFunction(e))b[a](function(){if((f=e.apply(this,arguments))&&h.isFunction(f.promise))f.promise().then(d.resolve,d.reject);else d[t](f)});else b[a](d[t])})}).promise()},promise:function(a){if(null==a){if(d)return d;d=a={}}for(var c=la.length;c--;)a[la[c]]=b[la[c]];return a}});b.done(c.cancel).fail(b.cancel);delete b.cancel;a&&a.call(b,b);return b},when:function(a){function b(a){return function(b){c[a]=1<arguments.length?va.call(arguments,
0):b;--f||g.resolveWith(g,va.call(c,0))}}var c=arguments,d=0,e=c.length,f=e,g=1>=e&&a&&h.isFunction(a.promise)?a:h.Deferred();if(1<e){for(;d<e;d++)c[d]&&h.isFunction(c[d].promise)?c[d].promise().then(b(d),g.reject):--f;f||g.resolveWith(g,c)}else g!==a&&g.resolveWith(g,e?[a]:[]);return g.promise()}});h.support=function(){var a=v.createElement("div"),b=v.documentElement,c,d,e,f,g,k;a.setAttribute("className","t");a.innerHTML="   <link/><table></table><a href='/a' style='top:1px;float:left;opacity:.55;'>a</a><input type='checkbox'/>";
c=a.getElementsByTagName("*");d=a.getElementsByTagName("a")[0];if(!c||!c.length||!d)return{};e=v.createElement("select");f=e.appendChild(v.createElement("option"));c=a.getElementsByTagName("input")[0];g={leadingWhitespace:3===a.firstChild.nodeType,tbody:!a.getElementsByTagName("tbody").length,htmlSerialize:!!a.getElementsByTagName("link").length,style:/top/.test(d.getAttribute("style")),hrefNormalized:"/a"===d.getAttribute("href"),opacity:/^0.55$/.test(d.style.opacity),cssFloat:!!d.style.cssFloat,
checkOn:"on"===c.value,optSelected:f.selected,getSetAttribute:"t"!==a.className,submitBubbles:!0,changeBubbles:!0,focusinBubbles:!1,deleteExpando:!0,noCloneEvent:!0,inlineBlockNeedsLayout:!1,shrinkWrapBlocks:!1,reliableMarginRight:!0};c.checked=!0;g.noCloneChecked=c.cloneNode(!0).checked;e.disabled=!0;g.optDisabled=!f.disabled;try{delete a.test}catch(l){g.deleteExpando=!1}!a.addEventListener&&(a.attachEvent&&a.fireEvent)&&(a.attachEvent("onclick",function(){g.noCloneEvent=!1}),a.cloneNode(!0).fireEvent("onclick"));
c=v.createElement("input");c.value="t";c.setAttribute("type","radio");g.radioValue="t"===c.value;c.setAttribute("checked","checked");a.appendChild(c);d=v.createDocumentFragment();d.appendChild(a.firstChild);g.checkClone=d.cloneNode(!0).cloneNode(!0).lastChild.checked;a.innerHTML="";a.style.width=a.style.paddingLeft="1px";e=v.getElementsByTagName("body")[0];d=v.createElement(e?"div":"body");f={visibility:"hidden",width:0,height:0,border:0,margin:0};e&&h.extend(f,{position:"absolute",left:-1E3,top:-1E3});
...
"";e[1].style.display="none";g.reliableHiddenOffsets=c&&0===e[0].offsetHeight;a.innerHTML="";v.defaultView&&v.defaultView.getComputedStyle&&(c=v.createElement("div"),c.style.width="0",c.style.marginRight="0",a.appendChild(c),g.reliableMarginRight=0===(parseInt((v.defaultView.getComputedStyle(c,null)||{marginRight:0}).marginRight,10)||0));d.innerHTML="";b.removeChild(d);if(a.attachEvent)for(k in{submit:1,change:1,focusin:1})b="on"+k,c=b in a,c||(a.setAttribute(b,"return;"),c="function"===typeof a[b]),
g[k+"Bubbles"]=c;d=d=e=f=e=c=a=c=null;return g}();h.boxModel=h.support.boxModel;var Ta=/^(?:\{.*\}|\[.*\])$/,Sa=/([a-z])([A-Z])/g;h.extend({cache:{},uuid:0,expando:"jQuery"+(h.fn.jquery+Math.random()).replace(/\D/g,""),noData:{embed:!0,object:"clsid:D27CDB6E-AE6D-11cf-96B8-444553540000",applet:!0},hasData:function(a){a=a.nodeType?h.cache[a[h.expando]]:a[h.expando];return!!a&&!d(a)},data:function(a,c,d,e){if(h.acceptData(a)){var f=h.expando,g="string"===typeof c,k=a.nodeType,l=k?h.cache:a,m=k?a[h.expando]:
a[h.expando]&&h.expando;if(m&&(!e||!m||l[m][f])||!g||d!==b){m||(k?a[h.expando]=m=++h.uuid:m=h.expando);l[m]||(l[m]={},k||(l[m].toJSON=h.noop));if("object"===typeof c||"function"===typeof c)e?l[m][f]=h.extend(l[m][f],c):l[m]=h.extend(l[m],c);a=l[m];e&&(a[f]||(a[f]={}),a=a[f]);d!==b&&(a[h.camelCase(c)]=d);return"events"!==c||a[c]?g?a[h.camelCase(c)]||a[c]:a:a[f]&&a[f].events}}},removeData:function(b,c,e){if(h.acceptData(b)){var f=h.expando,g=b.nodeType,k=g?h.cache:b,l=g?b[h.expando]:h.expando;if(k[l]){if(c){var m=
e?k[l][f]:k[l];if(m&&(delete m[c],!d(m)))return}if(e&&(delete k[l][f],!d(k[l])))return;c=k[l][f];h.support.deleteExpando||k!=a?delete k[l]:k[l]=null;c?(k[l]={},g||(k[l].toJSON=h.noop),k[l][f]=c):g&&(h.support.deleteExpando?delete b[h.expando]:b.removeAttribute?b.removeAttribute(h.expando):b[h.expando]=null)}}},_data:function(a,b,c){return h.data(a,b,c,!0)},acceptData:function(a){if(a.nodeName){var b=h.noData[a.nodeName.toLowerCase()];if(b)return!(!0===b||a.getAttribute("classid")!==b)}return!0}});
h.fn.extend({data:function(a,d){var e=null;if("undefined"===typeof a){if(this.length&&(e=h.data(this[0]),1===this[0].nodeType))for(var f=this[0].attributes,g,k=0,l=f.length;k<l;k++)g=f[k].name,0===g.indexOf("data-")&&(g=h.camelCase(g.substring(5)),c(this[0],g,e[g]));return e}if("object"===typeof a)return this.each(function(){h.data(this,a)});var m=a.split(".");m[1]=m[1]?"."+m[1]:"";return d===b?(e=this.triggerHandler("getData"+m[1]+"!",[m[0]]),e===b&&this.length&&(e=h.data(this[0],a),e=c(this[0],
a,e)),e===b&&m[1]?this.data(m[0]):e):this.each(function(){var b=h(this),c=[m[0],d];b.triggerHandler("setData"+m[1]+"!",c);h.data(this,a,d);b.triggerHandler("changeData"+m[1]+"!",c)})},removeData:function(a){return this.each(function(){h.removeData(this,a)})}});h.extend({_mark:function(a,c){a&&(c=(c||"fx")+"mark",h.data(a,c,(h.data(a,c,b,!0)||0)+1,!0))},_unmark:function(a,c,d){!0!==a&&(d=c,c=a,a=!1);if(c){d=d||"fx";var f=d+"mark";(a=a?0:(h.data(c,f,b,!0)||1)-1)?h.data(c,f,a,!0):(h.removeData(c,f,!0),
...
h.queue(this,a,c);"fx"===a&&"inprogress"!==b[0]&&h.dequeue(this,a)})},dequeue:function(a){return this.each(function(){h.dequeue(this,a)})},delay:function(a,b){a=h.fx?h.fx.speeds[a]||a:a;b=b||"fx";return this.queue(b,function(){var c=this;setTimeout(function(){h.dequeue(c,b)},a)})},clearQueue:function(a){return this.queue(a||"fx",[])},promise:function(a,c){function d(){--k||e.resolveWith(f,[f])}"string"!==typeof a&&(a=b);a=a||"fx";for(var e=h.Deferred(),f=this,g=f.length,k=1,l=a+"defer",m=a+"queue",
n=a+"mark",q;g--;)if(q=h.data(f[g],l,b,!0)||(h.data(f[g],m,b,!0)||h.data(f[g],n,b,!0))&&h.data(f[g],l,h._Deferred(),!0))k++,q.done(d);d();return e.promise()}});var wa=/[\n\t\r]/g,ma=/\s+/,fb=/\r/g,gb=/^(?:button|input)$/i,hb=/^(?:button|input|object|select|textarea)$/i,ib=/^a(?:rea)?$/i,xa=/^(?:autofocus|autoplay|async|checked|controls|defer|disabled|hidden|loop|multiple|open|readonly|required|scoped|selected)$/i,jb=/\:|^on/,J,ya;h.fn.extend({attr:function(a,b){return h.access(this,a,b,!0,h.attr)},
removeAttr:function(a){return this.each(function(){h.removeAttr(this,a)})},prop:function(a,b){return h.access(this,a,b,!0,h.prop)},removeProp:function(a){a=h.propFix[a]||a;return this.each(function(){try{this[a]=b,delete this[a]}catch(c){}})},addClass:function(a){var b,c,d,e,f,g,k;if(h.isFunction(a))return this.each(function(b){h(this).addClass(a.call(this,b,this.className))});if(a&&"string"===typeof a)for(b=a.split(ma),c=0,d=this.length;c<d;c++)if(e=this[c],1===e.nodeType)if(e.className||1!==b.length){f=
" "+e.className+" ";g=0;for(k=b.length;g<k;g++)~f.indexOf(" "+b[g]+" ")||(f+=b[g]+" ");e.className=h.trim(f)}else e.className=a;return this},removeClass:function(a){var c,d,e,f,g,k,l;if(h.isFunction(a))return this.each(function(b){h(this).removeClass(a.call(this,b,this.className))});if(a&&"string"===typeof a||a===b)for(c=(a||"").split(ma),d=0,e=this.length;d<e;d++)if(f=this[d],1===f.nodeType&&f.className)if(a){g=(" "+f.className+" ").replace(wa," ");k=0;for(l=c.length;k<l;k++)g=g.replace(" "+c[k]+
" "," ");f.className=h.trim(g)}else f.className="";return this},toggleClass:function(a,b){var c=typeof a,d="boolean"===typeof b;return h.isFunction(a)?this.each(function(c){h(this).toggleClass(a.call(this,c,this.className,b),b)}):this.each(function(){if("string"===c)for(var e,f=0,g=h(this),k=b,l=a.split(ma);e=l[f++];)k=d?k:!g.hasClass(e),g[k?"addClass":"removeClass"](e);else if("undefined"===c||"boolean"===c)this.className&&h._data(this,"__className__",this.className),this.className=this.className||
!1===a?"":h._data(this,"__className__")||""})},hasClass:function(a){a=" "+a+" ";for(var b=0,c=this.length;b<c;b++)if(-1<(" "+this[b].className+" ").replace(wa," ").indexOf(a))return!0;return!1},val:function(a){var c,d,e=this[0];if(!arguments.length){if(e){if((c=h.valHooks[e.nodeName.toLowerCase()]||h.valHooks[e.type])&&"get"in c&&(d=c.get(e,"value"))!==b)return d;d=e.value;return"string"===typeof d?d.replace(fb,""):null==d?"":d}return b}var f=h.isFunction(a);return this.each(function(d){var e=h(this);
1===this.nodeType&&(d=f?a.call(this,d,e.val()):a,null==d?d="":"number"===typeof d?d+="":h.isArray(d)&&(d=h.map(d,function(a){return null==a?"":a+""})),c=h.valHooks[this.nodeName.toLowerCase()]||h.valHooks[this.type],c&&"set"in c&&c.set(this,d,"value")!==b||(this.value=d))})}});h.extend({valHooks:{option:{get:function(a){var b=a.attributes.value;return!b||b.specified?a.value:a.text}},select:{get:function(a){var b,c=a.selectedIndex,d=[],e=a.options;a="select-one"===a.type;if(0>c)return null;for(var f=
a?c:0,g=a?c+1:e.length;f<g;f++)if(b=e[f],b.selected&&!((h.support.optDisabled?b.disabled:null!==b.getAttribute("disabled"))||b.parentNode.disabled&&h.nodeName(b.parentNode,"optgroup"))){b=h(b).val();if(a)return b;d.push(b)}return a&&!d.length&&e.length?h(e[c]).val():d},set:function(a,b){var c=h.makeArray(b);h(a).find("option").each(function(){this.selected=0<=h.inArray(h(this).val(),c)});c.length||(a.selectedIndex=-1);return c}}},attrFn:{val:!0,css:!0,html:!0,text:!0,data:!0,width:!0,height:!0,offset:!0},
attrFix:{tabindex:"tabIndex"},attr:function(a,c,d,e){var f=a.nodeType;if(!a||3===f||8===f||2===f)return b;if(e&&c in h.attrFn)return h(a)[c](d);if(!("getAttribute"in a))return h.prop(a,c,d);var g,k;if(e=1!==f||!h.isXMLDoc(a))c=h.attrFix[c]||c,(k=h.attrHooks[c])||(xa.test(c)?k=ya:J&&("className"!==c&&(h.nodeName(a,"form")||jb.test(c)))&&(k=J));if(d!==b){if(null===d)return h.removeAttr(a,c),b;if(k&&"set"in k&&e&&(g=k.set(a,d,c))!==b)return g;a.setAttribute(c,""+d);return d}if(k&&"get"in k&&e&&null!==
(g=k.get(a,c)))return g;g=a.getAttribute(c);return null===g?b:g},removeAttr:function(a,b){var c;1===a.nodeType&&(b=h.attrFix[b]||b,h.support.getSetAttribute?a.removeAttribute(b):(h.attr(a,b,""),a.removeAttributeNode(a.getAttributeNode(b))),xa.test(b)&&(c=h.propFix[b]||b)in a&&(a[c]=!1))},attrHooks:{type:{set:function(a,b){if(gb.test(a.nodeName)&&a.parentNode)h.error("type property can't be changed");else if(!h.support.radioValue&&"radio"===b&&h.nodeName(a,"input")){var c=a.value;a.setAttribute("type",
b);c&&(a.value=c);return b}}},tabIndex:{get:function(a){var c=a.getAttributeNode("tabIndex");return c&&c.specified?parseInt(c.value,10):hb.test(a.nodeName)||ib.test(a.nodeName)&&a.href?0:b}},value:{get:function(a,b){return J&&h.nodeName(a,"button")?J.get(a,b):b in a?a.value:null},set:function(a,b,c){if(J&&h.nodeName(a,"button"))return J.set(a,b,c);a.value=b}}},propFix:{tabindex:"tabIndex",readonly:"readOnly","for":"htmlFor","class":"className",maxlength:"maxLength",cellspacing:"cellSpacing",cellpadding:"cellPadding",
rowspan:"rowSpan",colspan:"colSpan",usemap:"useMap",frameborder:"frameBorder",contenteditable:"contentEditable"},prop:function(a,c,d){var e=a.nodeType;if(!a||3===e||8===e||2===e)return b;var f,g;1===e&&h.isXMLDoc(a)||(c=h.propFix[c]||c,g=h.propHooks[c]);return d!==b?g&&"set"in g&&(f=g.set(a,d,c))!==b?f:a[c]=d:g&&"get"in g&&(f=g.get(a,c))!==b?f:a[c]},propHooks:{}});ya={get:function(a,c){return h.prop(a,c)?c.toLowerCase():b},set:function(a,b,c){!1===b?h.removeAttr(a,c):(b=h.propFix[c]||c,b in a&&(a[b]=
!0),a.setAttribute(c,c.toLowerCase()));return c}};h.support.getSetAttribute||(h.attrFix=h.propFix,J=h.attrHooks.name=h.attrHooks.title=h.valHooks.button={get:function(a,c){var d;return(d=a.getAttributeNode(c))&&""!==d.nodeValue?d.nodeValue:b},set:function(a,b,c){if(a=a.getAttributeNode(c))return a.nodeValue=b}},h.each(["width","height"],function(a,b){h.attrHooks[b]=h.extend(h.attrHooks[b],{set:function(a,c){if(""===c)return a.setAttribute(b,"auto"),c}})}));h.support.hrefNormalized||h.each(["href",
...
function(){h.valHooks[this]={get:function(a){return null===a.getAttribute("value")?"on":a.value}}});h.each(["radio","checkbox"],function(){h.valHooks[this]=h.extend(h.valHooks[this],{set:function(a,b){if(h.isArray(b))return a.checked=0<=h.inArray(h(a).val(),b)}})});var ga=/\.(.*)$/,na=/^(?:textarea|input|select)$/i,Ua=/\./g,Va=/ /g,kb=/[^\w\s.|`]/g,lb=function(a){return a.replace(kb,"\\$&")};h.event={add:function(a,c,d,e){if(3!==a.nodeType&&8!==a.nodeType){if(!1===d)d=f;else if(!d)return;var g,k;
d.handler&&(g=d,d=g.handler);d.guid||(d.guid=h.guid++);if(k=h._data(a)){var l=k.events,m=k.handle;l||(k.events=l={});m||(k.handle=m=function(a){return"undefined"===typeof h||a&&h.event.triggered===a.type?b:h.event.handle.apply(m.elem,arguments)});m.elem=a;c=c.split(" ");for(var n,q=0,x;n=c[q++];){k=g?h.extend({},g):{handler:d,data:e};-1<n.indexOf(".")?(x=n.split("."),n=x.shift(),k.namespace=x.slice(0).sort().join(".")):(x=[],k.namespace="");k.type=n;k.guid||(k.guid=d.guid);var p=l[n],y=h.event.special[n]||
{};p||(p=l[n]=[],y.setup&&!1!==y.setup.call(a,e,x,m)||(a.addEventListener?a.addEventListener(n,m,!1):a.attachEvent&&a.attachEvent("on"+n,m)));y.add&&(y.add.call(a,k),k.handler.guid||(k.handler.guid=d.guid));p.push(k);h.event.global[n]=!0}a=null}}},global:{},remove:function(a,c,d,e){if(3!==a.nodeType&&8!==a.nodeType){!1===d&&(d=f);var g,k,l=0,m,n,q,x,p,y,r=h.hasData(a)&&h._data(a),s=r&&r.events;if(r&&s)if(c&&c.type&&(d=c.handler,c=c.type),!c||"string"===typeof c&&"."===c.charAt(0))for(g in c=c||"",
s)h.event.remove(a,g+c);else{for(c=c.split(" ");g=c[l++];)if(x=g,m=0>g.indexOf("."),n=[],m||(n=g.split("."),g=n.shift(),q=RegExp("(^|\\.)"+h.map(n.slice(0).sort(),lb).join("\\.(?:.*\\.)?")+"(\\.|$)")),p=s[g])if(d){x=h.event.special[g]||{};for(k=e||0;k<p.length;k++)if(y=p[k],d.guid===y.guid){if(m||q.test(y.namespace))null==e&&p.splice(k--,1),x.remove&&x.remove.call(a,y);if(null!=e)break}if(0===p.length||null!=e&&1===p.length)x.teardown&&!1!==x.teardown.call(a,n)||h.removeEvent(a,g,r.handle),delete s[g]}else for(k=
0;k<p.length;k++)if(y=p[k],m||q.test(y.namespace))h.event.remove(a,x,y.handler,k),p.splice(k--,1);if(h.isEmptyObject(s)){if(c=r.handle)c.elem=null;delete r.events;delete r.handle;h.isEmptyObject(r)&&h.removeData(a,b,!0)}}}},customEvent:{getData:!0,setData:!0,changeData:!0},trigger:function(c,d,e,f){var g=c.type||c,k=[],l;0<=g.indexOf("!")&&(g=g.slice(0,-1),l=!0);0<=g.indexOf(".")&&(k=g.split("."),g=k.shift(),k.sort());if(e&&!h.event.customEvent[g]||h.event.global[g]){c="object"===typeof c?c[h.expando]?
c:new h.Event(g,c):new h.Event(g);c.type=g;c.exclusive=l;c.namespace=k.join(".");c.namespace_re=RegExp("(^|\\.)"+k.join("\\.(?:.*\\.)?")+"(\\.|$)");if(f||!e)c.preventDefault(),c.stopPropagation();if(!e)h.each(h.cache,function(){var a=this[h.expando];a&&(a.events&&a.events[g])&&h.event.trigger(c,d,a.handle.elem)});else if(3!==e.nodeType&&8!==e.nodeType){c.result=b;c.target=e;d=null!=d?h.makeArray(d):[];d.unshift(c);k=e;f=0>g.indexOf(":")?"on"+g:"";do l=h._data(k,"handle"),c.currentTarget=k,l&&l.apply(k,
d),f&&(h.acceptData(k)&&k[f]&&!1===k[f].apply(k,d))&&(c.result=!1,c.preventDefault()),k=k.parentNode||k.ownerDocument||k===c.target.ownerDocument&&a;while(k&&!c.isPropagationStopped());if(!c.isDefaultPrevented()){var m,k=h.event.special[g]||{};if(!(k._default&&!1!==k._default.call(e.ownerDocument,c)||"click"===g&&h.nodeName(e,"a")||!h.acceptData(e))){try{f&&e[g]&&((m=e[f])&&(e[f]=null),h.event.triggered=g,e[g]())}catch(n){}m&&(e[f]=m);h.event.triggered=b}}return c.result}}},handle:function(c){c=h.event.fix(c||
a.event);var d=((h._data(this,"events")||{})[c.type]||[]).slice(0),e=!c.exclusive&&!c.namespace,f=Array.prototype.slice.call(arguments,0);f[0]=c;c.currentTarget=this;for(var g=0,k=d.length;g<k;g++){var l=d[g];if(e||c.namespace_re.test(l.namespace))if(c.handler=l.handler,c.data=l.data,c.handleObj=l,l=l.handler.apply(this,f),l!==b&&(c.result=l,!1===l&&(c.preventDefault(),c.stopPropagation())),c.isImmediatePropagationStopped())break}return c.result},props:"altKey attrChange attrName bubbles button cancelable charCode clientX clientY ctrlKey currentTarget data detail eventPhase fromElement handler keyCode layerX layerY metaKey newValue offsetX offsetY pageX pageY prevValue relatedNode relatedTarget screenX screenY shiftKey srcElement target toElement view wheelDelta which".split(" "),
fix:function(a){if(a[h.expando])return a;var c=a;a=h.Event(c);for(var d=this.props.length,e;d;)e=this.props[--d],a[e]=c[e];a.target||(a.target=a.srcElement||v);3===a.target.nodeType&&(a.target=a.target.parentNode);!a.relatedTarget&&a.fromElement&&(a.relatedTarget=a.fromElement===a.target?a.toElement:a.fromElement);null==a.pageX&&null!=a.clientX&&(d=a.target.ownerDocument||v,c=d.documentElement,d=d.body,a.pageX=a.clientX+(c&&c.scrollLeft||d&&d.scrollLeft||0)-(c&&c.clientLeft||d&&d.clientLeft||0),a.pageY=
...
m(a.origType,a.selector),a)}},beforeunload:{setup:function(a,b,c){h.isWindow(this)&&(this.onbeforeunload=c)},teardown:function(a,b){this.onbeforeunload===b&&(this.onbeforeunload=null)}}}};h.removeEvent=v.removeEventListener?function(a,b,c){a.removeEventListener&&a.removeEventListener(b,c,!1)}:function(a,b,c){a.detachEvent&&a.detachEvent("on"+b,c)};h.Event=function(a,b){if(!this.preventDefault)return new h.Event(a,b);a&&a.type?(this.originalEvent=a,this.type=a.type,this.isDefaultPrevented=a.defaultPrevented||
!1===a.returnValue||a.getPreventDefault&&a.getPreventDefault()?g:f):this.type=a;b&&h.extend(this,b);this.timeStamp=h.now();this[h.expando]=!0};h.Event.prototype={preventDefault:function(){this.isDefaultPrevented=g;var a=this.originalEvent;a&&(a.preventDefault?a.preventDefault():a.returnValue=!1)},stopPropagation:function(){this.isPropagationStopped=g;var a=this.originalEvent;a&&(a.stopPropagation&&a.stopPropagation(),a.cancelBubble=!0)},stopImmediatePropagation:function(){this.isImmediatePropagationStopped=
g;this.stopPropagation()},isDefaultPrevented:f,isPropagationStopped:f,isImmediatePropagationStopped:f};var za=function(a){var b=a.relatedTarget,c=!1,d=a.type;a.type=a.data;b!==this&&(b&&(c=h.contains(this,b)),c||(h.event.handle.apply(this,arguments),a.type=d))},Aa=function(a){a.type=a.data;h.event.handle.apply(this,arguments)};h.each({mouseenter:"mouseover",mouseleave:"mouseout"},function(a,b){h.event.special[a]={setup:function(c){h.event.add(this,b,c&&c.selector?Aa:za,a)},teardown:function(a){h.event.remove(this,
b,a&&a.selector?Aa:za)}}});h.support.submitBubbles||(h.event.special.submit={setup:function(a,b){if(h.nodeName(this,"form"))return!1;h.event.add(this,"click.specialSubmit",function(a){var b=a.target,c=b.type;"submit"!==c&&"image"!==c||!h(b).closest("form").length||k("submit",this,arguments)});h.event.add(this,"keypress.specialSubmit",function(a){var b=a.target,c=b.type;"text"!==c&&"password"!==c||(!h(b).closest("form").length||13!==a.keyCode)||k("submit",this,arguments)})},teardown:function(a){h.event.remove(this,
".specialSubmit")}});if(!h.support.changeBubbles){var W,Ba=function(a){var b=a.type,c=a.value;"radio"===b||"checkbox"===b?c=a.checked:"select-multiple"===b?c=-1<a.selectedIndex?h.map(a.options,function(a){return a.selected}).join("-"):"":h.nodeName(a,"select")&&(c=a.selectedIndex);return c},da=function(a,c){var d=a.target,e,f;na.test(d.nodeName)&&!d.readOnly&&(e=h._data(d,"_change_data"),f=Ba(d),"focusout"===a.type&&"radio"===d.type||h._data(d,"_change_data",f),e===b||f===e||null==e&&!f||(a.type=
"change",a.liveFired=b,h.event.trigger(a,c,d)))};h.event.special.change={filters:{focusout:da,beforedeactivate:da,click:function(a){var b=a.target,c=h.nodeName(b,"input")?b.type:"";("radio"===c||"checkbox"===c||h.nodeName(b,"select"))&&da.call(this,a)},keydown:function(a){var b=a.target,c=h.nodeName(b,"input")?b.type:"";(13===a.keyCode&&!h.nodeName(b,"textarea")||32===a.keyCode&&("checkbox"===c||"radio"===c)||"select-multiple"===c)&&da.call(this,a)},beforeactivate:function(a){a=a.target;h._data(a,
"_change_data",Ba(a))}},setup:function(a,b){if("file"===this.type)return!1;for(var c in W)h.event.add(this,c+".specialChange",W[c]);return na.test(this.nodeName)},teardown:function(a){h.event.remove(this,".specialChange");return na.test(this.nodeName)}};W=h.event.special.change.filters;W.focus=W.beforeactivate}h.support.focusinBubbles||h.each({focus:"focusin",blur:"focusout"},function(a,b){function c(a){var d=h.event.fix(a);d.type=b;d.originalEvent={};h.event.trigger(d,null,d.target);d.isDefaultPrevented()&&
a.preventDefault()}var d=0;h.event.special[b]={setup:function(){0===d++&&v.addEventListener(a,c,!0)},teardown:function(){0===--d&&v.removeEventListener(a,c,!0)}}});h.each(["bind","one"],function(a,c){h.fn[c]=function(a,d,e){var f;if("object"===typeof a){for(var g in a)this[c](g,d,a[g],e);return this}if(2===arguments.length||!1===d)e=d,d=b;"one"===c?(f=function(a){h(this).unbind(a,f);return e.apply(this,arguments)},f.guid=e.guid||h.guid++):f=e;if("unload"===a&&"one"!==c)this.one(a,d,e);else{g=0;for(var k=
this.length;g<k;g++)h.event.add(this[g],a,f,d)}return this}});h.fn.extend({unbind:function(a,b){if("object"!==typeof a||a.preventDefault)for(var c=0,d=this.length;c<d;c++)h.event.remove(this[c],a,b);else for(c in a)this.unbind(c,a[c]);return this},delegate:function(a,b,c,d){return this.live(b,c,d,a)},undelegate:function(a,b,c){return 0===arguments.length?this.unbind("live"):this.die(b,null,c,a)},trigger:function(a,b){return this.each(function(){h.event.trigger(a,b,this)})},triggerHandler:function(a,
b){if(this[0])return h.event.trigger(a,b,this[0],!0)},toggle:function(a){var b=arguments,c=a.guid||h.guid++,d=0,e=function(c){var e=(h.data(this,"lastToggle"+a.guid)||0)%d;h.data(this,"lastToggle"+a.guid,e+1);c.preventDefault();return b[e].apply(this,arguments)||!1};for(e.guid=c;d<b.length;)b[d++].guid=c;return this.click(e)},hover:function(a,b){return this.mouseenter(a).mouseleave(b||a)}});var oa={focus:"focusin",blur:"focusout",mouseenter:"mouseover",mouseleave:"mouseout"};h.each(["live","die"],
function(a,c){h.fn[c]=function(a,d,e,g){var k=0,t,l,n=g||this.selector,q=g?this:h(this.context);if("object"===typeof a&&!a.preventDefault){for(t in a)q[c](t,d,a[t],n);return this}if("die"===c&&!a&&g&&"."===g.charAt(0))return q.unbind(g),this;if(!1===d||h.isFunction(d))e=d||f,d=b;for(a=(a||"").split(" ");null!=(g=a[k++]);)if(t=ga.exec(g),l="",t&&(l=t[0],g=g.replace(ga,"")),"hover"===g)a.push("mouseenter"+l,"mouseleave"+l);else if(t=g,oa[g]?(a.push(oa[g]+l),g+=l):g=(oa[g]||g)+l,"live"===c){l=0;for(var x=
q.length;l<x;l++)h.event.add(q[l],"live."+m(g,n),{data:d,selector:n,handler:e,origType:g,origHandler:e,preType:t})}else q.unbind("live."+m(g,n),e);return this}});h.each("blur focus focusin focusout load resize scroll unload click dblclick mousedown mouseup mousemove mouseover mouseout mouseenter mouseleave change select submit keydown keypress keyup error".split(" "),function(a,b){h.fn[b]=function(a,c){null==c&&(c=a,a=null);return 0<arguments.length?this.bind(b,a,c):this.trigger(b)};h.attrFn&&(h.attrFn[b]=
!0)});(function(){function a(b,c,d,e,f,g){f=0;for(var h=e.length;f<h;f++){var k=e[f];if(k){for(var t=!1,k=k[b];k;){if(k.sizcache===d){t=e[k.sizset];break}1!==k.nodeType||g||(k.sizcache=d,k.sizset=f);if(k.nodeName.toLowerCase()===c){t=k;break}k=k[b]}e[f]=t}}}function c(a,b,d,e,f,g){f=0;for(var h=e.length;f<h;f++){var k=e[f];if(k){for(var t=!1,k=k[a];k;){if(k.sizcache===d){t=e[k.sizset];break}if(1===k.nodeType)if(g||(k.sizcache=d,k.sizset=f),"string"!==typeof b){if(k===b){t=!0;break}}else if(0<n.filter(b,
[k]).length){t=k;break}k=k[a]}e[f]=t}}}var d=/((?:\((?:\([^()]+\)|[^()]+)+\)|\[(?:\[[^\[\]]*\]|['"][^'"]*['"]|[^\[\]'"]+)+\]|\\.|[^ >+~,(\[\\]+)+|[>+~])(\s*,\s*)?((?:.|\r|\n)*)/g,e=0,f=Object.prototype.toString,g=!1,k=!0,l=/\\/g,m=/\W/;[0,0].sort(function(){k=!1;return 0});var n=function(a,b,c,e){c=c||[];var g=b=b||v;if(1!==b.nodeType&&9!==b.nodeType)return[];if(!a||"string"!==typeof a)return c;var h,k,t,l,G,m=!0,K=n.isXML(b),p=[],y=a;do if(d.exec(""),h=d.exec(y))if(y=h[3],p.push(h[1]),h[2]){l=h[3];
break}while(h);if(1<p.length&&x.exec(a))if(2===p.length&&q.relative[p[0]])k=B(p[0]+p[1],b);else for(k=q.relative[p[0]]?[b]:n(p.shift(),b);p.length;)a=p.shift(),q.relative[a]&&(a+=p.shift()),k=B(a,k);else if(!e&&(1<p.length&&9===b.nodeType&&!K&&q.match.ID.test(p[0])&&!q.match.ID.test(p[p.length-1]))&&(h=n.find(p.shift(),b,K),b=h.expr?n.filter(h.expr,h.set)[0]:h.set[0]),b)for(h=e?{expr:p.pop(),set:r(e)}:n.find(p.pop(),1!==p.length||"~"!==p[0]&&"+"!==p[0]||!b.parentNode?b:b.parentNode,K),k=h.expr?n.filter(h.expr,
h.set):h.set,0<p.length?t=r(k):m=!1;p.length;)h=G=p.pop(),q.relative[G]?h=p.pop():G="",null==h&&(h=b),q.relative[G](t,h,K);else t=[];t||(t=k);t||n.error(G||a);if("[object Array]"===f.call(t))if(m)if(b&&1===b.nodeType)for(a=0;null!=t[a];a++)t[a]&&(!0===t[a]||1===t[a].nodeType&&n.contains(b,t[a]))&&c.push(k[a]);else for(a=0;null!=t[a];a++)t[a]&&1===t[a].nodeType&&c.push(k[a]);else c.push.apply(c,t);else r(t,c);l&&(n(l,g,c,e),n.uniqueSort(c));return c};n.uniqueSort=function(a){if(u&&(g=k,a.sort(u),g))for(var b=
1;b<a.length;b++)a[b]===a[b-1]&&a.splice(b--,1);return a};n.matches=function(a,b){return n(a,null,null,b)};n.matchesSelector=function(a,b){return 0<n(b,null,null,[a]).length};n.find=function(a,b,c){var d;if(!a)return[];for(var e=0,f=q.order.length;e<f;e++){var g,h=q.order[e];if(g=q.leftMatch[h].exec(a)){var k=g[1];g.splice(1,1);if("\\"!==k.substr(k.length-1)&&(g[1]=(g[1]||"").replace(l,""),d=q.find[h](g,b,c),null!=d)){a=a.replace(q.match[h],"");break}}}d||(d="undefined"!==typeof b.getElementsByTagName?
b.getElementsByTagName("*"):[]);return{set:d,expr:a}};n.filter=function(a,c,d,e){for(var f,g,h=a,k=[],t=c,l=c&&c[0]&&n.isXML(c[0]);a&&c.length;){for(var G in q.filter)if(null!=(f=q.leftMatch[G].exec(a))&&f[2]){var m,K,D=q.filter[G];K=f[1];g=!1;f.splice(1,1);if("\\"!==K.substr(K.length-1)){t===k&&(k=[]);if(q.preFilter[G])if(f=q.preFilter[G](f,t,d,k,e,l),!f)g=m=!0;else if(!0===f)continue;if(f)for(var X=0;null!=(K=t[X]);X++)if(K){m=D(K,f,X,t);var p=e^!!m;d&&null!=m?p?g=!0:t[X]=!1:p&&(k.push(K),g=!0)}if(m!==
b){d||(t=k);a=a.replace(q.match[G],"");if(!g)return[];break}}}if(a===h)if(null==g)n.error(a);else break;h=a}return t};n.error=function(a){throw"Syntax error, unrecognized expression: "+a;};var q=n.selectors={order:["ID","NAME","TAG"],match:{ID:/#((?:[\w\u00c0-\uFFFF\-]|\\.)+)/,CLASS:/\.((?:[\w\u00c0-\uFFFF\-]|\\.)+)/,NAME:/\[name=['"]*((?:[\w\u00c0-\uFFFF\-]|\\.)+)['"]*\]/,ATTR:/\[\s*((?:[\w\u00c0-\uFFFF\-]|\\.)+)\s*(?:(\S?=)\s*(?:(['"])(.*?)\3|(#?(?:[\w\u00c0-\uFFFF\-]|\\.)*)|)|)\s*\]/,TAG:/^((?:[\w\u00c0-\uFFFF\*\-]|\\.)+)/,
CHILD:/:(only|nth|last|first)-child(?:\(\s*(even|odd|(?:[+\-]?\d+|(?:[+\-]?\d*)?n\s*(?:[+\-]\s*\d+)?))\s*\))?/,POS:/:(nth|eq|gt|lt|first|last|even|odd)(?:\((\d*)\))?(?=[^\-]|$)/,PSEUDO:/:((?:[\w\u00c0-\uFFFF\-]|\\.)+)(?:\((['"]?)((?:\([^\)]+\)|[^\(\)]*)+)\2\))?/},leftMatch:{},attrMap:{"class":"className","for":"htmlFor"},attrHandle:{href:function(a){return a.getAttribute("href")},type:function(a){return a.getAttribute("type")}},relative:{"+":function(a,b){var c="string"===typeof b,d=c&&!m.test(b),
c=c&&!d;d&&(b=b.toLowerCase());for(var d=0,e=a.length,f;d<e;d++)if(f=a[d]){for(;(f=f.previousSibling)&&1!==f.nodeType;);a[d]=c||f&&f.nodeName.toLowerCase()===b?f||!1:f===b}c&&n.filter(b,a,!0)},">":function(a,b){var c,d="string"===typeof b,e=0,f=a.length;if(d&&!m.test(b))for(b=b.toLowerCase();e<f;e++){if(c=a[e])c=c.parentNode,a[e]=c.nodeName.toLowerCase()===b?c:!1}else{for(;e<f;e++)(c=a[e])&&(a[e]=d?c.parentNode:c.parentNode===b);d&&n.filter(b,a,!0)}},"":function(b,d,f){var g,h=e++,k=c;"string"!==
typeof d||m.test(d)||(g=d=d.toLowerCase(),k=a);k("parentNode",d,h,b,g,f)},"~":function(b,d,f){var g,h=e++,k=c;"string"!==typeof d||m.test(d)||(g=d=d.toLowerCase(),k=a);k("previousSibling",d,h,b,g,f)}},find:{ID:function(a,b,c){if("undefined"!==typeof b.getElementById&&!c)return(a=b.getElementById(a[1]))&&a.parentNode?[a]:[]},NAME:function(a,b){if("undefined"!==typeof b.getElementsByName){for(var c=[],d=b.getElementsByName(a[1]),e=0,f=d.length;e<f;e++)d[e].getAttribute("name")===a[1]&&c.push(d[e]);
...
(" "+d+" ").indexOf(f):f?"!="===e?d!==f:"^="===e?0===d.indexOf(f):"$="===e?d.substr(d.length-f.length)===f:"|="===e?d===f||d.substr(0,f.length+1)===f+"-":!1:d&&!1!==c},POS:function(a,b,c,d){var e=q.setFilters[b[2]];if(e)return e(a,c,b,d)}}},x=q.match.POS,p=function(a,b){return"\\"+(b-0+1)},y;for(y in q.match)q.match[y]=RegExp(q.match[y].source+/(?![^\[]*\])(?![^\(]*\))/.source),q.leftMatch[y]=RegExp(/(^(?:.|\r|\n)*?)/.source+q.match[y].source.replace(/\\(\d+)/g,p));var r=function(a,b){a=Array.prototype.slice.call(a,
0);return b?(b.push.apply(b,a),b):a};try{Array.prototype.slice.call(v.documentElement.childNodes,0)[0].nodeType}catch(s){r=function(a,b){var c=0,d=b||[];if("[object Array]"===f.call(a))Array.prototype.push.apply(d,a);else if("number"===typeof a.length)for(var e=a.length;c<e;c++)d.push(a[c]);else for(;a[c];c++)d.push(a[c]);return d}}var u,w;v.documentElement.compareDocumentPosition?u=function(a,b){return a===b?(g=!0,0):a.compareDocumentPosition&&b.compareDocumentPosition?a.compareDocumentPosition(b)&
...
9===c.nodeType)){if(f[1])return r(c.getElementsByTagName(b),d);if(f[2]&&q.find.CLASS&&c.getElementsByClassName)return r(c.getElementsByClassName(f[2]),d)}if(9===c.nodeType){if("body"===b&&c.body)return r([c.body],d);if(f&&f[3]){var g=c.getElementById(f[3]);if(g&&g.parentNode){if(g.id===f[3])return r([g],d)}else return r([],d)}try{return r(c.querySelectorAll(b),d)}catch(h){}}else if(1===c.nodeType&&"object"!==c.nodeName.toLowerCase()){var f=c,k=(g=c.getAttribute("id"))||"__sizzle__",t=c.parentNode,
l=/^\s*[+~]/.test(b);g?k=k.replace(/'/g,"\\$&"):c.setAttribute("id",k);l&&t&&(c=c.parentNode);try{if(!l||t)return r(c.querySelectorAll("[id='"+k+"'] "+b),d)}catch(G){}finally{g||f.removeAttribute("id")}}}return a(b,c,d,e)};for(var c in a)n[c]=a[c];b=null}}();(function(){var a=v.documentElement,b=a.matchesSelector||a.mozMatchesSelector||a.webkitMatchesSelector||a.msMatchesSelector;if(b){var c=!b.call(v.createElement("div"),"div"),d=!1;try{b.call(v.documentElement,"[test!='']:sizzle")}catch(e){d=!0}n.matchesSelector=
function(a,e){e=e.replace(/\=\s*([^'"\]]*)\s*\]/g,"='$1']");if(!n.isXML(a))try{if(d||!q.match.PSEUDO.test(e)&&!/!=/.test(e)){var f=b.call(a,e);if(f||!c||a.document&&11!==a.document.nodeType)return f}}catch(g){}return 0<n(e,null,null,[a]).length}}})();(function(){var a=v.createElement("div");a.innerHTML="<div class='test e'></div><div class='test'></div>";a.getElementsByClassName&&0!==a.getElementsByClassName("e").length&&(a.lastChild.className="e",1!==a.getElementsByClassName("e").length&&(q.order.splice(1,
0,"CLASS"),q.find.CLASS=function(a,b,c){if("undefined"!==typeof b.getElementsByClassName&&!c)return b.getElementsByClassName(a[1])},a=null))})();n.contains=v.documentElement.contains?function(a,b){return a!==b&&(a.contains?a.contains(b):!0)}:v.documentElement.compareDocumentPosition?function(a,b){return!!(a.compareDocumentPosition(b)&16)}:function(){return!1};n.isXML=function(a){return(a=(a?a.ownerDocument||a:0).documentElement)?"HTML"!==a.nodeName:!1};var B=function(a,b){for(var c,d=[],e="",f=b.nodeType?
[b]:b;c=q.match.PSEUDO.exec(a);)e+=c[0],a=a.replace(q.match.PSEUDO,"");a=q.relative[a]?a+"*":a;c=0;for(var g=f.length;c<g;c++)n(a,f[c],d);return n.filter(e,d)};h.find=n;h.expr=n.selectors;h.expr[":"]=h.expr.filters;h.unique=n.uniqueSort;h.text=n.getText;h.isXMLDoc=n.isXML;h.contains=n.contains})();var mb=/Until$/,nb=/^(?:parents|prevUntil|prevAll)/,ob=/,/,Wa=/^.[^:#\[\.,]*$/,pb=Array.prototype.slice,Ca=h.expr.match.POS,qb={children:!0,contents:!0,next:!0,prev:!0};h.fn.extend({find:function(a){var b=
this,c,d;if("string"!==typeof a)return h(a).filter(function(){c=0;for(d=b.length;c<d;c++)if(h.contains(b[c],this))return!0});var e=this.pushStack("","find",a),f,g,k;c=0;for(d=this.length;c<d;c++)if(f=e.length,h.find(a,this[c],e),0<c)for(g=f;g<e.length;g++)for(k=0;k<f;k++)if(e[k]===e[g]){e.splice(g--,1);break}return e},has:function(a){var b=h(a);return this.filter(function(){for(var a=0,c=b.length;a<c;a++)if(h.contains(this,b[a]))return!0})},not:function(a){return this.pushStack(n(this,a,!1),"not",
a)},filter:function(a){return this.pushStack(n(this,a,!0),"filter",a)},is:function(a){return!!a&&("string"===typeof a?0<h.filter(a,this).length:0<this.filter(a).length)},closest:function(a,b){var c=[],d,e,f=this[0];if(h.isArray(a)){var g,k={},l=1;if(f&&a.length){d=0;for(e=a.length;d<e;d++)g=a[d],k[g]||(k[g]=Ca.test(g)?h(g,b||this.context):g);for(;f&&f.ownerDocument&&f!==b;){for(g in k)d=k[g],(d.jquery?-1<d.index(f):h(f).is(d))&&c.push({selector:g,elem:f,level:l});f=f.parentNode;l++}}return c}g=Ca.test(a)||
"string"!==typeof a?h(a,b||this.context):0;d=0;for(e=this.length;d<e;d++)for(f=this[d];f;)if(g?-1<g.index(f):h.find.matchesSelector(f,a)){c.push(f);break}else if(f=f.parentNode,!f||!f.ownerDocument||f===b||11===f.nodeType)break;c=1<c.length?h.unique(c):c;return this.pushStack(c,"closest",a)},index:function(a){return a&&"string"!==typeof a?h.inArray(a.jquery?a[0]:a,this):h.inArray(this[0],a?h(a):this.parent().children())},add:function(a,b){var c="string"===typeof a?h(a,b):h.makeArray(a&&a.nodeType?
...
b){h.fn[a]=function(c,d){var e=h.map(this,b,c),f=pb.call(arguments);mb.test(a)||(d=c);d&&"string"===typeof d&&(e=h.filter(d,e));e=1<this.length&&!qb[a]?h.unique(e):e;(1<this.length||ob.test(d))&&nb.test(a)&&(e=e.reverse());return this.pushStack(e,a,f.join(","))}});h.extend({filter:function(a,b,c){c&&(a=":not("+a+")");return 1===b.length?h.find.matchesSelector(b[0],a)?[b[0]]:[]:h.find.matches(a,b)},dir:function(a,c,d){var e=[];for(a=a[c];a&&9!==a.nodeType&&(d===b||1!==a.nodeType||!h(a).is(d));)1===
a.nodeType&&e.push(a),a=a[c];return e},nth:function(a,b,c,d){b=b||1;for(d=0;a&&(1!==a.nodeType||++d!==b);a=a[c]);return a},sibling:function(a,b){for(var c=[];a;a=a.nextSibling)1===a.nodeType&&a!==b&&c.push(a);return c}});var rb=/ jQuery\d+="(?:\d+|null)"/g,pa=/^\s+/,Da=/<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/ig,Ea=/<([\w:]+)/,sb=/<tbody/i,tb=/<|&#?\w+;/,Fa=/<(?:script|object|embed|option|style)/i,Ga=/checked\s*(?:[^=]|=\s*.checked.)/i,ub=/\/(java|ecma)script/i,Xa=/^\s*<!(?:\[CDATA\[|\-\-)/,
F={option:[1,"<select multiple='multiple'>","</select>"],legend:[1,"<fieldset>","</fieldset>"],thead:[1,"<table>","</table>"],tr:[2,"<table><tbody>","</tbody></table>"],td:[3,"<table><tbody><tr>","</tr></tbody></table>"],col:[2,"<table><tbody></tbody><colgroup>","</colgroup></table>"],area:[1,"<map>","</map>"],_default:[0,"",""]};F.optgroup=F.option;F.tbody=F.tfoot=F.colgroup=F.caption=F.thead;F.th=F.td;h.support.htmlSerialize||(F._default=[1,"div<div>","</div>"]);h.fn.extend({text:function(a){return h.isFunction(a)?
this.each(function(b){var c=h(this);c.text(a.call(this,b,c.text()))}):"object"!==typeof a&&a!==b?this.empty().append((this[0]&&this[0].ownerDocument||v).createTextNode(a)):h.text(this)},wrapAll:function(a){if(h.isFunction(a))return this.each(function(b){h(this).wrapAll(a.call(this,b))});if(this[0]){var b=h(a,this[0].ownerDocument).eq(0).clone(!0);this[0].parentNode&&b.insertBefore(this[0]);b.map(function(){for(var a=this;a.firstChild&&1===a.firstChild.nodeType;)a=a.firstChild;return a}).append(this)}return this},
...
b?a:b;return this.map(function(){return h.clone(this,a,b)})},html:function(a){if(a===b)return this[0]&&1===this[0].nodeType?this[0].innerHTML.replace(rb,""):null;if("string"!==typeof a||Fa.test(a)||!h.support.leadingWhitespace&&pa.test(a)||F[(Ea.exec(a)||["",""])[1].toLowerCase()])h.isFunction(a)?this.each(function(b){var c=h(this);c.html(a.call(this,b,c.html()))}):this.empty().append(a);else{a=a.replace(Da,"<$1></$2>");try{for(var c=0,d=this.length;c<d;c++)1===this[c].nodeType&&(h.cleanData(this[c].getElementsByTagName("*")),
...
!0)},domManip:function(a,c,d){var e,f,g,k=a[0],l=[];if(!h.support.checkClone&&3===arguments.length&&"string"===typeof k&&Ga.test(k))return this.each(function(){h(this).domManip(a,c,d,!0)});if(h.isFunction(k))return this.each(function(e){var f=h(this);a[0]=k.call(this,e,c?f.html():b);f.domManip(a,c,d)});if(this[0]){e=k&&k.parentNode;e=h.support.parentNode&&e&&11===e.nodeType&&e.childNodes.length===this.length?{fragment:e}:h.buildFragment(a,this,l);g=e.fragment;if(f=1===g.childNodes.length?g=g.firstChild:
g.firstChild){c=c&&h.nodeName(f,"tr");f=0;for(var m=this.length,n=m-1;f<m;f++)d.call(c?h.nodeName(this[f],"table")?this[f].getElementsByTagName("tbody")[0]||this[f].appendChild(this[f].ownerDocument.createElement("tbody")):this[f]:this[f],e.cacheable||1<m&&f<n?h.clone(g,!0,!0):g)}l.length&&h.each(l,z)}return this}});h.buildFragment=function(a,b,c){var d,e,f,g;b&&b[0]&&(g=b[0].ownerDocument||b[0]);g.createDocumentFragment||(g=v);1===a.length&&("string"===typeof a[0]&&512>a[0].length&&g===v&&"<"===
a[0].charAt(0)&&!Fa.test(a[0])&&(h.support.checkClone||!Ga.test(a[0])))&&(e=!0,(f=h.fragments[a[0]])&&1!==f&&(d=f));d||(d=g.createDocumentFragment(),h.clean(a,g,d,c));e&&(h.fragments[a[0]]=f?d:1);return{fragment:d,cacheable:e}};h.fragments={};h.each({appendTo:"append",prependTo:"prepend",insertBefore:"before",insertAfter:"after",replaceAll:"replaceWith"},function(a,b){h.fn[a]=function(c){var d=[];c=h(c);var e=1===this.length&&this[0].parentNode;if(e&&11===e.nodeType&&1===e.childNodes.length&&1===
c.length)return c[b](this[0]),this;for(var e=0,f=c.length;e<f;e++){var g=(0<e?this.clone(!0):this).get();h(c[e])[b](g);d=d.concat(g)}return this.pushStack(d,a,c.selector)}});h.extend({clone:function(a,b,c){var d=a.cloneNode(!0),e,f,g;if(!(h.support.noCloneEvent&&h.support.noCloneChecked||1!==a.nodeType&&11!==a.nodeType||h.isXMLDoc(a)))for(s(a,d),e=r(a),f=r(d),g=0;e[g];++g)s(e[g],f[g]);if(b&&(p(a,d),c))for(e=r(a),f=r(d),g=0;e[g];++g)p(e[g],f[g]);return d},clean:function(a,b,c,d){b=b||v;"undefined"===
typeof b.createElement&&(b=b.ownerDocument||b[0]&&b[0].ownerDocument||v);for(var e=[],f,g=0,k;null!=(k=a[g]);g++)if("number"===typeof k&&(k+=""),k){if("string"===typeof k)if(tb.test(k)){k=k.replace(Da,"<$1></$2>");f=(Ea.exec(k)||["",""])[1].toLowerCase();var l=F[f]||F._default,m=l[0],n=b.createElement("div");for(n.innerHTML=l[1]+k+l[2];m--;)n=n.lastChild;if(!h.support.tbody)for(m=sb.test(k),l="table"!==f||m?"<table>"!==l[1]||m?[]:n.childNodes:n.firstChild&&n.firstChild.childNodes,f=l.length-1;0<=
f;--f)h.nodeName(l[f],"tbody")&&!l[f].childNodes.length&&l[f].parentNode.removeChild(l[f]);!h.support.leadingWhitespace&&pa.test(k)&&n.insertBefore(b.createTextNode(pa.exec(k)[0]),n.firstChild);k=n.childNodes}else k=b.createTextNode(k);var q;if(!h.support.appendChecked)if(k[0]&&"number"===typeof(q=k.length))for(f=0;f<q;f++)w(k[f]);else w(k);k.nodeType?e.push(k):e=h.merge(e,k)}if(c)for(a=function(a){return!a.type||ub.test(a.type)},g=0;e[g];g++)!d||!h.nodeName(e[g],"script")||e[g].type&&"text/javascript"!==
e[g].type.toLowerCase()?(1===e[g].nodeType&&(b=h.grep(e[g].getElementsByTagName("script"),a),e.splice.apply(e,[g+1,0].concat(b))),c.appendChild(e[g])):d.push(e[g].parentNode?e[g].parentNode.removeChild(e[g]):e[g]);return e},cleanData:function(a){for(var b,c,d=h.cache,e=h.expando,f=h.event.special,g=h.support.deleteExpando,k=0,l;null!=(l=a[k]);k++)if(!l.nodeName||!h.noData[l.nodeName.toLowerCase()])if(c=l[h.expando]){if((b=d[c]&&d[c][e])&&b.events){for(var m in b.events)f[m]?h.event.remove(l,m):h.removeEvent(l,
m,b.handle);b.handle&&(b.handle.elem=null)}g?delete l[h.expando]:l.removeAttribute&&l.removeAttribute(h.expando);delete d[c]}}});var Ha=/alpha\([^)]*\)/i,vb=/opacity=([^)]*)/,wb=/([A-Z]|^ms)/g,Ia=/^-?\d+(?:px)?$/i,xb=/^-?\d/,yb=/^[+\-]=/,zb=/[^+\-\.\de]+/g,Ab={position:"absolute",visibility:"hidden",display:"block"},Ya=["Left","Right"],Za=["Top","Bottom"],N,Ja,Ka;h.fn.css=function(a,c){return 2===arguments.length&&c===b?this:h.access(this,a,c,!0,function(a,c,d){return d!==b?h.style(a,c,d):h.css(a,
c)})};h.extend({cssHooks:{opacity:{get:function(a,b){if(b){var c=N(a,"opacity","opacity");return""===c?"1":c}return a.style.opacity}}},cssNumber:{fillOpacity:!0,fontWeight:!0,lineHeight:!0,opacity:!0,orphans:!0,widows:!0,zIndex:!0,zoom:!0},cssProps:{"float":h.support.cssFloat?"cssFloat":"styleFloat"},style:function(a,c,d,e){if(a&&3!==a.nodeType&&8!==a.nodeType&&a.style){var f,g=h.camelCase(c),k=a.style,l=h.cssHooks[g];c=h.cssProps[g]||g;if(d!==b){if(e=typeof d,!("number"===e&&isNaN(d)||null==d||("string"===
e&&yb.test(d)&&(d=+d.replace(zb,"")+parseFloat(h.css(a,c)),e="number"),"number"!==e||h.cssNumber[g]||(d+="px"),l&&"set"in l&&(d=l.set(a,d))===b)))try{k[c]=d}catch(m){}}else return l&&"get"in l&&(f=l.get(a,!1,e))!==b?f:k[c]}},css:function(a,c,d){var e,f;c=h.camelCase(c);f=h.cssHooks[c];c=h.cssProps[c]||c;"cssFloat"===c&&(c="float");if(f&&"get"in f&&(e=f.get(a,!0,d))!==b)return e;if(N)return N(a,c)},swap:function(a,b,c){var d={},e;for(e in b)d[e]=a.style[e],a.style[e]=b[e];c.call(a);for(e in b)a.style[e]=
d[e]}});h.curCSS=h.css;h.each(["height","width"],function(a,b){h.cssHooks[b]={get:function(a,c,d){var e;if(c){if(0!==a.offsetWidth)return q(a,b,d);h.swap(a,Ab,function(){e=q(a,b,d)});return e}},set:function(a,b){if(Ia.test(b)){if(b=parseFloat(b),0<=b)return b+"px"}else return b}}});h.support.opacity||(h.cssHooks.opacity={get:function(a,b){return vb.test((b&&a.currentStyle?a.currentStyle.filter:a.style.filter)||"")?parseFloat(RegExp.$1)/100+"":b?"1":""},set:function(a,b){var c=a.style,d=a.currentStyle;
c.zoom=1;var e=h.isNaN(b)?"":"alpha(opacity="+100*b+")",d=d&&d.filter||c.filter||"";c.filter=Ha.test(d)?d.replace(Ha,e):d+" "+e}});h(function(){h.support.reliableMarginRight||(h.cssHooks.marginRight={get:function(a,b){var c;h.swap(a,{display:"inline-block"},function(){c=b?N(a,"margin-right","marginRight"):a.style.marginRight});return c}})});v.defaultView&&v.defaultView.getComputedStyle&&(Ja=function(a,c){var d,e;c=c.replace(wb,"-$1").toLowerCase();if(!(e=a.ownerDocument.defaultView))return b;if(e=
e.getComputedStyle(a,null))d=e.getPropertyValue(c),""!==d||h.contains(a.ownerDocument.documentElement,a)||(d=h.style(a,c));return d});v.documentElement.currentStyle&&(Ka=function(a,b){var c,d=a.currentStyle&&a.currentStyle[b],e=a.runtimeStyle&&a.runtimeStyle[b],f=a.style;!Ia.test(d)&&xb.test(d)&&(c=f.left,e&&(a.runtimeStyle.left=a.currentStyle.left),f.left="fontSize"===b?"1em":d||0,d=f.pixelLeft+"px",f.left=c,e&&(a.runtimeStyle.left=e));return""===d?"auto":d});N=Ja||Ka;h.expr&&h.expr.filters&&(h.expr.filters.hidden=
function(a){var b=a.offsetHeight;return 0===a.offsetWidth&&0===b||!h.support.reliableHiddenOffsets&&"none"===(a.style.display||h.css(a,"display"))},h.expr.filters.visible=function(a){return!h.expr.filters.hidden(a)});var Bb=/%20/g,$a=/\[\]$/,La=/\r?\n/g,Cb=/#.*$/,Db=/^(.*?):[ \t]*([^\r\n]*)\r?$/mg,Eb=/^(?:color|date|datetime|email|hidden|month|number|password|range|search|tel|text|time|url|week)$/i,Fb=/^(?:GET|HEAD)$/,Gb=/^\/\//,Ma=/\?/,Hb=/<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi,Ib=
/^(?:select|textarea)/i,sa=/\s+/,Jb=/([?&])_=[^&]*/,Na=/^([\w\+\.\-]+:)(?:\/\/([^\/?#:]*)(?::(\d+))?)?/,Oa=h.fn.load,ha={},Pa={},L,I;try{L=bb.href}catch(Pb){L=v.createElement("a"),L.href="",L=L.href}I=Na.exec(L.toLowerCase())||[];h.fn.extend({load:function(a,c,d){if("string"!==typeof a&&Oa)return Oa.apply(this,arguments);if(!this.length)return this;var e=a.indexOf(" ");if(0<=e){var f=a.slice(e,a.length);a=a.slice(0,e)}e="GET";c&&(h.isFunction(c)?(d=c,c=b):"object"===typeof c&&(c=h.param(c,h.ajaxSettings.traditional),
e="POST"));var g=this;h.ajax({url:a,type:e,dataType:"html",data:c,complete:function(a,b,c){c=a.responseText;a.isResolved()&&(a.done(function(a){c=a}),g.html(f?h("<div>").append(c.replace(Hb,"")).find(f):c));d&&g.each(d,[c,b,a])}});return this},serialize:function(){return h.param(this.serializeArray())},serializeArray:function(){return this.map(function(){return this.elements?h.makeArray(this.elements):this}).filter(function(){return this.name&&!this.disabled&&(this.checked||Ib.test(this.nodeName)||
Eb.test(this.type))}).map(function(a,b){var c=h(this).val();return null==c?null:h.isArray(c)?h.map(c,function(a,c){return{name:b.name,value:a.replace(La,"\r\n")}}):{name:b.name,value:c.replace(La,"\r\n")}}).get()}});h.each("ajaxStart ajaxStop ajaxComplete ajaxError ajaxSuccess ajaxSend".split(" "),function(a,b){h.fn[b]=function(a){return this.bind(b,a)}});h.each(["get","post"],function(a,c){h[c]=function(a,d,e,f){h.isFunction(d)&&(f=f||e,e=d,d=b);return h.ajax({type:c,url:a,data:d,success:e,dataType:f})}});
h.extend({getScript:function(a,c){return h.get(a,b,c,"script")},getJSON:function(a,b,c){return h.get(a,b,c,"json")},ajaxSetup:function(a,b){b?h.extend(!0,a,h.ajaxSettings,b):(b=a,a=h.extend(!0,h.ajaxSettings,b));for(var c in{context:1,url:1})c in b?a[c]=b[c]:c in h.ajaxSettings&&(a[c]=h.ajaxSettings[c]);return a},ajaxSettings:{url:L,isLocal:/^(?:about|app|app\-storage|.+\-extension|file|widget):$/.test(I[1]),global:!0,type:"GET",contentType:"application/x-www-form-urlencoded",processData:!0,async:!0,
accepts:{xml:"application/xml, text/xml",html:"text/html",text:"text/plain",json:"application/json, text/javascript","*":"*/*"},contents:{xml:/xml/,html:/html/,json:/json/},responseFields:{xml:"responseXML",text:"responseText"},converters:{"* text":a.String,"text html":!0,"text json":h.parseJSON,"text xml":h.parseXML}},ajaxPrefilter:x(ha),ajaxTransport:x(Pa),ajax:function(a,c){function d(a,c,t,q){if(2!==v){v=2;u&&clearTimeout(u);s=b;x=q||"";A.readyState=a?4:0;var p,G,y;if(t){q=e;var r=A,D=q.contents,
w=q.dataTypes,z=q.responseFields,E,C,M,fa;for(C in z)C in t&&(r[z[C]]=t[C]);for(;"*"===w[0];)w.shift(),E===b&&(E=q.mimeType||r.getResponseHeader("content-type"));if(E)for(C in D)if(D[C]&&D[C].test(E)){w.unshift(C);break}if(w[0]in t)M=w[0];else{for(C in t){if(!w[0]||q.converters[C+" "+w[0]]){M=C;break}fa||(fa=C)}M=M||fa}M?(M!==w[0]&&w.unshift(M),t=t[M]):t=void 0}else t=b;if(200<=a&&300>a||304===a){if(e.ifModified){if(E=A.getResponseHeader("Last-Modified"))h.lastModified[n]=E;if(E=A.getResponseHeader("Etag"))h.etag[n]=
E}if(304===a)c="notmodified",p=!0;else try{E=e;E.dataFilter&&(t=E.dataFilter(t,E.dataType));var Q=E.dataTypes;C={};var F,Y,aa=Q.length,H,O=Q[0],J,L,P,I,R;for(F=1;F<aa;F++){if(1===F)for(Y in E.converters)"string"===typeof Y&&(C[Y.toLowerCase()]=E.converters[Y]);J=O;O=Q[F];if("*"===O)O=J;else if("*"!==J&&J!==O){L=J+" "+O;P=C[L]||C["* "+O];if(!P)for(I in R=b,C)if(H=I.split(" "),H[0]===J||"*"===H[0])if(R=C[H[1]+" "+O]){I=C[I];!0===I?P=R:!0===R&&(P=I);break}P||R||h.error("No conversion from "+L.replace(" ",
" to "));!0!==P&&(t=P?P(t):R(I(t)))}}G=t;c="success";p=!0}catch(N){c="parsererror",y=N}}else if(y=c,!c||a)c="error",0>a&&(a=0);A.status=a;A.statusText=c;p?k.resolveWith(f,[G,c,A]):k.rejectWith(f,[A,c,y]);A.statusCode(m);m=b;B&&g.trigger("ajax"+(p?"Success":"Error"),[A,e,p?G:y]);l.resolveWith(f,[A,c]);B&&(g.trigger("ajaxComplete",[A,e]),--h.active||h.event.trigger("ajaxStop"))}}"object"===typeof a&&(c=a,a=b);c=c||{};var e=h.ajaxSetup({},c),f=e.context||e,g=f!==e&&(f.nodeType||f instanceof h)?h(f):
h.event,k=h.Deferred(),l=h._Deferred(),m=e.statusCode||{},n,q={},p={},x,r,s,u,w,v=0,B,z,A={readyState:0,setRequestHeader:function(a,b){if(!v){var c=a.toLowerCase();a=p[c]=p[c]||a;q[a]=b}return this},getAllResponseHeaders:function(){return 2===v?x:null},getResponseHeader:function(a){var c;if(2===v){if(!r)for(r={};c=Db.exec(x);)r[c[1].toLowerCase()]=c[2];c=r[a.toLowerCase()]}return c===b?null:c},overrideMimeType:function(a){v||(e.mimeType=a);return this},abort:function(a){a=a||"abort";s&&s.abort(a);
d(0,a);return this}};k.promise(A);A.success=A.done;A.error=A.fail;A.complete=l.done;A.statusCode=function(a){if(a){var b;if(2>v)for(b in a)m[b]=[m[b],a[b]];else b=a[A.status],A.then(b,b)}return this};e.url=((a||e.url)+"").replace(Cb,"").replace(Gb,I[1]+"//");e.dataTypes=h.trim(e.dataType||"*").toLowerCase().split(sa);null==e.crossDomain&&(w=Na.exec(e.url.toLowerCase()),e.crossDomain=!(!w||w[1]==I[1]&&w[2]==I[2]&&(w[3]||("http:"===w[1]?80:443))==(I[3]||("http:"===I[1]?80:443))));e.data&&(e.processData&&
"string"!==typeof e.data)&&(e.data=h.param(e.data,e.traditional));y(ha,e,c,A);if(2===v)return!1;B=e.global;e.type=e.type.toUpperCase();e.hasContent=!Fb.test(e.type);B&&0===h.active++&&h.event.trigger("ajaxStart");if(!e.hasContent&&(e.data&&(e.url+=(Ma.test(e.url)?"&":"?")+e.data),n=e.url,!1===e.cache)){w=h.now();var E=e.url.replace(Jb,"$1_="+w);e.url=E+(E===e.url?(Ma.test(e.url)?"&":"?")+"_="+w:"")}(e.data&&e.hasContent&&!1!==e.contentType||c.contentType)&&A.setRequestHeader("Content-Type",e.contentType);
e.ifModified&&(n=n||e.url,h.lastModified[n]&&A.setRequestHeader("If-Modified-Since",h.lastModified[n]),h.etag[n]&&A.setRequestHeader("If-None-Match",h.etag[n]));A.setRequestHeader("Accept",e.dataTypes[0]&&e.accepts[e.dataTypes[0]]?e.accepts[e.dataTypes[0]]+("*"!==e.dataTypes[0]?", */*; q=0.01":""):e.accepts["*"]);for(z in e.headers)A.setRequestHeader(z,e.headers[z]);if(e.beforeSend&&(!1===e.beforeSend.call(f,A,e)||2===v))return A.abort(),!1;for(z in{success:1,error:1,complete:1})A[z](e[z]);if(s=y(Pa,
e,c,A)){A.readyState=1;B&&g.trigger("ajaxSend",[A,e]);e.async&&0<e.timeout&&(u=setTimeout(function(){A.abort("timeout")},e.timeout));try{v=1,s.send(q,d)}catch(C){2>status?d(-1,C):h.error(C)}}else d(-1,"No Transport");return A},param:function(a,c){var d=[],e=function(a,b){b=h.isFunction(b)?b():b;d[d.length]=encodeURIComponent(a)+"="+encodeURIComponent(b)};c===b&&(c=h.ajaxSettings.traditional);if(h.isArray(a)||a.jquery&&!h.isPlainObject(a))h.each(a,function(){e(this.name,this.value)});else for(var f in a)B(f,
a[f],c,e);return d.join("&").replace(Bb,"+")}});h.extend({active:0,lastModified:{},etag:{}});var Kb=h.now(),ea=/(\=)\?(&|$)|\?\?/i;h.ajaxSetup({jsonp:"callback",jsonpCallback:function(){return h.expando+"_"+Kb++}});h.ajaxPrefilter("json jsonp",function(b,c,d){c="application/x-www-form-urlencoded"===b.contentType&&"string"===typeof b.data;if("jsonp"===b.dataTypes[0]||!1!==b.jsonp&&(ea.test(b.url)||c&&ea.test(b.data))){var e,f=b.jsonpCallback=h.isFunction(b.jsonpCallback)?b.jsonpCallback():b.jsonpCallback,
...
e){if(e||!c.readyState||/loaded|complete/.test(c.readyState))c.onload=c.onreadystatechange=null,d&&c.parentNode&&d.removeChild(c),c=b,e||f(200,"success")};d.insertBefore(c,d.firstChild)},abort:function(){if(c)c.onload(0,1)}}}});var qa=a.ActiveXObject?function(){for(var a in U)U[a](0,1)}:!1,Lb=0,U;h.ajaxSettings.xhr=a.ActiveXObject?function(){var b;if(!(b=!this.isLocal&&A()))a:{try{b=new a.ActiveXObject("Microsoft.XMLHTTP");break a}catch(c){}b=void 0}return b}:A;(function(a){h.extend(h.support,{ajax:!!a,
...
e[l])}catch(m){}g.send(c.hasContent&&c.data||null);d=function(a,e){var l,m,n,q,p;try{if(d&&(e||4===g.readyState))if(d=b,k&&(g.onreadystatechange=h.noop,qa&&delete U[k]),e)4!==g.readyState&&g.abort();else{l=g.status;n=g.getAllResponseHeaders();q={};(p=g.responseXML)&&p.documentElement&&(q.xml=p);q.text=g.responseText;try{m=g.statusText}catch(x){m=""}l||!c.isLocal||c.crossDomain?1223===l&&(l=204):l=q.text?200:404}}catch(y){e||f(-1,y)}q&&f(l,m,q,n)};c.async&&4!==g.readyState?(k=++Lb,qa&&(U||(U={},h(a).unload(qa)),
U[k]=d),g.onreadystatechange=d):d()},abort:function(){d&&d(0,1)}}}});var ia={},H,S,Mb=/^(?:toggle|show|hide)$/,Nb=/^([+\-]=)?([\d+.\-]+)([a-z%]*)$/i,V,ta=[["height","marginTop","marginBottom","paddingTop","paddingBottom"],["width","marginLeft","marginRight","paddingLeft","paddingRight"],["opacity"]],Z,ra=a.webkitRequestAnimationFrame||a.mozRequestAnimationFrame||a.oRequestAnimationFrame;h.fn.extend({show:function(a,b,c){if(a||0===a)return this.animate(C("show",3),a,b,c);c=0;for(var d=this.length;c<
d;c++)a=this[c],a.style&&(b=a.style.display,h._data(a,"olddisplay")||"none"!==b||(b=a.style.display=""),""===b&&"none"===h.css(a,"display")&&h._data(a,"olddisplay",aa(a.nodeName)));for(c=0;c<d;c++)if(a=this[c],a.style&&(b=a.style.display,""===b||"none"===b))a.style.display=h._data(a,"olddisplay")||"";return this},hide:function(a,b,c){if(a||0===a)return this.animate(C("hide",3),a,b,c);a=0;for(b=this.length;a<b;a++)this[a].style&&(c=h.css(this[a],"display"),"none"===c||h._data(this[a],"olddisplay")||
...
f.top+d);null!=b.left&&(l.left=b.left-f.left+k);"using"in b?b.using.call(a,l):e.css(l)}};h.fn.extend({position:function(){if(!this[0])return null;var a=this[0],b=this.offsetParent(),c=this.offset(),d=Qa.test(b[0].nodeName)?{top:0,left:0}:b.offset();c.top-=parseFloat(h.css(a,"marginTop"))||0;c.left-=parseFloat(h.css(a,"marginLeft"))||0;d.top+=parseFloat(h.css(b[0],"borderTopWidth"))||0;d.left+=parseFloat(h.css(b[0],"borderLeftWidth"))||0;return{top:c.top-d.top,left:c.left-d.left}},offsetParent:function(){return this.map(function(){for(var a=
this.offsetParent||v.body;a&&!Qa.test(a.nodeName)&&"static"===h.css(a,"position");)a=a.offsetParent;return a})}});h.each(["Left","Top"],function(a,c){var d="scroll"+c;h.fn[d]=function(c){var e,f;return c===b?(e=this[0],e?(f=Q(e))?f[a?"pageYOffset":"pageXOffset"]||h.support.boxModel&&f.document.documentElement[d]||f.document.body[d]:e[d]:null):this.each(function(){(f=Q(this))?f.scrollTo(a?h(f).scrollLeft():c,a?c:h(f).scrollTop()):this[d]=c})}});h.each(["Height","Width"],function(a,c){var d=c.toLowerCase();
...
f}return 9===e.nodeType?Math.max(e.documentElement["client"+c],e.body["scroll"+c],e.documentElement["scroll"+c],e.body["offset"+c],e.documentElement["offset"+c]):a===b?(e=h.css(e,d),f=parseFloat(e),h.isNaN(f)?e:f):this.css(d,"string"===typeof a?a:a+"px")}});a.jQuery=a.$=h;a.$.rebindWindowContext=function(b){a=b;v=b.document;rootjQuery=$(v);return function(a,b){return new h.fn.init(a,b,rootjQuery)}};var Ra=function(a){for(var b="",c,d=0;a[d];d++)c=a[d],3===c.nodeType||4===c.nodeType?b+=c.nodeValue:
8!==c.nodeType&&(b+=Ra(c.childNodes));return b};h.expr[":"].textEquals=function(a,b,c){b=c[3];return Ra([a]).replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g,"")===b}})(window);jQuery.fn.center=function(){this.css("position","absolute");this.css("top",Math.max(0,($(window).height()-this.outerHeight())/2+$(window).scrollTop())+"px");this.css("left",Math.max(0,($(window).width()-this.outerWidth())/2+$(window).scrollLeft())+"px");return this};
(function(a,b){"function"===typeof define&&define.amd?define([],b):"object"===typeof exports?module.exports=b():a.DeepDiff=b()})(this,function(a){function b(a,b){a.super_=b;a.prototype=Object.create(b.prototype,{constructor:{value:a,enumerable:!1,writable:!0,configurable:!0}})}function c(a,b){Object.defineProperty(this,"kind",{value:a,enumerable:!0});b&&b.length&&Object.defineProperty(this,"path",{value:b,enumerable:!0})}function d(a,b,c){d.super_.call(this,"E",a);Object.defineProperty(this,"lhs",
{value:b,enumerable:!0});Object.defineProperty(this,"rhs",{value:c,enumerable:!0})}function e(a,b){e.super_.call(this,"N",a);Object.defineProperty(this,"rhs",{value:b,enumerable:!0})}function f(a,b){f.super_.call(this,"D",a);Object.defineProperty(this,"lhs",{value:b,enumerable:!0})}function g(a,b,c){g.super_.call(this,"A",a);Object.defineProperty(this,"index",{value:b,enumerable:!0});Object.defineProperty(this,"item",{value:c,enumerable:!0})}function k(a,b,c){c=a.slice((c||b)+1||a.length);a.length=
0>b?a.length+b:b;a.push.apply(a,c);return a}function l(a){var b=typeof a;return"object"!==b?b:a===Math?"math":null===a?"null":Array.isArray(a)?"array":"[object Date]"===Object.prototype.toString.call(a)?"date":/^\/.*\//.test(a.toString())?"regexp":"object"}function m(b,c,n,p,r,s,w){r=r||[];var u=r.slice(0);if("undefined"!==typeof s){if(p&&p(u,s,{lhs:b,rhs:c}))return;u.push(s)}"regexp"===l(b)&&"regexp"===l(c)&&(b=b.toString(),c=c.toString());r=typeof b;s=typeof c;if("undefined"===r)"undefined"!==s&&
n(new e(u,c));else if("undefined"===s)n(new f(u,b));else if(l(b)!==l(c))n(new d(u,b,c));else if("[object Date]"===Object.prototype.toString.call(b)&&"[object Date]"===Object.prototype.toString.call(c)&&0!==b-c)n(new d(u,b,c));else if("object"===r&&null!==b&&null!==c){if(w=w||[],0>w.indexOf(b)){w.push(b);if(Array.isArray(b)){for(r=0;r<b.length;r++)r>=c.length?n(new g(u,r,new f(a,b[r]))):m(b[r],c[r],n,p,u,r,w);for(;r<c.length;)n(new g(u,r,new e(a,c[r++])))}else{r=Object.keys(b);var z=Object.keys(c);
r.forEach(function(d,e){var f=z.indexOf(d);0<=f?(m(b[d],c[d],n,p,u,d,w),z=k(z,f)):m(b[d],a,n,p,u,d,w)});z.forEach(function(b){m(a,c[b],n,p,u,b,w)})}w.length-=1}}else b!==c&&("number"===r&&isNaN(b)&&isNaN(c)||n(new d(u,b,c)))}function n(b,c,d,e){e=e||[];m(b,c,function(a){a&&e.push(a)},d);return e.length?e:a}function p(a,b,c){if(c.path&&c.path.length){b=a[b];var d,e=c.path.length-1;for(d=0;d<e;d++)b=b[c.path[d]];switch(c.kind){case "A":p(b[c.path[d]],c.index,c.item);break;case "D":delete b[c.path[d]];
break;case "E":case "N":b[c.path[d]]=c.rhs}}else switch(c.kind){case "A":p(a[b],c.index,c.item);break;case "D":a=k(a,b);break;case "E":case "N":a[b]=c.rhs}return a}function s(a,b,c){if(a&&b&&c&&c.kind){b=-1;for(var d=c.path?c.path.length-1:0;++b<d;)"undefined"===typeof a[c.path[b]]&&(a[c.path[b]]="number"===typeof c.path[b]?[]:{}),a=a[c.path[b]];switch(c.kind){case "A":p(c.path?a[c.path[b]]:a,c.index,c.item);break;case "D":delete a[c.path[b]];break;case "E":case "N":a[c.path[b]]=c.rhs}}}function r(a,
b,c){if(c.path&&c.path.length){b=a[b];var d,e=c.path.length-1;for(d=0;d<e;d++)b=b[c.path[d]];switch(c.kind){case "A":r(b[c.path[d]],c.index,c.item);break;case "D":b[c.path[d]]=c.lhs;break;case "E":b[c.path[d]]=c.lhs;break;case "N":delete b[c.path[d]]}}else switch(c.kind){case "A":r(a[b],c.index,c.item);break;case "D":a[b]=c.lhs;break;case "E":a[b]=c.lhs;break;case "N":a=k(a,b)}return a}var u,w,z=[];u="object"===typeof global&&global?global:"undefined"!==typeof window?window:{};(w=u.DeepDiff)&&z.push(function(){"undefined"!==
typeof w&&u.DeepDiff===n&&(u.DeepDiff=w,w=a)});b(d,c);b(e,c);b(f,c);b(g,c);Object.defineProperties(n,{diff:{value:n,enumerable:!0},observableDiff:{value:m,enumerable:!0},applyDiff:{value:function(a,b,c){a&&b&&m(a,b,function(d){c&&!c(a,b,d)||s(a,b,d)})},enumerable:!0},applyChange:{value:s,enumerable:!0},revertChange:{value:function(a,b,c){if(a&&b&&c&&c.kind){var d;d=c.path.length-1;for(b=0;b<d;b++)"undefined"===typeof a[c.path[b]]&&(a[c.path[b]]={}),a=a[c.path[b]];switch(c.kind){case "A":r(a[c.path[b]],
c.index,c.item);break;case "D":a[c.path[b]]=c.lhs;break;case "E":a[c.path[b]]=c.lhs;break;case "N":delete a[c.path[b]]}}},enumerable:!0},isConflict:{value:function(){return"undefined"!==typeof w},enumerable:!0},noConflict:{value:function(){z&&(z.forEach(function(a){a()}),z=null);return n},enumerable:!0}});return n});
(function(a){var b={vertical:{x:!1,y:!0},horizontal:{x:!0,y:!1},both:{x:!0,y:!0},x:{x:!0,y:!1},y:{x:!1,y:!0}},c={duration:"fast",direction:"both"},d=/^(?:html)$/i,e=function(b){var c=a(window),e=d.test(b[0].nodeName),f;if(e)f={top:0,left:0,bottom:0,right:0};else{var n=b[0],p;p=document.defaultView&&document.defaultView.getComputedStyle?document.defaultView.getComputedStyle(n,null):n.currentStyle;var s=document.defaultView&&document.defaultView.getComputedStyle?!0:!1;f=parseFloat(s?p.borderTopWidth:
a.css(n,"borderTopWidth"))||0;var r=parseFloat(s?p.borderLeftWidth:a.css(n,"borderLeftWidth"))||0,u=parseFloat(s?p.borderBottomWidth:a.css(n,"borderBottomWidth"))||0,n=parseFloat(s?p.borderRightWidth:a.css(n,"borderRightWidth"))||0;f={top:f,left:r,bottom:u,right:n,vertical:f+u,horizontal:r+n}}c={top:(e?c:b).scrollTop(),left:(e?c:b).scrollLeft()};r={right:e?0:b.innerWidth()-b[0].clientWidth,bottom:e?0:b.innerHeight()-b[0].clientHeight};u=b[0].getBoundingClientRect();return{border:f,scroll:c,scrollbar:r,
rect:{top:e?0:u.top,left:e?0:u.left,bottom:e?b[0].clientHeight:u.bottom,right:e?b[0].clientWidth:u.right}}};a.fn.extend({scrollintoview:function(f){f=a.extend({},c,f);f.direction=b["string"===typeof f.direction&&f.direction.toLowerCase()]||b.both;var k="";!0===f.direction.x&&(k="horizontal");!0===f.direction.y&&(k=k?"both":"vertical");var l=this.eq(0),m=l.closest(":scrollable("+k+")");if(0<m.length){var m=m.eq(0),n=e(l),k=e(m),l=n.rect.top-(k.rect.top+k.border.top),p=k.rect.bottom-k.border.bottom-
k.scrollbar.bottom-n.rect.bottom,s=n.rect.left-(k.rect.left+k.border.left),n=k.rect.right-k.border.right-k.scrollbar.right-n.rect.right,r={};!0===f.direction.y&&(0>l?r.scrollTop=k.scroll.top+l:0<l&&0>p&&(r.scrollTop=k.scroll.top+Math.min(l,-p)));!0===f.direction.x&&(0>s?r.scrollLeft=k.scroll.left+s:0<s&&0>n&&(r.scrollLeft=k.scroll.left+Math.min(s,-n)));a.isEmptyObject(r)?a.isFunction(f.complete)&&f.complete.call(m[0]):(d.test(m[0].nodeName)&&(m=a("html,body")),m.animate(r,f.duration).eq(0).queue(function(b){a.isFunction(f.complete)&&
f.complete.call(m[0]);b()}))}return this}});var f={auto:!0,scroll:!0,visible:!1,hidden:!1};a.extend(a.expr[":"],{scrollable:function(a,c,e,m){c=b["string"===typeof e[3]&&e[3].toLowerCase()]||b.both;e=document.defaultView&&document.defaultView.getComputedStyle?document.defaultView.getComputedStyle(a,null):a.currentStyle;var n=f[e.overflowX.toLowerCase()]||!1,p=f[e.overflowY.toLowerCase()]||!1,s=d.test(a.nodeName);if(!n&&!p&&!s)return!1;a={height:{scroll:a.scrollHeight,client:a.clientHeight},width:{scroll:a.scrollWidth,
client:a.clientWidth},scrollableX:function(){return(n||s)&&this.width.scroll>this.width.client},scrollableY:function(){return(p||s)&&this.height.scroll>this.height.client}};return c.y&&a.scrollableY()||c.x&&a.scrollableX()}})})(jQuery);
"undefined"==typeof JooseX||JooseX.SimpleRequest||Class("JooseX.SimpleRequest",{have:{req:null},methods:{initialize:function(){this.req=window.XMLHttpRequest?new XMLHttpRequest:new ActiveXObject("Microsoft.XMLHTTP")},getText:function(a,b,c,d){var e=this.req,f,g;"string"!=typeof a?(f=a.headers,g=a.url,b=b||a.async,c=c||a.callback,d=d||a.scope):g=a;e.open("GET",g,b||!1);f&&Joose.O.eachOwn(f,function(a,b){e.setRequestHeader(b,a)});try{e.onreadystatechange=function(a){b&&4==e.readyState&&(200==e.status||
...
Role("Siesta.Test.Simulate.Mouse",{requires:["simulateEvent","getSimulateEventsWith","normalizeElement","isTextInput"],has:{dragDelay:25,moveCursorBetweenPoints:!0,mouseMovePrecision:$.browser.msie?10:5,enableUnreachableClickWarning:!0,autoScrollElementsIntoView:!0,overEls:Joose.I.Array,delayAfterScrollIntoView:200},after:{cleanup:function(){this.overEls=null}},methods:{createMouseEvent:function(a,b,c){var d,e=this.global;b=$.extend({bubbles:!/(ms)?(mouse|pointer)enter/i.test(a)&&!/(ms)?(mouse|pointer)leave/i.test(a),
cancelable:!/(ms)?(mouse|pointer)move/i.test(a),view:e,detail:0,screenX:0,screenY:0,ctrlKey:!1,altKey:!1,shiftKey:!1,metaKey:!1,button:0,relatedTarget:void 0},b);if(!("clientX"in b&&"clientY"in b)){var f=this.findCenter(c);b=$.extend({clientX:f[0],clientY:f[1]},b)}"screenX"in window&&(b=$.extend(b,{screenX:e.screenX+b.clientX,screenY:e.screenY+b.clientY}));c=c.ownerDocument;c.createEvent&&"dispatchEvent"==this.getSimulateEventsWith()?(f=a.match(/^(ms)?pointer/i),d=c.createEvent(f?(f[1]?"MS":"")+"PointerEvent":
"MouseEvents"),d[f?"initPointerEvent":"initMouseEvent"](a,b.bubbles,b.cancelable,b.view,b.detail,b.screenX,b.screenY,b.clientX,b.clientY,b.ctrlKey,b.altKey,b.shiftKey,b.metaKey,b.button,b.relatedTarget||c.documentElement,null,null,null,null,null,null,null,null,null,4,null,null)):c.createEventObject&&(d=c.createEventObject(),$.extend(d,b),d.button={0:1,1:4,2:2}[d.button]||d.button);"mouseover"!==a&&"mouseout"!==a&&(f=c.defaultView||c.parentWindow,a=b.clientX,c=b.clientY,f!==e&&(e=this.$(f.frameElement).offset(),
a+=e.left,c+=e.top),b.doNotUpdateCurrentPosition||(this.currentPosition[0]=a,this.currentPosition[1]=c));return d},moveMouseTo:function(a,b,c,d,e){if(!a)throw"Trying to call moveMouseTo without a target";!1!==e?this.waitForTargetAndSyncMousePosition(a,d,function(){this.afterMouseInteraction();b.call(c||this)},[],!1):(a=this.getNormalizedTopElementInfo(a,!0,"moveMouseTo",d))?this.syncCursor(a.globalXY,b||function(){}):b&&b.call(c||this)},moveCursorTo:function(a,b,c,d){this.moveMouseTo.apply(this,arguments)},
moveMouseBy:function(a,b,c){this.moveCursorBy.apply(this,arguments)},moveCursorBy:function(a,b,c){if(!a)throw"Trying to call moveCursorBy without relative distances";this.moveMouse(this.currentPosition,[this.currentPosition[0]+a[0],this.currentPosition[1]+a[1]],b,c)},moveMouse:function(a,b,c,d,e,f,g){var k=this;this.movePointerTemplate({xy:a,xy2:b,callback:c,scope:d,options:g||{},overEls:this.overEls,interval:!1!==f?this.dragDelay:0,callbackDelay:!1!==f?50:0,precision:e||k.mouseMovePrecision,onVoidOverEls:function(){return k.overEls=
[]},onPointerEnter:function(a,b,c){k.simulateEvent(a,"mouseenter",b,c)},onPointerLeave:function(a,b,c){k.simulateEvent(a,"mouseleave",b,c)},onPointerOver:function(a,b,c){k.simulateEvent(a,"mouseover",b,c)},onPointerOut:function(a,b,c){k.simulateEvent(a,"mouseout",b,c)},onPointerMove:function(a,b,c){k.simulateEvent(a,"mousemove",b,c)}})},nodeIsUnloaded:function(a){try{a&&a.tagName;var b=a.ownerDocument;return!Boolean(b&&(b.defaultView||b.parentWindow))}catch(c){return!0}},movePointerTemplate:function(a){var b=
this.global.document,c=this,d=a.overEls,e=d[d.length-1];e&&this.nodeIsUnloaded(e)&&(e=null,d=a.onVoidOverEls());for(var f=a.precision,g=a.options||{},k=this.getPathBetweenPoints(a.xy,a.xy2),l=Siesta.Harness.Browser.FeatureSupport().supports,m=new Siesta.Util.Queue({deferer:this.originalSetTimeout,deferClearer:this.originalClearTimeout,interval:a.interval,callbackDelay:a.callbackDelay,observeTest:this,processor:function(f,m){for(var n=f.targetIndex,p=f.sourceIndex;p<=n;p++){var q=k[p],s=c.elementFromPoint(q[0],
q[1]);if(s){if(s.ownerDocument!==b){var y=c.$((s.ownerDocument.defaultView||s.ownerDocument.parentWindow).frameElement).offset();q[0]-=y.left;q[1]-=y.top}if(s!==e){for(var B=d.length-1;0<=B;B--)if(y=d[B],c.nodeIsUnloaded(y))d.splice(B,1);else if(y!==s&&0===c.$(y).has(s).length){if(l.mouseEnterLeave)a.onPointerLeave(y,$.extend({clientX:q[0],clientY:q[1],relatedTarget:s},g));d.splice(B,1)}if(e)a.onPointerOut(e,$.extend({clientX:q[0],clientY:q[1],relatedTarget:s},g));if(l.mouseEnterLeave&&-1==jQuery.inArray(s,
d)){for(var y=[],B=s.ownerDocument.documentElement,A=s;A&&A!=B;)y.unshift(A),A=A.parentNode;for(B=0;B<y.length;B++)-1==jQuery.inArray(y[B],d)&&(a.onPointerEnter(y[B],$.extend({clientX:q[0],clientY:q[1],relatedTarget:e},g)),d.push(y[B]))}a.onPointerOver(s,$.extend({clientX:q[0],clientY:q[1],relatedTarget:e},g));e=s}a.onPointerMove(s,$.extend({clientX:q[0],clientY:q[1]},g),p<n)}}}}),n=0,p=k.length;n<p;n+=f)m.addStep({sourceIndex:n,targetIndex:Math.min(n+f-1,k.length-1)});var s=this.beginAsync();m.run(function(){c.endAsync(s);
c.processCallbackFromTest(a.callback,null,a.scope||c)})},waitForTargetAndSyncMousePosition:function(a,b,c,d,e,f){var g,k="Array"!=this.typeOf(a),l=this.suppressPassedWaitForAssertion;this.suppressPassedWaitForAssertion=!0;this.chain({waitForAnimations:[]},k&&{waitForElementVisible:a},k&&this.autoScrollElementsIntoView?function(c){!0===this.scrollTargetIntoView(a,b)?this.waitFor(this.delayAfterScrollIntoView,c):c()}:null,function(d){g=this.getNormalizedTopElementInfo(a,!0,c.toString(),b).globalXY;
this.moveCursorBetweenPoints&&!1!==f?this.syncCursor(g,d):d()},!1!==e&&k&&function(c){this.waitForTarget(a,c,this,null,b)},function(m){var n=(m=this.getNormalizedTopElementInfo(a,!0,c.toString(),b))&&m.globalXY;!k||m&&g[0]===n[0]&&g[1]===n[1]?(this.suppressPassedWaitForAssertion=l,c.apply(this,d)):(this.diag(Siesta.Resource("Siesta.Test.Browser","targetMoved")),this.waitFor(100,function(){this.waitForTargetAndSyncMousePosition(a,b,c,d,e,f)}))})},afterMouseInteraction:function(){var a=this.overEls,
a=a[a.length-1];this.global.document.body&&a&&(this.nodeIsUnloaded(a)?(this.overEls=[],this.mouseOver(this.currentPosition)):$.contains(a,a.ownerDocument.body)||this.mouseOver(this.currentPosition))},genericMouseClick:function(a,b,c,d,e,f,g){jQuery.isFunction(a)&&(c=b,b=a,a=null);a=a||this.currentPosition;!1!==g&&b?this.waitForTargetAndSyncMousePosition(a,f,this.genericMouseClick,[a,b,c,d,e,f,!1]):(d=d||{},(g=this.getNormalizedTopElementInfo(a,!0,e,f))?(g.originalEl=a,g.method=e,g.offset=f,d.clientX=
null!=d.clientX?d.clientX:g.localXY[0],d.clientY=null!=d.clientY?d.clientY:g.localXY[1],this[e](g,b,c,d)):b&&b.call(c||this))},click:function(a,b,c,d,e,f){this.genericMouseClick(a,b,c,d,"simulateMouseClick",e,f)},rightClick:function(a,b,c,d,e,f){this.genericMouseClick(a,b,c,d,"simulateRightClick",e,f)},doubleClick:function(a,b,c,d,e,f){this.genericMouseClick(a,b,c,d,"simulateDoubleClick",e,f)},mouseDown:function(a,b,c,d,e,f){this.genericMouseClick(a,d,e,b,"simulateMouseDown",c,f)},simulateMouseDown:function(a,
...
"mouseover",b))},mouseOut:function(a,b){var c=this.getNormalizedTopElementInfo(a,!0);c&&(b=b||{},b.clientX=null!=b.clientX?b.clientX:c.localXY[0],b.clientY=null!=b.clientY?b.clientY:c.localXY[1],this.simulateEvent(a,"mouseout",b))},processMouseClickSteps:function(a,b,c,d,e){a.originalEl&&this.enableUnreachableClickWarning&&this.getNormalizedTopElementInfo(a.originalEl,!1,a.method,a.offset);var f=this,g=a.globalXY[0],k=a.globalXY[1],l="option"===a.el.nodeName.toLowerCase(),m=f.global.document,n=m.body.scrollTop,
p=l?a.el:f.elementFromPoint(g,k,!1,a.el),s=!1,r=new Siesta.Util.Queue({deferer:this.originalSetTimeout,deferClearer:this.originalClearTimeout,interval:b?10:0,callbackDelay:f.afterActionDelay,observeTest:this,processor:function(a){var b=m.body?m.body.scrollTop-n:0,b=l?p:f.elementFromPoint(g,k-b,!1,p);!l&&a.recaptureTarget&&(p=b,s=!1);l||(b==p||$.contains(b,p)||$.contains(p,b))||(s=!0);if(!s||!a.cancelIfTargetChanged){var c=f.simulateEvent(b,a.event,d,a.suppressLog);a.focus&&f.mimicFocusOnMouseDown(b,
c)}}});Joose.A.each(e,function(a){r.addStep(a)});var u=f.beginAsync();r.run(function(){f.endAsync(u);f.afterMouseInteraction();f.processCallbackFromTest(b,null,c||f)})},simulateMouseClick:function(a,b,c,d){this.processMouseClickSteps(a,b,c,d,[{event:"mousedown",suppressLog:!0,focus:!0},{event:"mouseup",suppressLog:!0},{event:"click",suppressLog:!1,cancelIfTargetChanged:!0}])},simulateRightClick:function(a,b,c,d){var e=-1<navigator.platform.indexOf("Mac");d=d||{};d.button=2;this.processMouseClickSteps(a,
b,c,d,[{event:"mousedown",suppressLog:!1,focus:!0}].concat(e?[]:[{event:"mouseup",suppressLog:!0}]).concat([{event:"contextmenu",suppressLog:!1}]))},simulateDoubleClick:function(a,b,c,d){this.processMouseClickSteps(a,b,c,d,[{event:"mousedown",suppressLog:!1,focus:!0},{event:"mouseup",suppressLog:!0},{event:"click",suppressLog:!1,cancelIfTargetChanged:!0},{event:"mousedown",suppressLog:!1,recaptureTarget:!0,focus:!0},{event:"mouseup",suppressLog:!0},{event:"click",suppressLog:!0,cancelIfTargetChanged:!0},
{event:"dblclick",suppressLog:!1,cancelIfTargetChanged:!0}])},syncCursor:function(a,b,c){var d=this,e=this.currentPosition;c=c||[];a[0]!==e[0]||a[1]!==e[1]?this.moveMouse(e,a,function(){b&&b.apply(d,c)}):b&&b.apply(this,c)},drag:function(a,b,c,d,e,f){if(!a)throw"No drag source defined";b?this.dragTo(a,b,d,e,f):this.dragBy(a,c,d,e,f)},dragTo:function(a,b,c,d,e,f,g,k,l){if(!b)throw"No drag target defined";a=a||this.currentPosition;e=e||{};!1!==l&&c?this.waitForTargetAndSyncMousePosition(a,g,this.dragTo,
[a,b,c,d,e,f,g,k,!1]):(a=this.getNormalizedTopElementInfo(a,!0,"dragTo: Source",g),(b=this.getNormalizedTopElementInfo(b,!1,"dragTo: Target",k))?this.simulateDrag(a.globalXY,b.globalXY,function(){this.afterMouseInteraction();c.call(d||this)},null,e,f):this.processCallbackFromTest(c,null,d||this))},dragBy:function(a,b,c,d,e,f,g,k){if(!b)throw"No drag delta defined";a=a||this.currentPosition;!1!==k&&c?this.waitForTargetAndSyncMousePosition(a,g,this.dragBy,[a,b,c,d,e,f,g,!1]):(a=this.getNormalizedTopElementInfo(a,
!0,"dragBy: Source",g))?(a=a.globalXY,this.simulateDrag(a,[a[0]+b[0],a[1]+b[1]],function(){this.afterMouseInteraction();c.call(d||this)},null,e,f)):c&&c.call(d||this)},simulateDrag:function(a,b,c,d,e,f){var g=this;e=e||{};var k=g.elementFromPoint(a[0],a[1],!0);g.elementFromPoint(b[0],b[1],!0);var l=new Siesta.Util.Queue({deferer:this.originalSetTimeout,deferClearer:this.originalClearTimeout,interval:g.dragDelay,callbackDelay:g.afterActionDelay,observeTest:this});l.addStep({processor:function(){g.simulateEvent(k,
"mouseover",$.extend({clientX:a[0],clientY:a[1]},e))}});l.addStep({processor:function(){k=g.elementFromPoint(a[0],a[1],!0,k);g.simulateEvent(k,"mouseover",$.extend({clientX:a[0],clientY:a[1]},e))}});l.addStep({processor:function(){var b=g.simulateEvent(k,"mousedown",$.extend({clientX:a[0],clientY:a[1]},e));g.mimicFocusOnMouseDown(k,b)}});l.addStep({isAsync:!0,processor:function(c){g.moveMouse(a,b,c.next,this,null,!0,e)}});var m;l.addStep({processor:function(){m=g.elementFromPoint(b[0],b[1],!0);g.simulateEvent(m,
"mouseover",$.extend({clientX:b[0],clientY:b[1]},e))}});f||(l.addStep({processor:function(){g.simulateEvent(m,"mouseup",$.extend({clientX:b[0],clientY:b[1]},e))}}),l.addStep({processor:function(){m&&(m===k||$.contains(k,m))&&g.simulateEvent(k,"click",$.extend({clientX:b[0],clientY:b[1]},e))}}));var n=this.beginAsync();l.run(function(){g.endAsync(n);g.processCallbackFromTest(c,null,d||g)})},mimicFocusOnMouseDown:function(a,b){if(!this.isEventPrevented(b))if(this.isElementFocusable(a))this.focus(a,
!0);else{var c=a.ownerDocument,d=c.body;if(d){for(;a&&a!=d&&a!=c;){if($.browser.msie&&"on"==a.getAttribute("unselectable"))return;if(this.isElementFocusable(a)){this.focus(a,!0);return}a=a.parentNode}this.focus(d||c.documentElement,!0)}}}}});
...
a.nodeName&&a.nodeName.toLowerCase(),d=Siesta.Harness.Browser.FeatureSupport().supports,e=Siesta.Test.Simulate.KeyCodes().keys;"a"!=c&&"button"!=c||(b!==e.ENTER||d.enterOnAnchorTriggersClick)||this.simulateEvent(a,"click",{doNotUpdateCurrentPosition:!0},!0)}}});
...
b,c):/^change$|^input$|^submit/.test(a)?this.createGenericEvent(a,b,c):this.createHtmlEvent(a,b,c))&&$.browser.msie&&9<=Number($.browser.version)){var d=a.preventDefault;a.preventDefault=function(){arguments.callee.$prevented=!0;this.returnValue=!1;return d&&d.apply(this,arguments)}}return a},createGenericEvent:function(a,b,c){b=c.ownerDocument;if(b.createEvent&&"dispatchEvent"==this.getSimulateEventsWith())return b=b.createEvent("Events"),b.initEvent(a,!0,!0),b;if(b.createEventObject)return b.createEventObject()},
createHtmlEvent:function(a,b,c){b=c.ownerDocument;if(b.createEvent&&"dispatchEvent"==this.getSimulateEventsWith())return b=b.createEvent("HTMLEvents"),b.initEvent(a,!1,!1),b;if(b.createEventObject)return b.createEventObject()},dispatchEvent:function(a,b,c){if(a.dispatchEvent&&"dispatchEvent"==this.getSimulateEventsWith())a.dispatchEvent(c);else if(a.fireEvent)try{a.fireEvent("on"+b,c)}catch(d){}else throw"Can't dispatch event: "+b;return c},mimicBrowserBehaviorBefore:function(a,b,c){},mimicBrowserBehaviorAfter:function(a,
b,c){var d=c.tagName.toLowerCase();switch(b){case "mousedown":this.isTextInput(c)&&this.mimicClearTextSelection(c);break;case "click":$.browser.msie&&11>Number(/^(\d+)/.exec($.browser.version)[1])&&"a"===d&&c.getAttribute("href")?this.mimicHashUpdate(c):"option"!==d||c.getAttribute("disabled")||this.mimicOptionSelect(c);break;case "dblclick":this.isTextInput(c)&&this.mimicTextSelection(c);break;case "keydown":b=Siesta.Test.Simulate.KeyCodes().keys,a.keyCode===b.BACKSPACE&&this.mimicHistoryChangeAfterBackspace(a,
c)}},mimicClearTextSelection:function(a){var b=this.global.Ext&&this.global.Ext.versions,b=b&&b.extjs&&b.extjs.equals("5.1.0.107");if(!$.browser.msie||!b||"9.0"!==$.browser.version&&"8.0"!==$.browser.version)this.selectText(a,a.value.length-1,a.value.length),this.setCaretPosition(a,a.value.length)},mimicTextSelection:function(a){this.selectText(a)},mimicHashUpdate:function(a){if(a=a.getAttribute("href").match(/#(.*)/))this.global.location.hash=a[1]},mimicHistoryChangeAfterBackspace:function(a,b){if(!$.browser.safari){var c=
b.ownerDocument;"true"===b.getAttribute("contenteditable")||("on"===c.designMode.toLowerCase()||this.isTextInput(b))||(c=b.ownerDocument.defaultView||b.ownerDocument.parentWindow,a.shiftKey?this.mimicNextHistory(c):this.mimicPreviousHistory(c))}},mimicPreviousHistory:function(a){a.history.back()},mimicNextHistory:function(a){a.history.forward()},mimicOptionSelect:function(a){var b=this.$(a).closest("select")[0],c=b.value;b.value=a.value;c!==a.value&&this.simulateEvent(b,"change")}}});
Role("Siesta.Test.Simulate.Touch",{requires:["normalizeElement"],has:{touchEventNamesMap:{lazy:"this.buildTouchEventNamesMap"},currentTouchId:1,activeTouches:Joose.I.Object,notSupportedWarned:!1},methods:{checkTouchEventsSupport:function(){var a=Siesta.Harness.Browser.FeatureSupport().supports,b=this.getRootTest();a.TouchEvents||(a.PointerEvents||a.MSPointerEvents||b.notSupportedWarned)||(b.notSupportedWarned=!0,this.warn("Touch events are not supported by browser. For Chrome, you can enable them, by launching it with: --args --touch-events"))},
...
(b=a);a!=b||(g||k)||(g=["25%","50%"],k=["75%","50%"]);var m=this.getNormalizedTopElementInfo(a,!0,"pinch: target1",g),n=this.getNormalizedTopElementInfo(b,!0,"pinch: target2",k);if(m&&n){var p=new Siesta.Util.Queue({deferer:this.originalSetTimeout,deferClearer:this.originalClearTimeout,interval:d?30:0,observeTest:this}),s,r,u=m.localXY[0]-n.localXY[0],w=m.localXY[1]-n.localXY[1],z=Math.sqrt(u*u+w*w);1>z&&(z=1);c=(z*c-z)/2;var u=Math.atan(w/u),q=Math.round(m.localXY[0]-c*Math.cos(u)),x=Math.round(m.localXY[1]-
c*Math.sin(u)),y=Math.round(n.localXY[0]+c*Math.cos(u)),B=Math.round(n.localXY[1]+c*Math.sin(u)),A=Joose.O.extend({},f);p.addStep({processor:function(){s=l.touchStart(null,null,f,m);r=l.touchStart(null,null,A,n)}});p.addAsyncStep({processor:function(a){var b=!1,c=!1;l.touchMove(s,q,x,function(){(b=!0)&&c&&a.next()},null,f);l.touchMove(r,y,B,function(){c=!0;b&&c&&a.next()},null,A)}});p.addStep({processor:function(){l.touchEnd(s,f);l.touchEnd(r,A)}});var E=l.beginAsync();p.run(function(){l.endAsync(E);
...
b||{});this.simulateTouchEventGeneric(c.currentEl||c.target,"end",b,{touchId:a})},touchMove:function(a,b,c,d,e,f){var g=this.activeTouches[a];if(!g)throw"Can't find active touch: "+a;var k=this,l=[];this.movePointerTemplate({xy:[g.clientX,g.clientY],xy2:[b,c],callback:d,scope:e,options:f||{},overEls:l,interval:this.dragDelay,callbackDelay:k.afterActionDelay,precision:k.mouseMovePrecision,onVoidOverEls:function(){return l=[]},onPointerEnter:function(a,b,c){},onPointerLeave:function(a,b,c){},onPointerOver:function(a,
...
c});Joose.A.each(d,function(a){c[a.id]||a.isDestroyed||a.destroy()})}if(a.ClassManager&&a.undefine){var e={};Joose.O.each(a.ClassManager.classes,function(c,d){var f=d.split(".")[0];b.isGlobalExpected(f,e)||a.undefine(d)})}if(a.data&&a.data.StoreManager){var f=[];a.data.StoreManager.each(function(a){"ext-empty-store"!==a.storeId&&f.push(a)});a.data.StoreManager.unregister.apply(a.data.StoreManager,f)}},processMouseEventName:function(a){var b=this.getEventMap();return b&&b[a]||a},processSubTestConfig:function(){var a=
this.SUPERARG(arguments);a.waitForAppReady=!1;a.waitForExtReady=!1;return a},isReady:function(){var a=this.SUPERARG(arguments);if(!a.ready)return a;var b=this,c=this.getExt(),a=Siesta.Resource("Siesta.Test.ExtJSCore"),d=this.requires;d&&(!this.requiringWaitingStarted&&c&&c.require)&&(this.requiringWaitingStarted=!0,c.require(d,function(){b.isRequiringDone=!0}));this.waitForExtReady&&(!this.onReadyWaitingStarted&&c&&c.onReady)&&(this.onReadyWaitingStarted=!0,c.onReady(function(){b.isExtOnReadyDone=
!0;c.ComponentQuery&&(c.ComponentQuery.pseudos.root=function(a,b){var c=0,d=a.length,l,m=[],n=void 0===b;for(n||(b=Number(b)-1);c<d;c++)(l=a[c].up())&&l.contains&&l.contains(a[c])||m.push(a[c]);n||(m=m[b]?[m[b]]:[]);return m})}));return d&&!this.isRequiringDone?{ready:!1,reason:a.get("waitedForRequires")}:this.waitForExtReady&&!this.isExtOnReadyDone?{ready:!1,reason:a.get("waitedForExt")}:this.waitForAppReady&&!this.isAppReadyDone?{ready:!1,reason:a.get("waitedForApp")}:{ready:!0}},simulateMouseClick:function(a,
b,c,d){var e=a.el,f=this.getExt(),f=f&&f.getVersion&&f.getVersion("extjs")&&5==f.getVersion("extjs").major;if("fireEvent"!==this.getSimulateEventsWith()&&!f||"checkbox"!==e.type&&"radio"!==e.type||e.disabled||e.readOnly)this.SUPERARG(arguments);else{var g=e.checked;b?this.SUPER(a,function(){e.checked===g&&(e.checked=!g);b.call(c||this)}):(this.SUPERARG(arguments),e.checked===g&&(e.checked=!g))}}},methods:{initialize:function(){this.expectGlobals("Ext","id");this.SUPER()},start:function(a){var b=this,
c=this.getExt();if(c){this.harness.generateLoaderPathHook()(this.global.StartTest,c,this.loaderPath);c.isReady=!0;var d=c.ClassManager&&Boolean(c.ClassManager.get("Ext.app.Application"));d||(this.waitForAppReady=!1);this.waitForAppReady&&d&&c.util.Observable.observe(c.app.Application,{launch:function(){b.isAppReadyDone=!0},single:!0,delay:100})}else this.waitForExtReady=this.waitForAppReady=!1,this.requires=null;this.SUPERARG(arguments)},getExt:function(){return this.global.Ext},Ext:function(){return this.global.Ext},
isExtJSComponent:function(a){var b=this.getExt();return Boolean(b&&b.Component&&a instanceof b.Component)},normalizeComponent:function(a,b,c){c=c||{};var d=this.Ext(),e=!1;if("String"===this.typeOf(a)){a=this.trimString(a.replace(/^(\s*>>)?/,""));var d=d.ComponentQuery.query(a),f=Siesta.Resource("Siesta.Test.ExtJSCore");!b&&1>d.length&&this.warn(f.get("noComponentMatch").replace("{component}",a));if(c.ignoreNonVisible){var g=[];Joose.A.each(d,function(a){(a.isVisible?a.isVisible():!a.isHidden())&&
g.push(a)});d=g}1<d.length&&(e=!0,a=f.get("multipleComponentMatch").replace("{component}",a),this.harness.failOnMultipleComponentMatches?this.fail(a):this.warn(a));a=d[0]}return c.detailed?{comp:a,matchingMultiple:e}:a},compToEl:function(a,b){var c=this.Ext();if(!a)return null;b=!1!==b;c.Editor&&(a instanceof c.Editor&&a.field)&&(a=a.field);if(c&&c.form&&c.form.Field&&b){if(c.form.Checkbox&&a instanceof c.form.Checkbox||c.form.Radio&&a instanceof c.form.Radio)return(c=a.displayEl)&&a.boxLabel?c:a.el.down(".x-form-field")||
a.inputEl;if(a instanceof c.form.Field&&a.inputEl)return(c=a.el.down(".x-form-field"))&&c.dom||a.inputEl.dom||a.inputEl;if(c.form.HtmlEditor&&a instanceof c.form.HtmlEditor)return a.iframe||a.inputEl}c&&(c.field&&c.field.Field&&a instanceof c.field.Field&&b)&&(a=a.getComponent());return a.getEl?a.getEl():b&&a.input||a.el||a.element},normalizeElement:function(a,b,c,d,e){if(!a)return null;if(a.nodeName)return a;var f=!1;this.getExt();var g=a,k,l=e&&e.stopAtComponentLevel;e=e&&e.hasOwnProperty("ignoreNonVisible")?
e.ignoreNonVisible:!0;if("string"===typeof a){f=a.split("->");if(2===f.length&&(k=this.adjustScope(a),a=this.trimString(f[1]),!k||(a.match(/^\s*>>/)||a.match(/=>/))&&!this.Ext()))return this.resetScope(),null;if(a.match(/=>/))f=this.compositeQuery(a,null,b,e),a=f[0],f=1<f.length;else if(a.match(/^\s*>>/))f=this.normalizeComponent(a,b,{ignoreNonVisible:e,detailed:!0}),a=f.comp,f=f.matchingMultiple;else return d=this.SUPER(a,b,c,d),k&&this.resetScope(),d;if(!b&&!a)throw d=Siesta.Resource("Siesta.Test.ExtJSCore").get("noComponentFound")+
": "+g,this.warn(d),k&&this.resetScope(),d;}g=!1;this.isExtJSComponent(a)&&(l?g=!0:a=this.compToEl(a));a&&a.dom&&(l?g=!0:a=a.dom);a=g?a:this.SUPER(a,b,c);k&&this.resetScope();return d?{el:a,matchingMultiple:f}:a},normalizeActionTarget:function(a,b){return this.normalizeElement(a,b,!1,!1,{stopAtComponentLevel:!0})},knownBugIn:function(a,b,c){var d=this.getExt(),d=d.versions.extjs||d.versions.touch,e=Siesta.Resource("Siesta.Test.ExtJSCore");this.harness.failKnownBugIn||d.isGreaterThan(a)?b.call(this.global,
this):this.todo(e.get("knownBugIn")+" "+a+": "+(c||""),b)},requireOk:function(){var a=this,b=this.getExt(),c=Array.prototype.concat.apply([],arguments),d=Siesta.Resource("Siesta.Test.ExtJSCore"),e;"Function"==this.typeOf(c[c.length-1])&&(e=c.pop());var f=function(){a.endAsync(k);Joose.A.each(c,function(c){var e=b.ClassManager,f=e.get(c);e.overrideMap&&e.overrideMap[c]||f&&("Function"==a.typeOf(f)||"Function"==a.typeOf(f.self))?a.pass(d.get("Class")+": "+c+" "+d.get("wasLoaded")):a.fail(d.get("Class")+
": "+c+" "+d.get("wasNotLoaded"))});a.processCallbackFromTest(e)},g=this.defaultTimeout,k=this.beginAsync(g+100),l=!1,m=this.originalSetTimeout,n=this.originalClearTimeout,p=m(function(){l=!0;f()},g);b.Loader.setConfig({enabled:!0});b.require(c,function(){n(p);l||f()})},clickComponentQuery:function(a,b,c){2==arguments.length&&"Function"==this.typeOf(arguments[1])&&(c=b,b=this.Ext().ComponentQuery);1==arguments.length&&(b=this.Ext().ComponentQuery);var d=b.query(a);this.chainClick(d,function(){c&&
c.call(this,d)})},clickCQ:function(){this.clickComponentQuery.apply(this,arguments)},compositeQuery:function(a,b,c,d){c=!1!==c;var e=this.Ext(),f=Siesta.Resource("Siesta.Test.ExtJSCore"),g=a.split("=>");b=b||e&&e.ComponentQuery;if(!b)return[];if(2>g.length)throw f.get("invalidCompositeQuery")+": "+a;e=g[0];g=g[1];if(e.match(/\.\w+\(/)){for(var k,l=/(.+?)\.(\w+)\(\)/g;b&&null!=(k=l.exec(e));)(b=b.query(k[1])[0])&&k[2]&&(b=b[k[2]]());if(!b&&!c)throw f.get("invalidCompositeQuery")+": "+a;b=[b]}else b=
b.query(e);if(!b.length){if(c)return[];throw f.get("ComponentQuery")+" "+e+" "+f.get("matchedNoCmp");}for(e=0;e<b.length;e++)if(k=b[e],k.rendered&&(!d||(k.isVisible?k.isVisible():!k.isHidden()))&&(k=this.compToEl(k,!1),k=Array.prototype.slice.call($(g,k.dom)),0<k.length))return k;if(c)return[];throw f.get("CompositeQuery")+" "+a+" "+f.get("matchedNoCmp");},cq:function(a){return this.Ext().ComponentQuery.query(a)},cq1:function(a){return this.Ext().ComponentQuery.query(a)[0]},waitForTarget:function(a,
b,c,d,e){var f=this.SUPER;this.waitForAnimations(function(){f.call(this,a,b,c,d,e)},this,d)},messageBoxIsVisible:function(a){return this.notOk(this.Ext().Msg.isHidden(),a||Siesta.Resource("Siesta.Test.ExtJSCore","messageBoxVisible"))},messageBoxIsHidden:function(a){return this.ok(this.Ext().Msg.isHidden(),a||Siesta.Resource("Siesta.Test.ExtJSCore","messageBoxHidden"))},cqExists:function(a,b){this.ok(this.cq1(a),b)},cqNotExists:function(a,b){this.notOk(this.cq1(a),b)},componentQueryExists:function(){this.cqExists.apply(this,
arguments)},setValue:function(a,b,c,d){a=this.normalizeComponent(a);(a.setRawValue||a.setValue).call(a,b);c&&this.processCallbackFromTest(c,null,d)},waitForAnimations:function(a,b,c){var d=Siesta.Resource("Siesta.Test.ExtJS"),e=this;return this.waitFor({method:function(){return!e.areAnimationsRunning()},callback:a,scope:b,timeout:c,assertionName:"waitForAnimations",description:" "+d.get("animationsToFinalize")})}}});
...
Role("Siesta.Test.ExtJS.Component",{requires:["waitFor"],methods:{waitForComponentVisible:function(a,b,c,d){var e=Siesta.Resource("Siesta.Test.ExtJS.Component"),f=this;if("String"!=this.typeOf(a)&&!this.isExtJSComponent(a))throw e.get("badInputText")+": "+a;return this.waitFor({method:function(){var b=f.normalizeComponent(a,!0);if(!b)return!1;var c=f.compToEl(b);return c&&f.elementIsTop(c,!0)&&b},callback:b,scope:c,timeout:d,assertionName:"waitForComponentVisible",description:" "+e.get("component")+
' "'+("String"==f.typeOf(a)?a:a.id)+'" '+e.get("toBeVisible")})},waitForComponentNotVisible:function(a,b,c,d){var e=Siesta.Resource("Siesta.Test.ExtJS.Component"),f=this;if("String"!=this.typeOf(a)&&!this.isExtJSComponent(a))throw e.get("badInputText")+": "+a;return this.waitFor({method:function(){var b=f.normalizeComponent(a,!0);if(!b)return!1;var c=f.compToEl(b);return(b.isHidden()||c&&!f.isElementVisible(c))&&b},callback:b,scope:c,timeout:d,assertionName:"waitForComponentNotVisible",description:" "+
e.get("component")+' "'+("String"==f.typeOf(a)?a:a.id)+'" '+e.get("toNotBeVisible")})},waitForComponentQuery:function(a,b,c,d,e){"Function"==this.typeOf(b)&&(e=d,d=c,c=b,b=this.getExt()&&this.getExt().ComponentQuery);return this.waitFor({method:function(){var c=b&&b.query(a)||this.getExt()&&this.getExt().ComponentQuery.query(a);return c&&0<c.length?c:!1},callback:c,scope:d,timeout:e,assertionName:"waitForComponentQuery",description:" "+Siesta.Resource("Siesta.Test.ExtJS.Component","componentQuery")+
' "'+a+'"'})},waitForCompositeQuery:function(a,b,c,d,e){"Function"==this.typeOf(b)&&(e=d,d=c,c=b,b=this.getExt().ComponentQuery);var f=this;return f.waitFor({method:function(){var c=f.compositeQuery(a,b,!0);return 0<c.length?c:!1},callback:c,scope:d,timeout:e,assertionName:"waitForCompositeQuery",description:" "+Siesta.Resource("Siesta.Test.ExtJS.Component","compositeQuery")+' "'+a+'"'})},waitForCompositeQueryNotFound:function(a,b,c,d,e){"Function"==this.typeOf(b)&&(e=d,d=c,c=b,b=this.getExt().ComponentQuery);
var f=this;return f.waitFor({method:function(){return 0<f.compositeQuery(a,b,!0).length?!1:!0},callback:c,scope:d,timeout:e,assertionName:"waitForCompositeQueryNotFound",description:" "+Siesta.Resource("Siesta.Test.ExtJS.Component","compositeQuery")+' "'+a+'" '+Siesta.Resource("Siesta.Test.ExtJS.Component","toReturnEmptyArray")})},waitForCQ:function(){return this.waitForComponentQuery.apply(this,arguments)},waitForCQNotFound:function(){return this.waitForComponentQueryNotFound.apply(this,arguments)},
waitForComponentQueryNotFound:function(a,b,c,d,e){var f=Siesta.Resource("Siesta.Test.ExtJS.Component");"Function"==this.typeOf(b)&&(e=d,d=c,c=b,b=this.getExt().ComponentQuery);return this.waitFor({method:function(){var c=b.query(a);return 0===c.length&&c},callback:c,scope:d,timeout:e,assertionName:"waitForComponentQueryNotFound",description:f.get("componentQuery")+": "+a+" "+f.get("toReturnEmpty")})},waitForCQVisible:function(){return this.waitForComponentQueryVisible.apply(this,arguments)},waitForCQNotVisible:function(){return this.waitForComponentQueryNotVisible.apply(this,
arguments)},waitForComponentQueryVisible:function(a,b,c,d,e){var f=this,g=Siesta.Resource("Siesta.Test.ExtJS.Component"),k=f.getExt();"Function"==this.typeOf(b)&&(e=d,d=c,c=b,b=k.ComponentQuery);return this.waitFor({method:function(){var c=b.query(a),d=!0;return 0<c.length?(Joose.A.each(c,function(a){if(!a.rendered||!f.isElementVisible(a))return d=!1}),d&&c):!1},callback:c,scope:d,timeout:e,assertionName:"waitForComponentQueryVisible",description:" "+g.get("componentQuery")+": "+a+" "+g.get("toReturnAVisibleComponent")})},
waitForComponentQueryNotVisible:function(a,b,c,d,e){var f=Siesta.Resource("Siesta.Test.ExtJS.Component"),g=this.getExt();"Function"==this.typeOf(b)&&(e=d,d=c,c=b,b=g.ComponentQuery);return this.waitFor({method:function(){var c=b.query(a),d=!0;return 0<c.length?(Joose.A.each(c,function(a){if(a.rendered&&!a.isHidden())return d=!1}),d&&c):!0},callback:c,scope:d,timeout:e,assertionName:"waitForComponentQueryVisible",description:" "+f.get("componentQuery")+": "+a+" "+f.get("toReturnHiddenCmp")})},waitForXType:function(a,
b,c,d,e){return this.waitForComponentQuery(a,b,c,d,e)},waitForComponent:function(a,b,c,d,e){var f=this.getExt();a=f.isString(a)?f.ClassManager.get(a).xtype:a.xtype;b&&(a+="[rendered]");return this.waitForXType(a,c,d,e)},hasSize:function(a,b,c,d){a=this.normalizeComponent(a);this.isDeeply(a.getSize(),{width:b,height:c},d)},hasPosition:function(a,b,c,d){a=this.normalizeComponent(a);this.isDeeply(a.getPosition(),[b,c],d)},destroysOk:function(a,b){var c=this.Ext(),d=Siesta.Resource("Siesta.Test.ExtJS.Component");
"Array"!=this.typeOf(a)&&(a="String"==this.typeOf(a)?this.Ext().ComponentQuery.query(a):[a]);if(a.length){var e,f=this.getExceptionCatcher()(function(){Joose.A.each(a,function(a){e=a;a.destroy()})});if(void 0!==f)this.fail(b,{assertionName:"destroysOk",got:f,gotDesc:d.get("exception"),annotation:d.get("exceptionAnnotation")+" "+e.id});else{var g=this;!1!==Joose.A.each(a,function(a){if(!a.isDestroyed&&a.destroy!=c.emptyFn)return g.fail(b,{assertionName:"destroysOk",annotation:d.get("Component")+" ["+
a.id+"] "+d.get("destroyFailed")}),!1})&&this.pass(b,{descTpl:d.get("destroyPassed")})}}else this.fail(b,{assertionName:"destroysOk",annotation:d.get("invalidDestroysOkInput")})}}});
...
Role("Siesta.Test.TextSelection",{methods:{getSelectedText:function(a){a=this.normalizeElement(a);if("selectionStart"in a)try{return a.value.substring(a.selectionStart,a.selectionEnd)}catch(b){}a=this.global;var c=a.document;if(a.getSelection)return a.getSelection().toString();if(c.getSelection)return c.getSelection();if(c.selection)return c.selection.createRange().text},selectText:function(a,b,c){a=this.normalizeElement(a);var d=a.value||a.innerHTML,e=!0;0<d.length&&(b=void 0===b?0:b,c=void 0===
...
f="",g=0;g<a;g++){var k=this.randomBetween(0,e-1);k<b.length?f+=b.substr(k,1):(k-=b.length,k<d.length?f+=d.substr(k,1):(k-=d.length,f+="["+c[k]+"]"))}return f},monkeyTest:function(a,b,c,d,e){a=this.normalizeElement(a,!1,!0);this.suppressPassedWaitForAssertion=!0;"function"===typeof b?(d=b,e=c,c=""):"function"===typeof c&&(d=c,c="");b="number"===typeof b?b:30;var f=this.global,g=a==f.document.body,k=this,l=k.$(a).offset(),m=l.left+k.$(g?f:a).width(),n=l.top+k.$(g?f:a).height(),p=[],s=Siesta.Resource("Siesta.Test.Element"),
r=new Siesta.Util.Queue({deferer:k.originalSetTimeout,deferClearer:k.originalClearTimeout,interval:50,observeTest:this,processor:function(a){if(k.nbrExceptions||k.failed)k.warn(s.get("monkeyActionLog")+":"+JSON2.stringify(p)),r.abort();else{var b=k.beginAsync(null,function(a){a.fail(s.get("monkeyException"));k.warn(s.get("monkeyActionLog")+":"+JSON.stringify(p));return!0}),c=a.next;a.next=function(){k.endAsync(b);c()};a.action(a)}}});a=[];a.length=b;var u=function(a,b){var c=k.normalizeElement(a.dragFrom||
a.xy);return c&&("a"==c.tagName.toLowerCase()||0<$(c).closest("a").length)?(p[a.logIndex]=null,a.isDouble&&(p[a.logIndex-1]=null),a.next(),!0):!1};Joose.A.each(a,function(a,b){var c=[k.randomBetween(l.left,m),k.randomBetween(l.top,n)];switch(k.randomBetween(0,4)){case 0:p.push({click:c});r.addAsyncStep({action:function(a){k.waitForSelector("body",a.next)}});r.addAsyncStep({action:function(a){u(a)||k.click(a.xy,a.next)},xy:c,logIndex:p.length-1});break;case 1:p.push({doubleclick:c});r.addAsyncStep({action:function(a){k.waitForSelector("body",
a.next)}});r.addAsyncStep({action:function(a){u(a)||k.doubleClick(a.xy,a.next)},xy:c,logIndex:p.length-1});break;case 2:"oncontextmenu"in window?p.push({rightclick:c}):p.push({click:c});r.addAsyncStep({action:function(a){k.waitForSelector("body",a.next)}});r.addAsyncStep({action:function(a){"oncontextmenu"in window?k.rightClick(a.xy,a.next):u(a)||k.click(a.xy,a.next)},xy:c});break;case 3:var d=[k.randomBetween(l.left,m),k.randomBetween(l.top,n)];p.push({action:"drag",target:c,to:d});r.addAsyncStep({action:function(a){k.waitForSelector("body",
a.next)}});r.addAsyncStep({action:function(a){u(a)||k.drag(a.dragFrom,a.dragTo,null,a.next)},dragFrom:c,dragTo:d});break;case 4:var e=k.getRandomTypeString(15);p.push({click:c});p.push({type:e});r.addAsyncStep({action:function(a){k.waitForSelector("body",a.next)}});r.addAsyncStep({action:function(a){u(a)||k.click(a.xy,function(){k.waitForSelector("body",function(){k.type(null,e,a.next)})})},xy:c,logIndex:p.length-1,isDouble:!0})}});var w=!1,z=function(){w=!0;k.nbrExceptions&&k.warn(s.get("monkeyActionLog")+
":"+JSON.stringify(p));k.is(k.nbrExceptions,0,c||s.get("monkeyNoExceptions"))};this.on("beforetestfinalizeearly",z);r.run(function(){w||(k.un("beforetestfinalizeearly",z),z());this.suppressPassedWaitForAssertion=!1;k.processCallbackFromTest(d,null,e||k)})},hasCls:function(a,b,c){var d=Siesta.Resource("Siesta.Test.Element");a=this.normalizeElement(a);this.$(a).hasClass(b)?this.pass(c,{descTpl:d.get("elementHasClass")+" {cls}",cls:b}):this.fail(c,{assertionName:"hasCls",got:a.className,gotDesc:d.get("elementClasses"),
...
this.normalizeElement(a,!0,null,!1);var c=this.isOffsetInsideElementBox(a,b);if(a&&this.isElementVisible(a)&&c&&this.elementIsScrolledOut(a,b))return a.scrollIntoView(),this.$(a).scrollintoview({duration:0}),this.elementIsScrolledOut(a,b)&&(c=$(a).closest(":scrollable")[0])&&b&&(0<b[0]&&(c.scrollLeft=Math.max(0,b[0]-1)),0<b[1]&&(c.scrollTop=Math.max(0,b[1]-1))),!0}},processSubTestConfig:function(){var a=this.SUPERARG(arguments),b=this;Joose.A.each("currentPosition actionDelay afterActionDelay dragDelay moveCursorBetweenPoints mouseMovePrecision overEls realAlert realConfirm realPrompt realPrint realOpen popups".split(" "),
function(c){a[c]=b[c]});a.simulateEventsWith=b.getSimulateEventsWith();return a},normalizeElement:function(a,b,c,d){if(a&&a.nodeName)return a;var e=!1;if("String"===this.typeOf(a)){c=a;var e=this.adjustScope(a),f=this.$(0<=a.indexOf("->")?a.split("->")[1]:a);e&&this.resetScope();a=f[0];e=1<f.length;if(!b&&!a)throw a=Siesta.Resource("Siesta.Test.Browser","noDomElementFound")+": "+c,this.warn(a),a;}"Array"==this.typeOf(a)&&(a=this.elementFromPoint(a[0],a[1]));return d?{el:a,matchingMultiple:e}:a},normalizeActionTarget:function(a,
b){return this.normalizeElement(a,b)},getPathBetweenPoints:function(a,b){if("number"!==typeof a[0]||"number"!==typeof a[1]||"number"!==typeof b[0]||"number"!==typeof b[1]||isNaN(a[0])||isNaN(a[1])||isNaN(b[0])||isNaN(b[1]))throw"Incorrect arguments passed to getPathBetweenPoints";var c=[],d=Math.floor(a[0]),e=Math.floor(b[0]),f=Math.floor(a[1]),g=Math.floor(b[1]),k=Math.abs(e-d),l=Math.abs(g-f),m,n,p,s;m=d<e?1:-1;n=f<g?1:-1;for(p=k-l;d!==e||f!==g;)s=2*p,s>-l&&(p-=l,d+=m),s<k&&(p+=k,f+=n),c.push([d,
...
a||(Joose.A.each(this.popups,function(a){if(!a.popup.closed)return c=a.popup,!1}),a=c);"String"==this.typeOf(a)&&(a={title:a});if("Object"==this.typeOf(a)){c=null;var e=a.title||a.url;"String"==this.typeOf(e)&&(e=RegExp("^"+this.escapeRegExp(e)+"$"));Joose.A.each(this.popups,function(b){b=b.popup;if(!b.closed&&(a.url&&e.test(b.location.href)||a.title&&e.test(b.document&&b.document.title||"")))return c=b,!1});a=c}a&&a.self==a?(this.global=a,this.waitFor({suppressAssertion:!0,method:function(){return a.document&&
"complete"==a.document.readyState},callback:b})):(this.fail("Can't resolve target win: "+a),this.processCallbackFromTest(b,null,this))}});return this.global},switchToMain:function(a){this.switchTo(this.scopeProvider.scope,a)},setCursorPosition:function(a,b){this.moveMouse(this.currentPosition,[a,b],null,null,1E5,!1)},waitForPageLoad:function(a,b){var c=this,d=this.global,e=!1,f=Siesta.Resource("Siesta.Test.More").get("pageToLoad"),g=function(){d.removeEventListener("unload",g);e=!0};d.addEventListener("unload",
g);this.chain({description:f,waitFor:function(){return e||"complete"!=c.global.document.readyState}},function(a){d.removeEventListener("unload",g);g=d=null;a()},{description:f,waitFor:function(){return"complete"==c.global.document.readyState}},{waitFor:50},function(){c.processCallbackFromTest(a,[c.global],b||c)})},setTimeout:function(a,b){var c=this.global.setTimeout;c(a,b)},clearTimeout:function(a){var b=this.global.clearTimeout;b(a)}}});
...
("function"==typeof g||d.isPrimitive(g))){var z;a:{for(var q=c+"."+f,x=0;x<k.length;x++)if(k[x].test(q)){z=!0;break a}z=!1}z||e.push(c+"."+f)}}}catch(y){}return e};c.waitFor(function(){return f.Ext&&f.Ext.isReady},function(){var b=c.global,k=[];d.iterate(d.ClassManager.classes,function(a){if(a.match(/^Ext\./)){var c=g(f,a),d=g(b,a);if(c&&"undefined"!==typeof d){var e=l(c,d,a);k.push.apply(k,e);d.prototype&&(a=l(c.prototype,d.prototype,a+".prototype"),k.push.apply(k,a))}}});c.globalExtOverrides=k;
...
Class("Siesta.Harness.Browser",{isa:Siesta.Harness,has:{id:null,testClass:Siesta.Test.Browser,viewportClass:"Siesta.Harness.Browser.UI.Viewport",viewport:null,autoRun:!1,viewDOM:!1,domContainerRegion:"east",speedRun:!0,mouseMovePrecision:null,breakOnFail:!1,debuggerOnFail:!1,failOnResourceLoadError:!1,contentManagerClass:Siesta.Content.Manager.Browser,scopeProvider:"Scope.Provider.IFrame",disableCaching:!1,baseUrl:window.location.href.replace(/(\?|#).*$/,"").replace(/\/[^/]*$/,"/"),baseHost:window.location.host,
...
b,c)}},methods:{buildHostPageUrlStopsInheriting:function(){return{preload:!0,innerHtmlHead:!0,innerHtmlBody:!0}},buildSandboxHashStructure:function(){return"preload alsoPreload hostPageUrl pageUrl useStrictMode overrideSetTimeout".split(" ")},createViewport:function(a){return Ext.create(this.viewportClass,a)},canShowCursorForTest:function(a){return a.scopeProvider instanceof Scope.Provider.IFrame?this.testOfForcedIFrame?this.testOfForcedIFrame.isFromTheSameGeneration(a):Boolean(a.scopeProvider.wrapper):
!1},configure:function(){this.SUPERARG(arguments);this.id=this.title||window.location.href},start:function(){$.browser.opera&&(this.autoCheckGlobals=!1);$.browser.msie&&"9.0"!==$.browser.version&&!this.hasOwnProperty("runCore")&&(this.runCore="sequential");this.SUPERARG(arguments)},populateCleanScopeGlobals:function(a,b){this.disableGlobalsCheck||$.browser.msie&&9>Number(/^(\d+)/.exec($.browser.version)[1])?(this.disableGlobalsCheck=!0,b()):this.SUPER("Scope.Provider.IFrame",b)},onUnload:function(){Joose.O.each(this.scopesByURL,
function(a,b){a.cleanup()})},setup:function(a){var b=this,c=this.SUPER;window.onunload=function(){b.onUnload()};window.focus();$(function(){Siesta.Harness.Browser.FeatureSupport();var d=b.hasOwnProperty("needUI")||!b.isAutomated?b.needUI:!1;"undefined"!=typeof Ext&&d?(b.autoLaunchTests=!1,Ext.onReady(function(){c.call(b,function(){b.viewport=b.createViewport({title:b.title,harness:b});a&&a()})})):c.call(b,a)})},getDescriptorConfig:function(a,b,c){if(!(b in this.hostPageUrlStopsInheriting))return this.SUPERARG(arguments);
var d=a.testConfig,d=d&&d.hasOwnProperty(b)||a.hasOwnProperty(b),e=this.lookUpValueInDescriptorTree(a,b);if(Boolean(this.getDescriptorConfig(a,"pageUrl",!0))&&"inherit"!=e)return d?e:[];do{if((e=(d=a.testConfig)&&d.hasOwnProperty(b))||a.hasOwnProperty(b))if(d=e?d[b]:a[b],"inherit"!=d)return d;a=a.parent}while(a&&a!=this);return c?void 0:this[b]},normalizeScopeProvider:function(a){this.SUPERARG(arguments);this.getDescriptorConfig(a,"runInPopup")&&(a.scopeProvider="Scope.Provider.Window")},getScopeProviderConfigFor:function(a,
b){var c=this,d=this.SUPERARG(arguments);d.cleanupDelay=0;d.name=a.title||a.url.replace(/(.*\/)?(.*)/,"$2");d.cls="tr-iframe";d.performWrap=!0;var e=document.createElement("div");e.className="tr-iframe-wrapper";e.innerHTML="<div class='tr-close fa fa-close'>&nbsp;</div><div class='tr-iframe-wrapper-inner'></div>";e.childNodes[0].onclick=function(){var b=c.getTestByURL(a.url);if(b){if(c.hideForcedIFrame(b),c.viewport)c.viewport.onManualCloseOfForcedIframe(b)}else this.parentElement.style.left="-10000px",
this.parentElement.style.top="-10000px"};d.wrapper=e;d.iframeParentEl=e.childNodes[1];d.sourceURL=d.sourceURL||this.getDescriptorConfig(a,"pageUrl");d.minViewportSize=d.minViewportSize||{width:this.getDescriptorConfig(a,"viewportWidth"),height:this.getDescriptorConfig(a,"viewportHeight")};d.innerHtmlHead=this.getDescriptorConfig(a,"innerHtmlHead");d.innerHtmlBody=this.getDescriptorConfig(a,"innerHtmlBody");d.failOnResourceLoadError=this.getDescriptorConfig(a,"failOnResourceLoadError");d.hasOwnProperty("useStrictMode")||
(d.useStrictMode=this.getDescriptorConfig(a,"useStrictMode"));return d},getNewTestConfiguration:function(a,b,c,d){var e=this,f=this.SUPERARG(arguments);this.hasOwnProperty("simulateEventsWith")&&(f.simulateEventsWith=this.simulateEventsWith);Joose.A.each(["forceDOMVisible","mouseMovePrecision","autoScrollElementsIntoView","enableUnreachableClickWarning","restartOnBlur"],function(b){f[b]=e.getDescriptorConfig(a,b)});this.getDescriptorConfig(a,"speedRun")&&(null==f.mouseMovePrecision&&(f.mouseMovePrecision=
20),Joose.O.extend(f,{actionDelay:1,dragDelay:10}));null==f.mouseMovePrecision&&delete f.mouseMovePrecision;return f},assignUniqueTag:function(a,b){if(null==a)return"";if(a===Object(a))return a.__UNIQUE__?a.__UNIQUE__:a.__UNIQUE__=(this.uniqueCounter++).toString(36);a+="";var c=this.valueToHashIndicies[b];c||(c=this.valueToHashIndicies[b]={});return c[a]?c[a]:c[a]=(this.uniqueCounter++).toString(36)},calculateSharedContextGroupHash:function(a){var b=this,c=this.getSandboxHashStructure(),d="";Joose.A.each(c,
function(c){d+=b.assignUniqueTag(b.getDescriptorConfig(a,c),c)});this.sandboxBoundaryByGroup&&(d+=this.assignUniqueTag(a.parent));return d},sortDescriptors:function(a,b,c){var d=this,e=[],f=[],g=[],k={};Joose.A.each(a,function(a){if(d.getDescriptorConfig(a,"sandbox"))"sequential"==(b||d.getDescriptorConfig(a,"runCore"))||d.getDescriptorConfig(a,"forceDOMVisible")?f.push(c?a.id:a):e.push(c?a.id:a);else{var m=d.calculateSharedContextGroupHash(a),n=k[m];n||(n=k[m]={groupHash:m,items:[]},g.push(n));n.items.push(c?
a.id:a)}});return{sharedContextGroups:g,mustRunSequential:f,canRunParallel:e}},runCoreGeneral:function(a,b,c,d){var e=this,f=this.sortDescriptors(a,this.forcedRunCore,!1);e.runCoreSharedContext(f.sharedContextGroups,b,c,function(){e.runCoreParallel(f.canRunParallel,b,c,function(){e.runCoreSequential(f.mustRunSequential,b,c,d)})})},runCoreSharedContext:function(a,b,c,d){var e=this,f=function(d,l,m,n){if(d.length){var p=d.shift(),s=0<d.length;l?e.processURL(p,p.index,b,c,function(){f(d,!1,e.scopesByURL[p.url],
p)},s):e.processUrlShared(p,p.index,b,c,function(){f(d,!1,m,n)},s,m,n)}else g(a)},g=function(a){a.length?(a=a.shift(),f(a.items,!0)):d()};g(a)},processUrlShared:function(a,b,c,d,e,f,g,k){function l(){if(g.scope){var b=m.getDescriptorConfig(a,"testClass");"String"==m.typeOf(b)&&(b=Joose.S.strToClass(b));var l=m.getNewTestConfiguration(a,g,c,d);n.test=new b(l);m.launchTest({testHolder:n,desc:a,scopeProvider:g,contentManager:c,launchState:d,preloadErrors:p,onErrorHandler:s,startTestAnchor:g.scope.StartTest,
noCleanup:f,cleanupUrl:k.url,reusingSandbox:!0},e)}else e()}var m=this;if(a.isMissing)e();else{var n={},p=[],s=this.getOnErrorHandler(n,p);b=this.getDescriptorConfig(a,"transparentEx");g.addOnErrorHandler(s,!b);a.testCode||this.cachePreload&&c.hasContentOf(a.url)?g.runCode(a.testCode||c.getContentOf(a.url),l):g.runScript(this.resolveURL(a.url,g,a),l)}},normalizeURL:function(a){/^jsan:/.test(a)&&(a="/jsan/"+a.replace(/^jsan:/,"").replace(/\./g,"/")+".js");/\.js$/.test(a)||(/\//.test(a)||/\.css(\?.*)?$/i.test(a))||
...
browserWindowHasFocus:function(){window.focus();var a=this.getFocusChecker();a.focus();$.rebindWindowContext(window);return $(a).is(":focus")}},my:{methods:{isStandardPackage:function(a){a||this.staticDeprecationWarning("isStandardPackage");return Boolean(Siesta.Harness.Browser.Automation)},getQueryParam:function(a,b){b||this.staticDeprecationWarning("getQueryParam");var c=RegExp("(?:\\?|&)"+a+"=(.*?)(?:\\?|&|$)","i").exec(window.location.search);return c?c[1]:null}}}});
...
var a=!1,b=!1,e=!0;Joose.A.each(this.childNodes,function(f){if(f.isLeaf()){var g=f.get("test");if(g&&g.isFailed())return e=!1,b=!0,!1;!g&&f.get("isStarting")&&(a=!0);g&&!g.isFinished()&&(a=!0);g&&!g.isPassed()&&(e=!1);g||(e=!1)}else{f=f.computeFolderStatus();if("red"==f)return e=!1,b=!0,!1;if("working"==f)return a=!0,!1;"yellow"==f&&(e=!1)}});return a?"working":b?"red":e?"green":"yellow"},updateFolderStatus:function(){this.set("folderStatus",this.computeFolderStatus());var a=this.parentNode;a&&!a.isRoot()&&
...
this.getResult().isWorking())return"working";if(!this.childNodes.length)return"yellow";var a=!1,b=!1,e=!0;Joose.A.each(this.childNodes,function(f){var g=f.getResult();if(f.isLeaf()){if(f.isWaitingAssertion()&&(a=!0),f.isAssertion()&&!g.isPassed())return e=!1,b=!0,!1}else{f=f.computeFolderStatus();if("red"==f)return e=!1,b=!0,!1;if(g.isWorking()||"working"==f)return a=!0,!1;"yellow"==f&&(e=!1)}});return a?"working":b?"red":e?"green":"yellow"}},b?{config:a}:a))}(),Ext.define("Sch.data.mixin.FilterableTreeStore",
...
this.getFilters().fireEvent("endupdate",this.getFilters())},getIndexInTotalDataset:function(a){var b=this.getRootNode(),c=-1,d=this.rootVisible;if(!d&&a==b)return-1;var e=this.isTreeFiltered(),f=this.currentFilterGeneration,g=function(k){if((e&&k.__filterGen!=f||k.hidden)&&k==a)return!1;(d||k!=b)&&c++;if(k==a)return!1;if(!k.data.leaf&&k.isExpanded()){k=k.childNodes;for(var l=k.length,m=0;m<l;m++)if(!1===g(k[m]))return!1}};g(b);return c},isTreeFiltered:function(a){return this.isFilteredFlag||a&&this.isHiddenFlag},
markFilteredNodes:function(a,b){var c=this,d=this.currentFilterGeneration,e={},f=this.getRootNode(),g=this.rootVisible,k=function(a){for(a=a.parentNode;a&&!e[a.internalId];)e[a.internalId]=!0,a=a.parentNode},l=b.filter,m=b.scope||this,n=b.shallow,p=b.checkParents||n,s=b.fullMatchingParents,r=b.onlyParents||s;if(r&&p)throw Error("Can't combine `onlyParents` and `checkParents` options");g&&(e[f.internalId]=!0);var u=function(a){if(!a.hidden){var b,c,d;if(a.data.leaf)l.call(m,a,e)&&(e[a.internalId]=
!0,k(a));else if(r){b=l.call(m,a);c=a.childNodes;d=c.length;if(b&&(e[a.internalId]=!0,k(a),s)){a.cascadeBy(function(a){e[a.internalId]=!0});return}for(a=0;a<d;a++)b&&c[a].data.leaf?e[c[a].internalId]=!0:c[a].data.leaf||u(c[a])}else if(p&&(b=l.call(m,a,e))&&(e[a.internalId]=!0,k(a)),!p||!n||n&&(b||a==f&&!g))for(c=a.childNodes,d=c.length,a=0;a<d;a++)u(c[a])}};u(a);f.cascadeBy(function(a){e[a.internalId]&&(a.__filterGen=d,c.allowExpandCollapseWhileFiltered&&!a.data.leaf&&a.expand())})},filterTreeBy:function(a,
...
!1});this.isHiddenFlag=!1;this.lastTreeHiding=null;this.isTreeFiltered(!0)||this.stopDataChangeMonitoring();a||this.refreshNodeStoreContent()},inheritables:function(){return{onNodeExpand:function(a,b,c){if(this.isTreeFiltered(!0)&&a==this.getRoot())this.callParent(arguments),this.reApplyFilter();else return this.callParent(arguments)},onNodeCollapse:function(a,b,c,d,e){var f=this,g=f.data,k=g.contains,l=f.isTreeFiltered(),m=f.currentFilterGeneration;g.contains=function(){var c,d,e,g=f.indexOf(a)+
1,u=!1;for(c=0;c<b.length;c++)if(!(b[c].hidden||l&&b[c].__filterGen!=m)&&k.call(this,b[c])){for(c=a;c.parentNode;){d=c;do d=d.nextSibling;while(d&&(d.hidden||l&&d.__filterGen!=m));if(d){u=!0;e=f.indexOf(d);break}else c=c.parentNode}u||(e=f.getCount());f.removeAt(g,e-g);break}return!1};this.callParent(arguments);g.contains=k},handleNodeExpand:function(a,b,c){for(var d=[],e=this.isTreeFiltered(),f=this.currentFilterGeneration,g=0;g<b.length;g++){var k=b[g];e&&k.__filterGen!=f||k.hidden||(d[d.length]=
k)}return this.callParent([a,d,c])},onNodeInsert:function(a,b,c){var d=b.raw||b.data,e;this.filterFn&&(e=this.filterFn(b),b.set("visible",e),e&&a.set("visible",this.filterFn(a)));this.registerNode(b,!0);this.beginUpdate();if(this.isVisible(b)){if(0!==c&&b.previousSibling){for(c=b.previousSibling;c&&!c.get("visible");c=c.previousSibling);if(c){for(;c.isExpanded()&&c.lastChild;)c=c.lastChild;a=c}}this.insert(this.indexOf(a)+1,b);if(!b.isLeaf()&&b.isExpanded())if(b.isLoaded())this.onNodeExpand(b,b.childNodes);
...
filterGroups:!1,cls:"filterfield",store:null,filterField:"text",hasAndCheck:null,andChecker:null,andCheckerScope:null,triggerLeafCls:"fa-file-o",triggerGroupCls:"fa-folder-o",tipText:null,constructor:function(a){var b=this;Ext.apply(a,{triggers:{clear:{cls:"fa-close",handler:function(){b.store.clearTreeFilter();b.reset()}},leafOrGroup:{cls:b.triggerLeafCls,handler:function(){b.setFilterGroups(!b.getFilterGroups())}}},listeners:{change:{fn:this.onFilterChange,buffer:400,scope:this},specialkey:this.onFilterSpecialKey,
...
b){for(var c=0;c<b.length;c++){for(var d=!0,e=b[c].length,f=0;f<e;f++)if(!b[c][f].test(a)){d=!1;break}if(d)return!0}return!1},onFilterChange:function(a,b){if(b||this.hasAndCheck&&this.hasAndCheck()){var c=this.filterField,d,e,f=this.filterGroups;f||(d=b.split(/\s*\>\s*/),e=1<d.length?d[0]:"",b=1<d.length?d[1]:d[0]);d=b.split(/\s*\|\s*/);var g=this.splitTermByPipe(b),k=e?this.splitTermByPipe(e):null,l=this.andChecker,m=this.andCheckerScope||this,n=this;this.store.filterTreeBy({filter:function(a){if(l&&
!l.call(m,a))return!1;if(!f&&e){for(var b=a,d=!1;b&&b.parentNode;)if(b=b.parentNode,n.matchAnyOfRegExps(b.get(c),k)){d=!0;break}if(!d)return!1}a=a.get(c);return n.matchAnyOfRegExps(a,g)?!0:!g.length},fullMatchingParents:f})}else this.store.clearTreeFilter()}}),Ext.define("Siesta.Harness.Browser.UI.CanFillAssertionsStore",{processNewResult:function(a,b,c,d){b={id:c.id,result:c,loaded:!0,leaf:!(c instanceof Siesta.Result.SubTest),expanded:c instanceof Siesta.Result.SubTest&&"it"!=c.test.specType};var e=
...
trackMouse:!0,showSelectorText:!0,bufferTime:30,injectIntoTestFrame:!1,getIndicatorEl:function(){return this.boxIndicatorEl},getExt:function(){return this.window.Ext},start:function(a,b){a=a||this.window;if(!a)throw"Must provide a window context for the inspector";this.window=a;var c=this.getExt(),d=this.injectIntoTestFrame?a.document.body:b||a.document.body;this.boxIndicatorEl=this.boxIndicatorEl||Ext.fly(d).createChild({cls:"target-inspector-box",style:"position : absolute;left:0;top:0;pointer-events : none;z-index : 100001; border : 2px solid red;transition-property : transform;transition-duration : 0.3s;",
children:[{tag:"div",style:"border:1px solid red;width : 13px; height : 13px;position : absolute;margin-top : -8px;margin-left : -8px;border-radius:19px;transition-property : transform;transition-duration : 0.3s;box-sizing: border-box;-moz-box-sizing: border-box;-ms-box-sizing: border-box;-webkit-box-sizing: border-box;",cls:"target-inspector-coordinate",html:'<div style="border-left: 1px solid red;position: absolute;top: -3px;left: 5px;height: 6px;box-sizing: border-box;-moz-box-sizing: border-box;-ms-box-sizing: border-box;-webkit-box-sizing: border-box;"></div><div style="border-left: 1px solid red;position: absolute;bottom: -3px;left: 5px;height: 6px;box-sizing: border-box;-moz-box-sizing: border-box;-ms-box-sizing: border-box;-webkit-box-sizing: border-box;"></div><div style="border-top: 1px solid red;position: absolute;top: 5px;left: -3px;width: 6px;box-sizing: border-box;-moz-box-sizing: border-box;-ms-box-sizing: border-box;-webkit-box-sizing: border-box;"></div><div style="border-top: 1px solid red;position: absolute;top: 5px;right: -3px;width: 6px;box-sizing: border-box;-moz-box-sizing: border-box;-ms-box-sizing: border-box;-webkit-box-sizing: border-box;"></div>'}].concat(this.showSelectorText?
...
a.getXType&&a.getXType()||a.xtype;if(!b)for(var c=a,d=0;10>d&&!b;d++)c=a.superclass,b=c.xtype;return b},updateHighlightContent:function(a,b){var c,d="#",e;if("string"===typeof a)c=a;else if(Ext.ClassManager){c=Ext.ComponentQuery.query("recorderpanel")[0];var f=a.el.dom.ownerDocument.defaultView,f=f&&f.Ext&&f.Ext.ComponentQuery;if(c&&c.isVisible()){var g;f&&(g=(g=c.recorder.extractor.findComponentQueryFor(a))&&g.query||b);c=">>"+(g||b)}else{if(g=this.findExtAncestorClassName(a))d=Siesta.Resource("Siesta.Harness.Browser.UI.DomContainer",
"docsUrlText"),d=Ext.String.format(d,Ext.versions.touch?"touch":"extjs",g),e=Siesta.Resource("Siesta.Harness.Browser.UI.DomContainer","viewDocsText")+g;c=b}}c&&(g=this.boxIndicatorEl.down(".target-inspector-label",!0),g.href=d,g.title=e,g.innerHTML=c)},highlightTarget:function(a,b,c){var d=this.boxIndicatorEl.dom.style;this.active||this.start();if(a){var e=this.getOffsets(a),f=Ext.fly(a).getX()-1+e[0]+"px",e=Ext.fly(a).getY()-1+e[1]+"px",f=$.browser.opera?"translate("+f+","+e+")":"translate3d("+f+
","+e+", 0)";d.setProperty("transform",f);d.width=(Ext.fly(a).getWidth()||parseInt(a.style.width.substring(0,a.style.width.length-2),10))+2+"px";d.height=(Ext.fly(a).getHeight()||parseInt(a.style.height.substring(0,a.style.height.length-2),10))+2+"px";d["border-color"]="red";this.showSelectorText&&b&&this.updateHighlightContent(b)}else d["border-color"]="transparent";a=this.boxIndicatorEl.down(".target-inspector-coordinate",!0);c?(f=$.browser.opera?"translate("+c[0]+"px,"+c[1]+"px)":"translate3d("+
c[0]+"px, "+c[1]+"px, 0)",a.style.setProperty("display","block"),a.style.setProperty("transform",f)):a.style.setProperty("display","none")},findComponentByTarget:function(a){var b=this.getExt();a.ownerDocument!==this.window.document&&(b=(a.ownerDocument.parentWindow||a.ownerDocument.defaultView).frameElement.contentWindow.Ext);for(var c;!c&&a&&"BODY"!==a.nodeName;)c=b.getCmp(a.id),a=a.parentNode;return c},getOffsets:function(a){var b=[0,0];a.ownerDocument!==this.window.document&&(b=Ext.fly((a.ownerDocument.parentWindow||
a.ownerDocument.defaultView).frameElement).getXY(),b[0]-=a.ownerDocument.body.scrollLeft,b[1]-=a.ownerDocument.body.scrollTop);return b},findExtAncestorClassName:function(a){for(;a;){var b=Ext.ClassManager.getName(a);if(b.match(/^Ext./))return b;a=a.superclass}return""}}),Ext.define("Siesta.Harness.Browser.UI.DomContainer",{extend:"Ext.Panel",alias:"widget.domcontainer",cls:"siesta-domcontainer",header:!1,collapsible:!0,animCollapse:!1,padding:10,test:null,testListeners:null,maintainViewportSize:!0,
canManageDOM:!0,suspendAfterLayoutAlign:!1,inspector:null,enableConsole:!0,trackMouse:!0,inspectorConfig:null,initComponent:function(){this.testListeners=[];this.title=Siesta.Resource("Siesta.Harness.Browser.UI.DomContainer","title");this.enableConsole&&Ext.apply(this,{dockedItems:this.consoleCt={xtype:"component",dock:"bottom",hidden:!0,height:20,cls:"domcontainer-console",renderTpl:'<div><input type="text" /></div>'}});this.callParent();this.on({afterlayout:this.onAfterLayout,expand:this.onExpand,
collapse:this.onCollapse,scope:this});this.inspector=new Siesta.Harness.Browser.UI.ComponentInspector(this.inspectorConfig);if(this.trackMouse)this.inspector.on({start:this.onInspectionStart,stop:this.onInspectionStop,scope:this});this.relayEvents(this.inspector,["start","stop"],"inspection")},afterRender:function(){this.callParent(arguments);if(this.enableConsole){var a=this.consoleInput=this.el.down(".domcontainer-console input");this.inspector.on("targethover",function(b,c){a.dom.value='Ext.getCmp("'+
c.id+'").'});this.inspector.on("targetselected",function(b,c){a.focus(!0)});a.on({keyup:function(b,c){var d=a.dom.value;if(b.getKey()===b.ENTER&&d){var e=this.getIFrame();try{var f=e.contentWindow.eval(d);window.console&&console.log(f)}catch(g){window.console&&console.log(g.message)}}},scope:this})}},setCanManageDOM:function(a){(this.canManageDOM=a)&&!this.hidden&&this.alignIFrame()},getIFrameWrapper:function(a){var b=this.test;return b?(this.canManageDOM||a)&&b.scopeProvider&&b.scopeProvider.wrapper||
null:null},getIFrame:function(a){var b=this.test;return b?(this.canManageDOM||a)&&b.scopeProvider&&b.scopeProvider.iframe||null:null},onAfterLayout:function(){this.suspendAfterLayoutAlign||this.alignIFrame()},alignIFrame:function(a){var b=this.getIFrameWrapper(a);if(this.isFrameVisible()&&b){Ext.fly(b).removeCls("tr-iframe-hidden");Ext.fly(b).removeCls("tr-iframe-forced");var c=this.body.getBox();Ext.fly(b).setBox(c);this.maintainViewportSize||Ext.fly(this.getIFrame(a)).setSize(this.body.getSize());
...
inspecting:!1,toggleInspectionMode:function(a){this.test&&(a?this.startInspection():this.stopInspection())},startInspection:function(a){if(this.test&&this.test.global){var b=Ext.get(this.getIFrameWrapper());this.inspector.start(this.test.global,b.child(".tr-iframe-wrapper-inner",!0));this.trackMouse&&(b.un("mouseout",this.onMouseLeave,this),b.on("mouseout",this.onMouseLeave,this));this.enableConsole&&!1!==a&&(this.consoleCt instanceof Ext.Component||(this.consoleCt=Ext.widget(this.consoleCt)),this.consoleCt.show());
this.addCls("inspection-mode")}},stopInspection:function(){this.inspector.stop();this.removeCls("inspection-mode");this.enableConsole&&this.consoleCt.rendered&&this.consoleCt.hide()},onMouseLeave:function(a,b){this.el.contains(a.relatedTarget)||Ext.fly(this.getIFrameWrapper()).contains(a.relatedTarget)||this.stopInspection()},onInspectionStart:function(){var a=Ext.get(this.getIFrameWrapper());if(a)a.on("mouseout",this.onMouseLeave,this)},onInspectionStop:function(){var a=Ext.get(this.getIFrameWrapper());
a&&a.un("mouseout",this.onMouseLeave,this)},clearHighlight:function(){this.stopInspection()},highlightTarget:function(a,b,c){var d=a instanceof Array;this.inspector.active||this.startInspection();d?(c=a,a=null):(a=this.test.normalizeElement(a,!0,!0,!1))&&c&&(c=this.test.normalizeOffset(c,$(a)));this.inspector.highlightTarget(a,b,c)}}),Ext.define("Siesta.Harness.Browser.UI.AssertionGrid",{alias:"widget.assertiongrid",extend:"Ext.tree.Panel",mixins:["Siesta.Harness.Browser.UI.CanFillAssertionsStore"],
cls:"siesta-assertion-grid",enableColumnHide:!1,enableColumnMove:!1,enableColumnResize:!1,sortableColumns:!1,useArrows:!0,border:!1,minWidth:100,trackMouseOver:!1,autoScrollToBottom:!0,hideHeaders:!0,rowLines:!1,isStandalone:!1,rootVisible:!1,collapseDirection:"left",test:null,testListeners:null,viewType:"filterabletreeview",lines:!1,disableSelection:!0,bufferedRenderer:!1,initComponent:function(){this.testListeners=[];this.store||(this.store=new Siesta.Harness.Browser.Model.AssertionTreeStore({proxy:"memory",
...
c="";switch(b.meta.name){case "Siesta.Result.Diagnostic":return"tr-diagnostic-row "+(b.isWarning?"tr-warning-row":"");case "Siesta.Result.Summary":return"tr-summary-row "+(b.isFailed?" tr-summary-failure":"");case "Siesta.Result.SubTest":return c="tr-subtest-row tr-subtest-row-"+a.get("folderStatus"),"describe"==b.test.specType&&(c+=" tr-subtest-row-describe"),"it"==b.test.specType&&(c+=" tr-subtest-row-it"),c;case "Siesta.Result.Assertion":return c+="tr-assertion-row ",c=b.isWaitFor?c+("tr-waiting-row "+
(b.completed?b.passed?"tr-waiting-row-passed":"tr-assertion-row-failed tr-waiting-row-failed":"")):b.isException?c+(b.isTodo?"tr-exception-todo-row":"tr-exception-row"):b.isTodo?c+(b.passed?"tr-todo-row-passed":"tr-todo-row-failed"):c+(b.passed?"tr-assertion-row-passed":"tr-assertion-row-failed");default:throw"Unknown result class";}},showTest:function(a,b){this.test&&(Joose.A.each(this.testListeners,function(a){a.remove()}),this.testListeners=[]);this.test=a;this.testListeners=[].concat(this.isStandalone?
[a.on("testupdate",this.onTestUpdate,this),a.on("testendbubbling",this.onEveryTestEnd,this),a.on("assertiondiscard",this.onAssertionDiscarded,this)]:[]);Ext.suspendLayouts();b&&this.store!==b?this.reconfigure(b):0<this.getStore().getRoot().childNodes.length&&this.store.removeAll();Ext.resumeLayouts()},onTestUpdate:function(a,b,c,d){this.processNewResult(this.store,b,c,d)},onEveryTestEnd:function(a,b){this.processEveryTestEnd(this.store,b)},onAssertionDiscarded:function(a,b,c){this.store.getNodeById(c.id).remove()},
bindStore:function(a,b,c){this.callParent(arguments);(this.store=a)&&a.nodeStore&&(this.getView().dataSource=a.nodeStore,this.getView().bindStore(a,b,c))},destroy:function(){Joose.A.each(this.testListeners,function(a){a.remove()});this.testListeners=[];this.test=null;this.callParent(arguments)},setInitializing:function(a){a?this.getView().addCls("siesta-test-initializing"):this.getView().removeCls("siesta-test-initializing")}}),Ext.define("Siesta.Harness.Browser.UI.AssertionTreeColumn",{extend:"Ext.tree.Column",
alias:"widget.assertiontreecolumn",imgWithOffsetText:'<img src="{1}" class="{0}" style="left:{2}px" />',tdCls:"tr-tree-column",resultTpl:null,dataIndex:"folderStatus",flex:1,menuDisabled:!0,sortable:!1,descriptionTpl:'<span class="assertion-text">{text}</span>',initComponent:function(){this.descriptionTpl=this.descriptionTpl instanceof Ext.XTemplate?this.descriptionTpl:new Ext.XTemplate(this.descriptionTpl);Ext.apply(this,{scope:this});this.callParent(arguments)},renderer:function(a,b,c,d,e,f){b=
"";b=c.data.result;a=b.annotation;if(b instanceof Siesta.Result.Summary)return c.data.result.description.join("<br>");b=this.descriptionTpl.apply({text:Ext.String.htmlEncode(b.isWarning?"WARN: "+b.description:b.description)});a&&(b+='<pre title="'+a.replace(/"/g,"'")+'" style="margin-left:'+16*c.data.depth+'px" class="tr-assert-row-annontation">'+Ext.String.htmlEncode(a)+"</pre>");return b},treeRenderer:function(a,b,c){var d=c.getResult();d instanceof Siesta.Result.Assertion?c.data.iconCls=d.isWaitFor?
d.completed?"fa-clock-o":"fa-spinner fa-spin":d.isException?"fa-flag":d.passed?"fa-check":"fa-bug":d instanceof Siesta.Result.SubTest&&("working"===c.get("folderStatus")?c.data.iconCls="fa-spinner fa-spin":c.data.iconCls="");return this.callParent(arguments)}}),Ext.define("Siesta.Harness.Browser.UI.TestNameColumn",{extend:"Ext.tree.Column",xtype:"testnamecolumn",sortable:!1,dataIndex:"title",menuDisabled:!0,flex:1,tdCls:"test-name-cell",scope:this,filterGroups:null,store:null,initComponent:function(){var a=
Siesta.Resource("Siesta.Harness.Browser.UI.TestGrid");Ext.apply(this,{items:[{xtype:"treefilter",emptyText:a.get("filterTestsText"),margins:"0 0 0 10",itemId:"trigger",filterGroups:this.filterGroups,filterField:"title",store:this.store,tipText:a.get("filterFieldTooltip")}]});this.callParent(arguments)},treeRenderer:function(a,b,c){b.tdCls="test-name-cell-"+(c.data.leaf?"leaf":"parent");if(c.isLeaf()){var d=c.get("test");d?c.get("isFailed")?c.data.iconCls="siesta-test-failed fa-flag":c.get("isRunning")&&
!d.isFinished()?c.data.iconCls="fa-flash siesta-running-not-finished":d.isFinished()?d.isPassed()?c.data.iconCls="fa-check siesta-test-passed":c.data.iconCls="fa-bug siesta-test-failed":c.data.iconCls="fa-hourglass-o siesta-test-starting":c.get("isMissing")?c.data.iconCls="fa-close siesta-test-file-missing":c.get("isStarting")?c.data.iconCls="fa-hourglass-o siesta-test-starting":c.data.iconCls="fa-file-o siesta-test-file"}else d=c.get("folderStatus"),c.data.iconCls="working"==d?" fa-hourglass-o siesta-folder-running":
"green"==d?" fa-check siesta-folder-pass":"red"==d?" fa-bug siesta-folder-fail":"";return this.callParent(arguments)},renderer:function(a,b,c){return a}}),Ext.define("Siesta.Harness.Browser.UI.TestGridController",{extend:"Ext.app.ViewController",alias:"controller.testgrid",control:{"#tool-menu [option]":{click:"onMenuItemClick"},"[actionName^=run]":{click:"onRunBtnClicked"},"[actionName=show-coverage]":{click:"onShowCoverageReport"},"#aboutSiesta":{click:"onAboutSiesta"}},onShowCoverageReport:function(){this.getView().fireEvent("showcoverageinfo",
this)},onRunBtnClicked:function(a){this.getView().fireEvent("buttonclick",this,a,a.actionName)},onMenuItemClick:function(a){this.getView().fireEvent("optionchange",this,a.option,a.checked)},onAboutSiesta:function(){(new Siesta.Harness.Browser.UI.AboutWindow).show()}}),Ext.define("Siesta.Harness.Browser.UI.TestGrid",{extend:"Ext.tree.Panel",alias:"widget.testgrid",controller:"testgrid",requires:["Siesta.Harness.Browser.UI.FilterableTreeView"],stateful:!0,rootVisible:!1,header:!1,rowLines:!1,useArrows:!0,
border:!1,cls:"tr-testgrid",iconCls:"tr-status-neutral-small",width:340,collapsible:!0,expanded:!0,viewType:"filterabletreeview",enableColumnMove:!1,lines:!1,filter:null,filterGroups:!1,resultSummary:null,stateConfig:null,showSizeControls:!1,coverageReportButton:null,viewConfig:{enableTextSelection:!0,toggleOnDblClick:!1,markDirty:!1,trackOver:!1,getRowClass:function(a){if(a.get("descriptor").isSystemDescriptor)return"siesta-system-descriptor"},shouldUpdateCell:function(a,b,c){return"passCount"===
b.dataIndex&&c&&!Ext.Array.contains(c,"passCount")&&!Ext.Array.contains(c,"todoPassCount")||"failCount"===b.dataIndex&&c&&!Ext.Array.contains(c,"failCount")&&!Ext.Array.contains(c,"todoFailCount")?0:Ext.tree.View.prototype.shouldUpdateCell.apply(this,arguments)}},initComponent:function(){var a=this,b=Siesta.Resource("Siesta.Harness.Browser.UI.TestGrid"),c=this.stateConfig;Ext.apply(this,{title:b.get("title"),columns:{createFocusableContainerKeyNav:Ext.emptyFn,items:[{xtype:"testnamecolumn",store:this.store},
...
itemId:"aboutSiesta"},{text:b.get("documentationText"),href:b.get("siestaDocsUrl"),hrefTarget:"_blank"}]}},"->",{xtype:"component",cls:"summary-bar",border:!1,width:55,itemId:"result-summary",data:{pass:0,fail:0},tpl:'<div><span class="total-pass">{pass}</span><span class="icon fa-check"></span></div><div><span class="total-fail">{fail}</span><span class="icon fa-bug"></span></div>'}]},dockedItems:this.showSizeControls?[{xtype:"toolbar",cls:"size-toolbar",border:!0,dock:"bottom",items:[{xtype:"slider",
...
b.setFilterGroups(a.filterGroups);a.filter&&b.setValue(a.filter);return!a.filter},null,{single:!0});this.on("afterrender",this.onMyViewReady,this);this.coverageReportButton=this.down("[actionName=show-coverage]")},onHistoryChange:function(a){a&&(a=this.store.getNodeById(a))&&this.selectTestFile(a)},onDimensionOrOrientationChange:function(a,b){var c=this.viewportSizes[this.framesizeSlider.getValue()],d=this.orientationCheckbox.getValue();this.sizeLabel.setText(c.join("x"));this.fireEvent("framesizechange",
a,c[0],c[1],d)},getFilterValue:function(){return this.down("#trigger").getValue()},getFilterGroups:function(){return this.down("#trigger").getFilterGroups()},passedColumnRenderer:function(a,b,c){if(!c.isLeaf())return"";0<c.data.todoPassCount&&(a+=' <span title="'+c.data.todoPassCount+" "+Siesta.Resource("Siesta.Harness.Browser.UI.TestGrid","todoPassedText")+'" class="tr-test-todo tr-test-todo-pass">+ '+c.data.todoPassCount+"</span>");return a},failedColumnRenderer:function(a,b,c){if(!c.isLeaf())return"";
0<c.data.todoFailCount&&(a+=' <span title="'+c.data.todoFailCount+" "+Siesta.Resource("Siesta.Harness.Browser.UI.TestGrid","todoFailedText")+'" class="tr-test-todo tr-test-todo-fail">+ '+c.data.todoFailCount+"</span>");return a},afterRender:function(){this.callParent(arguments);this.summaryPassEl=this.el.down(".total-pass");this.summaryFailEl=this.el.down(".total-fail");if(this.showSizeControls){this.orientationCheckbox=this.down("#orientationCheckbox");this.sizeLabel=this.down("#sizeLabel");this.framesizeSlider=
this.down("#framesizeSlider");var a=this.viewportSizes[this.framesizeSlider.getValue()];this.sizeLabel.setText(a.join("x"))}},onMyViewReady:function(){Ext.History.on("change",this.onHistoryChange,this);var a=window.location.hash;if(a)this.onHistoryChange(a.substring(1))},updateStatus:function(a,b){this.summaryPassEl.update(String(a));this.summaryFailEl.update(String(b))},enableCoverageButton:function(){this.coverageReportButton.enable()},disableCoverageButton:function(){this.coverageReportButton.disable()},
setFilterValue:function(a){this.down("treefilter").setValue(a)},selectTestFile:function(a){a&&(a.bubble(function(a){a.expand()}),this.store.getById(a.id)&&0<=this.store.indexOf(a)&&(!this.getCollapsed()&&0<this.getView().getNodes().length&&this.ensureVisible(a),this.getSelectionModel().select(a)))}}),Ext.define("Siesta.Harness.Browser.UI.TestGridContextMenu",{extend:"Ext.menu.Menu",xtype:"testgridcontextmenu",items:[{itemId:"uncheckOthers",text:Siesta.Resource("Siesta.Harness.Browser.UI.Viewport").get("uncheckOthersText")},
{itemId:"uncheckAll",text:Siesta.Resource("Siesta.Harness.Browser.UI.Viewport").get("uncheckAllText")},{itemId:"checkAll",text:Siesta.Resource("Siesta.Harness.Browser.UI.Viewport").get("checkAllText")},{itemId:"runThis",text:Siesta.Resource("Siesta.Harness.Browser.UI.Viewport").get("runThisText")},{itemId:"viewSource",text:Siesta.Resource("Siesta.Harness.Browser.UI.Viewport").get("viewSource")},{xtype:"menuseparator"},{itemId:"expandAll",text:Siesta.Resource("Siesta.Harness.Browser.UI.Viewport").get("expandAll")},
{itemId:"collapseAll",text:Siesta.Resource("Siesta.Harness.Browser.UI.Viewport").get("collapseAll")},{xtype:"menuseparator"},{itemId:"filterToCurrentGroup",text:Siesta.Resource("Siesta.Harness.Browser.UI.Viewport").get("filterToCurrentGroup")},{itemId:"filterToFailed",text:Siesta.Resource("Siesta.Harness.Browser.UI.Viewport").get("filterToFailed")}]}),Ext.define("Siesta.Harness.Browser.UI.SourcePanel",{extend:"Ext.Panel",alias:"widget.sourcepanel",__filled__:!1,autoScroll:!0,cls:"test-source-ct",
layout:"absolute",border:!1,bodyBorder:!1,setSource:function(a,b){var c=this.el;this.__filled__||(this.__filled__=!0,this.update(Ext.String.format('<pre class="brush: javascript;">{0}</pre>',a)),SyntaxHighlighter.defaults["quick-code"]=!1,SyntaxHighlighter.highlight(c));c.select(".highlighted").removeCls("highlighted");Ext.Array.each(b,function(a){c.select(".line.number"+a).addCls("highlighted")});if(0<b.length){var d=c.down(".highlighted");d&&d.scrollIntoView(c)}},clear:function(){this.__filled__=
!1}}),Ext.define("Siesta.Harness.Browser.UI.ResultPanel",{extend:"Ext.Panel",alias:"widget.resultpanel",requires:["Siesta.Harness.Browser.UI.AssertionGrid","Siesta.Harness.Browser.UI.DomContainer"],slots:!0,test:null,testListeners:null,maintainViewportSize:!0,viewDOM:!1,border:!1,canManageDOM:!0,harness:null,isStandalone:!1,showToolbar:!0,title:"Result panel",header:!1,minWidth:100,layout:"border",sourceButton:null,filterButton:null,inspectionButton:null,recorderPanel:null,recorderConfig:null,recorderPanelClass:"Siesta.Recorder.UI.RecorderPanel",
domContainerRegion:"east",initComponent:function(){var a=Siesta.Resource("Siesta.Harness.Browser.UI.ResultPanel"),b=this.domContainerRegion||"east";Ext.apply(this,{cls:"tr-container",tbar:{cls:"resultpanel-toolbar",defaults:{tooltipType:"title",scope:this},items:this.showToolbar?[{text:a.get("rerunText"),cls:"rerun-button",glyph:61515,scale:"medium",handler:this.onRunTestClick},{xtype:"label",cls:"resultpanel-testtitle",itemId:"resultpanel-testtitle",margin:"0 0 0 10",height:35,text:" ",flex:1},this.viewDomButton=
new Ext.Button({tooltip:a.get("toggleDomVisibleText"),cls:"testaction-button",action:"view-dom",scale:"medium",glyph:62060,enableToggle:!0,scope:this,pressed:this.viewDOM,handler:function(a){this.setViewDOM(a.pressed)}}),this.sourceButton=new Ext.Button({tooltip:a.get("viewSourceText"),action:"view-source",cls:"testaction-button",glyph:61686,scale:"medium",tooltipType:"title",disabled:!0,enableToggle:!0,scope:this,handler:function(a){a.pressed?this.showSource():this.hideSource()}}),this.filterButton=
...
action:"toggle-recorder",cls:"testaction-button",scale:"medium",disabled:!Siesta.Recorder||Ext.isIE9m,tooltip:a.get("eventRecorderText"),handler:this.onRecorderClick,margin:"0 30 0 0",scope:this,enableToggle:!0}),{xtype:"versionupdatebutton"},{xtype:"component",id:"siesta-logo"}]:null},items:[{region:"center",slot:"cardContainer",xtype:"container",layout:{type:"card",deferredRender:!0},activeItem:0,minWidth:100,items:[{xtype:"assertiongrid",slot:"grid",isStandalone:this.isStandalone,listeners:{itemdblclick:this.onAssertionDoubleClick,
scope:this}},{xtype:"sourcepanel",slot:"source",listeners:{render:function(a){a.getEl().appendChild({cls:"si-sourcepanel-close fa-close",style:"right:"+(Ext.getScrollbarSize().width+5)+"px"}).on("click",this.hideSource,this)},scope:this}}].concat(Ext.ClassManager.getByAlias("widget.coveragereport")?{xtype:"coveragereport",slot:"coverageReport",harness:this.harness}:[])},{xtype:"domcontainer",region:b,collapsible:!0,split:{size:7},bodyStyle:"text-align : center",slot:"domContainer",stateful:!0,id:this.id+
"-domContainer",width:"east"==b||"west"==b?"50%":null,height:"south"==b||"north"==b?"50%":null,cls:"siesta-domcontainer",collapsed:!this.viewDOM}]});this.callParent();this.slots.domContainer.on({expand:this.onDomContainerExpand,collapse:this.onDomContainerCollapse,inspectionstart:function(){this.inspectionButton.toggle(!0)},inspectionstop:function(){this.inspectionButton.toggle(!1)},scope:this})},ensureLayout:function(){var a=this.getWidth(),b=this.slots.cardContainer,c=this.slots.domContainer,d=
c.getWidth(),b=b.minWidth+20;a-d<b&&c.setWidth(Math.max(0,a-b))},showSource:function(a){var b=this.test;if(this.test){var c=[],d=this.slots,e=d.source;d.cardContainer.layout.setActiveItem(e);0===arguments.length?Ext.each(b.getFailedAssertions(),function(a){null!=a.sourceLine&&c.push(a.sourceLine)}):c=[a];e.setSource(b.getSource(),c)}},hideSource:function(){var a=this.slots,b=a.cardContainer;b.layout.getActiveItem()===a.source&&(this.sourceButton.setPressed(!1),b.layout.setActiveItem(a.grid))},setViewDOM:function(a){var b=
this.slots.domContainer;a?b.expand(!1):b.collapse(null,!1)},onDomContainerCollapse:function(){this.viewDOM=!1;this.viewDomButton.toggle(!1);this.fireEvent("viewdomchange",this,!1)},onDomContainerExpand:function(){this.viewDOM=!0;this.viewDomButton.toggle(!0);this.fireEvent("viewdomchange",this,!0)},onRunTestClick:function(){this.fireEvent("runbuttonclick",this)},showTest:function(a,b){var c=this.slots.recorderPanel;this.slots.source.clear();this.filterButton&&this.filterButton.toggle(!1);this.hideSource();
...
onRecorderClick:function(){var a=this.slots.cardContainer;this.recorderPanel||(this.recorderPanel=Ext.create(this.recorderPanelClass,{slot:"recorderPanel",harness:this.harness,domContainer:this.slots.domContainer,recorderConfig:this.recorderConfig,closeButton:{text:Siesta.Resource("Siesta.Harness.Browser.UI.ResultPanel","closeText"),cls:"recorder-tool",handler:function(){a.layout.setActiveItem(0)}},listeners:{startrecord:function(a,c){this.fireEvent("startrecord",a,c);this.showTest(c)},show:function(){this.recorderButton.toggle(!0)},
play:function(a,c){this.showTest(c)},hide:function(){this.recorderButton.toggle(!1)},scope:this}}),this.slots.cardContainer.add(this.recorderPanel),this.relayEvents(this.recorderPanel,["startrecord","play"],"recorder"),this.test&&this.slots.recorderPanel.attachTo(this.test));a.layout.getActiveItem()===this.recorderPanel?a.layout.setActiveItem(this.slots.grid):a.layout.setActiveItem(this.recorderPanel)},afterRender:function(){this.callParent(arguments);this.testTitle=this.down("#resultpanel-testtitle");
this.child("bordersplitter").tracker.tolerance=0}}),Ext.define("Siesta.Harness.Browser.UI.AboutWindow",{extend:"Ext.Window",id:"aboutwindow",bodyPadding:20,modal:!0,width:500,height:380,closeAction:"destroy",bodyStyle:"background: #fff",autoScroll:!0,initComponent:function(){this.title=Siesta.Resource("Siesta.Harness.Browser.UI.AboutWindow","titleText").replace("{VERSION}",Siesta.meta.VERSION||"1.0.0");this.html=Siesta.Resource("Siesta.Harness.Browser.UI.AboutWindow","bodyText");this.buttons={padding:"10 13",
style:"background: transparent",items:[{hidden:!Siesta.Harness.Browser.Automation,text:Siesta.Resource("Siesta.Harness.Browser.UI.AboutWindow","upgradeText"),handler:function(){window.open("http://bryntum.com/store/siesta")}},{text:Siesta.Resource("Siesta.Harness.Browser.UI.AboutWindow","closeText"),handler:function(){this.up("window").close()}}]};this.callParent(arguments)}}),Ext.define("Siesta.Harness.Browser.UI.VersionUpdateButton",{extend:"Ext.Button",xtype:"versionupdatebutton",text:Siesta.Resource("Siesta.Harness.Browser.UI.VersionUpdateButton",
"newUpdateText"),action:"upgrade-siesta",hidden:!0,latestVersion:null,scale:"medium",constructor:function(){this.callParent(arguments);this.scope=this;Siesta.meta.VERSION&&!window.location.href.match("^https")&&this.fetchVersionInfo()},fetchVersionInfo:function(){Ext.data.JsonP.request({url:"//bryntum.com/siesta_version",params:{v:Siesta.meta.VERSION},scope:this,callback:this.onRequestCompleted})},onRequestCompleted:function(a,b){a&&(b&&b.name&&(new Ext.Version(b.name)).isGreaterThan(Siesta.meta.VERSION||
"1.0.0"))&&(this.latestVersion=b.name,this.show())},handler:function(){var a=Siesta.Resource("Siesta.Harness.Browser.UI.VersionUpdateButton"),b=new Ext.Window({cls:"changelog-window",title:a.get("updateWindowTitleText")+(Siesta.meta.VERSION||"1.0.0"),bodyPadding:5,modal:!0,width:500,height:380,closeAction:"destroy",plain:!0,autoScroll:!0,buttons:{padding:"10 13",style:"background: transparent",items:[{cls:"light-button",href:"http://www.bryntum.com/products/siesta/download-lite",hrefTarget:"_blank",
scale:"medium",text:a.get("downloadText")+this.latestVersion+a.get("liteText")},{cls:"light-button",href:"http://bryntum.com/customerzone",hrefTarget:"_blank",scale:"medium",text:a.get("downloadText")+this.latestVersion+a.get("standardText")},{text:a.get("cancelText"),scale:"medium",handler:function(){b.close()}}]}});b.show();b.body.mask(a.get("loadingChangelogText"));Ext.Ajax.request({useDefaultXhrHeader:!1,url:"http://bryntum.com/changelogs/_siesta.php",callback:function(a,d,e){b.body.unmask();
d&&e&&e.responseText?b.body.update(e.responseText):b.body.update(Siesta.Resource("Siesta.Harness.Browser.UI.VersionUpdateButton","changelogLoadFailedText"))}})}}),Ext.define("Siesta.Harness.Browser.UI.Header",{extend:"Ext.Component",xtype:"siesta-header",cls:"siesta-header",afterRender:function(){var a=Siesta.Resource("Siesta.Harness.Browser.UI.Viewport");this.callParent(arguments);this.getEl().createChild([{tag:"a",cls:"logo-link",href:"#",cn:[{tag:"span",html:Siesta.meta.VERSION||"1.0.0",cls:"tr-version-indicator"}]},
{tag:"div",cls:"right-top-area",cn:[{tag:"a",id:"bryntum-logo",href:"http://bryntum.com/",target:"_blank",cls:"bryntum-logo"},{tag:"a",cls:"apidocs-link",href:a.get("apiLinkUrl"),target:"_blank",html:a.get("apiLinkText")}]},{tag:"div",id:"update-ct"}])}}),Ext.define("Siesta.Harness.Browser.UI.ViewportController",{extend:"Ext.app.ViewController",alias:"controller.viewport",control:{testgrid:{selectionchange:"onTestGridSelectionChange",checkchange:"onTestGridCheckChange",itemcontextmenu:"onTestFileContextMenu",
itemdblclick:"onTestFileDoubleClick",showcoverageinfo:"showCoverageReport",resize:"onTestGridResize",optionchange:"onTestGridOptionChange",buttonclick:"onTestGridToolbarClick",framesizechange:"onFrameSizeChange"},"testnamecolumn treefilter":{change:{fn:"onFilterChange",buffer:300}},"testgridcontextmenu #uncheckOthers":{click:"uncheckOthers"},"testgridcontextmenu #runThis":{click:"runThisFile"},"testgridcontextmenu #uncheckAll":{click:"uncheckAll"},"testgridcontextmenu #checkAll":{click:"checkAll"},
"testgridcontextmenu #expandAll":{click:"expandAll"},"testgridcontextmenu #collapseAll":{click:"collapseAll"},"testgridcontextmenu #filterToCurrentGroup":{click:"filterToCurrentGroup"},"testgridcontextmenu #filterToFailed":{click:"filterToFailed"},"testgridcontextmenu #viewSource":{click:"viewSource"},resultpanel:{viewdomchange:"onDomPanelVisibilityChange",runbuttonclick:"runTest"},coveragereport:{backtomainui:"onCoverageReportBackToMainUI"}},disableRunButtonTimeout:null,disableRunButtonInterval:150,
onFilterChange:function(){this.getView().saveState()},filterToFailed:function(){var a=this.getView(),b=[];a.forEachTestFile(function(a){var d=a.get("test");d&&d.isFailed()&&b.push(a.get("title"))});b.length&&a.slots.filesTree.setFilterValue(b.join(" | "))},filterToCurrentGroup:function(){var a=this.getView(),b=a.currentFile.get("descriptor");b.parent&&a.slots.filesTree.setFilterValue(b.parent.group+">")},onTestGridSelectionChange:function(a,b){if(b.length){var c=this.getView(),d=b[0],e=d.get("test");
e&&c.slots.resultPanel.showTest(e,d.get("assertionsStore"));d.isLeaf()&&Ext.History.add(d.data.url)}},onTestGridCheckChange:function(a,b){this.getView().setNodeChecked(a,b)},onTestFileContextMenu:function(a,b,c,d,e){a=this.getView();a.currentFile=b;a.contextMenu||(a.contextMenu=new Siesta.Harness.Browser.UI.TestGridContextMenu);a.contextMenu.showAt(e.getXY());e.preventDefault()},onTestFileDoubleClick:function(a,b){var c=this.getView(),d=c.testsStore;if(d.isTreeFiltered()&&!b.isLeaf()){var e=[];b.cascadeBy(function(a){a!=
b&&(a.isLeaf()&&d.isNodeFilteredIn(a))&&e.push(a.get("descriptor"))});c.harness.launch(e)}else c.launchTest(b)},showCoverageReport:function(){var a=this.getView(),b=a.slots.resultPanel,c=b.slots.cardContainer,d=b.slots.coverageReport;d.loadHtmlReport(a.harness.generateCoverageHtmlReport(!1));if(c.getLayout().getActiveItem()!==d)b.hideIFrame(),b.slots.domContainer.collapse(),c.getLayout().setActiveItem(d);else this.onCoverageReportBackToMainUI()},onTestGridResize:function(){this.getView().slots.resultPanel.ensureLayout()},
onTestGridOptionChange:function(a,b,c){a=this.getView();a.setOption(b,c);a.saveState()},onTestGridToolbarClick:function(a,b,c){a=this.getView();switch(c){case "run-checked":a.runChecked();break;case "run-failed":a.runFailed();break;case "run-all":a.runAll();break;case "stop":a.stopSuite(b)}},onFrameSizeChange:function(a,b,c,d){a=this.getView();d||(d=b,b=c,c=d);$(".tr-iframe").width(b);$(".tr-iframe").height(c);a.harness.viewportHeight=c;a.harness.viewportWidth=b},uncheckOthers:function(){var a=this.getView(),
b=a.currentFile;a.uncheckAllExcept(b);a.setNodeChecked(b,!0)},runThisFile:function(){var a=this.getView();a.harness.launch([a.currentFile.get("descriptor")])},uncheckAll:function(){this.getView().uncheckAllExcept()},checkAll:function(){var a=this.getView();a.testsStore.forEach(function(b){a.setNodeChecked(b,!0,!0)})},expandAll:function(){this.getView().slots.filesTree.expandAll()},collapseAll:function(){this.getView().slots.filesTree.collapseAll()},viewSource:function(){var a=this.getView().currentFile,
b=a.get("test"),c=window.open(null,"siesta-source"),d=c.document.documentElement.getElementsByTagName("head")[0],e=c.document.body;d.innerHTML="<title>"+a.get("title")+"</title>";b?e.innerHTML="<pre>"+b.getSource()+"</pre>":$.ajax(a.get("url"),{success:function(a){e.innerHTML="<pre>"+a+"</pre>"}})},onDomPanelVisibilityChange:function(a,b){var c=this.getView();c.setOption("viewDOM",b);c.saveState()},runTest:function(){var a=this;null==a.disableRunButtonTimeout&&(a.disableRunButtonTimeout=setTimeout(function(){a.disableRunButtonTimeout=
null},a.disableRunButtonInterval),a.getView().runTest())},onCoverageReportBackToMainUI:function(){var a=this.getView().slots.resultPanel;a.slots.cardContainer.getLayout().setActiveItem(0);a.alignIFrame()}}),Ext.supports&&(Ext.supports.TouchEvents&&!Ext.supports.Touch)&&(Ext.supports.Touch=!1,Ext.supports.touchScroll=!1),Ext.define("Siesta.Harness.Browser.UI.Viewport",{extend:"Ext.container.Viewport",mixins:["Siesta.Harness.Browser.UI.CanFillAssertionsStore"],controller:"viewport",requires:["Ext.state.LocalStorageProvider",
"Ext.state.CookieProvider","ExtX.Reference.Slot","Siesta.Harness.Browser.UI.TestGrid","Siesta.Harness.Browser.UI.ResultPanel"],title:null,harness:null,stateful:!1,layout:"border",selection:null,filter:null,filterGroups:!1,testsStore:null,contextMenu:null,mouseVisualizer:null,enableVersionCheck:!0,collapsedNodes:null,showSizeControls:!1,expectedExtJSVersion:"6.0.1.250",viewportSizes:[[640,480],[800,600],[1024,768],[1920,1080],[2048,1536]],initComponent:function(){var a=this.harness;Ext.getBody().addCls("siesta");
Ext.getBody().on("keydown",this.onBodyKeyDown,this);Ext.setGlyphFontFamily("FontAwesome");Ext.state.Manager.setProvider(Ext.supports.LocalStorage?new Ext.state.LocalStorageProvider:new Ext.state.CookieProvider);this.selection={};a.stateful&&this.applyState(this.loadState());var b=this.buildTreeData({id:"root",group:"test suite"+this.title,items:a.descriptors}).children,b=this.testsStore=new Siesta.Harness.Browser.Model.FilterableTreeStore({model:"Siesta.Harness.Browser.Model.TestFile",sortOnLoad:!1,
root:{expanded:!0,children:b},proxy:"memory",listeners:{nodecollapse:this.saveState,nodeexpand:this.saveState,scope:this}});Ext.apply(this,{mouseVisualizer:Ext.isIE?void 0:new Siesta.Harness.Browser.UI.MouseVisualizer({harness:a}),slots:!0,items:[{region:"west",xtype:"testgrid",store:b,slot:"filesTree",id:a.id.replace(/\W/g,"_")+"-testTree",showSizeControls:this.showSizeControls,viewportSizes:this.viewportSizes,stateConfig:this.getState(),animate:!Ext.isIE,split:{size:7},filter:this.filter,filterGroups:this.filterGroups},
{xtype:"resultpanel",region:"center",slot:"resultPanel",cls:"resultPanel-panel",viewDOM:this.getOption("viewDOM"),id:a.id.replace(/\W/g,"_")+"-resultpanel",harness:a,recorderConfig:a.recorderConfig,maintainViewportSize:a.maintainViewportSize,domContainerRegion:a.domContainerRegion}]});this.callParent();this.on("afterlayout",this.onAfterLayout,this,{single:!0,delay:1});this.slots.filesTree.store.on({"filter-set":this.saveState,"filter-clear":this.saveState,scope:this});a.on("testendbubbling",this.onEveryTestEnd,
this);a.on("hassomecoverageinfo",this.onHasSomeCoverageInfo,this);a.on("nocoverageinfo",this.onNoCoverageInfo,this);a.on("testsuitelaunch",this.onTestSuiteLaunch,this);a.on("assertiondiscard",this.onAssertionDiscarded,this);if(this.mouseVisualizer)this.slots.resultPanel.on("recorderplay",function(a,b){this.mouseVisualizer.beginCursorVisualization(b)},this);window.location.href.match("^file:///")&&(a=Siesta.Resource("Siesta.Harness.Browser.UI.Viewport"),Ext.Msg.alert(a.get("httpWarningTitle"),a.get("httpWarningDesc")))},
buildTreeData:function(a){var b={id:a.id,title:a.group||a.title||a.name||a.url.replace(/(?:.*\/)?([^/]+)$/,"$1"),descriptor:a,nodeType:1,cloneNode:function(){return this}},c=this,d=b.id,e=this.collapsedNodes||{};if(a.group){var f=[];Ext.each(a.items,function(a){f.push(c.buildTreeData(a))});Ext.apply(b,{expanded:null!=e[d]||!1===a.expanded?!1:!0,checked:c.selection.hasOwnProperty(d)||!1,folderStatus:"yellow",children:f,leaf:!1})}else Ext.apply(b,{url:a.url,leaf:!0,checked:c.selection.hasOwnProperty(d)||
!1,passCount:0,failCount:0,time:0,assertionsStore:new Siesta.Harness.Browser.Model.AssertionTreeStore({model:"Siesta.Harness.Browser.Model.Assertion",proxy:"memory",root:{id:"__ROOT__",expanded:!0}})});return b},onBodyKeyDown:function(a){a.getKey()==Ext.EventObject[this.harness.rerunHotKey]&&a.ctrlKey&&(this.runTest(),a.preventDefault())},onAfterLayout:function(){if(this.getOption("autoRun")){var a=this.getChecked();this.harness.launch(a.length&&a||this.harness.descriptors)}},setNodeChecked:function(a,
b,c,d){var e=this,f=a.getId();b?this.selection[f]=1:delete this.selection[f];a.set("checked",b);!b&&a.parentNode&&e.setNodeChecked(a.parentNode,!1,!0,!0);a.isLeaf()||c||Ext.each(a.childNodes,function(a){e.setNodeChecked(a,b,!1,!0)});d||this.saveState()},forEachTestFile:function(a,b){this.testsStore.each(a,b)},getChecked:function(){var a=[];this.forEachTestFile(function(b){b.get("checked")&&b.isLeaf()&&a.push(b.get("descriptor"))});return a},runChecked:function(){0<this.getChecked().length&&this.harness.launch(this.getChecked())},
runFailed:function(){var a=[];this.forEachTestFile(function(b){var c=b.get("test");c&&c.isFailed()&&a.push(b.get("descriptor"))});0<a.length&&this.harness.launch(a)},runAll:function(){var a=[];this.forEachTestFile(function(b){b.isLeaf()&&a.push(b.get("descriptor"))});0<a.length&&this.harness.launch(a)},stopSuite:function(a){this.performStop();a.disable();setTimeout(function(){a.enable()},1E3)},performStop:function(){this.harness.needToStop=!0;this.testsStore.forEach(function(a){a.get("isStarting")&&
!a.get("isStarted")&&a.set("isStarting",!1)})},onBeforeScopePreload:function(a,b){this.testsStore.getNodeById(b).data.isStarted=!0},isTestRunningVisible:function(a){if(!(a.scopeProvider instanceof Scope.Provider.IFrame))return!1;if(this.harness.testOfForcedIFrame)return this.harness.testOfForcedIFrame.isFromTheSameGeneration(a);var b=this.slots.resultPanel;return b.test&&b.test.isFromTheSameGeneration(a)?b.isFrameVisible():!1},resetDescriptors:function(a){var b=this.testsStore;Joose.A.each(this.harness.flattenDescriptors(a),
function(a){var d=b.getNodeById(a.id);d.get("assertionsStore").removeAll(!0);d.reject();d.set("checked",this.selection.hasOwnProperty(a.id)||!1)},this)},onTestSuiteStart:function(a){Ext.getBody().addCls("testsuite-running");var b=this.slots.filesTree.getSelectionModel(),c=b.getLastSelected(),d=this.testsStore;this.resetDescriptors(a);c&&b.select(d.getNodeById(c.getId()))},onTestSuiteLaunch:function(a,b){var c=this.testsStore,d={};Joose.A.each(this.harness.flattenDescriptors(b),function(a){var b=c.getNodeById(a.id);
b.set({isMissing:a.isMissing,isStarting:!0});if((a=b.parentNode)&&!d[a.getId()]){for(b=a;b;b=b.parentNode)d[b.getId()]=!0;a.updateFolderStatus()}})},onTestSuiteEnd:function(a){Ext.getBody().removeCls("testsuite-running");this.updateStatusIndicator();Ext.isChrome?window.focus():(document.body.tabIndex=-1,document.body.focus())},onTestStart:function(a){var b=this.testsStore.getNodeById(a.url);b.beginEdit();b.set({test:a,isRunning:!0});b.endEdit();var c=this.slots.filesTree.getSelectionModel().getLastSelected();
c&&c.getId()==a.url&&(c=this.slots.resultPanel,c.showTest(a,b.get("assertionsStore")),c.setInitializing(!1))},isTestUpdateActual:function(a,b){b=b||this.testsStore.getNodeById(a.url);var c=b.get("test");return c?c&&c.isFromTheSameGeneration(a)&&c.launchId==a.launchId:!0},onTestUpdate:function(a,b,c){var d=this.testsStore.getNodeById(a.url);this.isTestUpdateActual(a,d)&&(this.processNewResult(d.get("assertionsStore"),a,b,c),this.getOption("breakOnFail")&&0<a.getFailCount()&&(this.performStop(),this.slots.filesTree.getSelectionModel().select(d)))},
onAssertionDiscarded:function(a,b,c){a=this.testsStore.getNodeById(b.url);this.isTestUpdateActual(b,a)&&a.get("assertionsStore").getNodeById(c.id).remove()},onTestEnd:function(a){var b=this.testsStore.getNodeById(a.url);this.isTestUpdateActual(a,b)&&(b.beginEdit(),b.set({passCount:a.getPassCount(),failCount:a.getFailCount(),todoPassCount:a.getTodoPassCount(),todoFailCount:a.getTodoFailCount()}),b.endEdit(),b.parentNode&&b.parentNode.updateFolderStatus());this.updateStatusIndicator()},onEveryTestEnd:function(a,
b){var c=this.testsStore.getNodeById(b.url);this.isTestUpdateActual(b,c)&&this.processEveryTestEnd(c.get("assertionsStore"),b)},onTestFail:function(a,b,c){b=this.testsStore.getNodeById(a.url);this.isTestUpdateActual(a,b)&&!a.isTodo&&(b.set("isFailed",!0),b.parentNode&&b.parentNode.updateFolderStatus())},getOption:function(a){switch(a){case "selection":return this.selection;default:return this.harness[a]}},setOption:function(a,b){switch(a){case "selection":return this.selection=b||{};case "collapsedNodes":return this.collapsedNodes=
b;case "filter":return this.filter=b;case "filterGroups":return this.filterGroups=b;default:return this.harness[a]=b}},getState:function(){return{autoRun:this.getOption("autoRun"),speedRun:this.getOption("speedRun"),viewDOM:this.getOption("viewDOM"),cachePreload:this.getOption("cachePreload"),transparentEx:this.getOption("transparentEx"),breakOnFail:this.getOption("breakOnFail"),debuggerOnFail:this.getOption("debuggerOnFail"),selection:this.getCheckedNodes(),collapsedNodes:this.getCollapsedFolders(),
filter:this.slots?this.slots.filesTree.getFilterValue():this.filter,filterGroups:this.slots?this.slots.filesTree.getFilterGroups():this.filterGroups}},getCheckedNodes:function(){var a={};this.testsStore.forEach(function(b){b.get("checked")&&(a[b.getId()]=1)});return a},getCollapsedFolders:function(){var a={};this.testsStore.forEach(function(b){b.isLeaf()||b.isExpanded()||(a[b.getId()]=1)});return a},applyState:function(a){var b=this;a&&Joose.O.each(a,function(a,d){b.setOption(d,a)})},getStateId:function(){return"test-run-"+
this.title},loadState:function(){var a=this.getStateId(),b=Ext.state.Manager.get(a);if(b)return b.collapsedNodes||(b.collapsedNodes=Ext.state.Manager.get(a+"-collapsed")),b.selection||(b.selection=Ext.state.Manager.get(a+"-selection")),b},saveState:function(){var a=this.getStateId(),b=this.getState();Ext.state.Manager.set(a+"-collapsed",b.collapsedNodes);Ext.state.Manager.set(a+"-selection",b.selection);delete b.collapsedNodes;delete b.selection;Ext.state.Manager.set(a,b)},uncheckAllExcept:function(a){var b=
this;this.testsStore.forEach(function(c){c!=a&&b.setNodeChecked(c,!1,!0)})},launchTest:function(a){var b=this.slots.resultPanel,c=a instanceof Ext.data.Model&&a.data.leaf||!0;a=a instanceof Siesta.Test?this.harness.getScriptDescriptor(a):a.get("descriptor");c&&(Ext.History.add(a.url),b.setInitializing(!0));this.harness.launch([a])},updateStatusIndicator:function(){var a=0,b=0;this.testsStore.forEach(function(c){(c=c.get("test"))&&c.isFinished()&&(a+=c.getPassCount(),b+=c.getFailCount())});this.slots.filesTree.updateStatus(a,
b)},runTest:function(){var a=this.slots.filesTree.getSelectionModel().getSelection()[0]||this.slots.resultPanel.test;a&&this.launchTest(a)},afterRender:function(){this.callParent(arguments);Ext.versions.extjs.equals(this.expectedExtJSVersion)||Ext.Msg.alert("Wrong Ext JS version detected","The Siesta UI expects that you use Ext JS version: "+this.expectedExtJSVersion+". You may experience errors when using another version");this.harness.isAutomated||setTimeout(Ext.Function.bind(this.deferredSetup,
this),1E3)},deferredSetup:function(){Ext.QuickTips&&Ext.QuickTips.init();this.enableVersionCheck&&Siesta.Harness.Browser.UI.VersionUpdateButton&&new Siesta.Harness.Browser.UI.VersionUpdateButton},onHasSomeCoverageInfo:function(){this.slots.filesTree.enableCoverageButton()},onNoCoverageInfo:function(){this.slots.filesTree.disableCoverageButton()},onManualCloseOfForcedIframe:function(a){var b=this.down("domcontainer");b&&b.test==a&&b.alignIFrame(!0)}}),Ext.XTemplate.override({strict:!0}),Ext.data.Connection.override({parseStatus:function(a){var b=
this.callOverridden(arguments);0===a&&(b.success=!0);return b}}));
Class("Siesta.Harness.Browser.UI.MouseVisualizer",{has:{cursorEl:null,onEventSimulatedListener:null,onTestFinishedListener:null,harness:null,currentTest:null,currentContainer:null,clickEvents:function(){return{click:0,dblclick:0,touchstart:0,touchend:0,mousedown:0,contextmenu:0}}},methods:{initialize:function(a){a=a||{};for(var b in a)a.hasOwnProperty(b)&&(this[b]=a[b]);delete this.harness;this.setHarness(a.harness)},getCursorEl:function(){if(this.cursorEl)return this.cursorEl;var a=this.currentContainer;
if(!a)throw"Need container for cursor";var b=a.querySelector(".ghost-cursor");b||(b=document.createElement("div"),b.className="ghost-cursor fa fa-mouse-pointer",b=a.appendChild(b));return this.cursorEl=b},setHarness:function(a){this.harness&&(this.harness.un("testframeshow",this.onTestFrameShow,this),this.harness.un("testframehide",this.onTestFrameHide,this));if(this.harness=a)a.on("testframeshow",this.onTestFrameShow,this),a.on("testframehide",this.onTestFrameHide,this),a.on("recorderplay",this.onRecorderPlay,
this)},reset:function(){this.onEventSimulatedListener&&(this.onEventSimulatedListener.remove(),this.onEventSimulatedListener=null);this.onTestFinishedListener&&(this.onTestFinishedListener.remove(),this.onTestFinishedListener=null);this.currentContainer=this.currentTest=this.cursorEl=null},onTestFrameShow:function(a){this.beginCursorVisualization(a.source)},onRecorderPlay:function(a,b){this.beginCursorVisualization(b)},beginCursorVisualization:function(a){a!=this.currentTest&&(this.reset(),this.currentTest=
a,this.harness.canShowCursorForTest(a)&&(this.currentContainer=a.scopeProvider.wrapper.childNodes[1],this.onEventSimulatedListener=a.on("eventsimulated",this.onEventSimulated,this),this.onTestFinishedListener=a.on("testfinalize",this.onTestFinished,this)))},onTestFrameHide:function(a){this.cleanupCursor();this.reset()},cleanupCursor:function(a,b){a=a||this.cursorEl;if(b=b||this.currentContainer){try{a.parentNode.removeChild(a)}catch(c){}try{for(var d=b.querySelectorAll(".ghost-cursor-click-indicator-big"),
e=d.length;0<=e;--e){var f=d.item(e);f.parentNode.remove(f)}}catch(g){}}},onTestFinished:function(a,b){var c=this.cursorEl,d=this.currentContainer;this.reset();if(c){var e=this;c.classList.add("ghost-cursor-hidden");setTimeout(function(){e.cleanupCursor(c,d)},2E3)}},onEventSimulated:function(a,b,c,d,e){d.match(/touch|mouse|click|contextmenu/)&&("number"===typeof e.clientX&&"number"===typeof e.clientY)&&this.currentContainer&&(a=b.currentPosition[0],b=b.currentPosition[1],this.updateGhostCursor(d,
a,b),d in this.clickEvents&&this.showClickIndicator(d,a,b))},showClickIndicator:function(a,b,c){a=document.createElement("div");a.className="ghost-cursor-click-indicator ";a.style.setProperty("left",b+"px");a.style.setProperty("top",+c+"px");a.addEventListener("animationend",this.afterAnimation);a.addEventListener("webkitAnimationEnd",this.afterAnimation);this.currentContainer.appendChild(a)},afterAnimation:function(){this.parentNode.removeChild(this)},updateGhostCursor:function(a,b,c){a=this.getCursorEl();
b=$.browser.opera?"translate("+b+"px,"+c+"px)":"translate3d("+b+"px, "+c+"px, 0)";a.style.setProperty("-webkit-transform",b);a.style.setProperty("transform",b)}}});
