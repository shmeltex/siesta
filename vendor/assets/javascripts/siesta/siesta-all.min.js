...
!0;return(new b(a,c)).c},create:function(b,c,d){if(!b)return(new c(b,d)).c;var e=this;if(/^\./.test(b))return this.executeIn(a.top,function(){return e.create(b.replace(/^\./,""),c,d)});for(var f=d||{},g=a.S.saneSplit(b,"."),q=this.getCurrent(),u=q==a.top?[]:a.S.saneSplit(q.meta.name,"."),x=0;x<g.length;x++){var w=g[x],v=x==g.length-1;if("meta"==w||"my"==w||!w)throw"Module name ["+b+"] may not include a part called 'meta' or 'my' or empty part.";var y=q[w];u.push(w);var D=u.join("."),B=!1;if("undefined"==
typeof y)v?(y=this.earlyCreate(D,c,f),B=!0):y=(new a.Namespace.Keeper(D)).c,q[w]=y;else if(v&&y&&y.meta)if(q=y.meta,c==a.Namespace.Keeper)q.extend(f);else if(q instanceof a.Namespace.Keeper)q.plant(this.earlyCreate(D,c,f)),B=!0;else throw Error("Double declaration of ["+D+"]");else if(v&&!(y&&y.meta&&y.meta.meta))throw"Trying to setup module "+D+" failed. There is already something: "+y;v&&this.prepareMeta(y.meta);B&&y.meta.construct(f);q=y}return q},prepareMeta:function(){},prepareProperties:function(a,
...
!0,e&&e.apply(this,arguments),c.apply(this,arguments),c.__CALLING__=!1,!1!==d))return a.WebKitPoint?!1:!0},a.onerror.__SP_MANAGED__=!0)}},cachedOnError:null},override:{cleanup:function(){this.cachedOnError=null;try{this.scope.onerror=null}catch(a){}this.SUPERARG(arguments);this.scope=null}},methods:{cleanupHanlders:function(){var a=this.parentWindow.Scope.Provider;delete a.__ONLOAD__[this.scopeId];delete a.__ONERROR__[this.scopeId]},getHead:function(){return this.getDocument().getElementsByTagName("head")[0]},
...
unordered:!0})},addSeedingToPreload:function(){var a=this.getPreload();this.seedingCode&&a.unshift({type:"js",content:this.seedingCode});this.seedingScript&&a.push({type:"js",url:this.seedingScript})},setup:function(a){var b="v"=="\v"||Boolean(this.parentWindow.msWriteProfilerMark),c=!1;Joose.A.each(this.getPreload(),function(a){if("js"==a.type&&a.content&&!a.unordered)return c=!0,!1});this.sourceURL||b&&c?(this.addSeedingToPreload(),this.setupIncrementally(a)):(b||this.addSeedingToPreload(),this.setupWithDocWrite(a,
b))},setupWithDocWrite:function(a,b){var c=[],d=this;Joose.A.each(this.getPreload(),function(a){if("js"==a.type)c.push(d.getScriptTagString(a.url,a.content));else if("css"==a.type)c.push(d.getLinkTagString(a.url,a.content));else throw"Incorrect preload descriptor "+a;});this.create();var e=this.scopeId;this.parentWindow.Scope.Provider.__ONLOAD__[e]=function(){var c=function(){a&&a(d)};b?(d.seedingCode&&d.runCode(d.seedingCode),d.seedingScript?d.runScript(d.seedingScript,c):c()):c()};var f=this.getDocument();
f.open();f.write([this.useStrictMode?"<!DOCTYPE html>":"",'<html style="width: 100%; height: 100%; margin : 0; padding : 0;"><head>',this.innerHtmlHead||"",c.join(""),"</head>",'<body style="margin : 0; padding : 0; width: 100%; height: 100%" onload="(window.opener || window.parent).Scope.Provider.__ONLOAD__['+e+']()">',this.innerHtmlBody||"","</body></html>"].join(""));f.close();d.cachedOnError&&d.installOnErrorHandler(d.cachedOnError)},setupIncrementally:function(a){var b=this;this.create(function(){if(!b.sourceURL){var c=
b.getDocument();if(b.innerHtmlHead){var d=b.getHead();try{d.innerHTML=b.innerHtmlHead}catch(e){var f=c.createElement("div");f.innerHTML=b.innerHtmlHead;for(var g=0;g<f.children.length;g++)d.appendChild(f.children[g])}}b.innerHtmlBody&&(c.body.innerHTML=b.innerHtmlBody)}var k=function(a,c){var d=function(){k(a,c)};if(a.length){var e=a.shift();e.url?b.runScript(e.url,d):"js"==e.type?b.runCode(e.content,d):(b.addStyleTag(e.content),d())}else c&&c()};k(b.getPreload().slice(),a)})},getScriptTagString:function(a,
b){var c='<script type="text/javascript"';return c=a?c+(' src="'+a+'">\x3c/script>'):c+(">"+b.replace(/<\/script>/gi,"\\x3C/script>")+"\x3c/script>")},getLinkTagString:function(a,b){if(a)return'<link href="'+a+'" rel="stylesheet" type="text/css" />';if(b)return"<style>"+b+"</style>"},loadCSS:function(a,b){var c=this.getDocument(),d=c.createElement("link");d.type="text/css";d.rel="stylesheet";d.href=a;this.getHead().appendChild(d);var e=!1,d=function(){e||(e=!0,clearTimeout(f),b&&b(),c.body.removeChild(g))},
f=setTimeout(d,3E3),g=c.createElement("img");g.onerror=d;c.body.appendChild(g);g.src=a},runCode:function(a,b){this.getHead().appendChild(this.createScriptTag(a));b&&b()},runScript:function(a,b){this.isCSS(a)?this.loadCSS(a,b):this.getHead().appendChild(this.createScriptTag(null,a,b))},createScriptTag:function(a,b,c){var d=this.getDocument().createElement("script");d.setAttribute("type","text/javascript");b&&d.setAttribute("src",b);a&&(d.text=a);c&&(d.onload=d.onreadystatechange=function(){if(!d.readyState||
"loaded"==d.readyState||"complete"==d.readyState||4==d.readyState&&200==d.status)d.onload=d.onreadystatechange=null,"v"=="\v"?setTimeout(c,0):c()});return d},addStyleTag:function(a){var b=this.getDocument(),c=b.createElement("style");c.setAttribute("type","text/css");b.getElementsByTagName("head")[0].appendChild(c);c.styleSheet?c.styleSheet.cssText=a:c.appendChild(b.createTextNode(a))}}});
...
d.style.width=(e&&e.width||1024)+"px";d.style.height=(e&&e.height||768)+"px";d.setAttribute("frameborder",0);this.name&&d.setAttribute("name",this.name);var f=!1,g=function(){f||(d.detachEvent?d.detachEvent("onload",g):d.onload=null,a&&a(b))};d.attachEvent?d.attachEvent("onload",g):d.onload=g;d.src=this.sourceURL||"about:blank";if(this.performWrap){var k=this.wrapper=this.wrapper||c.createElement("div");k.className=this.wrapCls||"";k.appendChild(d)}(this.parentEl||c.body).appendChild(k||d);var l=
...
"Please enable popups for the host with this test suite running: "+this.parentWindow.location.host;"v"!="\v"&&!Boolean(this.parentWindow.msWriteProfilerMark)||this.sourceURL||(b=this.getDocument(),b.open(),b.write(""),b.close());this.cachedOnError&&this.installOnErrorHandler(this.cachedOnError);var d=function(a,b){var c=!1,d=!0,l=a.document,m=l.documentElement,n=l.addEventListener?"addEventListener":"attachEvent",p=l.addEventListener?"removeEventListener":"detachEvent",r=l.addEventListener?"":"on",
q=function(d){if("readystatechange"!=d.type||"complete"==l.readyState)("load"==d.type?a:l)[p](r+d.type,q,!1),!c&&(c=!0)&&b.call(a,d.type||d)},u=function(){try{m.doScroll("left")}catch(a){setTimeout(u,50);return}q("poll")};if("complete"==l.readyState)b.call(a,"lazy");else{if(l.createEventObject&&m.doScroll){try{d=!a.frameElement}catch(x){}d&&u()}l[n](r+"DOMContentLoaded",q,!1);l[n](r+"readystatechange",q,!1);a[n](r+"load",q,!1)}};this.sourceURL?setTimeout(function(){d(c,a||function(){})},10):d(c,a||
...
(function(){function a(a){return 10>a?"0"+a:a}function b(a){e.lastIndex=0;return e.test(a)?'"'+a.replace(e,function(a){var b=k[a];return"string"===typeof b?b:"\\u"+("0000"+a.charCodeAt(0).toString(16)).slice(-4)})+'"':'"'+a+'"'}function c(a,d){var e,k,q,u,x=f,w,v=d[a];v&&("object"===typeof v&&"function"===typeof v.toJSON)&&(v=v.toJSON(a));"function"===typeof l&&(v=l.call(d,a,v));switch(typeof v){case "string":return b(v);case "number":return isFinite(v)?String(v):"null";case "boolean":case "null":return String(v);
case "object":if(!v)return"null";f+=g;w=[];if("[object Array]"===Object.prototype.toString.apply(v)){u=v.length;for(e=0;e<u;e+=1)w[e]=c(e,v)||"null";q=0===w.length?"[]":f?"[\n"+f+w.join(",\n"+f)+"\n"+x+"]":"["+w.join(",")+"]";f=x;return q}if(l&&"object"===typeof l)for(u=l.length,e=0;e<u;e+=1)"string"===typeof l[e]&&(k=l[e],(q=c(k,v))&&w.push(b(k)+(f?": ":":")+q));else for(k in v)Object.prototype.hasOwnProperty.call(v,k)&&(q=c(k,v))&&w.push(b(k)+(f?": ":":")+q);q=0===w.length?"{}":f?"{\n"+f+w.join(",\n"+
f)+"\n"+x+"}":"{"+w.join(",")+"}";f=x;return q}}"function"!==typeof Date.prototype.toJSON&&(Date.prototype.toJSON=function(b){return isFinite(this.valueOf())?this.getUTCFullYear()+"-"+a(this.getUTCMonth()+1)+"-"+a(this.getUTCDate())+"T"+a(this.getUTCHours())+":"+a(this.getUTCMinutes())+":"+a(this.getUTCSeconds())+"Z":null},String.prototype.toJSON=Number.prototype.toJSON=Boolean.prototype.toJSON=function(a){return this.valueOf()});var d=/[\u0000\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,
...
target:"target",toAppear:"to appear",targetMoved:"Moving target detected, retargeting initiated",alertMethodNotCalled:"Expected a call to alert()"},"Siesta.Test.Date":{isEqualTo:"is equal to",Got:"Got"},"Siesta.Test.Element":{elementContent:"element content",toAppear:"to appear",toDisappear:"to disappear",monkeyException:"Monkey testing action did not complete properly - probably an exception was thrown",monkeyNoExceptions:"No exceptions thrown during monkey test",monkeyActionLog:"Monkey action log",
elementHasClass:"Element has the CSS class",elementHasNoClass:"Element has no CSS class",elementClasses:"Classes of element",needClass:"Need CSS class",hasStyleDescTpl:"Element has correct {value} for CSS style {property}",elementStyles:"Styles of element",needStyle:"Need style",hasNotStyleDescTpl:"Element does not have: {value} for CSS style {property}",hasTheStyle:"Element has the style",element:"element",toBeTopEl:"to be the top element at its position",toNotBeTopEl:"to not be the top element at its position",
selector:"selector",selectors:"selectors",toAppear:"to appear",toAppearAt:"to appear at",noCssSelector:"A CSS selector must be supplied",waitForSelectorsBadInput:"An array of CSS selectors must be supplied",Position:"Position",noElementAtPosition:"No element found at the specified position",elementIsAtDescTpl:"DOM element or its child is at [ {x}, {y} ] coordinates",topElement:"Top element",elementIsAtPassTpl:"DOM element is at [ {x}, {y} ] coordinates",allowChildrenDesc:"Need exactly this or its child",
allowChildrenAnnotation:"Passed element is not the top-most one and not the child of one",shouldBe:"Should be",noChildrenFailAnnotation:"Passed element is not the top-most one",topLeft:"(t-l)",bottomLeft:"(b-l)",topRight:"(t-r)",bottomRight:"(b-r)",elementIsNotTopElementPassTpl:"Element is not the top element on the screen",selectorIsAtPassTpl:"Found element matching CSS selector {selector} at [ {xy} ]",elementMatching:"Element matching",selectorIsAtFailAnnotation:"Passed selector does not match any selector at",
selectorExistsFailTpl:"No element matching the passed selector found",selectorExistsPassTpl:"Found DOM element(s) matching CSS selector {selector}",selectorNotExistsFailTpl:"Elements found matching the passed selector",selectorNotExistsPassTpl:"Did not find any DOM element(s) matching CSS selector {selector}",toChangeForElement:"to change for element",selectorCountIsPassTpl:"Found exactly {count} elements matching {selector}",selectorCountIsFailTpl:"Found {got} elements matching the selector {selector}, expected {need}",
isInViewPassTpl:"Passed element is within the visible viewport",toAppearInTheViewport:"to appear in the viewport",elementIsEmptyPassTpl:"Passed element is empty",elementIsNotEmptyPassTpl:"Passed element is not empty",elementToBeEmpty:"element to be empty",elementToNotBeEmpty:"element to not be empty"},"Siesta.Test.ExtJS":{bundleUrlNotFound:"Cannot find Ext JS bundle url",assertNoGlobalExtOverridesInvalid:"Was not able to find the Ext JS bundle URL in the `assertNoGlobalExtOverrides` assertion",assertNoGlobalExtOverridesPassTpl:"No global Ext overrides found",
assertNoGlobalExtOverridesGotDesc:"Number of overrides found",foundOverridesFor:"Found overrides for",animationsToFinalize:"animations to finalize",extOverridesInvalid:"Was not able to find the ExtJS bundle URL in the `assertMaxNumberOfGlobalExtOverrides` assertion)",foundLessOrEqualThan:"Found less or equal than",nbrOverridesFound:"Number of overrides found",globalOverrides:"Ext JS global overrides"},"Siesta.Test.ExtJSCore":{waitedForRequires:"Waiting for required classes took too long - \nCheck the `Net` tab in Firebug and the `loaderPath` config",
waitedForExt:"Waiting for Ext.onReady took too long - probably some dependency could not be loaded. \nCheck the `Net` tab in Firebug and the `loaderPath` config",waitedForApp:"Waiting for MVC application launch took too long - no MVC application on test page? \nYou may need to disable the `waitForAppReady` config option",noComponentMatch:'Your component query: "{component}" returned no components',multipleComponentMatch:'Your component query: "{component}" returned more than 1 component',noComponentFound:"No component found for CQ",
knownBugIn:"Known bug in",Class:"Class",wasLoaded:"was loaded",wasNotLoaded:"was not loaded",invalidCompositeQuery:"Invalid composite query selector",ComponentQuery:"ComponentQuery",CompositeQuery:"CompositeQuery",matchedNoCmp:"matched no Ext.Component",messageBoxVisible:"Message box is visible",messageBoxHidden:"Message box is hidden"},"Siesta.Test.Function":{Need:"need",atLeast:"at least",exactly:"exactly",methodCalledExactly:"method was called exactly {n} times",exceptionEvalutingClass:"Exception [{e}] caught while evaluating the class name"},
"Siesta.Test.More":{isGreaterPassTpl:"`{value1}` is greater than `{value2}`",isLessPassTpl:"`{value1}` is less than `{value2}`",isGreaterEqualPassTpl:"`{value1}` is greater or equal to`{value2}`",isLessEqualPassTpl:"`{value1}` is less or equal to`{value2}`",isApproxToPassTpl:"`{value1}` is approximately equal to `{value2}`",needGreaterThan:"Need greater than",needGreaterEqualTo:"Need greater or equal to",needLessThan:"Need less than",needLessEqualTo:"Need less or equal to",exactMatch:"Exact match",
withinThreshold:"Match within treshhold",needApprox:"Need approx",thresholdIs:"Threshold is",stringMatchesRe:"`{string}` matches regexp {regex}",stringNotMatchesRe:"`{string}` does not match regexp {regex}",needStringMatching:"Need string matching",needStringNotMatching:"Need string not matching",needStringContaining:"Need string containing",needStringNotContaining:"Need string not containing",stringHasSubstring:"`{string}` has a substring: `{regex}`",stringHasNoSubstring:"`{string}` does not have a substring: `{regex}`",
throwsOkInvalid:"throws_ok accepts a function as 1st argument",didntThrow:"Function did not throw an exception",exMatchesRe:"Function throws exception matching to {expected}",exceptionStringifiesTo:"Exception stringifies to",exContainsSubstring:"Function throws exception containing a substring: {expected}",fnDoesntThrow:"Function does not throw any exceptions",fnThrew:"Function threw an exception",isInstanceOfPass:"Object is an instance of the specified class",needInstanceOf:"Need instance of",isAString:"{value} is a string",
aStringValue:"AStringValue",isAnObject:"{value} is an object",anObject:"An object value",isAnArray:"{value} is an array",anArrayValue:"An array value",isANumber:"{value} is a number",aNumberValue:"a number value",isABoolean:"{value} is a boolean",aBooleanValue:"a number value",isADate:"{value} is a date",aDateValue:"a date value",isARe:"{value} is a regular expression",aReValue:"a regular expression",isAFunction:"{value} is a function",aFunctionValue:"a function",isDeeplyPassTpl:"{obj1} is deeply equal to {obj2}",
isDeeplyStrictPassTpl:"{obj1} is strictly deeply equal to {obj2}",globalCheckNotSupported:"Testing leakage of global variables is not supported on this platform",globalVariables:"Global Variables",noGlobalsFound:"No unexpected global variables found",globalFound:"Unexpected global found",globalName:"Global name",value:"value",conditionToBeFulfilled:"condition to be fulfilled",ms:"ms",waitingFor:"Waiting for",waitedTooLong:"Waited too long for",conditionNotFulfilled:"Condition was not fullfilled during",
waitingAborted:"Waiting aborted",Waited:"Waited",checkerException:"checker threw an exception",Exception:"Exception",msFor:"ms for",forcedWaitFinalization:"Forced finalization of waiting for",chainStepNotCompleted:"The step in `t.chain()` call did not complete within required timeframe, chain can not proceed",stepNumber:"Step number",oneBased:"(1-based)",atLine:"At line",chainStepEx:"Chain step threw an exception",stepFn:"Step function",notUsingNext:'does not use the provided "next" function anywhere',
calledMoreThanOnce:"The `next` callback of {num} step (1-based) of `t.chain()` call at line {line} is called more than once."},"Siesta.Test.SenchaTouch":{STSetupFailed:"Waiting for Ext.setup took too long - some dependency could not be loaded? Check the `Net` tab in Firebug",invalidSwipeDir:"Invalid swipe direction",moveFingerByInvalidInput:"Trying to call moveFingerBy without relative distances",scrollUntilFailed:"scrollUntil failed to achieve its mission",scrollUntilElementVisibleInvalid:"scrollUntilElementVisible: target or scrollable not provided",
scrollerReachPos:"scroller to reach position"},"Siesta.Test":{noCodeProvidedToTest:"No code provided to test",addingAssertionsAfterDone:"Adding assertions after the test has finished",testFailedAndAborted:"Assertion failed, test execution aborted",atLine:"at line",of:"of",character:"character",isTruthy:'`{value}` is a "truthy" value',needTruthy:'Need "truthy" value',isFalsy:'`{value}` is a "falsy" value',needFalsy:'Need "falsy" value',isEqualTo:"`{got}` is equal to `{expected}`",isNotEqualTo:"`{got}` is not equal to `{expected}`",
needNot:"Need not",isStrictlyEqual:"`{got}` is strictly equal to `{expected}`",needStrictly:"Need strictly",isStrictlyNotEqual:"`{got}` is strictly not equal to `{expected}`",needStrictlyNot:"Need strictly not",alreadyWaiting:"Already waiting with title",noOngoingWait:"There is no ongoing `wait` action with title",noMatchingEndAsync:"No matching `endAsync` call within",endAsyncMisuse:"Calls to endAsync without argument should only be performed if you have single beginAsync statement",codeBodyMissingForSubTest:"Code body is not provided for sub test",
codeBodyMissingTestArg:"Code body of sub test [{name}] does not declare a test instance as 1st argument",Subtest:"Subtest",Test:"Test",failedToFinishWithin:"failed to finish within",threwException:"threw an exception",testAlreadyStarted:"Test has already been started",setupTookTooLong:"`setup` method took too long to complete",errorBeforeTestStarted:"Error happened before the test started",testStillRunning:"Your test is still considered to be running, if this is unexpected please see console for more information",
testNotFinalized:'Your test [{url}] has not finalized, most likely since a timer (setTimeout) is still active. If this is the expected behavior, try setting "overrideSetTimeout : false" on your Harness configuration.',missingDoneCall:"Test has completed, but there was no `t.done()` call. Add it at the bottom, or use `t.beginAsync()` for asynchronous code",allTestsPassed:"All tests passed","Snoozed until":"Snoozed until",testTearDownTimeout:"Test's tear down process has timeout out"},"Siesta.Recorder.Editor.Code":{invalidSyntax:"Invalid syntax"},
"Siesta.Recorder.Editor.DragTarget":{targetLabel:"Target",toLabel:"To",byLabel:"By",cancelButtonText:"Cancel",saveButtonText:"Save",dragVariantTitle:"Edit `drag` action",moveCursorVariantTitle:"Edit `moveCursor` action"},"Siesta.Recorder.UI.RecorderPanel":{actionColumnHeader:"Action",offsetColumnHeader:"Offset",queryMatchesNothing:"Query matches no DOM elements or components",queryMatchesMultiple:"Query matches multiple components",noVisibleElsFound:"No visible elements found for target",noTestDetected:"No test detected",
noTestStarted:"You need to run a test first",recordTooltip:"Record",stopTooltip:"Stop",playTooltip:"Play",clearTooltip:"Clear all",codeWindowTitle:"Code",addNewTooltip:"Add a new step",removeAllPromptTitle:"Remove all?",removeAllPromptMessage:"Do you want to clear the recorded events?",Error:"Error"},"Siesta.Recorder.UI.TargetColumn":{headerText:"Target / Value",by:"by",to:"to"},"Siesta.Recorder.UI.TargetColumn":{headerText:"Target / Value",by:"by",to:"to"}};
...
g=" "+f.get("conditionToBeFulfilled"),k="waitFor",l=this,m=l.getSourceLine(),n=l.originalSetTimeout,p=l.originalClearTimeout,r,q;if(1===arguments.length&&"Object"==this.typeOf(a)){var u=a;a=u.method;b=u.callback;c=u.scope;d=u.timeout;e=u.interval;g=u.description||g;k=u.assertionName||k;q=u.suppressAssertion;r=u.errback}u="Number"==this.typeOf(a);b=b||function(){};var g=u?a+" "+f.get("ms"):g,x,w=l.startWaiting(f.get("waitingFor")+" "+g,m);e=e||this.waitForPollInterval;d=d||this.waitForTimeout;var v=
this.beginAsync((u?a:d)+3*e,function(){p(x);l.finalizeWaiting(w,!1,f.get("waitedTooLong")+": "+g,{assertionName:k,annotation:f.get("conditionNotFulfilled")+" "+d+f.get("ms")},r,q);return!0}),y=!1;this.on("beforetestfinalize",function(){y||(y=!0,l.finalizeWaiting(w,!1,f.get("waitingAborted"),null,null,q),l.endAsync(v),p(x))},null,{single:!0});if(u)x=n(function(){y=!0;l.finalizeWaiting(w,!0,f.get("Waited")+" "+a+" "+f.get("ms"),null,null,q);l.endAsync(v);l.processCallbackFromTest(b,[],c||l)},a);else{var D,
B=new Date,z=function(){var m=new Date-B;if(m>d)l.endAsync(v),l.finalizeWaiting(w,!1,f.get("waitedTooLong")+": "+g,{assertionName:k,annotation:f.get("conditionNotFulfilled")+" "+d+f.get("ms")},r,q),y=!0;else{try{D=a.call(c||l)}catch(p){l.endAsync(v);l.finalizeWaiting(w,!1,k+" "+f.get("checkerException"),{assertionName:k,got:p.toString(),gotDesc:f.get("Exception")},r,q);y=!0;return}null!=D&&!1!==D?(l.endAsync(v),y=!0,l.finalizeWaiting(w,!0,f.get("Waited")+" "+m+" "+f.get("msFor")+" "+g,null,null,q),
l.processCallbackFromTest(b,[D],c||l)):x=n(z,e)}};z()}return{force:function(){y||(y=!0,p(x),l.endAsync(v),l.finalizeWaiting(w,!0,f.get("forcedWaitFinalization")+" "+g,null,null,q),l.processCallbackFromTest(b,[],c||l))}}},waitForMs:function(){return this.waitFor.apply(this,arguments)},waitForFn:function(){return this.waitFor.apply(this,arguments)},analyzeChainStep:function(a){a=a.toString();var b=a.match(/function\s*[^(]*\(\s*(.*?)\s*(?:,|\))/)[1];return b?-1!=a.match(/\{([\s\S]*)\}/)[1].indexOf(b):
...
Siesta.Test)e.launchSubTest(a,g(!0).next);else if("Function"==e.typeOf(a)||"Function"==e.typeOf(a.action)){var u="Function"==e.typeOf(a)?a:a.action,g=g(!1);l.unshift(f?function(){}:g.next);f||e.analyzeChainStep(u)||e.fail(b.get("stepFn")+" ["+u.toString()+"] "+b.get("notUsingNext"));if(e.transparentEx)u.apply(e,l);else{var x=e.getExceptionCatcher()(function(){u.apply(e,l)});void 0!==x&&e.fail(b.get("chainStepEx"),{annotation:e.stringifyException(x)})}f&&e.endAsync(g.async)}else("String"==e.typeOf(a)?
...
(clearTimeout(e),c.launch())},function(a){d||(clearTimeout(e),c.launch(a))})},f=c.isReady();if(f.ready)e();else var g=setTimeout(function(){clearInterval(k);e(d)},c.isReadyTimeout),k=setInterval(function(){f=c.isReady();f.ready?(clearInterval(k),clearTimeout(g),e()):d=f.reason||d},100)}},setup:function(a,b){a.call(this)},tearDown:function(a,b){a.call(this)},earlySetup:function(a,b){a.call(this)},cleanupContextBeforeStart:function(){var a=this.global;this.forEachUnexpectedGlobal(function(b){try{delete a[b]}catch(c){}})},
...
function(){b.setupDone=!0;a()})},start:function(){var a=Siesta.my.activeHarness=this,b=Array.prototype.concat.apply([],arguments);this.setup(function(){a.normalizeDescriptors(b);a.launch(a.descriptors)})},normalizeDescriptors:function(a){var b=this,c=[];Joose.A.each(a,function(a,e){a&&c.push(b.normalizeDescriptor(a,b,e))});b.descriptors=c},launch:function(a,b,c){var d=this.currentLaunchId=this.launchCounter++,e=this;this.needToStop=!1;var f=this.flattenDescriptors(a),g=new Siesta.Content.Preset,k=
[g,this.mainPreset];Joose.A.each(f,function(a){a.preset!=e.mainPreset&&a.preset!=e.emptyPreset&&k.push(a.preset);a.testCode||g.addResource(a.url);e.deleteTestByURL(a.url)});var l=new this.contentManagerClass({harness:this,presets:[g].concat(this.cachePreload?k:[])}),m=this.launches[d]={increaseTimeout:"parallel"==this.runCore&&f.length>this.increaseTimeoutThreshold,launchId:d,descriptors:f.slice(),descriptorsLeft:null,contentManager:l};e.onTestSuiteStart(a,l);l.cache(function(){Joose.A.each(f,function(a){var b=
a.url;l.hasContentOf(b)?(b=a.testConfig=Siesta.getConfigForTestScript(l.getContentOf(b)))&&(b.preload||b.alsoPreload)&&(a.preset=e.getDescriptorPreset(a)):a.testCode||e.markMissingFile(a);e.normalizeScopeProvider(a)});e.fireEvent("testsuitelaunch",a,l);e.runCoreGeneral(f,l,m,m.callback=function(){e.onTestSuiteEnd(a,l);b&&b(a);delete e.launches[d]})},function(){},!0)},markMissingFile:function(a){a.isMissing=!0},flattenDescriptors:function(a,b){var c=[],d=this;Joose.A.each(a,function(a){a.group?(b&&
...
b,c,d){var e=this,f=0,g=a.length;g||d();for(var k=!1,l=!1,m=!1,n=function(m){e.processURL(m,m.index,b,c,function(){f++;e.needToStop||k?(k=!0,l||(l=!0,d())):f==g?d():p(a)})},p=function(a){var b=a.shift();b&&(m?setTimeout(function(){n(b)},e.pauseBetweenTests):n(b))},r=1;r<=this.maxThreads;r++)p(a);m=!0},runCoreSequential:function(a,b,c,d){c.descriptorsLeft||(c.descriptorsLeft=a);if(a.length&&!this.needToStop){var e=a.shift(),f=this,g=a.length;this.processURL(e,e.index,b,c,function(){a.length&&a.length==
...
"failuresFoundText")))},getExitCode:function(){return this.allPassed()?0:1}}});
...
f,b,!0)||h.data(a,g,b,!0)||(h.removeData(a,e,!0),k.resolve())},0)}function f(){return!1}function g(){return!0}function k(a,c,d){var e=h.extend({},d[0]);e.type=a;e.originalEvent={};e.liveFired=b;h.event.handle.call(c,e);e.isDefaultPrevented()&&d[0].preventDefault()}function l(a){var b,c,d,e,f,g,k,l,m,n,p,r=[];e=[];f=h._data(this,"events");if(a.liveFired!==this&&f&&f.live&&!(a.target.disabled||a.button&&"click"===a.type)){a.namespace&&(p=RegExp("(^|\\.)"+a.namespace.split(".").join("\\.(?:.*\\.)?")+
"(\\.|$)"));a.liveFired=this;var q=f.live.slice(0);for(k=0;k<q.length;k++)f=q[k],f.origType.replace(ia,"")===a.type?e.push(f.selector):q.splice(k--,1);e=h(a.target).closest(e,a.currentTarget);l=0;for(m=e.length;l<m;l++)for(n=e[l],k=0;k<q.length;k++)if(f=q[k],n.selector===f.selector&&(!p||p.test(f.namespace))&&!n.elem.disabled){g=n.elem;d=null;if("mouseenter"===f.preType||"mouseleave"===f.preType)a.type=f.preType,(d=h(a.relatedTarget).closest(f.selector)[0])&&h.contains(g,d)&&(d=g);d&&d===g||r.push({elem:g,
handleObj:f,level:n.level})}l=0;for(m=r.length;l<m;l++){e=r[l];if(c&&e.level>c)break;a.currentTarget=e.elem;a.data=e.handleObj.data;a.handleObj=e.handleObj;p=e.handleObj.origHandler.apply(e.elem,arguments);if(!1===p||a.isPropagationStopped())if(c=e.level,!1===p&&(b=!1),a.isImmediatePropagationStopped())break}return b}}function m(a,b){return(a&&"*"!==a?a+".":"")+b.replace(Xa,"`").replace(Ya,"&")}function n(a,b,c){b=b||0;if(h.isFunction(b))return h.grep(a,function(a,d){return!!b.call(a,d,a)===c});if(b.nodeType)return h.grep(a,
...
f[g][c],f[g][c].data)}}}}function r(a,b){var c;if(1===b.nodeType){b.clearAttributes&&b.clearAttributes();b.mergeAttributes&&b.mergeAttributes(a);c=b.nodeName.toLowerCase();if("object"===c)b.outerHTML=a.outerHTML;else if("input"===c&&("checkbox"===a.type||"radio"===a.type))a.checked&&(b.defaultChecked=b.checked=a.checked),b.value!==a.value&&(b.value=a.value);else if("option"===c)b.selected=a.defaultSelected;else if("input"===c||"textarea"===c)b.defaultValue=a.defaultValue;b.removeAttribute(h.expando)}}
function q(a){return"getElementsByTagName"in a?a.getElementsByTagName("*"):"querySelectorAll"in a?a.querySelectorAll("*"):[]}function u(a){if("checkbox"===a.type||"radio"===a.type)a.defaultChecked=a.checked}function x(a){h.nodeName(a,"input")?u(a):"getElementsByTagName"in a&&h.grep(a.getElementsByTagName("input"),u)}function w(a,b){b.src?h.ajax({url:b.src,async:!1,dataType:"script"}):h.globalEval((b.text||b.textContent||b.innerHTML||"").replace($a,"/*$0*/"));b.parentNode&&b.parentNode.removeChild(b)}
function v(a,b,c){var d="width"===b?a.offsetWidth:a.offsetHeight,e="width"===b?ab:bb;if(0<d)return"border"!==c&&h.each(e,function(){c||(d-=parseFloat(h.css(a,"padding"+this))||0);d="margin"===c?d+(parseFloat(h.css(a,c+this))||0):d-(parseFloat(h.css(a,"border"+this+"Width"))||0)}),d+"px";d=Q(a,b,b);if(0>d||null==d)d=a.style[b]||0;d=parseFloat(d)||0;c&&h.each(e,function(){d+=parseFloat(h.css(a,"padding"+this))||0;"padding"!==c&&(d+=parseFloat(h.css(a,"border"+this+"Width"))||0);"margin"===c&&(d+=parseFloat(h.css(a,
c+this))||0)});return d+"px"}function y(a){return function(b,c){"string"!==typeof b&&(c=b,b="*");if(h.isFunction(c))for(var d=b.toLowerCase().split(va),e=0,f=d.length,g,k;e<f;e++)g=d[e],(k=/^\+/.test(g))&&(g=g.substr(1)||"*"),g=a[g]=a[g]||[],g[k?"unshift":"push"](c)}}function D(a,c,d,e,f,h){f=f||c.dataTypes[0];h=h||{};h[f]=!0;f=a[f];for(var g=0,k=f?f.length:0,l=a===ja,m;g<k&&(l||!m);g++)m=f[g](c,d,e),"string"===typeof m&&(!l||h[m]?m=b:(c.dataTypes.unshift(m),m=D(a,c,d,e,m,h)));!l&&m||h["*"]||(m=D(a,
c,d,e,"*",h));return m}function B(a,b,c,d){if(h.isArray(b))h.each(b,function(b,e){c||cb.test(a)?d(a,e):B(a+"["+("object"===typeof e||h.isArray(e)?b:"")+"]",e,c,d)});else if(c||null==b||"object"!==typeof b)d(a,b);else for(var e in b)B(a+"["+e+"]",b[e],c,d)}function z(){try{return new a.XMLHttpRequest}catch(b){}}function I(){setTimeout(T,0);return ea=h.now()}function T(){ea=b}function O(a,b){var c={};h.each(wa.concat.apply([],wa.slice(0,b)),function(){c[this]=a});return c}function xa(a){if(!ka[a]){var b=
t.body,c=h("<"+a+">").appendTo(b),d=c.css("display");c.remove();if("none"===d||""===d)M||(M=t.createElement("iframe"),M.frameBorder=M.width=M.height=0),b.appendChild(M),V&&M.createElement||(V=(M.contentWindow||M.contentDocument).document,V.write(("CSS1Compat"===t.compatMode?"<!doctype html>":"")+"<html><body>"),V.close()),c=V.createElement(a),V.body.appendChild(c),d=h.css(c,"display"),b.removeChild(M);ka[a]=d}return ka[a]}function la(a){return h.isWindow(a)?a:9===a.nodeType?a.defaultView||a.parentWindow:
!1}var t=a.document,db=a.navigator,eb=a.location,h=function(){function c(){if(!d.isReady){try{t.documentElement.doScroll("left")}catch(a){setTimeout(c,1);return}d.ready()}}var d=function(a,b){return new d.fn.init(a,b,h)},e=a.jQuery,f=a.$,h,g=/^(?:[^<]*(<[\w\W]+>)[^>]*$|#([\w\-]*)$)/,k=/\S/,l=/^\s+/,m=/\s+$/,n=/\d/,p=/^<(\w+)\s*\/?>(?:<\/\1>)?$/,r=/^[\],:{}\s]*$/,q=/\\(?:["\\\/bfnrt]|u[0-9a-fA-F]{4})/g,v=/"[^"\\\n\r]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g,x=/(?:^|:|,)(?:\s*\[)+/g,u=
/(webkit)[ \/]([\w.]+)/,w=/(opera)(?:.*version)?[ \/]([\w.]+)/,y=/(msie) ([\w.]+)/,D=/(mozilla)(?:.*? rv:([\w.]+))?/,fb=/-([a-z])/ig,C=function(a,b){return b.toUpperCase()},aa=db.userAgent,fa,W,gb=Object.prototype.toString,ma=Object.prototype.hasOwnProperty,na=Array.prototype.push,ba=Array.prototype.slice,B=String.prototype.trim,z=Array.prototype.indexOf,ya={};d.fn=d.prototype={constructor:d,init:function(a,c,e){var s;if(!a)return this;if(a.nodeType)return this.context=this[0]=a,this.length=1,this;
if("body"===a&&!c&&t.body)return this.context=t,this[0]=t.body,this.selector=a,this.length=1,this;if("string"===typeof a){s="<"===a.charAt(0)&&">"===a.charAt(a.length-1)&&3<=a.length?[null,a,null]:g.exec(a);if(!s||!s[1]&&c)return!c||c.jquery?(c||e).find(a):this.constructor(c).find(a);if(s[1])return e=(c=c instanceof d?c[0]:c)?c.ownerDocument||c:t,(a=p.exec(a))?d.isPlainObject(c)?(a=[t.createElement(a[1])],d.fn.attr.call(a,c,!0)):a=[e.createElement(a[1])]:(a=d.buildFragment([s[1]],[e]),a=(a.cacheable?
d.clone(a.fragment):a.fragment).childNodes),d.merge(this,a);if((c=t.getElementById(s[2]))&&c.parentNode){if(c.id!==s[2])return e.find(a);this.length=1;this[0]=c}this.context=t;this.selector=a;return this}if(d.isFunction(a))return e.ready(a);a.selector!==b&&(this.selector=a.selector,this.context=a.context);return d.makeArray(a,this)},selector:"",jquery:"1.6.2",length:0,size:function(){return this.length},toArray:function(){return ba.call(this,0)},get:function(a){return null==a?this.toArray():0>a?this[this.length+
a]:this[a]},pushStack:function(a,b,c){var e=this.constructor();d.isArray(a)?na.apply(e,a):d.merge(e,a);e.prevObject=this;e.context=this.context;"find"===b?e.selector=this.selector+(this.selector?" ":"")+c:b&&(e.selector=this.selector+"."+b+"("+c+")");return e},each:function(a,b){return d.each(this,a,b)},ready:function(a){d.bindReady();fa.done(a);return this},eq:function(a){return-1===a?this.slice(a):this.slice(a,+a+1)},first:function(){return this.eq(0)},last:function(){return this.eq(-1)},slice:function(){return this.pushStack(ba.apply(this,
arguments),"slice",ba.call(arguments).join(","))},map:function(a){return this.pushStack(d.map(this,function(b,c){return a.call(b,c,b)}))},end:function(){return this.prevObject||this.constructor(null)},push:na,sort:[].sort,splice:[].splice};d.fn.init.prototype=d.fn;d.extend=d.fn.extend=function(){var a,c,e,s,f,h=arguments[0]||{},g=1,A=arguments.length,L=!1;"boolean"===typeof h&&(L=h,h=arguments[1]||{},g=2);"object"===typeof h||d.isFunction(h)||(h={});A===g&&(h=this,--g);for(;g<A;g++)if(null!=(a=arguments[g]))for(c in a)e=
h[c],s=a[c],h!==s&&(L&&s&&(d.isPlainObject(s)||(f=d.isArray(s)))?(f?(f=!1,e=e&&d.isArray(e)?e:[]):e=e&&d.isPlainObject(e)?e:{},h[c]=d.extend(L,e,s)):s!==b&&(h[c]=s));return h};d.extend({noConflict:function(b){a.$===d&&(a.$=f);b&&a.jQuery===d&&(a.jQuery=e);return d},isReady:!1,readyWait:1,holdReady:function(a){a?d.readyWait++:d.ready(!0)},ready:function(a){if(!0===a&&!--d.readyWait||!0!==a&&!d.isReady){if(!t.body)return setTimeout(d.ready,1);d.isReady=!0;!0!==a&&0<--d.readyWait||(fa.resolveWith(t,
[d]),d.fn.trigger&&d(t).trigger("ready").unbind("ready"))}},bindReady:function(){if(!fa){fa=d._Deferred();if("complete"===t.readyState)return setTimeout(d.ready,1);if(t.addEventListener)t.addEventListener("DOMContentLoaded",W,!1),a.addEventListener("load",d.ready,!1);else if(t.attachEvent){t.attachEvent("onreadystatechange",W);a.attachEvent("onload",d.ready);var b=!1;try{b=null==a.frameElement}catch(e){}t.documentElement.doScroll&&b&&c()}}},isFunction:function(a){return"function"===d.type(a)},isArray:Array.isArray||
function(a){return"array"===d.type(a)},isWindow:function(a){return a&&"object"===typeof a&&"setInterval"in a},isNaN:function(a){return null==a||!n.test(a)||isNaN(a)},type:function(a){return null==a?String(a):ya[gb.call(a)]||"object"},isPlainObject:function(a){if(!a||("object"!==d.type(a)||a.nodeType||d.isWindow(a))||a.constructor&&!ma.call(a,"constructor")&&!ma.call(a.constructor.prototype,"isPrototypeOf"))return!1;for(var c in a);return c===b||ma.call(a,c)},isEmptyObject:function(a){for(var b in a)return!1;
return!0},error:function(a){throw a;},parseJSON:function(b){if("string"!==typeof b||!b)return null;b=d.trim(b);if(a.JSON&&a.JSON.parse)return a.JSON.parse(b);if(r.test(b.replace(q,"@").replace(v,"]").replace(x,"")))return(new Function("return "+b))();d.error("Invalid JSON: "+b)},parseXML:function(b,c,e){a.DOMParser?(e=new DOMParser,c=e.parseFromString(b,"text/xml")):(c=new ActiveXObject("Microsoft.XMLDOM"),c.async="false",c.loadXML(b));(e=c.documentElement)&&e.nodeName&&"parsererror"!==e.nodeName||
d.error("Invalid XML: "+b);return c},noop:function(){},globalEval:function(b){b&&k.test(b)&&(a.execScript||function(b){a.eval.call(a,b)})(b)},camelCase:function(a){return a.replace(fb,C)},nodeName:function(a,b){return a.nodeName&&a.nodeName.toUpperCase()===b.toUpperCase()},each:function(a,c,e){var s,f=0,h=a.length,g=h===b||d.isFunction(a);if(e)if(g)for(s in a){if(!1===c.apply(a[s],e))break}else for(;f<h&&!1!==c.apply(a[f++],e););else if(g)for(s in a){if(!1===c.call(a[s],s,a[s]))break}else for(;f<
h&&!1!==c.call(a[f],f,a[f++]););return a},trim:B?function(a){return null==a?"":B.call(a)}:function(a){return null==a?"":a.toString().replace(l,"").replace(m,"")},makeArray:function(a,b){var c=b||[];if(null!=a){var e=d.type(a);null==a.length||"string"===e||"function"===e||"regexp"===e||d.isWindow(a)?na.call(c,a):d.merge(c,a)}return c},inArray:function(a,b){if(z)return z.call(b,a);for(var c=0,d=b.length;c<d;c++)if(b[c]===a)return c;return-1},merge:function(a,c){var d=a.length,e=0;if("number"===typeof c.length)for(var s=
c.length;e<s;e++)a[d++]=c[e];else for(;c[e]!==b;)a[d++]=c[e++];a.length=d;return a},grep:function(a,b,c){var d=[],e;c=!!c;for(var s=0,f=a.length;s<f;s++)e=!!b(a[s],s),c!==e&&d.push(a[s]);return d},map:function(a,c,e){var s,f,h=[],g=0,A=a.length;if(a instanceof d||A!==b&&"number"===typeof A&&(0<A&&a[0]&&a[A-1]||0===A||d.isArray(a)))for(;g<A;g++)s=c(a[g],g,e),null!=s&&(h[h.length]=s);else for(f in a)s=c(a[f],f,e),null!=s&&(h[h.length]=s);return h.concat.apply([],h)},guid:1,proxy:function(a,c){if("string"===
typeof c){var e=a[c];c=a;a=e}if(!d.isFunction(a))return b;var s=ba.call(arguments,2),e=function(){return a.apply(c,s.concat(ba.call(arguments)))};e.guid=a.guid=a.guid||e.guid||d.guid++;return e},access:function(a,c,e,s,f,h){var g=a.length;if("object"===typeof c){for(var A in c)d.access(a,A,c[A],s,f,e);return a}if(e!==b){s=!h&&s&&d.isFunction(e);for(A=0;A<g;A++)f(a[A],c,s?e.call(a[A],A,f(a[A],c)):e,h);return a}return g?f(a[0],c):b},now:function(){return(new Date).getTime()},uaMatch:function(a){a=a.toLowerCase();
if(a.match(/trident/i)&&a.match(/rv.\d\d/))return{browser:"msie",version:"11.0"};a=u.exec(a)||w.exec(a)||y.exec(a)||0>a.indexOf("compatible")&&D.exec(a)||[];return{browser:a[1]||"",version:a[2]||"0"}},sub:function(){function a(b,c){return new a.fn.init(b,c)}d.extend(!0,a,this);a.superclass=this;a.fn=a.prototype=this();a.fn.constructor=a;a.sub=this.sub;a.fn.init=function(c,e){e&&(e instanceof d&&!(e instanceof a))&&(e=a(e));return d.fn.init.call(this,c,e,b)};a.fn.init.prototype=a.fn;var b=a(t);return a},
browser:{}});d.each("Boolean Number String Function Array Date RegExp Object".split(" "),function(a,b){ya["[object "+b+"]"]=b.toLowerCase()});aa=d.uaMatch(aa);aa.browser&&(d.browser[aa.browser]=!0,d.browser.version=aa.version);d.browser.webkit&&(d.browser.safari=!0);k.test("\u00a0")&&(l=/^[\s\xA0]+/,m=/[\s\xA0]+$/);h=d(t);t.addEventListener?W=function(){t.removeEventListener("DOMContentLoaded",W,!1);d.ready()}:t.attachEvent&&(W=function(){"complete"===t.readyState&&(t.detachEvent("onreadystatechange",
W),d.ready())});return d}(),oa="done fail isResolved isRejected promise then always pipe".split(" "),za=[].slice;h.extend({_Deferred:function(){var a=[],b,c,d,e={done:function(){if(!d){var c=arguments,f,g,A,k,l;b&&(l=b,b=0);f=0;for(g=c.length;f<g;f++)A=c[f],k=h.type(A),"array"===k?e.done.apply(e,A):"function"===k&&a.push(A);l&&e.resolveWith(l[0],l[1])}return this},resolveWith:function(e,f){if(!d&&!b&&!c){f=f||[];c=1;try{for(;a[0];)a.shift().apply(e,f)}finally{b=[e,f],c=0}}return this},resolve:function(){e.resolveWith(this,
...
c[0],s=c[1],f;if(h.isFunction(e))b[a](function(){if((f=e.apply(this,arguments))&&h.isFunction(f.promise))f.promise().then(d.resolve,d.reject);else d[s](f)});else b[a](d[s])})}).promise()},promise:function(a){if(null==a){if(d)return d;d=a={}}for(var c=oa.length;c--;)a[oa[c]]=b[oa[c]];return a}});b.done(c.cancel).fail(b.cancel);delete b.cancel;a&&a.call(b,b);return b},when:function(a){function b(a){return function(b){c[a]=1<arguments.length?za.call(arguments,0):b;--f||g.resolveWith(g,za.call(c,0))}}
var c=arguments,d=0,e=c.length,f=e,g=1>=e&&a&&h.isFunction(a.promise)?a:h.Deferred();if(1<e){for(;d<e;d++)c[d]&&h.isFunction(c[d].promise)?c[d].promise().then(b(d),g.reject):--f;f||g.resolveWith(g,c)}else g!==a&&g.resolveWith(g,e?[a]:[]);return g.promise()}});h.support=function(){var a=t.createElement("div"),b=t.documentElement,c,d,e,f,g,k;a.setAttribute("className","t");a.innerHTML="   <link/><table></table><a href='/a' style='top:1px;float:left;opacity:.55;'>a</a><input type='checkbox'/>";c=a.getElementsByTagName("*");
d=a.getElementsByTagName("a")[0];if(!c||!c.length||!d)return{};e=t.createElement("select");f=e.appendChild(t.createElement("option"));c=a.getElementsByTagName("input")[0];g={leadingWhitespace:3===a.firstChild.nodeType,tbody:!a.getElementsByTagName("tbody").length,htmlSerialize:!!a.getElementsByTagName("link").length,style:/top/.test(d.getAttribute("style")),hrefNormalized:"/a"===d.getAttribute("href"),opacity:/^0.55$/.test(d.style.opacity),cssFloat:!!d.style.cssFloat,checkOn:"on"===c.value,optSelected:f.selected,
getSetAttribute:"t"!==a.className,submitBubbles:!0,changeBubbles:!0,focusinBubbles:!1,deleteExpando:!0,noCloneEvent:!0,inlineBlockNeedsLayout:!1,shrinkWrapBlocks:!1,reliableMarginRight:!0};c.checked=!0;g.noCloneChecked=c.cloneNode(!0).checked;e.disabled=!0;g.optDisabled=!f.disabled;try{delete a.test}catch(l){g.deleteExpando=!1}!a.addEventListener&&(a.attachEvent&&a.fireEvent)&&(a.attachEvent("onclick",function(){g.noCloneEvent=!1}),a.cloneNode(!0).fireEvent("onclick"));c=t.createElement("input");
c.value="t";c.setAttribute("type","radio");g.radioValue="t"===c.value;c.setAttribute("checked","checked");a.appendChild(c);d=t.createDocumentFragment();d.appendChild(a.firstChild);g.checkClone=d.cloneNode(!0).cloneNode(!0).lastChild.checked;a.innerHTML="";a.style.width=a.style.paddingLeft="1px";e=t.getElementsByTagName("body")[0];d=t.createElement(e?"div":"body");f={visibility:"hidden",width:0,height:0,border:0,margin:0};e&&h.extend(f,{position:"absolute",left:-1E3,top:-1E3});for(k in f)d.style[k]=
f[k];d.appendChild(a);b=e||b;b.insertBefore(d,b.firstChild);g.appendChecked=c.checked;g.boxModel=2===a.offsetWidth;"zoom"in a.style&&(a.style.display="inline",a.style.zoom=1,g.inlineBlockNeedsLayout=2===a.offsetWidth,a.style.display="",a.innerHTML="<div style='width:4px;'></div>",g.shrinkWrapBlocks=2!==a.offsetWidth);a.innerHTML="<table><tr><td style='padding:0;border:0;display:none'></td><td>t</td></tr></table>";e=a.getElementsByTagName("td");c=0===e[0].offsetHeight;e[0].style.display="";e[1].style.display=
"none";g.reliableHiddenOffsets=c&&0===e[0].offsetHeight;a.innerHTML="";t.defaultView&&t.defaultView.getComputedStyle&&(c=t.createElement("div"),c.style.width="0",c.style.marginRight="0",a.appendChild(c),g.reliableMarginRight=0===(parseInt((t.defaultView.getComputedStyle(c,null)||{marginRight:0}).marginRight,10)||0));d.innerHTML="";b.removeChild(d);if(a.attachEvent)for(k in{submit:1,change:1,focusin:1})b="on"+k,c=b in a,c||(a.setAttribute(b,"return;"),c="function"===typeof a[b]),g[k+"Bubbles"]=c;d=
d=e=f=e=c=a=c=null;return g}();h.boxModel=h.support.boxModel;var Wa=/^(?:\{.*\}|\[.*\])$/,Va=/([a-z])([A-Z])/g;h.extend({cache:{},uuid:0,expando:"jQuery"+(h.fn.jquery+Math.random()).replace(/\D/g,""),noData:{embed:!0,object:"clsid:D27CDB6E-AE6D-11cf-96B8-444553540000",applet:!0},hasData:function(a){a=a.nodeType?h.cache[a[h.expando]]:a[h.expando];return!!a&&!d(a)},data:function(a,c,d,e){if(h.acceptData(a)){var f=h.expando,g="string"===typeof c,k=a.nodeType,l=k?h.cache:a,m=k?a[h.expando]:a[h.expando]&&
h.expando;if(m&&(!e||!m||l[m][f])||!g||d!==b){m||(k?a[h.expando]=m=++h.uuid:m=h.expando);l[m]||(l[m]={},k||(l[m].toJSON=h.noop));if("object"===typeof c||"function"===typeof c)e?l[m][f]=h.extend(l[m][f],c):l[m]=h.extend(l[m],c);a=l[m];e&&(a[f]||(a[f]={}),a=a[f]);d!==b&&(a[h.camelCase(c)]=d);return"events"!==c||a[c]?g?a[h.camelCase(c)]||a[c]:a:a[f]&&a[f].events}}},removeData:function(b,c,e){if(h.acceptData(b)){var f=h.expando,g=b.nodeType,k=g?h.cache:b,l=g?b[h.expando]:h.expando;if(k[l]){if(c){var m=
...
n=a+"mark",p;g--;)if(p=h.data(f[g],l,b,!0)||(h.data(f[g],m,b,!0)||h.data(f[g],n,b,!0))&&h.data(f[g],l,h._Deferred(),!0))k++,p.done(d);d();return e.promise()}});var Aa=/[\n\t\r]/g,pa=/\s+/,hb=/\r/g,ib=/^(?:button|input)$/i,jb=/^(?:button|input|object|select|textarea)$/i,kb=/^a(?:rea)?$/i,Ba=/^(?:autofocus|autoplay|async|checked|controls|defer|disabled|hidden|loop|multiple|open|readonly|required|scoped|selected)$/i,lb=/\:|^on/,K,Ca;h.fn.extend({attr:function(a,b){return h.access(this,a,b,!0,h.attr)},
...
function(){h.valHooks[this]={get:function(a){return null===a.getAttribute("value")?"on":a.value}}});h.each(["radio","checkbox"],function(){h.valHooks[this]=h.extend(h.valHooks[this],{set:function(a,b){if(h.isArray(b))return a.checked=0<=h.inArray(h(a).val(),b)}})});var ia=/\.(.*)$/,qa=/^(?:textarea|input|select)$/i,Xa=/\./g,Ya=/ /g,mb=/[^\w\s.|`]/g,nb=function(a){return a.replace(mb,"\\$&")};h.event={add:function(a,c,d,e){if(3!==a.nodeType&&8!==a.nodeType){if(!1===d)d=f;else if(!d)return;var g,k;
d.handler&&(g=d,d=g.handler);d.guid||(d.guid=h.guid++);if(k=h._data(a)){var l=k.events,m=k.handle;l||(k.events=l={});m||(k.handle=m=function(a){return"undefined"===typeof h||a&&h.event.triggered===a.type?b:h.event.handle.apply(m.elem,arguments)});m.elem=a;c=c.split(" ");for(var n,p=0,r;n=c[p++];){k=g?h.extend({},g):{handler:d,data:e};-1<n.indexOf(".")?(r=n.split("."),n=r.shift(),k.namespace=r.slice(0).sort().join(".")):(r=[],k.namespace="");k.type=n;k.guid||(k.guid=d.guid);var q=l[n],v=h.event.special[n]||
{};q||(q=l[n]=[],v.setup&&!1!==v.setup.call(a,e,r,m)||(a.addEventListener?a.addEventListener(n,m,!1):a.attachEvent&&a.attachEvent("on"+n,m)));v.add&&(v.add.call(a,k),k.handler.guid||(k.handler.guid=d.guid));q.push(k);h.event.global[n]=!0}a=null}}},global:{},remove:function(a,c,d,e){if(3!==a.nodeType&&8!==a.nodeType){!1===d&&(d=f);var g,k,l=0,m,n,p,r,q,v,x=h.hasData(a)&&h._data(a),u=x&&x.events;if(x&&u)if(c&&c.type&&(d=c.handler,c=c.type),!c||"string"===typeof c&&"."===c.charAt(0))for(g in c=c||"",
u)h.event.remove(a,g+c);else{for(c=c.split(" ");g=c[l++];)if(r=g,m=0>g.indexOf("."),n=[],m||(n=g.split("."),g=n.shift(),p=RegExp("(^|\\.)"+h.map(n.slice(0).sort(),nb).join("\\.(?:.*\\.)?")+"(\\.|$)")),q=u[g])if(d){r=h.event.special[g]||{};for(k=e||0;k<q.length;k++)if(v=q[k],d.guid===v.guid){if(m||p.test(v.namespace))null==e&&q.splice(k--,1),r.remove&&r.remove.call(a,v);if(null!=e)break}if(0===q.length||null!=e&&1===q.length)r.teardown&&!1!==r.teardown.call(a,n)||h.removeEvent(a,g,x.handle),delete u[g]}else for(k=
0;k<q.length;k++)if(v=q[k],m||p.test(v.namespace))h.event.remove(a,r,v.handler,k),q.splice(k--,1);if(h.isEmptyObject(u)){if(c=x.handle)c.elem=null;delete x.events;delete x.handle;h.isEmptyObject(x)&&h.removeData(a,b,!0)}}}},customEvent:{getData:!0,setData:!0,changeData:!0},trigger:function(c,d,e,f){var g=c.type||c,k=[],l;0<=g.indexOf("!")&&(g=g.slice(0,-1),l=!0);0<=g.indexOf(".")&&(k=g.split("."),g=k.shift(),k.sort());if(e&&!h.event.customEvent[g]||h.event.global[g]){c="object"===typeof c?c[h.expando]?
...
fix:function(a){if(a[h.expando])return a;var c=a;a=h.Event(c);for(var d=this.props.length,e;d;)e=this.props[--d],a[e]=c[e];a.target||(a.target=a.srcElement||t);3===a.target.nodeType&&(a.target=a.target.parentNode);!a.relatedTarget&&a.fromElement&&(a.relatedTarget=a.fromElement===a.target?a.toElement:a.fromElement);null==a.pageX&&null!=a.clientX&&(d=a.target.ownerDocument||t,c=d.documentElement,d=d.body,a.pageX=a.clientX+(c&&c.scrollLeft||d&&d.scrollLeft||0)-(c&&c.clientLeft||d&&d.clientLeft||0),a.pageY=
...
g;this.stopPropagation()},isDefaultPrevented:f,isPropagationStopped:f,isImmediatePropagationStopped:f};var Da=function(a){var b=a.relatedTarget,c=!1,d=a.type;a.type=a.data;b!==this&&(b&&(c=h.contains(this,b)),c||(h.event.handle.apply(this,arguments),a.type=d))},Ea=function(a){a.type=a.data;h.event.handle.apply(this,arguments)};h.each({mouseenter:"mouseover",mouseleave:"mouseout"},function(a,b){h.event.special[a]={setup:function(c){h.event.add(this,b,c&&c.selector?Ea:Da,a)},teardown:function(a){h.event.remove(this,
b,a&&a.selector?Ea:Da)}}});h.support.submitBubbles||(h.event.special.submit={setup:function(a,b){if(h.nodeName(this,"form"))return!1;h.event.add(this,"click.specialSubmit",function(a){var b=a.target,c=b.type;"submit"!==c&&"image"!==c||!h(b).closest("form").length||k("submit",this,arguments)});h.event.add(this,"keypress.specialSubmit",function(a){var b=a.target,c=b.type;"text"!==c&&"password"!==c||(!h(b).closest("form").length||13!==a.keyCode)||k("submit",this,arguments)})},teardown:function(a){h.event.remove(this,
".specialSubmit")}});if(!h.support.changeBubbles){var ca,Fa=function(a){var b=a.type,c=a.value;"radio"===b||"checkbox"===b?c=a.checked:"select-multiple"===b?c=-1<a.selectedIndex?h.map(a.options,function(a){return a.selected}).join("-"):"":h.nodeName(a,"select")&&(c=a.selectedIndex);return c},ga=function(a,c){var d=a.target,e,f;qa.test(d.nodeName)&&!d.readOnly&&(e=h._data(d,"_change_data"),f=Fa(d),"focusout"===a.type&&"radio"===d.type||h._data(d,"_change_data",f),e===b||f===e||null==e&&!f||(a.type=
"change",a.liveFired=b,h.event.trigger(a,c,d)))};h.event.special.change={filters:{focusout:ga,beforedeactivate:ga,click:function(a){var b=a.target,c=h.nodeName(b,"input")?b.type:"";("radio"===c||"checkbox"===c||h.nodeName(b,"select"))&&ga.call(this,a)},keydown:function(a){var b=a.target,c=h.nodeName(b,"input")?b.type:"";(13===a.keyCode&&!h.nodeName(b,"textarea")||32===a.keyCode&&("checkbox"===c||"radio"===c)||"select-multiple"===c)&&ga.call(this,a)},beforeactivate:function(a){a=a.target;h._data(a,
"_change_data",Fa(a))}},setup:function(a,b){if("file"===this.type)return!1;for(var c in ca)h.event.add(this,c+".specialChange",ca[c]);return qa.test(this.nodeName)},teardown:function(a){h.event.remove(this,".specialChange");return qa.test(this.nodeName)}};ca=h.event.special.change.filters;ca.focus=ca.beforeactivate}h.support.focusinBubbles||h.each({focus:"focusin",blur:"focusout"},function(a,b){function c(a){var d=h.event.fix(a);d.type=b;d.originalEvent={};h.event.trigger(d,null,d.target);d.isDefaultPrevented()&&
a.preventDefault()}var d=0;h.event.special[b]={setup:function(){0===d++&&t.addEventListener(a,c,!0)},teardown:function(){0===--d&&t.removeEventListener(a,c,!0)}}});h.each(["bind","one"],function(a,c){h.fn[c]=function(a,d,e){var f;if("object"===typeof a){for(var g in a)this[c](g,d,a[g],e);return this}if(2===arguments.length||!1===d)e=d,d=b;"one"===c?(f=function(a){h(this).unbind(a,f);return e.apply(this,arguments)},f.guid=e.guid||h.guid++):f=e;if("unload"===a&&"one"!==c)this.one(a,d,e);else{g=0;for(var s=
this.length;g<s;g++)h.event.add(this[g],a,f,d)}return this}});h.fn.extend({unbind:function(a,b){if("object"!==typeof a||a.preventDefault)for(var c=0,d=this.length;c<d;c++)h.event.remove(this[c],a,b);else for(c in a)this.unbind(c,a[c]);return this},delegate:function(a,b,c,d){return this.live(b,c,d,a)},undelegate:function(a,b,c){return 0===arguments.length?this.unbind("live"):this.die(b,null,c,a)},trigger:function(a,b){return this.each(function(){h.event.trigger(a,b,this)})},triggerHandler:function(a,
b){if(this[0])return h.event.trigger(a,b,this[0],!0)},toggle:function(a){var b=arguments,c=a.guid||h.guid++,d=0,e=function(c){var e=(h.data(this,"lastToggle"+a.guid)||0)%d;h.data(this,"lastToggle"+a.guid,e+1);c.preventDefault();return b[e].apply(this,arguments)||!1};for(e.guid=c;d<b.length;)b[d++].guid=c;return this.click(e)},hover:function(a,b){return this.mouseenter(a).mouseleave(b||a)}});var ra={focus:"focusin",blur:"focusout",mouseenter:"mouseover",mouseleave:"mouseout"};h.each(["live","die"],
function(a,c){h.fn[c]=function(a,d,e,g){var k=0,s,l,n=g||this.selector,p=g?this:h(this.context);if("object"===typeof a&&!a.preventDefault){for(s in a)p[c](s,d,a[s],n);return this}if("die"===c&&!a&&g&&"."===g.charAt(0))return p.unbind(g),this;if(!1===d||h.isFunction(d))e=d||f,d=b;for(a=(a||"").split(" ");null!=(g=a[k++]);)if(s=ia.exec(g),l="",s&&(l=s[0],g=g.replace(ia,"")),"hover"===g)a.push("mouseenter"+l,"mouseleave"+l);else if(s=g,ra[g]?(a.push(ra[g]+l),g+=l):g=(ra[g]||g)+l,"live"===c){l=0;for(var r=
p.length;l<r;l++)h.event.add(p[l],"live."+m(g,n),{data:d,selector:n,handler:e,origType:g,origHandler:e,preType:s})}else p.unbind("live."+m(g,n),e);return this}});h.each("blur focus focusin focusout load resize scroll unload click dblclick mousedown mouseup mousemove mouseover mouseout mouseenter mouseleave change select submit keydown keypress keyup error".split(" "),function(a,b){h.fn[b]=function(a,c){null==c&&(c=a,a=null);return 0<arguments.length?this.bind(b,a,c):this.trigger(b)};h.attrFn&&(h.attrFn[b]=
!0)});(function(){function a(b,c,d,e,f,g){f=0;for(var h=e.length;f<h;f++){var k=e[f];if(k){for(var s=!1,k=k[b];k;){if(k.sizcache===d){s=e[k.sizset];break}1!==k.nodeType||g||(k.sizcache=d,k.sizset=f);if(k.nodeName.toLowerCase()===c){s=k;break}k=k[b]}e[f]=s}}}function c(a,b,d,e,f,g){f=0;for(var h=e.length;f<h;f++){var k=e[f];if(k){for(var s=!1,k=k[a];k;){if(k.sizcache===d){s=e[k.sizset];break}if(1===k.nodeType)if(g||(k.sizcache=d,k.sizset=f),"string"!==typeof b){if(k===b){s=!0;break}}else if(0<n.filter(b,
[k]).length){s=k;break}k=k[a]}e[f]=s}}}var d=/((?:\((?:\([^()]+\)|[^()]+)+\)|\[(?:\[[^\[\]]*\]|['"][^'"]*['"]|[^\[\]'"]+)+\]|\\.|[^ >+~,(\[\\]+)+|[>+~])(\s*,\s*)?((?:.|\r|\n)*)/g,e=0,f=Object.prototype.toString,g=!1,k=!0,l=/\\/g,m=/\W/;[0,0].sort(function(){k=!1;return 0});var n=function(a,b,c,e){c=c||[];var g=b=b||t;if(1!==b.nodeType&&9!==b.nodeType)return[];if(!a||"string"!==typeof a)return c;var h,k,s,l,H,L=!0,m=n.isXML(b),E=[],q=a;do if(d.exec(""),h=d.exec(q))if(q=h[3],E.push(h[1]),h[2]){l=h[3];
break}while(h);if(1<E.length&&r.exec(a))if(2===E.length&&p.relative[E[0]])k=D(E[0]+E[1],b);else for(k=p.relative[E[0]]?[b]:n(E.shift(),b);E.length;)a=E.shift(),p.relative[a]&&(a+=E.shift()),k=D(a,k);else if(!e&&(1<E.length&&9===b.nodeType&&!m&&p.match.ID.test(E[0])&&!p.match.ID.test(E[E.length-1]))&&(h=n.find(E.shift(),b,m),b=h.expr?n.filter(h.expr,h.set)[0]:h.set[0]),b)for(h=e?{expr:E.pop(),set:x(e)}:n.find(E.pop(),1!==E.length||"~"!==E[0]&&"+"!==E[0]||!b.parentNode?b:b.parentNode,m),k=h.expr?n.filter(h.expr,
h.set):h.set,0<E.length?s=x(k):L=!1;E.length;)h=H=E.pop(),p.relative[H]?h=E.pop():H="",null==h&&(h=b),p.relative[H](s,h,m);else s=[];s||(s=k);s||n.error(H||a);if("[object Array]"===f.call(s))if(L)if(b&&1===b.nodeType)for(a=0;null!=s[a];a++)s[a]&&(!0===s[a]||1===s[a].nodeType&&n.contains(b,s[a]))&&c.push(k[a]);else for(a=0;null!=s[a];a++)s[a]&&1===s[a].nodeType&&c.push(k[a]);else c.push.apply(c,s);else x(s,c);l&&(n(l,g,c,e),n.uniqueSort(c));return c};n.uniqueSort=function(a){if(w&&(g=k,a.sort(w),g))for(var b=
...
b.getElementsByTagName("*"):[]);return{set:d,expr:a}};n.filter=function(a,c,d,e){for(var f,g,h=a,k=[],s=c,l=c&&c[0]&&n.isXML(c[0]);a&&c.length;){for(var H in p.filter)if(null!=(f=p.leftMatch[H].exec(a))&&f[2]){var L,A,m=p.filter[H];A=f[1];g=!1;f.splice(1,1);if("\\"!==A.substr(A.length-1)){s===k&&(k=[]);if(p.preFilter[H])if(f=p.preFilter[H](f,s,d,k,e,l),!f)g=L=!0;else if(!0===f)continue;if(f)for(var da=0;null!=(A=s[da]);da++)if(A){L=m(A,f,da,s);var E=e^!!L;d&&null!=L?E?g=!0:s[da]=!1:E&&(k.push(A),
g=!0)}if(L!==b){d||(s=k);a=a.replace(p.match[H],"");if(!g)return[];break}}}if(a===h)if(null==g)n.error(a);else break;h=a}return s};n.error=function(a){throw"Syntax error, unrecognized expression: "+a;};var p=n.selectors={order:["ID","NAME","TAG"],match:{ID:/#((?:[\w\u00c0-\uFFFF\-]|\\.)+)/,CLASS:/\.((?:[\w\u00c0-\uFFFF\-]|\\.)+)/,NAME:/\[name=['"]*((?:[\w\u00c0-\uFFFF\-]|\\.)+)['"]*\]/,ATTR:/\[\s*((?:[\w\u00c0-\uFFFF\-]|\\.)+)\s*(?:(\S?=)\s*(?:(['"])(.*?)\3|(#?(?:[\w\u00c0-\uFFFF\-]|\\.)*)|)|)\s*\]/,
...
d.indexOf(f):"~="===e?0<=(" "+d+" ").indexOf(f):f?"!="===e?d!==f:"^="===e?0===d.indexOf(f):"$="===e?d.substr(d.length-f.length)===f:"|="===e?d===f||d.substr(0,f.length+1)===f+"-":!1:d&&!1!==c},POS:function(a,b,c,d){var e=p.setFilters[b[2]];if(e)return e(a,c,b,d)}}},r=p.match.POS,q=function(a,b){return"\\"+(b-0+1)},v;for(v in p.match)p.match[v]=RegExp(p.match[v].source+/(?![^\[]*\])(?![^\(]*\))/.source),p.leftMatch[v]=RegExp(/(^(?:.|\r|\n)*?)/.source+p.match[v].source.replace(/\\(\d+)/g,q));var x=
function(a,b){a=Array.prototype.slice.call(a,0);return b?(b.push.apply(b,a),b):a};try{Array.prototype.slice.call(t.documentElement.childNodes,0)[0].nodeType}catch(u){x=function(a,b){var c=0,d=b||[];if("[object Array]"===f.call(a))Array.prototype.push.apply(d,a);else if("number"===typeof a.length)for(var e=a.length;c<e;c++)d.push(a[c]);else for(;a[c];c++)d.push(a[c]);return d}}var w,y;t.documentElement.compareDocumentPosition?w=function(a,b){return a===b?(g=!0,0):a.compareDocumentPosition&&b.compareDocumentPosition?
a.compareDocumentPosition(b)&4?-1:1:a.compareDocumentPosition?-1:1}:(w=function(a,b){if(a===b)return g=!0,0;if(a.sourceIndex&&b.sourceIndex)return a.sourceIndex-b.sourceIndex;var c,d,e=[],f=[];c=a.parentNode;d=b.parentNode;var h=c;if(c===d)return y(a,b);if(!c)return-1;if(!d)return 1;for(;h;)e.unshift(h),h=h.parentNode;for(h=d;h;)f.unshift(h),h=h.parentNode;c=e.length;d=f.length;for(h=0;h<c&&h<d;h++)if(e[h]!==f[h])return y(e[h],f[h]);return h===c?y(a,f[h],-1):y(e[h],b,1)},y=function(a,b,c){if(a===
b)return c;for(a=a.nextSibling;a;){if(a===b)return-1;a=a.nextSibling}return 1});n.getText=function(a){for(var b="",c,d=0;a[d];d++)c=a[d],3===c.nodeType||4===c.nodeType?b+=c.nodeValue:8!==c.nodeType&&(b+=n.getText(c.childNodes));return b};(function(){var a=t.createElement("div"),c="script"+(new Date).getTime(),d=t.documentElement;a.innerHTML="<a name='"+c+"'/>";d.insertBefore(a,d.firstChild);t.getElementById(c)&&(p.find.ID=function(a,c,d){if("undefined"!==typeof c.getElementById&&!d)return(c=c.getElementById(a[1]))?
c.id===a[1]||"undefined"!==typeof c.getAttributeNode&&c.getAttributeNode("id").nodeValue===a[1]?[c]:b:[]},p.filter.ID=function(a,b){var c="undefined"!==typeof a.getAttributeNode&&a.getAttributeNode("id");return 1===a.nodeType&&c&&c.nodeValue===b});d.removeChild(a);d=a=null})();(function(){var a=t.createElement("div");a.appendChild(t.createComment(""));0<a.getElementsByTagName("*").length&&(p.find.TAG=function(a,b){var c=b.getElementsByTagName(a[1]);if("*"===a[1]){for(var d=[],e=0;c[e];e++)1===c[e].nodeType&&
d.push(c[e]);c=d}return c});a.innerHTML="<a href='#'></a>";a.firstChild&&("undefined"!==typeof a.firstChild.getAttribute&&"#"!==a.firstChild.getAttribute("href"))&&(p.attrHandle.href=function(a){return a.getAttribute("href",2)});a=null})();t.querySelectorAll&&function(){var a=n,b=t.createElement("div");b.innerHTML="<p class='TEST'></p>";if(!b.querySelectorAll||0!==b.querySelectorAll(".TEST").length){n=function(b,c,d,e){c=c||t;if(!e&&!n.isXML(c)){var f=/^(\w+$)|^\.([\w\-]+$)|^#([\w\-]+$)/.exec(b);
...
s=c.parentNode,l=/^\s*[+~]/.test(b);g?k=k.replace(/'/g,"\\$&"):c.setAttribute("id",k);l&&s&&(c=c.parentNode);try{if(!l||s)return x(c.querySelectorAll("[id='"+k+"'] "+b),d)}catch(H){}finally{g||f.removeAttribute("id")}}}return a(b,c,d,e)};for(var c in a)n[c]=a[c];b=null}}();(function(){var a=t.documentElement,b=a.matchesSelector||a.mozMatchesSelector||a.webkitMatchesSelector||a.msMatchesSelector;if(b){var c=!b.call(t.createElement("div"),"div"),d=!1;try{b.call(t.documentElement,"[test!='']:sizzle")}catch(e){d=
!0}n.matchesSelector=function(a,e){e=e.replace(/\=\s*([^'"\]]*)\s*\]/g,"='$1']");if(!n.isXML(a))try{if(d||!p.match.PSEUDO.test(e)&&!/!=/.test(e)){var f=b.call(a,e);if(f||!c||a.document&&11!==a.document.nodeType)return f}}catch(g){}return 0<n(e,null,null,[a]).length}}})();(function(){var a=t.createElement("div");a.innerHTML="<div class='test e'></div><div class='test'></div>";a.getElementsByClassName&&0!==a.getElementsByClassName("e").length&&(a.lastChild.className="e",1!==a.getElementsByClassName("e").length&&
(p.order.splice(1,0,"CLASS"),p.find.CLASS=function(a,b,c){if("undefined"!==typeof b.getElementsByClassName&&!c)return b.getElementsByClassName(a[1])},a=null))})();n.contains=t.documentElement.contains?function(a,b){return a!==b&&(a.contains?a.contains(b):!0)}:t.documentElement.compareDocumentPosition?function(a,b){return!!(a.compareDocumentPosition(b)&16)}:function(){return!1};n.isXML=function(a){return(a=(a?a.ownerDocument||a:0).documentElement)?"HTML"!==a.nodeName:!1};var D=function(a,b){for(var c,
d=[],e="",f=b.nodeType?[b]:b;c=p.match.PSEUDO.exec(a);)e+=c[0],a=a.replace(p.match.PSEUDO,"");a=p.relative[a]?a+"*":a;c=0;for(var g=f.length;c<g;c++)n(a,f[c],d);return n.filter(e,d)};h.find=n;h.expr=n.selectors;h.expr[":"]=h.expr.filters;h.unique=n.uniqueSort;h.text=n.getText;h.isXMLDoc=n.isXML;h.contains=n.contains})();var ob=/Until$/,pb=/^(?:parents|prevUntil|prevAll)/,qb=/,/,Za=/^.[^:#\[\.,]*$/,rb=Array.prototype.slice,Ga=h.expr.match.POS,sb={children:!0,contents:!0,next:!0,prev:!0};h.fn.extend({find:function(a){var b=
...
b){h.fn[a]=function(c,d){var e=h.map(this,b,c),f=rb.call(arguments);ob.test(a)||(d=c);d&&"string"===typeof d&&(e=h.filter(d,e));e=1<this.length&&!sb[a]?h.unique(e):e;(1<this.length||qb.test(d))&&pb.test(a)&&(e=e.reverse());return this.pushStack(e,a,f.join(","))}});h.extend({filter:function(a,b,c){c&&(a=":not("+a+")");return 1===b.length?h.find.matchesSelector(b[0],a)?[b[0]]:[]:h.find.matches(a,b)},dir:function(a,c,d){var e=[];for(a=a[c];a&&9!==a.nodeType&&(d===b||1!==a.nodeType||!h(a).is(d));)1===
a.nodeType&&e.push(a),a=a[c];return e},nth:function(a,b,c,d){b=b||1;for(d=0;a&&(1!==a.nodeType||++d!==b);a=a[c]);return a},sibling:function(a,b){for(var c=[];a;a=a.nextSibling)1===a.nodeType&&a!==b&&c.push(a);return c}});var tb=/ jQuery\d+="(?:\d+|null)"/g,sa=/^\s+/,Ha=/<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/ig,Ia=/<([\w:]+)/,ub=/<tbody/i,vb=/<|&#?\w+;/,Ja=/<(?:script|object|embed|option|style)/i,Ka=/checked\s*(?:[^=]|=\s*.checked.)/i,wb=/\/(java|ecma)script/i,$a=/^\s*<!(?:\[CDATA\[|\-\-)/,
...
b?a:b;return this.map(function(){return h.clone(this,a,b)})},html:function(a){if(a===b)return this[0]&&1===this[0].nodeType?this[0].innerHTML.replace(tb,""):null;if("string"!==typeof a||Ja.test(a)||!h.support.leadingWhitespace&&sa.test(a)||F[(Ia.exec(a)||["",""])[1].toLowerCase()])h.isFunction(a)?this.each(function(b){var c=h(this);c.html(a.call(this,b,c.html()))}):this.empty().append(a);else{a=a.replace(Ha,"<$1></$2>");try{for(var c=0,d=this.length;c<d;c++)1===this[c].nodeType&&(h.cleanData(this[c].getElementsByTagName("*")),
...
!0)},domManip:function(a,c,d){var e,f,g,k=a[0],l=[];if(!h.support.checkClone&&3===arguments.length&&"string"===typeof k&&Ka.test(k))return this.each(function(){h(this).domManip(a,c,d,!0)});if(h.isFunction(k))return this.each(function(e){var f=h(this);a[0]=k.call(this,e,c?f.html():b);f.domManip(a,c,d)});if(this[0]){e=k&&k.parentNode;e=h.support.parentNode&&e&&11===e.nodeType&&e.childNodes.length===this.length?{fragment:e}:h.buildFragment(a,this,l);g=e.fragment;if(f=1===g.childNodes.length?g=g.firstChild:
g.firstChild){c=c&&h.nodeName(f,"tr");f=0;for(var m=this.length,n=m-1;f<m;f++)d.call(c?h.nodeName(this[f],"table")?this[f].getElementsByTagName("tbody")[0]||this[f].appendChild(this[f].ownerDocument.createElement("tbody")):this[f]:this[f],e.cacheable||1<m&&f<n?h.clone(g,!0,!0):g)}l.length&&h.each(l,w)}return this}});h.buildFragment=function(a,b,c){var d,e,f,g;b&&b[0]&&(g=b[0].ownerDocument||b[0]);g.createDocumentFragment||(g=t);1===a.length&&("string"===typeof a[0]&&512>a[0].length&&g===t&&"<"===
a[0].charAt(0)&&!Ja.test(a[0])&&(h.support.checkClone||!Ka.test(a[0])))&&(e=!0,(f=h.fragments[a[0]])&&1!==f&&(d=f));d||(d=g.createDocumentFragment(),h.clean(a,g,d,c));e&&(h.fragments[a[0]]=f?d:1);return{fragment:d,cacheable:e}};h.fragments={};h.each({appendTo:"append",prependTo:"prepend",insertBefore:"before",insertAfter:"after",replaceAll:"replaceWith"},function(a,b){h.fn[a]=function(c){var d=[];c=h(c);var e=1===this.length&&this[0].parentNode;if(e&&11===e.nodeType&&1===e.childNodes.length&&1===
c.length)return c[b](this[0]),this;for(var e=0,f=c.length;e<f;e++){var g=(0<e?this.clone(!0):this).get();h(c[e])[b](g);d=d.concat(g)}return this.pushStack(d,a,c.selector)}});h.extend({clone:function(a,b,c){var d=a.cloneNode(!0),e,f,g;if(!(h.support.noCloneEvent&&h.support.noCloneChecked||1!==a.nodeType&&11!==a.nodeType||h.isXMLDoc(a)))for(r(a,d),e=q(a),f=q(d),g=0;e[g];++g)r(e[g],f[g]);if(b&&(p(a,d),c))for(e=q(a),f=q(d),g=0;e[g];++g)p(e[g],f[g]);return d},clean:function(a,b,c,d){b=b||t;"undefined"===
typeof b.createElement&&(b=b.ownerDocument||b[0]&&b[0].ownerDocument||t);for(var e=[],f,g=0,k;null!=(k=a[g]);g++)if("number"===typeof k&&(k+=""),k){if("string"===typeof k)if(vb.test(k)){k=k.replace(Ha,"<$1></$2>");f=(Ia.exec(k)||["",""])[1].toLowerCase();var l=F[f]||F._default,m=l[0],n=b.createElement("div");for(n.innerHTML=l[1]+k+l[2];m--;)n=n.lastChild;if(!h.support.tbody)for(m=ub.test(k),l="table"!==f||m?"<table>"!==l[1]||m?[]:n.childNodes:n.firstChild&&n.firstChild.childNodes,f=l.length-1;0<=
f;--f)h.nodeName(l[f],"tbody")&&!l[f].childNodes.length&&l[f].parentNode.removeChild(l[f]);!h.support.leadingWhitespace&&sa.test(k)&&n.insertBefore(b.createTextNode(sa.exec(k)[0]),n.firstChild);k=n.childNodes}else k=b.createTextNode(k);var p;if(!h.support.appendChecked)if(k[0]&&"number"===typeof(p=k.length))for(f=0;f<p;f++)x(k[f]);else x(k);k.nodeType?e.push(k):e=h.merge(e,k)}if(c)for(a=function(a){return!a.type||wb.test(a.type)},g=0;e[g];g++)!d||!h.nodeName(e[g],"script")||e[g].type&&"text/javascript"!==
...
m,b.handle);b.handle&&(b.handle.elem=null)}g?delete l[h.expando]:l.removeAttribute&&l.removeAttribute(h.expando);delete d[c]}}});var La=/alpha\([^)]*\)/i,xb=/opacity=([^)]*)/,yb=/([A-Z]|^ms)/g,Ma=/^-?\d+(?:px)?$/i,zb=/^-?\d/,Ab=/^[+\-]=/,Bb=/[^+\-\.\de]+/g,Cb={position:"absolute",visibility:"hidden",display:"block"},ab=["Left","Right"],bb=["Top","Bottom"],Q,Na,Oa;h.fn.css=function(a,c){return 2===arguments.length&&c===b?this:h.access(this,a,c,!0,function(a,c,d){return d!==b?h.style(a,c,d):h.css(a,
c)})};h.extend({cssHooks:{opacity:{get:function(a,b){if(b){var c=Q(a,"opacity","opacity");return""===c?"1":c}return a.style.opacity}}},cssNumber:{fillOpacity:!0,fontWeight:!0,lineHeight:!0,opacity:!0,orphans:!0,widows:!0,zIndex:!0,zoom:!0},cssProps:{"float":h.support.cssFloat?"cssFloat":"styleFloat"},style:function(a,c,d,e){if(a&&3!==a.nodeType&&8!==a.nodeType&&a.style){var f,g=h.camelCase(c),k=a.style,l=h.cssHooks[g];c=h.cssProps[g]||g;if(d!==b){if(e=typeof d,!("number"===e&&isNaN(d)||null==d||("string"===
e&&Ab.test(d)&&(d=+d.replace(Bb,"")+parseFloat(h.css(a,c)),e="number"),"number"!==e||h.cssNumber[g]||(d+="px"),l&&"set"in l&&(d=l.set(a,d))===b)))try{k[c]=d}catch(m){}}else return l&&"get"in l&&(f=l.get(a,!1,e))!==b?f:k[c]}},css:function(a,c,d){var e,f;c=h.camelCase(c);f=h.cssHooks[c];c=h.cssProps[c]||c;"cssFloat"===c&&(c="float");if(f&&"get"in f&&(e=f.get(a,!0,d))!==b)return e;if(Q)return Q(a,c)},swap:function(a,b,c){var d={},e;for(e in b)d[e]=a.style[e],a.style[e]=b[e];c.call(a);for(e in b)a.style[e]=
d[e]}});h.curCSS=h.css;h.each(["height","width"],function(a,b){h.cssHooks[b]={get:function(a,c,d){var e;if(c){if(0!==a.offsetWidth)return v(a,b,d);h.swap(a,Cb,function(){e=v(a,b,d)});return e}},set:function(a,b){if(Ma.test(b)){if(b=parseFloat(b),0<=b)return b+"px"}else return b}}});h.support.opacity||(h.cssHooks.opacity={get:function(a,b){return xb.test((b&&a.currentStyle?a.currentStyle.filter:a.style.filter)||"")?parseFloat(RegExp.$1)/100+"":b?"1":""},set:function(a,b){var c=a.style,d=a.currentStyle;
c.zoom=1;var e=h.isNaN(b)?"":"alpha(opacity="+100*b+")",d=d&&d.filter||c.filter||"";c.filter=La.test(d)?d.replace(La,e):d+" "+e}});h(function(){h.support.reliableMarginRight||(h.cssHooks.marginRight={get:function(a,b){var c;h.swap(a,{display:"inline-block"},function(){c=b?Q(a,"margin-right","marginRight"):a.style.marginRight});return c}})});t.defaultView&&t.defaultView.getComputedStyle&&(Na=function(a,c){var d,e;c=c.replace(yb,"-$1").toLowerCase();if(!(e=a.ownerDocument.defaultView))return b;if(e=
e.getComputedStyle(a,null))d=e.getPropertyValue(c),""!==d||h.contains(a.ownerDocument.documentElement,a)||(d=h.style(a,c));return d});t.documentElement.currentStyle&&(Oa=function(a,b){var c,d=a.currentStyle&&a.currentStyle[b],e=a.runtimeStyle&&a.runtimeStyle[b],f=a.style;!Ma.test(d)&&zb.test(d)&&(c=f.left,e&&(a.runtimeStyle.left=a.currentStyle.left),f.left="fontSize"===b?"1em":d||0,d=f.pixelLeft+"px",f.left=c,e&&(a.runtimeStyle.left=e));return""===d?"auto":d});Q=Na||Oa;h.expr&&h.expr.filters&&(h.expr.filters.hidden=
function(a){var b=a.offsetHeight;return 0===a.offsetWidth&&0===b||!h.support.reliableHiddenOffsets&&"none"===(a.style.display||h.css(a,"display"))},h.expr.filters.visible=function(a){return!h.expr.filters.hidden(a)});var Db=/%20/g,cb=/\[\]$/,Pa=/\r?\n/g,Eb=/#.*$/,Fb=/^(.*?):[ \t]*([^\r\n]*)\r?$/mg,Gb=/^(?:color|date|datetime|email|hidden|month|number|password|range|search|tel|text|time|url|week)$/i,Hb=/^(?:GET|HEAD)$/,Ib=/^\/\//,Qa=/\?/,Jb=/<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi,Kb=
/^(?:select|textarea)/i,va=/\s+/,Lb=/([?&])_=[^&]*/,Ra=/^([\w\+\.\-]+:)(?:\/\/([^\/?#:]*)(?::(\d+))?)?/,Sa=h.fn.load,ja={},Ta={},N,J;try{N=eb.href}catch(Rb){N=t.createElement("a"),N.href="",N=N.href}J=Ra.exec(N.toLowerCase())||[];h.fn.extend({load:function(a,c,d){if("string"!==typeof a&&Sa)return Sa.apply(this,arguments);if(!this.length)return this;var e=a.indexOf(" ");if(0<=e){var f=a.slice(e,a.length);a=a.slice(0,e)}e="GET";c&&(h.isFunction(c)?(d=c,c=b):"object"===typeof c&&(c=h.param(c,h.ajaxSettings.traditional),
e="POST"));var g=this;h.ajax({url:a,type:e,dataType:"html",data:c,complete:function(a,b,c){c=a.responseText;a.isResolved()&&(a.done(function(a){c=a}),g.html(f?h("<div>").append(c.replace(Jb,"")).find(f):c));d&&g.each(d,[c,b,a])}});return this},serialize:function(){return h.param(this.serializeArray())},serializeArray:function(){return this.map(function(){return this.elements?h.makeArray(this.elements):this}).filter(function(){return this.name&&!this.disabled&&(this.checked||Kb.test(this.nodeName)||
Gb.test(this.type))}).map(function(a,b){var c=h(this).val();return null==c?null:h.isArray(c)?h.map(c,function(a,c){return{name:b.name,value:a.replace(Pa,"\r\n")}}):{name:b.name,value:c.replace(Pa,"\r\n")}}).get()}});h.each("ajaxStart ajaxStop ajaxComplete ajaxError ajaxSuccess ajaxSend".split(" "),function(a,b){h.fn[b]=function(a){return this.bind(b,a)}});h.each(["get","post"],function(a,c){h[c]=function(a,d,e,f){h.isFunction(d)&&(f=f||e,e=d,d=b);return h.ajax({type:c,url:a,data:d,success:e,dataType:f})}});
h.extend({getScript:function(a,c){return h.get(a,b,c,"script")},getJSON:function(a,b,c){return h.get(a,b,c,"json")},ajaxSetup:function(a,b){b?h.extend(!0,a,h.ajaxSettings,b):(b=a,a=h.extend(!0,h.ajaxSettings,b));for(var c in{context:1,url:1})c in b?a[c]=b[c]:c in h.ajaxSettings&&(a[c]=h.ajaxSettings[c]);return a},ajaxSettings:{url:N,isLocal:/^(?:about|app|app\-storage|.+\-extension|file|widget):$/.test(J[1]),global:!0,type:"GET",contentType:"application/x-www-form-urlencoded",processData:!0,async:!0,
accepts:{xml:"application/xml, text/xml",html:"text/html",text:"text/plain",json:"application/json, text/javascript","*":"*/*"},contents:{xml:/xml/,html:/html/,json:/json/},responseFields:{xml:"responseXML",text:"responseText"},converters:{"* text":a.String,"text html":!0,"text json":h.parseJSON,"text xml":h.parseXML}},ajaxPrefilter:y(ja),ajaxTransport:y(Ta),ajax:function(a,c){function d(a,c,s,p){if(2!==w){w=2;u&&clearTimeout(u);x=b;q=p||"";C.readyState=a?4:0;var H,r,A;if(s){p=e;var v=C,t=p.contents,
D=p.dataTypes,B=p.responseFields,z,G,P,F;for(G in B)G in s&&(v[B[G]]=s[G]);for(;"*"===D[0];)D.shift(),z===b&&(z=p.mimeType||v.getResponseHeader("content-type"));if(z)for(G in t)if(t[G]&&t[G].test(z)){D.unshift(G);break}if(D[0]in s)P=D[0];else{for(G in s){if(!D[0]||p.converters[G+" "+D[0]]){P=G;break}F||(F=G)}P=P||F}P?(P!==D[0]&&D.unshift(P),s=s[P]):s=void 0}else s=b;if(200<=a&&300>a||304===a){if(e.ifModified){if(z=C.getResponseHeader("Last-Modified"))h.lastModified[n]=z;if(z=C.getResponseHeader("Etag"))h.etag[n]=
z}if(304===a)c="notmodified",H=!0;else try{z=e;z.dataFilter&&(s=z.dataFilter(s,z.dataType));var O=z.dataTypes;G={};var Z,I,M=O.length,T,R=O[0],K,N,S,J,U;for(Z=1;Z<M;Z++){if(1===Z)for(I in z.converters)"string"===typeof I&&(G[I.toLowerCase()]=z.converters[I]);K=R;R=O[Z];if("*"===R)R=K;else if("*"!==K&&K!==R){N=K+" "+R;S=G[N]||G["* "+R];if(!S)for(J in U=b,G)if(T=J.split(" "),T[0]===K||"*"===T[0])if(U=G[T[1]+" "+R]){J=G[J];!0===J?S=U:!0===U&&(S=J);break}S||U||h.error("No conversion from "+N.replace(" ",
" to "));!0!==S&&(s=S?S(s):U(J(s)))}}r=s;c="success";H=!0}catch(Q){c="parsererror",A=Q}}else if(A=c,!c||a)c="error",0>a&&(a=0);C.status=a;C.statusText=c;H?k.resolveWith(f,[r,c,C]):k.rejectWith(f,[C,c,A]);C.statusCode(m);m=b;y&&g.trigger("ajax"+(H?"Success":"Error"),[C,e,H?r:A]);l.resolveWith(f,[C,c]);y&&(g.trigger("ajaxComplete",[C,e]),--h.active||h.event.trigger("ajaxStop"))}}"object"===typeof a&&(c=a,a=b);c=c||{};var e=h.ajaxSetup({},c),f=e.context||e,g=f!==e&&(f.nodeType||f instanceof h)?h(f):
h.event,k=h.Deferred(),l=h._Deferred(),m=e.statusCode||{},n,p={},r={},q,v,x,u,t,w=0,y,B,C={readyState:0,setRequestHeader:function(a,b){if(!w){var c=a.toLowerCase();a=r[c]=r[c]||a;p[a]=b}return this},getAllResponseHeaders:function(){return 2===w?q:null},getResponseHeader:function(a){var c;if(2===w){if(!v)for(v={};c=Fb.exec(q);)v[c[1].toLowerCase()]=c[2];c=v[a.toLowerCase()]}return c===b?null:c},overrideMimeType:function(a){w||(e.mimeType=a);return this},abort:function(a){a=a||"abort";x&&x.abort(a);
d(0,a);return this}};k.promise(C);C.success=C.done;C.error=C.fail;C.complete=l.done;C.statusCode=function(a){if(a){var b;if(2>w)for(b in a)m[b]=[m[b],a[b]];else b=a[C.status],C.then(b,b)}return this};e.url=((a||e.url)+"").replace(Eb,"").replace(Ib,J[1]+"//");e.dataTypes=h.trim(e.dataType||"*").toLowerCase().split(va);null==e.crossDomain&&(t=Ra.exec(e.url.toLowerCase()),e.crossDomain=!(!t||t[1]==J[1]&&t[2]==J[2]&&(t[3]||("http:"===t[1]?80:443))==(J[3]||("http:"===J[1]?80:443))));e.data&&(e.processData&&
"string"!==typeof e.data)&&(e.data=h.param(e.data,e.traditional));D(ja,e,c,C);if(2===w)return!1;y=e.global;e.type=e.type.toUpperCase();e.hasContent=!Hb.test(e.type);y&&0===h.active++&&h.event.trigger("ajaxStart");if(!e.hasContent&&(e.data&&(e.url+=(Qa.test(e.url)?"&":"?")+e.data),n=e.url,!1===e.cache)){t=h.now();var z=e.url.replace(Lb,"$1_="+t);e.url=z+(z===e.url?(Qa.test(e.url)?"&":"?")+"_="+t:"")}(e.data&&e.hasContent&&!1!==e.contentType||c.contentType)&&C.setRequestHeader("Content-Type",e.contentType);
e.ifModified&&(n=n||e.url,h.lastModified[n]&&C.setRequestHeader("If-Modified-Since",h.lastModified[n]),h.etag[n]&&C.setRequestHeader("If-None-Match",h.etag[n]));C.setRequestHeader("Accept",e.dataTypes[0]&&e.accepts[e.dataTypes[0]]?e.accepts[e.dataTypes[0]]+("*"!==e.dataTypes[0]?", */*; q=0.01":""):e.accepts["*"]);for(B in e.headers)C.setRequestHeader(B,e.headers[B]);if(e.beforeSend&&(!1===e.beforeSend.call(f,C,e)||2===w))return C.abort(),!1;for(B in{success:1,error:1,complete:1})C[B](e[B]);if(x=D(Ta,
e,c,C)){C.readyState=1;y&&g.trigger("ajaxSend",[C,e]);e.async&&0<e.timeout&&(u=setTimeout(function(){C.abort("timeout")},e.timeout));try{w=1,x.send(p,d)}catch(F){2>status?d(-1,F):h.error(F)}}else d(-1,"No Transport");return C},param:function(a,c){var d=[],e=function(a,b){b=h.isFunction(b)?b():b;d[d.length]=encodeURIComponent(a)+"="+encodeURIComponent(b)};c===b&&(c=h.ajaxSettings.traditional);if(h.isArray(a)||a.jquery&&!h.isPlainObject(a))h.each(a,function(){e(this.name,this.value)});else for(var f in a)B(f,
a[f],c,e);return d.join("&").replace(Db,"+")}});h.extend({active:0,lastModified:{},etag:{}});var Mb=h.now(),ha=/(\=)\?(&|$)|\?\?/i;h.ajaxSetup({jsonp:"callback",jsonpCallback:function(){return h.expando+"_"+Mb++}});h.ajaxPrefilter("json jsonp",function(b,c,d){c="application/x-www-form-urlencoded"===b.contentType&&"string"===typeof b.data;if("jsonp"===b.dataTypes[0]||!1!==b.jsonp&&(ha.test(b.url)||c&&ha.test(b.data))){var e,f=b.jsonpCallback=h.isFunction(b.jsonpCallback)?b.jsonpCallback():b.jsonpCallback,
g=a[f],k=b.url,l=b.data,m="$1"+f+"$2";!1!==b.jsonp&&(k=k.replace(ha,m),b.url===k&&(c&&(l=l.replace(ha,m)),b.data===l&&(k+=(/\?/.test(k)?"&":"?")+b.jsonp+"="+f)));b.url=k;b.data=l;a[f]=function(a){e=[a]};d.always(function(){a[f]=g;if(e&&h.isFunction(g))a[f](e[0])});b.converters["script json"]=function(){e||h.error(f+" was not called");return e[0]};b.dataTypes[0]="json";return"script"}});h.ajaxSetup({accepts:{script:"text/javascript, application/javascript, application/ecmascript, application/x-ecmascript"},
...
e){if(e||!c.readyState||/loaded|complete/.test(c.readyState))c.onload=c.onreadystatechange=null,d&&c.parentNode&&d.removeChild(c),c=b,e||f(200,"success")};d.insertBefore(c,d.firstChild)},abort:function(){if(c)c.onload(0,1)}}}});var ta=a.ActiveXObject?function(){for(var a in X)X[a](0,1)}:!1,Nb=0,X;h.ajaxSettings.xhr=a.ActiveXObject?function(){var b;if(!(b=!this.isLocal&&z()))a:{try{b=new a.ActiveXObject("Microsoft.XMLHTTP");break a}catch(c){}b=void 0}return b}:z;(function(a){h.extend(h.support,{ajax:!!a,
...
e[l])}catch(m){}g.send(c.hasContent&&c.data||null);d=function(a,e){var l,m,n,p,r;try{if(d&&(e||4===g.readyState))if(d=b,k&&(g.onreadystatechange=h.noop,ta&&delete X[k]),e)4!==g.readyState&&g.abort();else{l=g.status;n=g.getAllResponseHeaders();p={};(r=g.responseXML)&&r.documentElement&&(p.xml=r);p.text=g.responseText;try{m=g.statusText}catch(q){m=""}l||!c.isLocal||c.crossDomain?1223===l&&(l=204):l=p.text?200:404}}catch(A){e||f(-1,A)}p&&f(l,m,p,n)};c.async&&4!==g.readyState?(k=++Nb,ta&&(X||(X={},h(a).unload(ta)),
X[k]=d),g.onreadystatechange=d):d()},abort:function(){d&&d(0,1)}}}});var ka={},M,V,Ob=/^(?:toggle|show|hide)$/,Pb=/^([+\-]=)?([\d+.\-]+)([a-z%]*)$/i,Y,wa=[["height","marginTop","marginBottom","paddingTop","paddingBottom"],["width","marginLeft","marginRight","paddingLeft","paddingRight"],["opacity"]],ea,ua=a.webkitRequestAnimationFrame||a.mozRequestAnimationFrame||a.oRequestAnimationFrame;h.fn.extend({show:function(a,b,c){if(a||0===a)return this.animate(O("show",3),a,b,c);c=0;for(var d=this.length;c<
...
f.top+d);null!=b.left&&(l.left=b.left-f.left+k);"using"in b?b.using.call(a,l):e.css(l)}};h.fn.extend({position:function(){if(!this[0])return null;var a=this[0],b=this.offsetParent(),c=this.offset(),d=Ua.test(b[0].nodeName)?{top:0,left:0}:b.offset();c.top-=parseFloat(h.css(a,"marginTop"))||0;c.left-=parseFloat(h.css(a,"marginLeft"))||0;d.top+=parseFloat(h.css(b[0],"borderTopWidth"))||0;d.left+=parseFloat(h.css(b[0],"borderLeftWidth"))||0;return{top:c.top-d.top,left:c.left-d.left}},offsetParent:function(){return this.map(function(){for(var a=
this.offsetParent||t.body;a&&!Ua.test(a.nodeName)&&"static"===h.css(a,"position");)a=a.offsetParent;return a})}});h.each(["Left","Top"],function(a,c){var d="scroll"+c;h.fn[d]=function(c){var e,f;return c===b?(e=this[0],e?(f=la(e))?f[a?"pageYOffset":"pageXOffset"]||h.support.boxModel&&f.document.documentElement[d]||f.document.body[d]:e[d]:null):this.each(function(){(f=la(this))?f.scrollTo(a?h(f).scrollLeft():c,a?c:h(f).scrollTop()):this[d]=c})}});h.each(["Height","Width"],function(a,c){var d=c.toLowerCase();
...
f}return 9===e.nodeType?Math.max(e.documentElement["client"+c],e.body["scroll"+c],e.documentElement["scroll"+c],e.body["offset"+c],e.documentElement["offset"+c]):a===b?(e=h.css(e,d),f=parseFloat(e),h.isNaN(f)?e:f):this.css(d,"string"===typeof a?a:a+"px")}});a.jQuery=a.$=h;a.$.rebindWindowContext=function(b){a=b;t=b.document;rootjQuery=$(t);return function(a,b){return new h.fn.init(a,b,rootjQuery)}}})(window);
jQuery.fn.center=function(){this.css("position","absolute");this.css("top",Math.max(0,($(window).height()-this.outerHeight())/2+$(window).scrollTop())+"px");this.css("left",Math.max(0,($(window).width()-this.outerWidth())/2+$(window).scrollLeft())+"px");return this};
(function(a){var b={vertical:{x:!1,y:!0},horizontal:{x:!0,y:!1},both:{x:!0,y:!0},x:{x:!0,y:!1},y:{x:!1,y:!0}},c={duration:"fast",direction:"both"},d=/^(?:html)$/i,e=function(b){var c=a(window),e=d.test(b[0].nodeName),f;if(e)f={top:0,left:0,bottom:0,right:0};else{var n=b[0],p;p=document.defaultView&&document.defaultView.getComputedStyle?document.defaultView.getComputedStyle(n,null):n.currentStyle;var r=document.defaultView&&document.defaultView.getComputedStyle?!0:!1;f=parseFloat(r?p.borderTopWidth:
a.css(n,"borderTopWidth"))||0;var q=parseFloat(r?p.borderLeftWidth:a.css(n,"borderLeftWidth"))||0,u=parseFloat(r?p.borderBottomWidth:a.css(n,"borderBottomWidth"))||0,n=parseFloat(r?p.borderRightWidth:a.css(n,"borderRightWidth"))||0;f={top:f,left:q,bottom:u,right:n,vertical:f+u,horizontal:q+n}}c={top:(e?c:b).scrollTop(),left:(e?c:b).scrollLeft()};q={right:e?0:b.innerWidth()-b[0].clientWidth,bottom:e?0:b.innerHeight()-b[0].clientHeight};u=b[0].getBoundingClientRect();return{border:f,scroll:c,scrollbar:q,
...
k.scrollbar.bottom-n.rect.bottom,r=n.rect.left-(k.rect.left+k.border.left),n=k.rect.right-k.border.right-k.scrollbar.right-n.rect.right,q={};!0===f.direction.y&&(0>l?q.scrollTop=k.scroll.top+l:0<l&&0>p&&(q.scrollTop=k.scroll.top+Math.min(l,-p)));!0===f.direction.x&&(0>r?q.scrollLeft=k.scroll.left+r:0<r&&0>n&&(q.scrollLeft=k.scroll.left+Math.min(r,-n)));a.isEmptyObject(q)?a.isFunction(f.complete)&&f.complete.call(m[0]):(d.test(m[0].nodeName)&&(m=a("html,body")),m.animate(q,f.duration).eq(0).queue(function(b){a.isFunction(f.complete)&&
f.complete.call(m[0]);b()}))}return this}});var f={auto:!0,scroll:!0,visible:!1,hidden:!1};a.extend(a.expr[":"],{scrollable:function(a,c,e,m){c=b["string"===typeof e[3]&&e[3].toLowerCase()]||b.both;e=document.defaultView&&document.defaultView.getComputedStyle?document.defaultView.getComputedStyle(a,null):a.currentStyle;var n=f[e.overflowX.toLowerCase()]||!1,p=f[e.overflowY.toLowerCase()]||!1,r=d.test(a.nodeName);if(!n&&!p&&!r)return!1;a={height:{scroll:a.scrollHeight,client:a.clientHeight},width:{scroll:a.scrollWidth,
client:a.clientWidth},scrollableX:function(){return(n||r)&&this.width.scroll>this.width.client},scrollableY:function(){return(p||r)&&this.height.scroll>this.height.client}};return c.y&&a.scrollableY()||c.x&&a.scrollableX()}})})(jQuery);
...
Role("Siesta.Test.Simulate.Mouse",{requires:["simulateEvent","getSimulateEventsWith","normalizeElement","isTextInput"],has:{dragDelay:25,moveCursorBetweenPoints:!0,dragPrecision:$.browser.msie?10:5,enableUnreachableClickWarning:!0,autoScrollElementsIntoView:!0,overEls:Joose.I.Array},after:{cleanup:function(){this.overEls=null}},methods:{createMouseEvent:function(a,b,c){var d,e=this.global;b=$.extend({bubbles:"mouseenter"!==a&&"mouseleave"!==a,cancelable:"mousemove"!=a,view:e,detail:0,screenX:0,screenY:0,
ctrlKey:!1,altKey:!1,shiftKey:!1,metaKey:!1,button:0,relatedTarget:void 0},b);if(!("clientX"in b&&"clientY"in b)){var f=this.findCenter(c);b=$.extend({clientX:f[0],clientY:f[1]},b)}"screenX"in window&&(b=$.extend(b,{screenX:e.screenX+b.clientX,screenY:e.screenY+b.clientY}));c=c.ownerDocument;c.createEvent&&"dispatchEvent"==this.getSimulateEventsWith()?(f=a.match(/^(ms)?pointer/i),d=c.createEvent(f?(f[1]?"MS":"")+"PointerEvent":"MouseEvents"),d[f?"initPointerEvent":"initMouseEvent"](a,b.bubbles,b.cancelable,
b.view,b.detail,b.screenX,b.screenY,b.clientX,b.clientY,b.ctrlKey,b.altKey,b.shiftKey,b.metaKey,b.button,b.relatedTarget||c.documentElement,null,null,null,null,null,null,null,null,null,4,null,null)):c.createEventObject&&(d=c.createEventObject(),$.extend(d,b),d.button={0:1,1:4,2:2}[d.button]||d.button);"mouseover"!==a&&"mouseout"!==a&&(f=c.defaultView||c.parentWindow,a=b.clientX,c=b.clientY,f!==e&&(e=this.$(f.frameElement).offset(),a+=e.left,c+=e.top),b.doNotUpdateCurrentPosition||(this.currentPosition[0]=
a,this.currentPosition[1]=c));return d},moveMouseTo:function(a,b,c,d){if(!a)throw"Trying to call moveMouseTo without a target";this.waitForTargetAndSyncMousePosition(a,d,function(){this.afterMouseInteraction();b.call(c||this)},[],!1)},moveCursorTo:function(a,b,c,d){this.moveMouseTo.apply(this,arguments)},moveMouseBy:function(a,b,c){this.moveCursorBy.apply(this,arguments)},moveCursorBy:function(a,b,c){if(!a)throw"Trying to call moveCursorBy without relative distances";this.moveMouse(this.currentPosition,
[this.currentPosition[0]+a[0],this.currentPosition[1]+a[1]],b,c)},moveMouse:function(a,b,c,d,e,f,g){var k=this;this.movePointerTemplate({xy:a,xy2:b,callback:c,scope:d,options:g||{},overEls:this.overEls,interval:!1!==f?this.dragDelay:0,callbackDelay:!1!==f?50:0,precision:e||k.dragPrecision,onVoidOverEls:function(){return k.overEls=[]},onPointerEnter:function(a,b,c){k.simulateEvent(a,"mouseenter",b,c)},onPointerLeave:function(a,b,c){k.simulateEvent(a,"mouseleave",b,c)},onPointerOver:function(a,b,c){k.simulateEvent(a,
"mouseover",b,c)},onPointerOut:function(a,b,c){k.simulateEvent(a,"mouseout",b,c)},onPointerMove:function(a,b,c){k.simulateEvent(a,"mousemove",b,c)}})},movePointerTemplate:function(a){var b=this.global.document,c=this,d=a.overEls,e=d[d.length-1];try{e&&e.tagName}catch(f){e=null,d=a.onVoidOverEls()}for(var g=a.precision,k=a.options||{},l=this.getPathBetweenPoints(a.xy,a.xy2),m=Siesta.Harness.Browser.FeatureSupport().supports,n=new Siesta.Util.Queue({deferer:this.originalSetTimeout,deferClearer:this.originalClearTimeout,
interval:a.interval,callbackDelay:a.callbackDelay,observeTest:this,processor:function(f,g){for(var n=f.targetIndex,p=f.sourceIndex;p<=n;p++){var r=l[p],q=c.elementFromPoint(r[0],r[1]);if(q){if(q.ownerDocument!==b){var B=c.$((q.ownerDocument.defaultView||q.ownerDocument.parentWindow).frameElement).offset();r[0]-=B.left;r[1]-=B.top}if(q!==e){for(var z=d.length-1;0<=z;z--)if(B=d[z],B!==q&&0===c.$(B).has(q).length){if(m.mouseEnterLeave)a.onPointerLeave(B,$.extend({clientX:r[0],clientY:r[1],relatedTarget:q},
k));d.splice(z,1)}if(e)a.onPointerOut(e,$.extend({clientX:r[0],clientY:r[1],relatedTarget:q},k));if(m.mouseEnterLeave&&-1==jQuery.inArray(q,d)){for(var B=[],z=q.ownerDocument.documentElement,I=q;I&&I!=z;)B.unshift(I),I=I.parentNode;for(z=0;z<B.length;z++)-1==jQuery.inArray(B[z],d)&&(a.onPointerEnter(B[z],$.extend({clientX:r[0],clientY:r[1],relatedTarget:e},k)),d.push(B[z]))}a.onPointerOver(q,$.extend({clientX:r[0],clientY:r[1],relatedTarget:e},k));e=q}a.onPointerMove(q,$.extend({clientX:r[0],clientY:r[1]},
k),p<n)}}}}),p=0,r=l.length;p<r;p+=g)n.addStep({sourceIndex:p,targetIndex:Math.min(p+g-1,l.length-1)});var q=this.beginAsync();n.run(function(){c.endAsync(q);c.processCallbackFromTest(a.callback,null,a.scope||c)})},focusOnClick:function(a){if(this.isTextInput(a))this.focus(a);else{var b=a.ownerDocument,c=b.body;if(c){for(;a&&a!=c&&a!=b;){if("on"==a.getAttribute("unselectable"))return;if(null!=a.getAttribute("tabIndex")){this.focus(a);return}a=a.parentNode}this.focus(c||b.documentElement)}}},waitForTargetAndSyncMousePosition:function(a,
b,c,d,e){var f,g="Array"!=this.typeOf(a),k=this.suppressPassedWaitForAssertion;this.suppressPassedWaitForAssertion=!0;this.chain({waitForAnimations:[]},g&&{waitForElementVisible:a},function(d){g&&this.autoScrollElementsIntoView&&this.scrollTargetIntoView(a,b);f=this.getNormalizedTopElementInfo(a,!0,c.toString(),b).globalXY;this.moveCursorBetweenPoints?this.syncCursor(f,d):d()},!1!==e&&g&&function(c){this.waitForTarget(a,c,this,null,b)},function(e){var m=(e=this.getNormalizedTopElementInfo(a,!0,c.toString(),
b))&&e.globalXY;!g||e&&f[0]===m[0]&&f[1]===m[1]?(this.suppressPassedWaitForAssertion=k,c.apply(this,d)):(this.diag(Siesta.Resource("Siesta.Test.Browser","targetMoved")),this.waitFor(100,function(){this.waitForTargetAndSyncMousePosition(a,b,c,d)}))})},afterMouseInteraction:function(){if(this.overEls&&0<this.overEls.length){var a=this.overEls[this.overEls.length-1],b=a.ownerDocument;b&&$.contains(a,b.body)||this.mouseOver(this.currentPosition)}},genericMouseClick:function(a,b,c,d,e,f,g){jQuery.isFunction(a)&&
(c=b,b=a,a=null);a=a||this.currentPosition;!1!==g&&b?this.waitForTargetAndSyncMousePosition(a,f,this.genericMouseClick,[a,b,c,d,e,f,!1]):(d=d||{},(g=this.getNormalizedTopElementInfo(a,!0,e,f))?(g.originalEl=a,g.method=e,g.offset=f,d.clientX=null!=d.clientX?d.clientX:g.localXY[0],d.clientY=null!=d.clientY?d.clientY:g.localXY[1],this[e](g,b,c,d)):b&&b.call(c||this))},click:function(a,b,c,d,e){this.genericMouseClick(a,b,c,d,"simulateMouseClick",e)},rightClick:function(a,b,c,d,e){this.genericMouseClick(a,
b,c,d,"simulateRightClick",e)},doubleClick:function(a,b,c,d,e){this.genericMouseClick(a,b,c,d,"simulateDoubleClick",e)},mouseDown:function(a,b,c){var d=this.getNormalizedTopElementInfo(a,!1,"mouseDown",c);d?(b=b||{},b.clientX=null!=b.clientX?b.clientX:d.localXY[0],b.clientY=null!=b.clientY?b.clientY:d.localXY[1],a=a||d.el,this.simulateEvent(a,"mousedown",b)):this.waitForTarget(a,function(){this.mouseDown(a,b,c)},this,null,c)},mouseUp:function(a,b,c){if(c=this.getNormalizedTopElementInfo(a,!1,"mouseUp",
c))b=b||{},b.clientX=null!=b.clientX?b.clientX:c.localXY[0],b.clientY=null!=b.clientY?b.clientY:c.localXY[1],a=a||c.el,this.simulateEvent(a,"mouseup",b)},mouseOver:function(a,b){var c=this.getNormalizedTopElementInfo(a,!0);c&&(b=b||{},b.clientX=null!=b.clientX?b.clientX:c.localXY[0],b.clientY=null!=b.clientY?b.clientY:c.localXY[1],this.simulateEvent(a,"mouseover",b))},mouseOut:function(a,b){var c=this.getNormalizedTopElementInfo(a,!0);c&&(b=b||{},b.clientX=null!=b.clientX?b.clientX:c.localXY[0],b.clientY=
null!=b.clientY?b.clientY:c.localXY[1],this.simulateEvent(a,"mouseout",b))},processMouseClickSteps:function(a,b,c,d,e){a.originalEl&&this.enableUnreachableClickWarning&&this.getNormalizedTopElementInfo(a.originalEl,!1,a.method,a.offset);var f=this,g=a.globalXY[0],k=a.globalXY[1],l=f.elementFromPoint(g,k,!1,a.el),m=!1,n=new Siesta.Util.Queue({deferer:this.originalSetTimeout,deferClearer:this.originalClearTimeout,interval:b?10:0,callbackDelay:f.afterActionDelay,observeTest:this,processor:function(a){var b=
f.elementFromPoint(g,k,!1,l);a.reCaptureTheTarget&&(l=b,m=!1);b==l||($.contains(b,l)||$.contains(l,b))||(m=!0);if(!m||!a.cancelIfTargetChanged){var c=f.simulateEvent(b,a.event,d,a.suppressLog);!a.focus||"mousedown"==a.event&&f.isEventPrevented(c)||f.focusOnClick(b);$.browser.msie&&(11>Number(/^(\d+)/.exec($.browser.version)[1])&&"click"===e[e.length-1].event&&"a"===b.tagName.toLowerCase()&&b.getAttribute("href")&&"click"===a.event)&&(a=b.getAttribute("href").match(/#(.*)/))&&(f.global.location.hash=
a[1])}}});Joose.A.each(e,function(a){n.addStep(a)});var p=f.beginAsync();n.run(function(){f.endAsync(p);f.afterMouseInteraction();f.processCallbackFromTest(b,null,c||f)})},simulateMouseClick:function(a,b,c,d){this.processMouseClickSteps(a,b,c,d,[{event:"mousedown",suppressLog:!0,focus:!0},{event:"mouseup",suppressLog:!0},{event:"click",suppressLog:!1,cancelIfTargetChanged:!0}])},simulateRightClick:function(a,b,c,d){d=d||{};d.button=2;this.processMouseClickSteps(a,b,c,d,[{event:"mousedown",suppressLog:!1,
focus:!0},{event:"mouseup",suppressLog:!0},{event:"contextmenu",suppressLog:!1}])},simulateDoubleClick:function(a,b,c,d){this.processMouseClickSteps(a,b,c,d,[{event:"mousedown",suppressLog:!1,focus:!0},{event:"mouseup",suppressLog:!0},{event:"click",suppressLog:!1,cancelIfTargetChanged:!0},{event:"mousedown",suppressLog:!1,reCaptureTheTarget:!0,focus:!0},{event:"mouseup",suppressLog:!0},{event:"click",suppressLog:!0,cancelIfTargetChanged:!0},{event:"dblclick",suppressLog:!1,cancelIfTargetChanged:!0}])},
syncCursor:function(a,b,c){var d=this,e=this.currentPosition;c=c||[];a[0]!==e[0]||a[1]!==e[1]?this.moveMouse(e,a,function(){b&&b.apply(d,c)}):b&&b.apply(this,c)},drag:function(a,b,c,d,e,f){if(!a)throw"No drag source defined";b?this.dragTo(a,b,d,e,f):this.dragBy(a,c,d,e,f)},dragTo:function(a,b,c,d,e,f,g,k,l){if(!b)throw"No drag target defined";a=a||this.currentPosition;e=e||{};!1!==l&&c?this.waitForTargetAndSyncMousePosition(a,g,this.dragTo,[a,b,c,d,e,f,g,k,!1]):(a=this.getNormalizedTopElementInfo(a,
!0,"dragTo: Source",g),(b=this.getNormalizedTopElementInfo(b,!1,"dragTo: Target",k))?this.simulateDrag(a.globalXY,b.globalXY,function(){this.afterMouseInteraction();c.call(d||this)},null,e,f):this.processCallbackFromTest(c,null,d||this))},dragBy:function(a,b,c,d,e,f,g,k){if(!b)throw"No drag delta defined";a=a||this.currentPosition;!1!==k&&c?this.waitForTargetAndSyncMousePosition(a,g,this.dragBy,[a,b,c,d,e,f,g,!1]):(a=this.getNormalizedTopElementInfo(a,!0,"dragBy: Source",g).globalXY,this.simulateDrag(a,
[a[0]+b[0],a[1]+b[1]],function(){this.afterMouseInteraction();c.call(d||this)},null,e,f))},simulateDrag:function(a,b,c,d,e,f){var g=this;e=e||{};var k=g.elementFromPoint(a[0],a[1],!0);g.elementFromPoint(b[0],b[1],!0);var l=new Siesta.Util.Queue({deferer:this.originalSetTimeout,deferClearer:this.originalClearTimeout,interval:g.dragDelay,callbackDelay:g.afterActionDelay,observeTest:this});l.addStep({processor:function(){g.simulateEvent(k,"mouseover",$.extend({clientX:a[0],clientY:a[1]},e))}});l.addStep({processor:function(){k=
g.elementFromPoint(a[0],a[1],!0,k);g.simulateEvent(k,"mouseover",$.extend({clientX:a[0],clientY:a[1]},e))}});l.addStep({processor:function(){g.simulateEvent(k,"mousedown",$.extend({clientX:a[0],clientY:a[1]},e))}});l.addStep({isAsync:!0,processor:function(c){g.moveMouse(a,b,c.next,this,null,!0,e)}});var m;l.addStep({processor:function(){m=g.elementFromPoint(b[0],b[1],!0);g.simulateEvent(m,"mouseover",$.extend({clientX:b[0],clientY:b[1]},e))}});f||(l.addStep({processor:function(){g.simulateEvent(m,
"mouseup",$.extend({clientX:b[0],clientY:b[1]},e))}}),l.addStep({processor:function(){m===k&&g.simulateEvent(m,"click",$.extend({clientX:b[0],clientY:b[1]},e))}}));var n=this.beginAsync();l.run(function(){g.endAsync(n);g.processCallbackFromTest(c,null,d||g)})}}});
...
c.initTextEvent)return c.initTextEvent("textInput",!0,!0,this.global,b.text,0),c}catch(d){}return null},findNextFocusable:function(a,b){var c=this.$(a),d=this.$(":input, a[href]",a.ownerDocument).not(":disabled").not(":hidden").not("a[href]:empty");if("INPUT"===a.tagName&&"radio"===a.type&&""!==a.name)var e=a.name.replace(/(!"#$%&'\(\)\*\+,\.\/:;<=>\?@\[\]^`\{\|\}~)/g,"\\\\$1"),d=d.not("input[type=radio][name="+e+"]").add(c);e=d.filter("[tabindex]");e.sort(function(a,b){return a.tabIndex<b.tabIndex?
-1:1});var e=$(e.toArray().concat(d.filter(":not([tabindex])").toArray())),c=($(e).index(c)+b)%e.length,f;0<c&&(f=e.eq(c));return f&&f[0]||null},emulateTab:function(a,b){var c=this.findNextFocusable(a,b||1);c?this.focus(c):a.blur();return c},type:function(a,b,c,d,e){a=this.normalizeElement(a||this.activeElement());if(null===b||void 0===b)throw"Must supply a string to type";var f=this.getSelectedText(a);f&&(a.value=a.value.replace(f,""));var g=this;if(a.readOnly||a.disabled)g.processCallbackFromTest(c,
null,d||g);else{b=(b+"").match(/(\[(?:\w|-)+\])|([\s\S])/g)||[];var k=new Siesta.Util.Queue({deferer:this.originalSetTimeout,deferClearer:this.originalClearTimeout,interval:this.actionDelay,callbackDelay:this.afterActionDelay,observeTest:this,processor:function(b,c){var d=g.activeElement(!0,a,a);g.keyPress(d,b.key,e)}});k.addStep({processor:function(){g.focus(a)}});$.browser.msie&&k.addStep({processor:function(){g.focus(a)}});jQuery.each(b,function(a,b){k.addStep({key:1==b.length?b:b.substring(1,
b.length-1)})});var l=this.beginAsync();k.run(function(){g.endAsync(l);g.processCallbackFromTest(c,null,d||g)})}},keyPress:function(a,b,c){a=this.normalizeElement(a);var d=Siesta.Test.Simulate.KeyCodes().keys,e=d[b.toUpperCase()]||0;c=c||{};c.readableKey=b;var f=this.isReadableKey(e),g=f?b.charCodeAt(0):0;b=this.isTextInput(a);var k=this.isEditableNode(a),l=b||k,m=this.simulateEvent(a,"keydown",$.extend({charCode:0,keyCode:e},c),!0),m=this.isEventPrevented(m);a=this.activeElement(!0,a,a);var g=this.simulateEvent(a,
"keypress",$.extend({charCode:g,keyCode:f?0:e},c),!1),n=this.isEventPrevented(g),g=Siesta.Harness.Browser.FeatureSupport().supports;m||(n||e!==d.TAB)||(a=this.emulateTab(a,c.shiftKey?-1:1)||a);!n&&(l&&e!=d.TAB)&&(l=this.harness.isPhantomJS,m="value"in a?"value":"innerHTML",f&&(l||(k&&($.browser.msie&&0===a.innerHTML.indexOf("&nbsp;"))&&(a.innerHTML=a.innerHTML.substring(6)),k&&!$.browser.msie?(8203===a.innerHTML.charCodeAt(a.innerHTML.length-1)&&(a.innerHTML=a.innerHTML.substring(0,a.innerHTML.length-
1)),a.ownerDocument.execCommand("insertText",!1,c.readableKey)):this.simulateEvent(a,"textInput",{text:c.readableKey},!0)),f=a[m].length,k=a.getAttribute("maxlength"),null!=k&&(k=Number(k)),!b&&!$.browser.msie||(g.canSimulateKeyCharacters&&!l||f!==a[m].length||f===k)||(a[m]+=c.readableKey)),e===d.BACKSPACE&&(!g.canSimulateBackspace&&0<a[m].length)&&(b||$.browser.msie?a[m]=a[m].substring(0,a[m].length-1):a.ownerDocument.execCommand("delete")),"value"!==m||(e!==d.ENTER||g.enterSubmitsForm)||(b=this.$(a).closest("form"),
b.length&&b.submit()));b=a.nodeName&&a.nodeName.toLowerCase();"a"!=b&&"button"!=b||(e!==d.ENTER||g.enterOnAnchorTriggersClick)||this.simulateEvent(a,"click",{doNotUpdateCurrentPosition:!0},!0);this.simulateEvent(a,"keyup",$.extend({charCode:0,keyCode:e},c),!0)},isTextInput:function(a){var b=a.nodeName&&a.nodeName.toLowerCase();a=a.type&&a.type.toLowerCase();return"textarea"===b||"input"===b&&("password"===a||"number"===a||"search"===a||"text"===a||"email"===a)},isEditableNode:function(a){return"on"===
a.ownerDocument.designMode.toLowerCase()||"true"===a.contentEditable.toLowerCase()},isReadableKey:function(a){var b=Siesta.Test.Simulate.KeyCodes();return!b.isNav(a)&&!b.isSpecial(a)}}});
...
b;return c}}});
Role("Siesta.Test.Simulate.Touch",{requires:["normalizeElement"],has:{touchEventNamesMap:{lazy:"this.buildTouchEventNamesMap"},currentTouchId:1,activeTouches:Joose.I.Object},methods:{checkTouchEventsSupport:function(){var a=Siesta.Harness.Browser.FeatureSupport().supports;a.TouchEvents||(a.PointerEvents||a.MSPointerEvents)||this.warn("Touch events are not supported by browser. For Chrome, you can enable them, by launching it with: --args --touch-events")},tap:function(a,b,c,d,e){this.checkTouchEventsSupport();var f=
this,g=this.getNormalizedTopElementInfo(a,!0,"tap",e);if(g){var k=new Siesta.Util.Queue({deferer:this.originalSetTimeout,deferClearer:this.originalClearTimeout,interval:b?30:0,observeTest:this}),l;k.addStep({processor:function(){l=f.touchStart(null,null,d,g)}});k.addStep({processor:function(){f.touchEnd(l,d)}});var m=f.beginAsync();k.run(function(){f.endAsync(m);f.processCallbackFromTest(b,null,c||f)})}else this.waitForTarget(a,function(){this.tap(a,b,c,e)},this,null,e)},doubleTap:function(a,b,c,
d,e){this.checkTouchEventsSupport();var f=this,g=this.getNormalizedTopElementInfo(a,!0,"doubleTap",e);if(g){var k=new Siesta.Util.Queue({deferer:this.originalSetTimeout,deferClearer:this.originalClearTimeout,interval:b?30:0,observeTest:this}),l;k.addStep({processor:function(){l=f.touchStart(null,null,d,g)}});k.addStep({processor:function(){f.touchEnd(l,d)}});k.addStep({processor:function(){l=f.touchStart(null,null,d,g)}});k.addStep({processor:function(){f.touchEnd(l,d)}});var m=f.beginAsync();k.run(function(){f.endAsync(m);
f.processCallbackFromTest(b,null,c||f)})}else this.waitForTarget(a,function(){this.doubleTap(a,b,c,e)},this,null,e)},getLongPressDelay:function(){return 1500},longpress:function(){return this.longPress.apply(this,arguments)},longPress:function(a,b,c,d,e){this.checkTouchEventsSupport();var f=this,g=this.getNormalizedTopElementInfo(a,!0,"longPress",e);if(g){var k=new Siesta.Util.Queue({deferer:this.originalSetTimeout,deferClearer:this.originalClearTimeout,interval:b?30:0,observeTest:this}),l;k.addStep({processor:function(){l=
f.touchStart(null,null,d,g)}});k.addDelayStep(this.getLongPressDelay());k.addStep({processor:function(){f.touchEnd(l,d)}});var m=f.beginAsync();k.run(function(){f.endAsync(m);f.processCallbackFromTest(b,null,c||f)})}else this.waitForTarget(a,function(){this.longPress(a,b,c,e)},this,null,e)},pinch:function(a,b,c,d,e,f,g,k){this.checkTouchEventsSupport();var l=this;"Number"==this.typeOf(b)&&(k=g,g=f,f=e,e=d,d=c,c=b,b=a);null==b&&(b=a);a!=b||(g||k)||(g=["25%","50%"],k=["75%","50%"]);var m=this.getNormalizedTopElementInfo(a,
!0,"pinch: target1",g),n=this.getNormalizedTopElementInfo(b,!0,"pinch: target2",k);if(m&&n){var p=new Siesta.Util.Queue({deferer:this.originalSetTimeout,deferClearer:this.originalClearTimeout,interval:d?30:0,observeTest:this}),r,q,u=m.localXY[0]-n.localXY[0],x=m.localXY[1]-n.localXY[1],w=Math.sqrt(u*u+x*x);1>w&&(w=1);c=(w*c-w)/2;var u=Math.atan(x/u),v=Math.round(m.localXY[0]-c*Math.cos(u)),y=Math.round(m.localXY[1]-c*Math.sin(u)),D=Math.round(n.localXY[0]+c*Math.cos(u)),B=Math.round(n.localXY[1]+
c*Math.sin(u)),z=Joose.O.extend({},f);p.addStep({processor:function(){r=l.touchStart(null,null,f,m);q=l.touchStart(null,null,z,n)}});p.addAsyncStep({processor:function(a){var b=!1,c=!1;l.touchMove(r,v,y,function(){(b=!0)&&c&&a.next()},null,f);l.touchMove(q,D,B,function(){c=!0;b&&c&&a.next()},null,z)}});p.addStep({processor:function(){l.touchEnd(r,f);l.touchEnd(q,z)}});var I=l.beginAsync();p.run(function(){l.endAsync(I);l.processCallbackFromTest(d,null,e||l)})}else p=Siesta.Resource("Siesta.Test.Browser"),
...
deferClearer:this.originalClearTimeout,interval:g.dragDelay,callbackDelay:g.afterActionDelay,observeTest:this}),l;k.addStep({processor:function(){l=g.touchStart(a,null,e)}});k.addAsyncStep({processor:function(a){g.touchMove(l,b[0],b[1],a.next,null,e)}});k.addStep({processor:function(){f||g.touchEnd(l,e)}});var m=g.beginAsync();k.run(function(){g.endAsync(m);g.processCallbackFromTest(c,[f?l:null],d||g)})},touchDragTo:function(a,b,c,d,e,f,g,k){var l=this,m=this.getNormalizedTopElementInfo(a,!0,"touchDragTo: source",
g),n=this.getNormalizedTopElementInfo(b,!0,"touchDragTo: target",k);m&&n?this.simulateTouchDrag(m.localXY,n.localXY,c,d,e,f):(m=Siesta.Resource("Siesta.Test.Browser"),this.waitFor({method:function(){var c=l.normalizeElement(a,!0),d=l.normalizeElement(b,!0);return c&&l.elementIsTop(c,!0,g)&&d&&l.elementIsTop(d,!0,k)},callback:function(){l.touchDragTo(a,b,c,d,e,f,g,k)},assertionName:"waitForTarget",description:" "+m.get("target")+' "'+a+'" and "'+b+'" '+m.get("toAppear")}))},touchDragBy:function(a,
b,c,d,e,f,g){var k=this.getNormalizedTopElementInfo(a,!0,"touchDragBy",g);k?(k=k.globalXY,this.simulateTouchDrag(k,[k[0]+b[0],k[1]+b[1]],c,d,e,f)):this.waitForTarget(a,function(){this.touchDragBy(a,b,c,d,e,f,g)},this,null,g)},swipe:function(a,b,c,d,e){this.checkTouchEventsSupport();if(a=this.normalizeElement(a,!0)){var f=this.Ext(),g=Siesta.Resource("Siesta.Test.SenchaTouch"),f=f.fly(a).getBox();switch(b){case "u":case "up":g=[f.x+f.width/2,f.y+9*f.height/10];f=[f.x+f.width/2,f.y+f.height/10];f[1]=
Math.min(g[1]-100,f[1]);break;case "d":case "down":g=[f.x+f.width/2,f.y+f.height/10];f=[f.x+f.width/2,f.y+9*f.height/10];f[1]=Math.max(g[1]+100,f[1]);break;case "r":case "right":g=[f.x+f.width/10,f.y+f.height/2];f=[f.x+9*f.width/10,f.y+f.height/2];f[0]=Math.max(g[0]+100,f[0]);break;case "l":case "left":g=[f.x+9*f.width/10,f.y+f.height/2];f=[f.x+f.width/10,f.y+f.height/2];f[0]=Math.min(g[0]-100,f[0]);break;default:throw g.get("invalidSwipeDir")+": "+b;}this.touchDragTo(g,f,c,d,e)}else this.waitForTarget(a,
...
"end",b,{touchId:a})},touchMove:function(a,b,c,d,e,f){var g=this.activeTouches[a];if(!g)throw"Can't find active touch: "+a;var k=this,l=[];this.movePointerTemplate({xy:[g.clientX,g.clientY],xy2:[b,c],callback:d,scope:e,options:f||{},overEls:l,interval:this.dragDelay,callbackDelay:k.afterActionDelay,precision:k.dragPrecision,onVoidOverEls:function(){return l=[]},onPointerEnter:function(a,b,c){},onPointerLeave:function(a,b,c){},onPointerOver:function(a,b,c){},onPointerOut:function(a,b,c){},onPointerMove:function(b,
c,d){g.clientX=c.clientX;g.clientY=c.clientY;g.pageX=c.clientX;g.pageY=c.clientY;g.currentEl=b;k.simulateTouchEventGeneric(b,"move",c,{touchId:a})}})},touchCancel:function(a,b){var c=this.activeTouches[a];if(!c)throw"Can't find active touch: "+a;this.simulateTouchEventGeneric(c.currentEl||c.target,"cancel",b,{touchId:a})},simulatePointerEvent:function(a,b,c,d){var e=Siesta.Harness.Browser.FeatureSupport().supports;c=c||{};var f=this.global.document,g=f.createEvent(e.PointerEvents?"PointerEvent":e.MSPointerEvents?
"MSPointerEvent":"MouseEvents");a=this.normalizeElement(a);if(!a)return!1;if(!/pointerdown$/i.test(b)||"clientX"in c&&"clientY"in c)g[e.MSPointerEvents||e.PointerEvents?"initPointerEvent":"initMouseEvent"](b,!0,!0,this.global,c.detail,c.screenX,c.screenY,c.clientX,c.clientY,c.ctrlKey||!1,c.altKey||!1,c.shiftKey||!1,c.metaKey||!1,c.button,c.relatedTarget||f.documentElement,null,null,null,null,null,null,null,null,d.touchId||this.currentTouchId++,4,null,null);else b=this.findCenter(a),Joose.O.extend({clientX:b[0],
clientY:b[1]},c);e.MSPointerEvents||e.PointerEvents||(g.pointerId=d.touchId||this.currentTouchId++);a.dispatchEvent(g);return g},simulateTouchEvent:function(a,b,c,d){c=c||{};b=new this.global.CustomEvent(b,{bubbles:!0,cancelable:!0});a=this.normalizeElement(a);"clientX"in c&&"clientY"in c||this.findCenter(a);var e=this.activeTouches;d=d.touch;var f=[],g=[],k;for(k in e){var l=e[k];f.push(l);l.target==a&&g.push(l)}Joose.O.extend(b,{target:a,changedTouches:this.createTouchList([d]),touches:this.createTouchList(f),
targetTouches:this.createTouchList(g),altKey:c.altKey,metaKey:c.metaKey,ctrlKey:c.ctrlKey,shiftKey:c.shiftKey});a.dispatchEvent(b);return b},createTouchList:function(a){var b=this.global.document;if(b.createTouch){for(var c=[],d=0;d<a.length;d++){var e=a[d];c.push(b.createTouch(b.defaultView||b.parentWindow,e.target,e.identifier||this.currentTouchId++,e.pageX,e.pageY,e.screenX||e.pageX,e.screenY||e.pageY,e.clientX,e.clientY))}return b.createTouchList.apply(b,c)}return a},createTouch:function(a,b,
...
1)},matchGridCellContent:function(a,b,c,d,e){a=this.normalizeComponent(a);a.getView();a=this.getCell(a,b,c).child("div");var f="RegExp"==this.typeOf(d),g=a.dom.innerHTML;(f?d.test(g):-1!=g.indexOf(d))?this.pass(e,{descTpl:f?"Cell content {content} matches regexp {string}":"Cell content {content} has a string {string}",content:g,string:d}):this.fail(e,{assertionName:"matchGridCellContent",got:a.dom.innerHTML,gotDesc:"Cell content",need:d,needDesc:"String matching",annotation:"Row index: "+b+", column index: "+
c})},clickToEditCell:function(a,b,c,d,e){var f=this.getExt(),g=(a=this.normalizeComponent(a))&&a.editingPlugin;if(g&&g instanceof f.grid.plugin.CellEditing){var k=this;this[2==g.clicksToEdit?"doubleClick":"click"](this.getCell(a,b,c),function(){g.getActiveEditor()||g.startEditByPosition({row:b,column:c});k.waitForSelectorAtCursor(e||"input",d)})}else this.fail("No grid, or grid has no editing plugin, or its not a Ext.grid.plugin.CellEditing plugin"),d&&d(null)}}});
...
Role("Siesta.Test.Element",{requires:["typeOf","chain","normalizeElement"],methods:{findCenter:function(a,b){return this.getTargetCoordinate(a,b)},normalizeOffset:function(a,b){var c;"Function"==this.typeOf(a)&&(a=a.call(this));a=a&&a.slice()||["50%","50%"];"string"===typeof a[0]&&(c=a[0].split("%"),a[0]=parseInt(a[0].match(/\d+/)[0],10)*(b.outerWidth()-1)/100,c[1]&&(a[0]+=parseInt(c[1])),a[0]=Math.round(a[0]));"string"===typeof a[1]&&(c=a[1].split("%"),a[1]=parseInt(a[1].match(/\d+/)[0],10)*(b.outerHeight()-
1)/100,c[1]&&(a[1]+=parseInt(c[1])),a[1]=Math.round(a[1]));return a},getTargetCoordinate:function(a,b,c){var d=this.normalizeElement(a);a=this.$(d);var e=a.offset(),d=d.ownerDocument,f=this.$(d),e=[e.left-f.scrollLeft(),e.top-f.scrollTop()];c=this.normalizeOffset(c,a);e[0]+=c[0];e[1]+=c[1];!1===b&&(b=d.defaultView||d.parentWindow,b!==this.global&&(b=this.$(b.frameElement).offset(),e[0]+=b.left,e[1]+=b.top));return e},isElementVisible:function(a){return(a=this.normalizeElement(a))?window.SVGElement&&
a instanceof this.global.SVGElement?"none"!==a.style.display&&"hidden"!==a.style.visibility:this.$(a).is(":visible")&&(!a.style||"hidden"!==a.style.visibility):!1},contentLike:function(a,b,c){a=this.normalizeElement(a);this.like(a.innerHTML,b,c)},contentNotLike:function(a,b,c){a=this.normalizeElement(a);this.unlike(a.innerHTML,b,c)},waitForContentLike:function(a,b,c,d,e){var f=Siesta.Resource("Siesta.Test.Element");a=this.normalizeElement(a);return this.waitFor({method:function(){return a.innerHTML.match(b)},
callback:c,scope:d,timeout:e,assertionName:"waitForContentLike",description:" "+f.get("elementContent")+' "'+b+'" '+f.get("toAppear")})},waitForContentNotLike:function(a,b,c,d,e){var f=Siesta.Resource("Siesta.Test.Element");a=this.normalizeElement(a);return this.waitFor({method:function(){return!a.innerHTML.match(b)},callback:c,scope:d,timeout:e,assertionName:"waitForContentNotLike",description:" "+f.get("elementContent")+' "'+b+'" '+f.get("toDisappear")})},monkeyTest:function(a,b,c,d,e){var f=this.global;
a=this.normalizeElement(a,!1,!0);this.suppressPassedWaitForAssertion=!0;"function"===typeof b?(d=b,e=c,c=""):"function"===typeof c&&(d=c,c="");b="number"===typeof b?b:30;var g=a==f.document.body,k=this,l=k.$(a).offset(),m=l.left+k.$(g?f:a).width();a=l.top+k.$(g?f:a).height();for(var n=[],p=Siesta.Resource("Siesta.Test.Element"),r=new Siesta.Util.Queue({deferer:k.originalSetTimeout,deferClearer:k.originalClearTimeout,interval:50,observeTest:this,processor:function(a){if(k.nbrExceptions||k.failed)k.warn(p.get("monkeyActionLog")+
":"+JSON2.stringify(n)),r.abort();else{var b=k.beginAsync(null,function(a){a.fail(p.get("monkeyException"));k.warn(p.get("monkeyActionLog")+":"+JSON.stringify(n));return!0}),c=a.next;a.next=function(){k.endAsync(b);c()};a.action(a)}}}),f=0;f<b;f++)switch(g=[k.randomBetween(l.left,m),k.randomBetween(l.top,a)],this.randomBetween(0,4)){case 0:n.push({click:g});r.addAsyncStep({action:function(a){k.waitForSelector("body",a.next)}});r.addAsyncStep({action:function(a){k.click(a.xy,a.next)},xy:g});break;
case 1:n.push({doubleclick:g});r.addAsyncStep({action:function(a){k.waitForSelector("body",a.next)}});r.addAsyncStep({action:function(a){k.doubleClick(a.xy,a.next)},xy:g});break;case 2:"oncontextmenu"in window?n.push({rightclick:g}):n.push({click:g});r.addAsyncStep({action:function(a){k.waitForSelector("body",a.next)}});r.addAsyncStep({action:function(a){"oncontextmenu"in window?k.rightClick(a.xy,a.next):k.click(a.xy,a.next)},xy:g});break;case 3:var q=[k.randomBetween(l.left,m),k.randomBetween(l.top,
a)];n.push({action:"drag",target:g,to:q});r.addAsyncStep({action:function(a){k.waitForSelector("body",a.next)}});r.addAsyncStep({action:function(a){k.drag(a.dragFrom,a.dragTo,null,a.next)},dragFrom:g,dragTo:q});break;case 4:var u=Math.random().toString(36).substring(7)+"[UP][RIGHT][DOWN][LEFT][ENTER][ESCAPE]";n.push({target:g,click:g});n.push({target:g,type:u});r.addAsyncStep({action:function(a){k.waitForSelector("body",a.next)}});r.addAsyncStep({action:function(a){k.click(a.xy,a.next)},xy:g});r.addAsyncStep({action:function(a){k.type(null,
u,a.next)},xy:g})}var x=!1,w=function(){x=!0;k.nbrExceptions&&k.warn(p.get("monkeyActionLog")+":"+JSON.stringify(n));k.is(k.nbrExceptions,0,c||p.get("monkeyNoExceptions"))};this.on("beforetestfinalizeearly",w);r.run(function(){x||(k.un("beforetestfinalizeearly",w),w());this.suppressPassedWaitForAssertion=!1;k.processCallbackFromTest(d,null,e||k)})},hasCls:function(a,b,c){var d=Siesta.Resource("Siesta.Test.Element");a=this.normalizeElement(a);this.$(a).hasClass(b)?this.pass(c,{descTpl:d.get("elementHasClass")+
...
Class("Siesta.Test.Browser",{isa:Siesta.Test,does:[Siesta.Test.Simulate.Event,Siesta.Test.Simulate.Mouse,Siesta.Test.Simulate.Touch,Siesta.Test.Simulate.Keyboard,Siesta.Test.Element,Siesta.Test.TextSelection],has:{currentPosition:{init:function(){return[0,0]}},forceDOMVisible:!1,isDOMForced:!1,browserInfo:{lazy:function(){return this.parseBrowser(window.navigator.userAgent)}},nextConfirmValue:null,nextPromptReturnValue:null,realAlert:null,realConfirm:null,realPrompt:null,realPrint:null,previousConfirm:null,
previousPrompt:null},after:{cleanup:function(){this.previousPrompt=this.previousConfirm=this.realAlert=this.realConfirm=this.realPrompt=this.realPrint=this._global=null}},methods:{initialize:function(){this.SUPER();var a=function(){};this.on("teststart",function(b){var c=this;b=this.global;c.parent||(c.realAlert=b.alert,c.realConfirm=b.confirm,c.realPrompt=b.prompt,c.realPrint=b.print);c.previousConfirm=b.confirm;c.previousPrompt=b.prompt;b.alert=b.print=a;b.confirm=function(){var a="boolean"===typeof c.nextConfirmValue?
c.nextConfirmValue:!0;c.nextConfirmValue=null;return a};b.prompt=function(){var a=c.nextPromptReturnValue||"";c.nextPromptReturnValue=null;return a}});this.on("beforetestfinalize",function(b){b=this.global;b.alert.__EXPECTED_ALERT__&&this.fail(Siesta.Resource("Siesta.Test.Browser","alertMethodNotCalled"));b.alert=a;this.parent?(b.confirm=this.realConfirm,b.prompt=this.realPrompt):(b.confirm=this.previousConfirm,b.prompt=this.previousPrompt,b.print=this.realPrint,b.alert=this.realAlert)})},$:function(){return $.rebindWindowContext(this.global).apply(this.global,
arguments)},isEventPrevented:function(a){return"Boolean"==this.typeOf(a.$defaultPrevented)?a.$defaultPrevented:"Boolean"==this.typeOf(a.defaultPrevented)?a.defaultPrevented:!1===a.returnValue},cleanupContextBeforeStart:function(){this.cleanupContextBeforeStartDom();this.SUPER()},cleanupContextBeforeStartDom:function(){this.global.document.body.innerHTML=""},getElementPageRect:function(a,b){b=b||this.$(a);var c=b.offset();return new Siesta.Util.Rect({left:c.left,top:c.top,width:b.outerWidth(),height:b.outerHeight()})},
elementHasScroller:function(a,b){b=b||this.$(a);var c=a.scrollWidth!=a.clientWidth&&"visible"!=b.css("overflow-x"),d=a.scrollHeight!=a.clientHeight&&"visible"!=b.css("overflow-y");return c||d?{x:c,y:d}:!1},hasForcedIframe:function(){return Boolean((this.isDOMForced||this.forceDOMVisible)&&this.scopeProvider instanceof Scope.Provider.IFrame&&this.scopeProvider.iframe)},elementIsScrolledOut:function(a,b){for(var c=this.$(a),d=[],e=c,f=this.global.document.body;e=e.parent(),e.length&&e[0]!=f;){var g=
this.elementHasScroller(e[0],e);g&&d.unshift({hasScroller:g,$el:e})}g=this.$(f);e=g.offset();e=new Siesta.Util.Rect({left:e.left+g.scrollLeft(),top:e.top+g.scrollTop(),width:this.$(this.global).width(),height:this.$(this.global).height()});for(f=0;f<d.length;f++){var g=d[f].hasScroller,k=d[f].$el;g&&g.x&&(e=e.cropLeftRight(this.getElementPageRect(k[0],k)));if(e.isEmpty())return!0;g&&g.y&&(e=e.cropTopBottom(this.getElementPageRect(k[0],k)));if(e.isEmpty())return!0}d=this.getElementPageRect(c[0],c);
g=e.intersect(d);if(g.isEmpty())return!0;b=this.normalizeOffset(b,c);return!g.contains(d.left+b[0],d.top+b[1])},scrollTargetIntoView:function(a,b){if("Array"!=this.typeOf(a)){a=this.normalizeElement(a,!0,null,!1);var c=this.isOffsetInsideElementBox(a,b);a&&(this.isElementVisible(a)&&c&&this.elementIsScrolledOut(a,b))&&(a.scrollIntoView(),this.$(a).scrollintoview({duration:0}))}},processSubTestConfig:function(){var a=this.SUPERARG(arguments),b=this;Joose.A.each("currentPosition actionDelay afterActionDelay dragDelay moveCursorBetweenPoints dragPrecision overEls realAlert realConfirm realPrompt realPrint".split(" "),
...
b){return this.normalizeElement(a,b)},getPathBetweenPoints:function(a,b){if("number"!==typeof a[0]||"number"!==typeof a[1]||"number"!==typeof b[0]||"number"!==typeof b[1]||isNaN(a[0])||isNaN(a[1])||isNaN(b[0])||isNaN(b[1]))throw"Incorrect arguments passed to getPathBetweenPoints";var c=[],d=Math.floor(a[0]),e=Math.floor(b[0]),f=Math.floor(a[1]),g=Math.floor(b[1]),k=Math.abs(e-d),l=Math.abs(g-f),m,n,p,r;m=d<e?1:-1;n=f<g?1:-1;for(p=k-l;d!==e||f!==g;)r=2*p,r>-l&&(p-=l,d+=m),r<k&&(p+=k,f+=n),c.push([d,
f]);d=c[c.length-1];0<c.length&&(d[0]!==b[0]||d[1]!==b[1])&&c.push(b.slice());return c},randomBetween:function(a,b){return Math.round(a+Math.random()*(b-a))},valueIsArray:function(a){return"Array"==this.typeOf(a)},elementFromPoint:function(a,b,c,d,e){var f=this.global.document,g=f.elementFromPoint(a,b);g||(g=f.elementFromPoint(a,b));g=g||d||f.body;d=a;f=b;if("IFRAME"==g.nodeName.toUpperCase()&&!c)try{var k=g.contentWindow.document,l=this.$(g).offset();d=a-l.left;var f=b-l.top,m=k.elementFromPoint(d,
f);m||(m=k.elementFromPoint(d,f));m=m||k.body;"HTML"===m.nodeName.toUpperCase()&&(m=k.body);g=m}catch(n){d=a,f=b}return e?{el:g,localXY:[d,f],globalXY:[a,b]}:g},activeElement:function(a,b,c){c=c?c.ownerDocument||c:this.global.document;var d=c.activeElement;if($(d).is("iframe")&&d.contentDocument&&d.contentDocument.body)d=d.contentDocument.activeElement;else if(!d||!d.nodeName||!d.tagName||d===c.body&&a)d=b;return d},getElementAtCursor:function(){var a=this.currentPosition;return this.elementFromPoint(a[0],
a[1])},waitForEvent:function(a,b,c,d,e){var f=!1,g=Siesta.Resource("Siesta.Test.Browser");this.addListenerToObservable(a,b,function(){f=!0});return this.waitFor({method:function(){return f},callback:c,scope:d,timeout:e,assertionName:"waitForEvent",description:" "+g.get("waitForEvent")+' "'+b+'" '+g.get("event")})},addListenerToObservable:function(a,b,c,d){this.$(a).bind(b,c)},removeListenerFromObservable:function(a,b,c){this.$(a).unbind(b,c)},firesOk:function(a,b,c,d,e,f,g){var k=this,l=k.getSourceLine(),
m=Siesta.Resource("Siesta.Test.Browser"),n=arguments.length,p;if(1==n)p=a.observable,b=a.events,n=a.during,f=a.desc||a.description,g=a.callback,d="Number"==this.typeOf(n)?n:null,e="Function"==this.typeOf(n)?n:null;else if(5<=n)p=a,"String"==this.typeOf(b)&&(n={},n[b]=c,b=n);else if(3>=n&&"Object"==this.typeOf(b))p=a,f=c;else if(4>=n&&"String"==this.typeOf(b))p=a,n={},n[b]=c,b=n,f=d,d=null;else throw Error(m.get("unrecognizedSignature"));var r={},q={};Joose.O.each(b,function(a,b){r[b]=0;var c=q[b]=
function(){r[b]++};k.addListenerToObservable(p,b,c)});var u=function(){Joose.O.each(b,function(a,b){k.removeListenerFromObservable(p,b,q[b]);var c=r[b];k.verifyExpectedNumber(c,a)?k.pass(f,{descTpl:m.get("observableFired")+" "+c+" `"+b+"` "+m.get("events")}):k.fail(f,{assertionName:"firesOk",sourceLine:l,descTpl:m.get("observableFiredOk")+" `"+b+"` "+m.get("events"),got:c,gotDesc:m.get("actualNbrEvents"),need:a,needDesc:m.get("expectedNbrEvents")})})};if(d){var x=this.beginAsync(d+100),n=this.originalSetTimeout;
n(function(){k.endAsync(x);u();k.processCallbackFromTest(g)},d)}else if(e)e(),u(),k.processCallbackFromTest(g);else this.on("beforetestfinalizeearly",u)},willFireNTimes:function(a,b,c,d,e){this.firesOk(a,b,e?">="+c:c,d)},getObjectWithExpectedEvents:function(a,b){var c={};"Array"==this.typeOf(a)?Joose.A.each(a,function(a){c[a]=b}):c[a]=b;return c},wontFire:function(a,b,c){this.firesOk({observable:a,events:this.getObjectWithExpectedEvents(b,0),desc:c})},firesOnce:function(a,b,c){this.firesOk({observable:a,
events:this.getObjectWithExpectedEvents(b,1),desc:c})},isntFired:function(){this.wontFire.apply(this,arguments)},firesAtLeastNTimes:function(a,b,c,d){this.firesOk(a,b,">="+c,d)},isFiredWithSignature:function(a,b,c,d){var e,f=this,g=f.getSourceLine(),k=Siesta.Resource("Siesta.Test.ExtJS.Observable"),l=function(){f.removeListenerFromObservable(a,b,m);e||f.fail(b+" "+k.get("isFiredWithSignatureNotFired"))};f.on("beforetestfinalizeearly",l);var m=function(){f.un("beforetestfinalizeearly",l);var n=c.apply(f,
arguments);!e&&n&&f.pass(d||k.get("observableFired")+" "+b+" "+k.get("correctSignature"),{sourceLine:g});n||(f.fail(d||k.get("observableFired")+" "+b+" "+k.get("incorrectSignature"),{sourceLine:g}),f.removeListenerFromObservable(a,b,m));e=!0};f.addListenerToObservable(a,b,m)},getNormalizedTopElementInfo:function(a,b,c,d){var e,f;a=a||this.currentPosition;var g="Array"==this.typeOf(a);g?(f=a,e=this.elementFromPoint(a[0],a[1],!1,null,!0),a=e.el,e=e.localXY):a=this.normalizeElement(a,b);if(a||!b){if(!g){var k=
Siesta.Resource("Siesta.Test.Browser");c="getNormalizedTopElementInfo: "+(c?k.get("targetElementOfAction")+" ["+c+"]":k.get("targetElementOfSomeAction"))+" "+k.get("isNotVisible")+": "+(a.id?"#"+a.id:a);if(this.isElementVisible(a))b||(!this.isOffsetInsideElementBox(a,d)||this.elementIsTop(a,!0,d))||this.warn(c);else{this.fail(c);return}}if(!g&&(b=a.ownerDocument,k=Siesta.Resource("Siesta.Test.Browser"),e=this.getTargetCoordinate(a,!0,d),f=this.getTargetCoordinate(a,!1,d),a=b.elementFromPoint(e[0],
e[1])||b.elementFromPoint(e[0],e[1])||b.body,!a)){this.fail("getNormalizedTopElementInfo: "+k.get("noElementFound")+" ["+e+"]");return}return{el:a,localXY:e,globalXY:f,offset:this.getOffsetRelativeToEl(a,e)}}},getOffsetRelativeToEl:function(a,b){var c=this.getElementPageRect(a);return[b[0]-c.left,b[1]-c.top]},waitForTextPresent:function(a,b,c,d){var e=Siesta.Resource("Siesta.Test.Browser");return this.waitFor({method:function(){var b=this.global.document.body,c=":contains("+a+")";return 0<this.$(c,
b).length||this.$(b).is(c)},callback:b,scope:c,timeout:d,assertionName:"waitForTextPresent",description:" "+e.get("text")+' "'+a+'" '+e.get("toBePresent")})},waitForTextNotPresent:function(a,b,c,d){var e=Siesta.Resource("Siesta.Test.Browser");return this.waitFor({method:function(){var b=this.global.document.body,c=":contains("+a+")";return 0===this.$(c,b).length&&!this.$(b).is(c)},callback:b,scope:c,timeout:d,assertionName:"waitForTextNotPresent",description:" "+e.get("text")+' "'+a+'" '+e.get("toNotBePresent")})},
waitForTarget:function(a,b,c,d,e){var f=this,g=Siesta.Resource("Siesta.Test.Browser");return this.waitFor({method:function(){var b=f.normalizeElement(a,!0,!0,!1,{offset:e});return b&&e&&f.isElementVisible(b)&&!f.isOffsetInsideElementBox(b,e)?!0:b&&f.elementIsTop(b,!0,e)},callback:b,scope:c,timeout:d,assertionName:"waitForTarget",description:" "+g.get("target")+' "'+a+'" '+g.get("toAppear")})},setWindowSize:function(a,b){this.scopeProvider.setViewportSize(a,b)},parseBrowser:function(a){var b="unknown",
c="",d;if(d=/Firefox\/((?:\d+\.?)+)/.exec(a))b="Firefox",c=d[1];if(d=/Chrome\/((?:\d+\.?)+)/.exec(a))b="Chrome",c=d[1];if(d=/MSIE\s*((?:\d+\.?)+)/.exec(a))b="IE",c=d[1];a.match(/trident/i)&&(d=/rv.(\d\d\.?\d?)/.exec(a))&&(b="IE",c=d[1]);if(d=/Apple.*Version\/((?:\d+\.?)+)\s*(?=Safari\/((?:\d+\.?)+))/.exec(a))b="Safari",c=d[1]+" ("+d[2]+")";return{name:b,version:c}},getJUnitClass:function(){var a=this.getBrowserInfo(),a=a.name+a.version;return a+":"+this.SUPER()},adjustScope:function(a){if("String"==
this.typeOf(a)&&(a=a.split("->"),2===a.length)){a=this.$(this.trimString(a[0]))[0];if(!a||!a.contentWindow)return!1;this._global=this.global;this.global=a.contentWindow;return!0}return!1},resetScope:function(){this.global=this._global||this.global;this._global=null},screenshot:function(a,b){this.diag("Command: `screenshot` skipped - not running in Standard Package");this.processCallbackFromTest(b,[!1],this)},expectAlertMessage:function(a,b){var c=this,d=this.global,e=d.alert;d.alert=function(b){("RegExp"==
...
null,this)},waitForAnimations:function(a){a.call(this)}}});
...
(a=b[1]);return!1}),b=b.parent;return a},getNumberOfGlobalExtOverrides:function(a){var b=this.globalExtOverrides;if(null!=b)a&&a.call(this,b.length,b);else{var c=this,d=this.getExt();if(b=c.getExtBundlePath()){this.expectGlobal("0");var e=d.core.DomHelper.append(d.getBody(),{tag:"iframe",style:"width:0;height:0"},!1),f=e.contentWindow;f.document.open();f.document.write('<html><head><script type="text/javascript" src="'+b+'">\x3c/script></head><body></body></html>');f.document.close();var g=function(a,
b){for(var c=b.split("."),d=a,e=0;e<c.length;e++)d=d[c[e]];return d},k=function(a,b,c){var e=[],f;for(f in b)try{b.hasOwnProperty(f)&&(!a.hasOwnProperty(f)&&"undefined"==typeof a[f]||"function"==typeof b[f]&&a[f].toString()!==b[f].toString()||d.isPrimitive(b[f])&&b[f].toString()!==a[f].toString())&&((c+"."+f).match(/Ext\.data\.Store\.ImplicitModel|collectorThreadId|Ext\.dom\.GarbageCollector\.lastTime/)||e.push(c+"."+f))}catch(g){}return e};c.waitFor(function(){return f.Ext&&f.Ext.isReady},function(){var b=
c.global,m=[];d.iterate(d.ClassManager.classes,function(a){if(a.match(/^Ext\./)){var c=g(f,a),d=g(b,a);if(c&&"undefined"!==typeof d){var e=k(c,d,a);m.push.apply(m,e);d.prototype&&(a=k(c.prototype,d.prototype,a+".prototype"),m.push.apply(m,a))}}});c.globalExtOverrides=m;d.destroy(e);a&&a.call(c,m.length,m)})}else c.fail(Siesta.Resource("Siesta.Test.ExtJS","bundleUrlNotFound")),a&&a.call(c,null,null)}},assertNoGlobalExtOverrides:function(a,b){this.getNumberOfGlobalExtOverrides(function(c,d){var e=Siesta.Resource("Siesta.Test.ExtJS");
null==c?this.fail(e.get("assertNoGlobalExtOverridesInvalid")):(c?this.fail(a,{assertionName:"assertNoGlobalExtOverrides",descTpl:e.get("assertNoGlobalExtOverridesPassTpl"),got:c,gotDesc:e.get("assertNoGlobalExtOverridesGotDesc"),annotation:e.get("foundOverridesFor")+": `"+d.join("`, `")+"`"}):this.pass(a,{descTpl:e.get("assertNoGlobalExtOverridesPassTpl")}),b&&b.call(this))})},assertMaxNumberOfGlobalExtOverrides:function(a,b,c){var d=Siesta.Resource("Siesta.Test.ExtJS");this.getNumberOfGlobalExtOverrides(function(e,
f){null==e?this.fail(d.get("extOverridesInvalid")):(e>a?this.fail(b,{assertionName:"assertNoGlobalExtOverrides",descTpl:d.get("foundLessOrEqualThan")+" "+a+" "+d.get("globalOverrides"),got:e,gotDesc:d.get("nbrOverridesFound"),annotation:d.get("foundOverridesFor")+": `"+f.join("`, `")+"`"}):this.pass(b,{descTpl:d.get("foundLessOrEqualThan")+" "+a+" "+d.get("globalOverrides"),annotation:d.get("nbrOverridesFound")+": "+e}),c&&c.call(this))})},getTotalLayoutCounter:function(){var a=0;this.Ext().each(this.cq("container"),
function(b){a+=b.layoutCounter});return a},assertNoLayoutTriggered:function(a,b,c){var d=this.getTotalLayoutCounter();a.call(b||this);this.is(this.getTotalLayoutCounter(),d,c)},areAnimationsRunning:function(){var a=this.Ext();return a&&a.fx&&a.fx.Manager.items&&0<a.fx.Manager.items.getCount()}}});
...
Class("Siesta.Harness.Browser",{my:{isa:Siesta.Harness,has:{id:null,testClass:Siesta.Test.Browser,viewportClass:"Siesta.Harness.Browser.UI.Viewport",viewport:null,autoRun:!1,viewDOM:!1,speedRun:!0,breakOnFail:!1,debuggerOnFail:!1,contentManagerClass:Siesta.Content.Manager.Browser,scopeProvider:"Scope.Provider.IFrame",disableCaching:!1,baseUrl:window.location.href.replace(/\?.*$/,"").replace(/\/[^/]*$/,"/"),baseHost:window.location.host,baseProtocol:window.location.protocol,forceDOMVisible:$.browser.msie,
runInPopup:!1,hostPageUrl:null,useStrictMode:!0,innerHtmlHead:null,innerHtmlBody:null,sandbox:!0,sandboxBoundaryByGroup:!1,sandboxCleanup:!0,uniqueCounter:0,valueToHashIndicies:Joose.I.Object,sandboxHashStructure:{lazy:"this.buildSandboxHashStructure"},runCore:"parallel",forcedRunCore:null,simulateEventsWith:{is:"rw",init:"dispatchEvent"},testOfForcedIFrame:null,autoScrollElementsIntoView:!0,enableUnreachableClickWarning:!0,maintainViewportSize:!0,viewportWidth:1024,viewportHeight:768,recorderConfig:null,
needUI:!0,isAutomated:!1,stateful:!0,uiMask:null,uiMaskActive:!1,hostPageUrlStopsInheriting:function(){return{preload:!0,innerHtmlHead:!0,innerHtmlBody:!0}},rerunHotKey:"E"},after:{onBeforeScopePreload:function(a,b){if(this.viewport)this.viewport.onBeforeScopePreload(a,b)},onTestSuiteStart:function(a,b){if(this.viewport)this.viewport.onTestSuiteStart(a,b)},onTestSuiteEnd:function(a,b){if(this.viewport)this.viewport.onTestSuiteEnd(a,b);delete this.testOfForcedIFrame;this.uiMaskActive&&this.hideUiMask()},
onTestStart:function(a){if(this.viewport)this.viewport.onTestStart(a);a.hasForcedIframe()?(this.testOfForcedIFrame&&this.hideForcedIFrame(this.testOfForcedIFrame),this.showForcedIFrame(a),this.testOfForcedIFrame=a):this.uiMaskActive&&this.hideUiMask()},onTestUpdate:function(a,b,c){if(this.viewport)this.viewport.onTestUpdate(a,b,c);b instanceof Siesta.Result.Diagnostic&&b.isWarning&&this.needUI&&"undefined"!=typeof console&&console.warn&&console.warn(b+"")},onTestEnd:function(a){a.hasForcedIframe()&&
this.hideForcedIFrame(a);a==this.testOfForcedIFrame&&(this.testOfForcedIFrame=null);if(this.viewport)this.viewport.onTestEnd(a);if(a=a.scopeProvider.wrapper)a.scrollLeft=a.scrollTop=0;document.body.scrollLeft=document.body.scrollTop=0},onTestFail:function(a,b,c){if(this.viewport)this.viewport.onTestFail(a,b,c)}},methods:{buildSandboxHashStructure:function(){return["preload","alsoPreload","hostPageUrl","useStrictMode","overrideSetTimeout"]},createViewport:function(a){return Ext.create("Siesta.Harness.Browser.UI.Viewport",
a)},canShowCursorForTest:function(a){return a.scopeProvider instanceof Scope.Provider.IFrame?this.testOfForcedIFrame?this.testOfForcedIFrame.isFromTheSameGeneration(a):Boolean(a.scopeProvider.wrapper):!1},configure:function(){this.SUPERARG(arguments);this.id=this.title||window.location.href},start:function(){$.browser.opera&&(this.autoCheckGlobals=!1);$.browser.msie&&"9.0"!==$.browser.version&&!this.hasOwnProperty("runCore")&&(this.runCore="sequential");this.SUPERARG(arguments)},launch:function(){var a=
this,b=arguments,c=this.SUPER;if(this.needUI&&!this.viewport){var d=function(){a.viewport=a.createViewport({title:a.title,harness:a});a.isAutomated&&c.apply(a,b)};if(Ext.setup)Ext.setup({onReady:d});else Ext.onReady(d)}else this.SUPERARG(arguments)},populateCleanScopeGlobals:function(a,b){$.browser.msie&&9>Number(/^(\d+)/.exec($.browser.version)[1])?(this.disableGlobalsCheck=!0,b()):this.SUPER("Scope.Provider.IFrame",b)},onUnload:function(){Joose.O.each(this.scopesByURL,function(a,b){a instanceof
Scope.Provider.Window&&a.cleanup()})},setup:function(a){var b=this,c=this.SUPER;window.onunload=function(){b.onUnload()};window.focus();if(this.isAutomated)$(function(){Siesta.Harness.Browser.FeatureSupport();c.call(b,a)});else Ext.onReady(function(){Siesta.Harness.Browser.FeatureSupport();c.call(b,a)})},getDescriptorConfig:function(a,b,c){if(!(b in this.hostPageUrlStopsInheriting))return this.SUPERARG(arguments);var d=a.testConfig,d=d&&d.hasOwnProperty(b)||a.hasOwnProperty(b),e=this.lookUpValueInDescriptorTree(a,
b);if(Boolean(this.getDescriptorConfig(a,"hostPageUrl",!0))&&"inherit"!=e)return d?e:[];do{if((e=(d=a.testConfig)&&d.hasOwnProperty(b))||a.hasOwnProperty(b))if(d=e?d[b]:a[b],"inherit"!=d)return d;a=a.parent}while(a&&a!=this);return c?void 0:this[b]},normalizeScopeProvider:function(a){this.SUPERARG(arguments);this.getDescriptorConfig(a,"runInPopup")&&(a.scopeProvider="Scope.Provider.Window")},getScopeProviderConfigFor:function(a,b){var c=this.SUPERARG(arguments);c.name=a.title||a.url.replace(/(.*\/)?(.*)/,
"$2");c.cls="tr-iframe";c.performWrap=!0;c.wrapCls="tr-iframe-wrapper";c.sourceURL=c.sourceURL||this.getDescriptorConfig(a,"hostPageUrl");c.minViewportSize=c.minViewportSize||{width:this.getDescriptorConfig(a,"viewportWidth"),height:this.getDescriptorConfig(a,"viewportHeight")};c.innerHtmlHead=this.getDescriptorConfig(a,"innerHtmlHead");c.innerHtmlBody=this.getDescriptorConfig(a,"innerHtmlBody");c.hasOwnProperty("useStrictMode")||(c.useStrictMode=this.getDescriptorConfig(a,"useStrictMode"));return c},
getNewTestConfiguration:function(a,b,c,d){var e=this.SUPERARG(arguments);this.getDescriptorConfig(a,"speedRun")&&Joose.O.extend(e,{actionDelay:1,dragPrecision:20,dragDelay:10});this.hasOwnProperty("simulateEventsWith")&&(e.simulateEventsWith=this.simulateEventsWith);e.forceDOMVisible=this.getDescriptorConfig(a,"forceDOMVisible");e.autoScrollElementsIntoView=this.getDescriptorConfig(a,"autoScrollElementsIntoView");e.enableUnreachableClickWarning=this.getDescriptorConfig(a,"enableUnreachableClickWarning");
return e},assignUniqueTag:function(a,b){if(null==a)return"";if(a===Object(a))return a.__UNIQUE__?a.__UNIQUE__:a.__UNIQUE__=(this.uniqueCounter++).toString(36);a+="";var c=this.valueToHashIndicies[b];c||(c=this.valueToHashIndicies[b]={});return c[a]?c[a]:c[a]=(this.uniqueCounter++).toString(36)},calculateSharedContextGroupHash:function(a){var b=this,c=this.getSandboxHashStructure(),d="";Joose.A.each(c,function(c){d+=b.assignUniqueTag(b.getDescriptorConfig(a,c),c)});this.sandboxBoundaryByGroup&&(d+=
this.assignUniqueTag(a.parent));return d},runCoreGeneral:function(a,b,c,d){var e=this,f=[],g=[],k=[],l={},m=this.forcedRunCore;Joose.A.each(a,function(a){if(e.getDescriptorConfig(a,"sandbox"))"sequential"==(m||e.getDescriptorConfig(a,"runCore"))||e.getDescriptorConfig(a,"forceDOMVisible")?g.push(a):f.push(a);else{var b=e.calculateSharedContextGroupHash(a),c=l[b];c||(c=l[b]={groupHash:b,items:[]},k.push(c));c.items.push(a)}});e.runCoreSharedContext(k,b,c,function(){e.runCoreParallel(f,b,c,function(){e.runCoreSequential(g,
b,c,d)})})},runCoreSharedContext:function(a,b,c,d){var e=this,f=function(d,l,m){if(d.length){var n=d.shift(),p=0<d.length;l?e.processURL(n,n.index,b,c,function(){f(d,!1,e.scopesByURL[n.url])},p):e.processUrlShared(n,n.index,b,c,function(){f(d,!1,m)},p,m)}else g(a)},g=function(a){a.length?(a=a.shift(),f(a.items,!0)):d()};g(a)},processUrlShared:function(a,b,c,d,e,f,g){function k(){if(g.scope){var b=l.getDescriptorConfig(a,"testClass");"String"==l.typeOf(b)&&(b=Joose.S.strToClass(b));var k=l.getNewTestConfiguration(a,
g,c,d);m.test=new b(k);l.launchTest({testHolder:m,desc:a,scopeProvider:g,contentManager:c,launchOptions:d,preloadErrors:n,onErrorHandler:p,startTestAnchor:g.scope.StartTest,noCleanup:f,reusingSandbox:!0},e)}else e()}var l=this;if(a.isMissing)e();else{var m={},n=[];b=this.getDescriptorConfig(a,"transparentEx");var p=function(a,b,c,d,e){(d=m.test)&&d.isStarted()?(d.nbrExceptions++,d.failWithException(e||a+" "+b+" "+c)):n.push(a+" "+b+" "+c)};g.addOnErrorHandler(p,!b);a.testCode||this.cachePreload&&
c.hasContentOf(a.url)?g.runCode(a.testCode||c.getContentOf(a.url),k):g.runScript(this.resolveURL(a.url,g,a),k)}},normalizeURL:function(a){/^jsan:/.test(a)&&(a="/jsan/"+a.replace(/^jsan:/,"").replace(/\./g,"/")+".js");/\.js$/.test(a)||(/\//.test(a)||/\.css(\?.*)?$/i.test(a))||(a="../lib/"+a.replace(/\./g,"/")+".js");return a},normalizeDescriptor:function(a,b,c,d){a=this.SUPERARG(arguments);!a.group&&a.jasmine&&(a.hostPageUrl=a.url,a.testCode=this.getJasmineTestCode(),a.preload=[]);return a},resolveURL:function(a,
...
hideForcedIFrame:function(a){$.rebindWindowContext(window);a.isDOMForced=!1;var b=a.scopeProvider.wrapper;$(b).removeClass("tr-iframe-forced");$(b).addClass("tr-iframe-hidden");a.fireEvent("testframehide")},showForcedIFrameScreenshot:function(a){this.showUiMask();$.rebindWindowContext(window);var b=a.scopeProvider.wrapper;$(b).addClass("tr-iframe-forced-screenshot");$(b).removeClass("tr-iframe-forced");$(b).removeClass("tr-iframe-hidden");a.fireEvent("testframeshow")},hideForcedIFrameScreenshot:function(a){this.hideUiMask();
$.rebindWindowContext(window);var b=a.scopeProvider.wrapper;$(b).removeClass("tr-iframe-forced-screenshot");a.isDOMForced&&($(b).addClass("tr-iframe-forced"),$(b).center());a.fireEvent("testframehide")},getQueryParam:function(a){return(a=RegExp("(?:\\?|&)"+a+"=(.*?)(?:\\?|&|$)","i").exec(window.location.search))?a[1]:null},getJasmineTestCode:function(){return";("+function(){StartTest(function(a){a.expectGlobals("getJasmineRequireObj","jasmineRequire","jasmine","xdescribe","describe","xdescribe","fdescribe",
"it","xit","fit","spyOn","fail","jsApiReporter","beforeEach","afterEach","beforeAll","afterAll","expect","pending");window.jasmine?jasmine.SiestaReporter?jasmine.SiestaReporter.importResults(a):a.fail(a.resource("Siesta.Harness.Browser","noJasmineSiestaReporter")):a.fail(a.resource("Siesta.Harness.Browser","noJasmine"))})}.toString()+")();"},isStandardPackage:function(){return Boolean(Siesta.Harness.Browser.Automation)}}}});
...
this.getExt();if(b){var c=b.getBody().select("iframe");a=a?"on":"un";b.getBody()[a]("mousemove",this.onMouseMove,{me:this},{buffer:30});for(b=0;b<c.getCount();b++){var d=c.item(b).dom.contentWindow.Ext;d&&d.getBody&&d.getBody()[a]("mousemove",this.onMouseMove,{me:this},{buffer:30})}}},onInspectionClick:function(a,b){if(this.boxIndicatorEl){var c=this.me;c.toggleMouseMoveListener(!1);c.inspectedComponent&&c.findComponentByTarget(b)===c.inspectedComponent?c.fireEvent("targetselected",c,c.inspectedComponent,
...
function(b,c){a.focus(!0)});a.on({keyup:function(b,c){var d=a.dom.value;if(b.getKey()===b.ENTER&&d){var e=this.getIFrame();try{var f=e.contentWindow.eval(d);window.console&&console.log(f)}catch(g){window.console&&console.log(g.message)}}},scope:this})},setCanManageDOM:function(a){(this.canManageDOM=a)&&!this.hidden&&this.alignIFrame()},getIFrameWrapper:function(){var a=this.test;return a?this.canManageDOM&&a.scopeProvider&&a.scopeProvider.wrapper||null:null},getIFrame:function(){var a=this.test;return a?
...
this.onTestFinished,this)))},onTestFrameHide:function(a){this.cleanupCursor();this.reset()},cleanupCursor:function(a,b){a=a||this.cursorEl;if(b=b||this.currentContainer){try{Ext.fly(a).remove()}catch(c){}try{Ext.select(".ghost-cursor-click-indicator",!1,b).remove()}catch(d){}}},onTestFinished:function(a,b){if(!(0<Ext.ComponentQuery.query("recorderpanel{isVisible()}").length)){var c=this.cursorEl,d=this.currentContainer;this.reset();if(c){var e=this;c.addCls("ghost-cursor-hidden");setTimeout(function(){e.cleanupCursor(c,
d)},2E3)}}},onEventSimulated:function(a,b,c,d,e){d.match(/touch|mouse|click|contextmenu/)&&(Ext.isNumber(e.clientX)&&Ext.isNumber(e.clientY))&&this.currentContainer&&(a=b.currentPosition[0],b=b.currentPosition[1],this.updateGhostCursor(d,a,b),this.supportsTransitions&&d in this.clickEvents&&this.showClickIndicator(d,a,b))},showClickIndicator:function(a,b,c){var d=Ext.fly(this.currentContainer).createChild({cls:"ghost-cursor-click-indicator ",style:"left:"+b+"px;top:"+c+"px"});setTimeout(function(){d.addCls("ghost-cursor-click-indicator-big")},
5)},updateGhostCursor:function(a,b,c){var d=this.getCursorEl();b="translate3d("+(b-5)+"px, "+c+"px, 0px)";d.setStyle({"-webkit-transform":b,"-moz-transform":b,"-o-transform":b,transform:b});switch(a){case "touchstart":case "mousedown":d.addCls("ghost-cursor-press");break;case "dblclick":d.addCls("ghost-cursor-press");Ext.Function.defer(d.removeCls,40,d,["ghost-cursor-press"]);break;case "touchend":case "mouseup":case "click":d.removeCls("ghost-cursor-press")}}}),Ext.define("Siesta.Harness.Browser.UI.AssertionGrid",
{alias:"widget.assertiongrid",extend:"Ext.tree.Panel",mixins:["Siesta.Harness.Browser.UI.CanFillAssertionsStore"],cls:"siesta-assertion-grid",enableColumnHide:!1,enableColumnMove:!1,enableColumnResize:!1,sortableColumns:!1,border:!1,minWidth:100,trackMouseOver:!1,autoScrollToBottom:!0,hideHeaders:!0,rowLines:!1,isStandalone:!1,rootVisible:!1,collapseDirection:"left",test:null,testListeners:null,viewType:"filterabletreeview",lines:!1,disableSelection:!0,bufferedRenderer:!1,initComponent:function(){this.testListeners=
[];this.store||(this.store=new Siesta.Harness.Browser.Model.AssertionTreeStore({proxy:"memory",root:{id:"__ROOT__",expanded:!0,loaded:!0}}));Ext.apply(this,{columns:[{xtype:"assertiontreecolumn"}],viewConfig:{enableTextSelection:!0,stripeRows:!1,markDirty:!1,animate:!1,trackOver:!1,store:new Ext.data.Store({fields:[],data:[]}),deferInitialRefresh:!1,getRowClass:this.getRowClass}});this.callParent(arguments);this.getView().on("itemadd",this.onMyItemAdd,this)},onMyItemAdd:function(a){!this.test.isFinished()&&
this.autoScrollToBottom&&this.ensureVisible(a[0])},getRowClass:function(a,b,c,d){b=a.getResult();c="";switch(b.meta.name){case "Siesta.Result.Diagnostic":return"tr-diagnostic-row "+(b.isWarning?"tr-warning-row":"");case "Siesta.Result.Summary":return"tr-summary-row "+(b.isFailed?" tr-summary-failure":"");case "Siesta.Result.SubTest":return c="tr-subtest-row tr-subtest-row-"+a.get("folderStatus"),"describe"==b.test.specType&&(c+=" tr-subtest-row-describe"),"it"==b.test.specType&&(c+=" tr-subtest-row-it"),
c;case "Siesta.Result.Assertion":return c+="tr-assertion-row ",c=b.isWaitFor?c+("tr-waiting-row "+(b.completed?b.passed?"tr-waiting-row-passed":"tr-assertion-row-failed tr-waiting-row-failed":"")):b.isException?c+(b.isTodo?"tr-exception-todo-row":"tr-exception-row"):b.isTodo?c+(b.passed?"tr-todo-row-passed":"tr-todo-row-failed"):c+(b.passed?"tr-assertion-row-passed":"tr-assertion-row-failed");default:throw"Unknown result class";}},showTest:function(a,b){this.test&&(Joose.A.each(this.testListeners,
function(a){a.remove()}),this.testListeners=[]);this.test=a;this.testListeners=[].concat(this.isStandalone?[a.on("testupdate",this.onTestUpdate,this),a.on("testendbubbling",this.onEveryTestEnd,this),a.on("assertiondiscard",this.onAssertionDiscarded,this)]:[]);Ext.suspendLayouts();b?this.reconfigure(b):this.store.removeAll();Ext.resumeLayouts()},onTestUpdate:function(a,b,c,d){this.processNewResult(this.store,b,c,d)},onEveryTestEnd:function(a,b){this.processEveryTestEnd(this.store,b)},onAssertionDiscarded:function(a,
b,c){this.store.getNodeById(c.id).remove()},bindStore:function(a,b,c){this.callParent(arguments);(this.store=a)&&a.nodeStore&&(this.getView().dataSource=a.nodeStore,this.getView().bindStore(a,b,c))},destroy:function(){Joose.A.each(this.testListeners,function(a){a.remove()});this.testListeners=[];this.test=null;this.callParent(arguments)},setInitializing:function(a){a?this.getView().addCls("siesta-test-initializing"):this.getView().removeCls("siesta-test-initializing")}}),Ext.define("Siesta.Harness.Browser.UI.AssertionTreeColumn",
{extend:"Ext.tree.Column",alias:"widget.assertiontreecolumn",imgWithOffsetText:'<img src="{1}" class="{0}" style="left:{2}px" />',tdCls:"tr-tree-column",resultTpl:null,dataIndex:"folderStatus",flex:1,menuDisabled:!0,sortable:!1,descriptionTpl:'<span class="assertion-text">{text}</span>',initComponent:function(){this.descriptionTpl=this.descriptionTpl instanceof Ext.XTemplate?this.descriptionTpl:new Ext.XTemplate(this.descriptionTpl);Ext.apply(this,{scope:this});this.callParent(arguments)},renderer:function(a,
b,c,d,e,f){b="";b=c.data.result;a=b.annotation;if(b instanceof Siesta.Result.Summary)return c.data.result.description.join("<br>");b=this.descriptionTpl.apply({text:Ext.String.htmlEncode(b.isWarning?"WARN: "+b.description:b.description)});a&&(b+='<pre title="'+a.replace(/"/g,"'")+'" style="margin-left:'+16*c.data.depth+'px" class="tr-assert-row-annontation">'+Ext.String.htmlEncode(a)+"</pre>");return b},_treeRenderer:function(a,b,c,d,e,f,g){for(var k=[],l=Ext.String.format,m=c.getDepth(),n=this.treePrefix,
p=this.elbowPrefix,r=this.expanderCls,q=this.imgText,u=this.checkboxText,x=this.origRenderer.apply(this.origScope,arguments),w=Ext.BLANK_IMAGE_URL,v=c.get("href"),y=c.get("hrefTarget"),D=c.get("cls");c;){if(!c.isRoot()||c.isRoot()&&g.rootVisible)c.getDepth()===m?(k.unshift(l(q,n+"icon "+n+"icon"+(c.get("icon")?"-inline ":c.isLeaf()?"-leaf ":"-parent ")+(c.get("iconCls")||""),c.get("icon")||w)),null!==c.get("checked")&&(k.unshift(l(u,n+"checkbox"+(c.get("checked")?" "+n+"checkbox-checked":""),c.get("checked")?
'aria-checked="true"':"")),c.get("checked")&&(b.tdCls+=" "+n+"checked")),c.isLast()?c.isExpandable()?k.unshift(l(q,p+"end-plus "+r,w)):k.unshift(l(q,p+"end",w)):c.isExpandable()?k.unshift(l(q,p+"plus "+r,w)):(k.unshift(l(q,n+"elbow",w)),k.unshift(l(this.imgWithOffsetText,n+"elbow-line tr-elbow-line",w,16*(c.getDepth()-1))))):c.isLast()||0===c.getDepth()?k.unshift(l(q,p+"empty",w)):0!==c.getDepth()&&(k.unshift(l(q,p+"line",w)),k.unshift(l(q,p+"line tr-elbow-line",w)));c=c.parentNode}v?k.push('<a href="',
v,'" target="',y,'">',x,"</a>"):k.push(x);D&&(b.tdCls+=" "+D);return k.join("")}}),Ext.define("Siesta.Harness.Browser.UI.TestNameColumn",{extend:"Ext.tree.Column",xtype:"testnamecolumn",sortable:!1,dataIndex:"title",menuDisabled:!0,flex:1,tdCls:"test-name-cell",scope:this,filterGroups:null,store:null,initComponent:function(){var a=Siesta.Resource("Siesta.Harness.Browser.UI.TestGrid");Ext.apply(this,{items:[{xtype:"treefilter",emptyText:a.get("filterTestsText"),margins:"0 0 0 10",itemId:"trigger",
filterGroups:this.filterGroups,filterField:"title",store:this.store,tipText:a.get("filterFieldTooltip")}]});this.callParent(arguments)},renderer:function(a,b,c){var d="",e="";b.tdCls="tr-test-status ";c.isLeaf()?d=(d=c.get("test"))?c.get("isFailed")?"icon-flag":c.get("isRunning")&&!d.isFinished()?"icon-lightning":d.isFinished()?d.isPassed()?"icon-checkmark":"icon-bug":"icon-busy":c.get("isMissing")?"icon-close":c.get("isStarting")?"icon-busy":"icon-file-2":(b=c.get("folderStatus"),d=c.data.expanded?
d+" icon-folder-open":d+" icon-folder","working"==b?d+=" icon-busy":"working"==b?d+=" icon-busy":"green"==b&&(e+=' <span class="folder-status-icon icon-checkmark"></span>'),d+=" tr-folder-"+b);return'<span class="test-icon '+d+'"></span>'+e+a}}),Ext.define("Siesta.Harness.Browser.UI.TestGridController",{extend:"Ext.app.ViewController",alias:"controller.testgrid",control:{"#":{collapse:"onCollapse",expand:"onExpand"},"#tool-menu [option]":{click:"onMenuItemClick"},"[actionName^=run]":{click:"onRunBtnClicked"},
"[actionName=show-coverage]":{click:"onShowCoverageReport"},"#aboutSiesta":{click:"onAboutSiesta"}},onCollapse:function(){Ext.getBody().down(".logo-link").hide()},onExpand:function(){Ext.getBody().down(".logo-link").show()},onShowCoverageReport:function(){this.getView().fireEvent("showcoverageinfo",this)},onRunBtnClicked:function(a){this.getView().fireEvent("buttonclick",this,a,a.actionName)},onMenuItemClick:function(a){this.getView().fireEvent("optionchange",this,a.option,a.checked)},onAboutSiesta:function(){(new Siesta.Harness.Browser.UI.AboutWindow).show()}}),
Ext.define("Siesta.Harness.Browser.UI.TestGrid",{extend:"Ext.tree.Panel",alias:"widget.testgrid",controller:"testgrid",requires:["Siesta.Harness.Browser.UI.FilterableTreeView"],stateful:!0,rootVisible:!1,header:!1,rowLines:!1,border:!1,cls:"tr-testgrid",iconCls:"tr-status-neutral-small",width:340,collapsible:!0,expanded:!0,viewType:"filterabletreeview",enableColumnMove:!1,lines:!1,filter:null,filterGroups:!1,resultSummary:null,stateConfig:null,showSizeControls:!1,coverageReportButton:null,initComponent:function(){var a=
this,b=Siesta.Resource("Siesta.Harness.Browser.UI.TestGrid"),c=this.stateConfig;Ext.apply(this,{title:b.get("title"),viewConfig:{enableTextSelection:!0,toggleOnDblClick:!1,markDirty:!1,trackOver:!1,shouldUpdateCell:function(a,b,c){return"passCount"===b.dataIndex&&c&&!Ext.Array.contains(c,"passCount")&&!Ext.Array.contains(c,"todoPassCount")||"failCount"===b.dataIndex&&c&&!Ext.Array.contains(c,"failCount")&&!Ext.Array.contains(c,"todoFailCount")?0:Ext.tree.View.prototype.shouldUpdateCell.apply(this,
arguments)}},columns:{createFocusableContainerKeyNav:Ext.emptyFn,items:[{xtype:"testnamecolumn",store:this.store},{header:b.get("passText"),width:50,sortable:!1,tdCls:"x-unselectable",menuDisabled:!0,dataIndex:"passCount",align:"center",renderer:this.passedColumnRenderer,scope:this},{header:b.get("failText"),width:50,sortable:!1,tdCls:"x-unselectable",menuDisabled:!0,dataIndex:"failCount",align:"center",renderer:this.failedColumnRenderer,scope:this}]},bbar:{xtype:"toolbar",cls:"main-bbar siesta-toolbar",
border:!1,height:45,defaults:{scale:"large",width:30,tooltipType:"title"},items:[{glyph:58895,cls:"run-checked",text:'<span class="icon-checkmark"></span>',tooltip:b.get("runCheckedText"),actionName:"run-checked"},{glyph:58898,cls:"run-all",tooltip:b.get("runAllText"),actionName:"run-all"},{glyph:58895,cls:"run-failed",text:'<span class="icon-bug"></span>',tooltip:b.get("runFailedText"),actionName:"run-failed"},{glyph:58903,tooltip:b.get("showCoverageReportText"),cls:"show-coverage",actionName:"show-coverage",
disabled:!0},{glyph:58904,tooltip:b.get("optionsText"),cls:"options",action:"options",menu:{itemId:"tool-menu",items:[{text:b.get("transparentExText"),option:"transparentEx",checked:c.transparentEx},{text:b.get("cachePreloadsText"),option:"cachePreload",checked:c.cachePreload},{text:b.get("autoLaunchText"),option:"autoRun",checked:c.autoRun},{text:b.get("speedRunText"),option:"speedRun",checked:c.speedRun},{text:b.get("breakOnFailText"),option:"breakOnFail",checked:c.breakOnFail},{text:b.get("debuggerOnFailText"),
option:"debuggerOnFail",checked:c.debuggerOnFail},{xtype:"menuseparator"},{text:b.get("aboutText"),itemId:"aboutSiesta"},{text:b.get("documentationText"),href:b.get("siestaDocsUrl"),hrefTarget:"_blank"}]}},"->",{xtype:"component",cls:"summary-bar",border:!1,width:55,itemId:"result-summary",data:{pass:0,fail:0},tpl:'<div><span class="total-pass">{pass}</span><span class="icon-checkmark"></span></div><div><span class="total-fail">{fail}</span><span class="icon-bug"></span></div>'}]},dockedItems:this.showSizeControls?
[{xtype:"toolbar",cls:"size-toolbar",border:!0,dock:"bottom",items:[{xtype:"slider",itemId:"framesizeSlider",width:130,value:3,increment:1,minValue:0,maxValue:this.viewportSizes.length-1,listeners:{change:this.onDimensionOrOrientationChange,scope:this}},{xtype:"label",cls:"size-label",itemId:"sizeLabel",width:65},{boxLabel:b.get("landscape"),itemId:"orientationCheckbox",xtype:"checkbox",checked:!0,listeners:{change:this.onDimensionOrOrientationChange,scope:this}}]}]:[]});this.callParent(arguments);
a=this;this.getView().on("beforerefresh",function(){var b=a.down("#trigger");a.filterGroups&&b.setFilterGroups(a.filterGroups);a.filter&&b.setValue(a.filter);return!a.filter},null,{single:!0});this.coverageReportButton=this.down("[actionName=show-coverage]")},onDimensionOrOrientationChange:function(a,b){var c=this.viewportSizes[this.framesizeSlider.getValue()],d=this.orientationCheckbox.getValue();this.sizeLabel.setText(c.join("x"));this.fireEvent("framesizechange",a,c[0],c[1],d)},getFilterValue:function(){return this.down("#trigger").getValue()},
getFilterGroups:function(){return this.down("#trigger").getFilterGroups()},passedColumnRenderer:function(a,b,c){if(!c.isLeaf())return"";0<c.data.todoPassCount&&(a+=' <span title="'+c.data.todoPassCount+" "+Siesta.Resource("Siesta.Harness.Browser.UI.TestGrid","todoPassedText")+'" class="tr-test-todo tr-test-todo-pass">+ '+c.data.todoPassCount+"</span>");return a},failedColumnRenderer:function(a,b,c){if(!c.isLeaf())return"";0<c.data.todoFailCount&&(a+=' <span title="'+c.data.todoFailCount+" "+Siesta.Resource("Siesta.Harness.Browser.UI.TestGrid",
"todoFailedText")+'" class="tr-test-todo tr-test-todo-fail">+ '+c.data.todoFailCount+"</span>");return a},afterRender:function(){this.callParent(arguments);this.summaryPassEl=this.el.down(".total-pass");this.summaryFailEl=this.el.down(".total-fail");if(this.showSizeControls){this.orientationCheckbox=this.down("#orientationCheckbox");this.sizeLabel=this.down("#sizeLabel");this.framesizeSlider=this.down("#framesizeSlider");var a=this.viewportSizes[this.framesizeSlider.getValue()];this.sizeLabel.setText(a.join("x"))}},
...
!1;Ext.Ajax.request({url:"http://bryntum.com/changelogs/_siesta.php",callback:function(a,d,e){b.body.unmask();d&&e&&e.responseText?b.body.update(e.responseText):b.body.update(Siesta.Resource("Siesta.Harness.Browser.UI.ResultPanel","changelogLoadFailedText"))}});Ext.data.Connection.prototype.useDefaultXhrHeader=!0}}),Ext.define("Siesta.Harness.Browser.UI.Header",{extend:"Ext.Component",xtype:"siesta-header",cls:"siesta-header",afterRender:function(){var a=Siesta.Resource("Siesta.Harness.Browser.UI.Viewport");
...
c&&c.getId()==a.url&&(c=this.slots.resultPanel,c.showTest(a,b.get("assertionsStore")),c.setInitializing(!1))},isTestUpdateActual:function(a,b){b=b||this.testsStore.getNodeById(a.url);var c=b.get("test");return c&&c.isFromTheSameGeneration(a)},onTestUpdate:function(a,b,c){var d=this.testsStore.getNodeById(a.url);this.isTestUpdateActual(a,d)&&(this.processNewResult(d.get("assertionsStore"),a,b,c),this.getOption("breakOnFail")&&0<a.getFailCount()&&(this.performStop(),this.slots.filesTree.getSelectionModel().select(d)))},
...
b){var c=this.testsStore.getNodeById(b.url);this.isTestUpdateActual(b,c)&&this.processEveryTestEnd(c.get("assertionsStore"),b)},onTestFail:function(a,b,c){b=this.testsStore.getNodeById(a.url);this.isTestUpdateActual(a,b)&&!a.isTodo&&(b.set("isFailed",!0),b.parentNode&&b.parentNode.updateFolderStatus())},getOption:function(a){switch(a){case "selection":return this.selection;case "selectedURL":return this.selectedURL;default:return this.harness[a]}},setOption:function(a,b){switch(a){case "selection":return this.selection=
b||{};case "selectedURL":return this.selectedURL=b;case "collapsedNodes":return this.collapsedNodes=b;case "filter":return this.filter=b;case "filterGroups":return this.filterGroups=b;default:return this.harness[a]=b}},getState:function(){return{autoRun:this.getOption("autoRun"),speedRun:this.getOption("speedRun"),viewDOM:this.getOption("viewDOM"),cachePreload:this.getOption("cachePreload"),transparentEx:this.getOption("transparentEx"),breakOnFail:this.getOption("breakOnFail"),debuggerOnFail:this.getOption("debuggerOnFail"),
...
Ext.data.Connection.override({parseStatus:function(a){var b=this.callOverridden(arguments);0===a&&(b.success=!0);return b}}));
